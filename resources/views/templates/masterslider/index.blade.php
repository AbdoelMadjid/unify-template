...
<body>
    <main>
        ...
        <section class="g-min-height-60vh g-py-50">
            <div class="container">
                <h1 class="h1 g-font-weight-300 g-color-black g-mb-20">Please download the <strong>Master
                        Slider</strong> demos from the provided dropbox link inside the <strong>README.txt</strong>
                    file.</h1>
            ...
            <div class="d-md-flex justify-content-md-center text-center">
                ...
                <div class="align-self-md-center">
                    <a class="btn btn-lg u-btn-white text-uppercase g-font-weight-600 g-font-size-12" target="_blank"
                        href="https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697">Purchase
                        Now</a>
                </div>
            </div>
        </section>
