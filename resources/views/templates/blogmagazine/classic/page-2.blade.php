...
<head>
    <!-- Title -->
    <title>Blog and Magazine Page Layout 3 | Unify - Responsive Website Template</title>
...
<body>
    <main>
        ...
        <div class="u-rev-slider-v2 g-overflow-hidden">
            <div id="revSliderWrapper" class="rev_slider_wrapper fullwidthbanner-container"
                style="margin: 0 auto; background: #fff; padding: 0; margin-top: 0;margin-bottom: 0;"
                data-alias="carousel-gallery" data-source="gallery">
                <!-- START REVOLUTION SLIDER 5.4.1 fullwidth mode -->
                <div id="revSlider" class="rev_slider fullwidthabanner" style="display: none;" data-version="5.4.1">
                    <ul>
                        <!-- SLIDE  -->
                        <li data-index="rs-41" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img12.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="SPORT"
                            data-title="First Look: New Niner AIR 9 Mountain Bike and RLT 9 Gravel Bike">
                            <!-- MAIN IMAGE -->
                            <img class="rev-slidebg" src="blogmagazine/classic/assets/img/bg/transparent.png"
                                alt="Image description"
                                data-lazyload="blogmagazine/classic/assets/img-temp/1920x1080/img2.jpg"
                            ...
                            <!-- LAYER NR. 1 -->
                            <div id="slide-41-layer-1" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 13px; line-height: 30px; font-weight: 700; color: #6281c8;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['155','155','145','180']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                SPORT <span
                                    class="g-color-secondary-dark-v1 g-font-size-10 g-opacity-0_3 g-pos-rel g-top-minus-2 mx-2">|</span>
                                <span class="g-color-secondary-dark-v1 g-font-weight-400 text-capital">August 17,
                                    2017</span>
                            </div>

                            <!-- LAYER NR. 2 -->
                            <a id="slide-41-layer-1" class="tp-caption tp-resizeme" href="#" target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: #fff; font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                                data-fontsize="['40','40','30','25']" data-lineheight="['55','55','45','35']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <div id="slide-41-layer-4" class="tp-caption tp-resizeme"
                                ...
                                data-y="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                data-voffset="['50','50','0','0']" data-fontsize="['15','15','15','13']"
                                data-lineheight="['30','30','30','25']" data-width="['600','550','350','260']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]">
                                <a class="btn u-btn-primary g-color-white g-font-weight-700 g-font-size-13 text-uppercase rounded g-py-12 g-px-20"
                                    href="bm-classic-single-2.html">Read More</a>
                            </div>
                        </li>

                        <!-- SLIDE  -->
                        <li data-index="rs-47" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img18.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="YOUTUBE VIDEO"
                            data-title="45 days of great adventures of two young Russian men in Vietnam tour">
                            <!-- MAIN IMAGE -->
                            <img src="blogmagazine/classic/assets/img-temp/1920x1080/img8.jpg" alt="Image description"
                                data-bgposition="center center" data-bgfit="cover" class="rev-slidebg"
                                data-no-retina>

                            <!-- BACKGROUND VIDEO LAYER -->
                            <div class="rs-background-video-layer" data-forcerewind="on" data-volume="100"
                            ...
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption Video-SubTitle   tp-resizeme" id="slide-47-layer-1"
                                data-x="10" data-y="bottom" data-voffset="50" data-width="['auto']"
                                data-height="['auto']" data-type="text" data-responsive_offset="on"
                                data-frames='[{"from":"y:bottom;rZ:90deg;sX:2;sY:2;","speed":1500,"to":"o:1;tO:-20% 50%;","delay":500,"ease":"Power3.easeInOut"},{"delay":3000,"speed":1000,"to":"y:50px;opacity:0;","ease":"Power3.easeInOut"}]'
                                data-textAlign="['left','left','left','left']" data-paddingtop="[5,5,5,5]"
                                data-paddingright="[5,5,5,5]" data-paddingbottom="[5,5,5,5]"
                                data-paddingleft="[5,5,5,5]"
                                style="z-index: 9; white-space: nowrap;text-transform:left;">NOW PLAYING
                            </div>

                            <!-- LAYER NR. 6 -->
                            <div class="tp-caption Video-Title   tp-resizeme" id="slide-1613-layer-2"
                                data-x="10" data-y="bottom" data-voffset="10" data-width="['auto']"
                                data-height="['auto']" data-type="text" data-responsive_offset="on"
                                data-frames='[{"from":"y:bottom;rZ:90deg;sX:2;sY:2;","speed":1500,"to":"o:1;tO:-20% 50%;","delay":750,"ease":"Power3.easeInOut"},{"delay":2500,"speed":1000,"to":"y:50px;opacity:0;","ease":"Power3.easeInOut"}]'
                                data-textAlign="['left','left','left','left']" data-paddingtop="[5,5,5,5]"
                                data-paddingright="[5,5,5,5]" data-paddingbottom="[5,5,5,5]"
                                data-paddingleft="[5,5,5,5]"
                                style="z-index: 10; white-space: nowrap;text-transform:left;">THE ROAD STORY VIETNAM
                            </div>
                        </li>
                        ...
                        <li data-index="rs-42" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img13.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="ARCHITECTURE"
                            data-title="Lesson in minimalism: at home with media mogul Mads Munk in Denmark">
                            <div class="tp-caption tp-shape tp-shapewrapper" id="slide-42-layer-5"
                            ...
                            <img class="rev-slidebg" src="blogmagazine/classic/assets/img/bg/transparent.png"
                                alt="Image description"
                                data-lazyload="blogmagazine/classic/assets/img-temp/1920x1080/img3.jpg"
                                data-bgposition="center center" data-kenburns="on" data-duration="30000"
                                data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120"
                                data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0"
                                data-offsetstart="0 0" data-offsetend="0 0">
                            ...
                            <!-- LAYER NR. 1 -->
                            <div id="slide-42-layer-1" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 13px; line-height: 30px; font-weight: 700; color: #6281c8;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['155','155','145','180']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                data-paddingleft="[0,0,0,0]">
                                ARCHITECTURE <span
                                    class="g-color-white g-font-size-10 g-opacity-0_3 g-pos-rel g-top-minus-2 mx-2">|</span>
                                <span class="g-color-white g-font-weight-400 text-capital g-opacity-0_6">August 16,
                                    2017</span>
                            </div>

                            <!-- LAYER NR. 2 -->
                            <a id="slide-42-layer-1" class="tp-caption tp-resizeme" href="#"
                                target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                                data-fontsize="['40','40','30','25']" data-lineheight="['55','55','45','35']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                                data-type="text" data-actions="" data-basealign="slide"
                                data-responsive_offset="on"
                                data-frames='[
                     {"from":"y:20px;opacity:0;","speed":2000,"to":"o:1;","delay":200,"ease":"Power4.easeOut"},
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                        ...
                        <!-- SLIDE  -->
                        <li data-index="rs-43" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img15.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="ART"
                            ...
                            <img class="rev-slidebg" src="assets/img/bg/transparent.png" alt="Image description"
                                data-lazyload="blogmagazine/classic/assets/img-temp/1920x1080/img5.jpg"
                                data-bgposition="center center" data-kenburns="on" data-duration="30000"
                                data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120"
                                data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0"
                                data-offsetstart="0 0" data-offsetend="0 0">
                            ...
                            <!-- LAYER NR. 1 -->
                            <div id="slide-43-layer-1" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 13px; line-height: 30px; font-weight: 700; color: #6281c8;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['155','155','145','180']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-43-layer-1" class="tp-caption tp-resizeme" href="#"
                                target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                        ...
                        <li data-index="rs-48" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img19.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="VIMEO VIDEO"
                            data-title="Volcano Calbuco erupted on April 22, 2015, for the first time in four decades.">
                            <!-- MAIN IMAGE -->
                            <img src="blogmagazine/classic/assets/img-temp/1920x1080/img9.jpg"
                            ...
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption Video-SubTitle   tp-resizeme" id="slide-48-layer-1"
                                data-x="10" data-y="bottom" data-voffset="50" data-width="['auto']"
                                data-height="['auto']" data-type="text" data-responsive_offset="on"
                                data-frames='[{"from":"y:bottom;rZ:90deg;sX:2;sY:2;","speed":1500,"to":"o:1;tO:-20% 50%;","delay":500,"ease":"Power3.easeInOut"},{"delay":3000,"speed":1000,"to":"y:50px;opacity:0;","ease":"Power3.easeInOut"}]'
                                data-textAlign="['left','left','left','left']" data-paddingtop="[5,5,5,5]"
                        ...
                        <!-- SLIDE  -->
                        <li data-index="rs-46" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img14.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="ARCHITECTURE"
                            ...
                            <!-- MAIN IMAGE -->
                            <img class="rev-slidebg" src="assets/img/bg/transparent.png" alt="Image description"
                                data-lazyload="blogmagazine/classic/assets/img-temp/1920x1080/img4.jpg"
                                data-bgposition="center center" data-kenburns="on" data-duration="30000"
                                data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120"
                                data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0"
                                data-offsetstart="0 0" data-offsetend="0 0">
                            ...
                            <!-- LAYER NR. 1 -->
                            <div id="slide-46-layer-1" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 13px; line-height: 30px; font-weight: 700; color: #6281c8;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['155','155','145','180']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                ARCHITECTURE <span
                                    class="g-color-white g-font-size-10 g-opacity-0_3 g-pos-rel g-top-minus-2 mx-2">|</span>
                                <span class="g-color-white g-font-weight-400 text-capital g-opacity-0_6">August 11,
                                    2017</span>
                            </div>

                            <!-- LAYER NR. 2 -->
                            <a id="slide-46-layer-1" class="tp-caption tp-resizeme" href="#"
                                target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                        ...
                        <li data-index="rs-44" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img16.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="BUSINESS"
                            ...
                            <!-- MAIN IMAGE -->
                            <img class="rev-slidebg" src="assets/img/bg/transparent.png" alt="Image description"
                                data-lazyload="blogmagazine/classic/assets/img-temp/1920x1080/img6.jpg"
                                data-bgposition="center center" data-kenburns="on" data-duration="30000"
                                data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120"
                                data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0"
                                data-offsetstart="0 0" data-offsetend="0 0">
                            ...
                            <!-- LAYER NR. 1 -->
                            <div id="slide-44-layer-1" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 13px; line-height: 30px; font-weight: 700; color: #6281c8;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['155','155','145','180']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-44-layer-1" class="tp-caption tp-resizeme" href="#"
                                target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                        ...
                        <!-- SLIDE  -->
                        <li data-index="rs-45" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300"
                            data-thumb="blogmagazine/classic/assets/img-temp/100x100/img17.jpg" data-rotate="0"
                            data-saveperformance="off" data-param1="STARTUP"
                            ...
                            <!-- MAIN IMAGE -->
                            <img class="rev-slidebg" src="assets/img/bg/transparent.png" alt="Image description"
                                data-lazyload="blogmagazine/classic/assets/img-temp/1920x1080/img7.jpg"
                                data-bgposition="center center" data-kenburns="on" data-duration="30000"
                                data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120"
                                data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0"
                                data-offsetstart="0 0" data-offsetend="0 0">
                            ...
                            <!-- LAYER NR. 1 -->
                            <div id="slide-45-layer-1" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 13px; line-height: 30px; font-weight: 700; color: #6281c8;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['155','155','145','180']"
                                data-width="['600','550','350','260']" data-height="none" data-whitespace="normal"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-45-layer-1" class="tp-caption tp-resizeme" href="#"
                                target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
        ...
        <div class="container g-pt-100 g-pb-500">
            <div class="u-heading-v3-1 g-mb-30">
                <h2 class="h5 u-heading-v3__title g-color-gray-dark-v1 text-uppercase g-brd-primary">Popular News</h2>
            </div>
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100"
                                src="blogmagazine/classic/assets/img-temp/400x270/img11.jpg"
                                alt="Image Description">
                        ...
                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">10 Best
                                tips and resources for UX/UI Designers in 2017</a>
                        </h3>
                        ...
                        <p class="g-color-gray-dark-v41">Clark Valberg is the founder and CEO of InVision. If you are
                            a designer, you have probably gotten. If you are a designer, you have probably gotten.</p>
                    ...
                    <article class="g-mb-40">
                        ...
                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                href="#">Exclusive interview with InVision's CEO at Pixeel</a>
                        </h3>
                        ...
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            ...
                            <figcaption class="g-pos-abs g-top-20 g-left-20">
                                <a class="btn btn-xs u-btn-darkgray text-uppercase rounded-0"
                                    href="#">Interior Design</a>
                            </figcaption>
                        </figure>

                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                href="#">Fashion's first showcase: It is a nice idea to make great design</a>
                        </h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100"
                                src="blogmagazine/classic/assets/img-temp/400x270/img14.jpg"
                                alt="Image Description">
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100"
                                src="blogmagazine/classic/assets/img-temp/400x270/img16.jpg"
                                alt="Image Description">
                        ...
                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Ice
                                Cream drinks for all in 2017</a>
                        </h3>
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100"
                                src="blogmagazine/classic/assets/img-temp/400x270/img17.jpg"
                                alt="Image Description">
                        ...
                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Awesome
                                New Year Event</a>
                        </h3>
        ...
        <div class="g-bg-secondary g-py-70">
            <div class="container">
                <div class="u-heading-v3-1 g-mb-30">
                    <h2 class="h5 u-heading-v3__title g-color-gray-dark-v1 text-uppercase g-brd-primary">Other News
                    </h2>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 g-mb-30">
                        ...
                        <article class="media">
                            <figure class="d-flex u-shadow-v25 mr-3 g-pos-rel">
                                <img class="g-width-140 g-height-80"
                                    src="blogmagazine/classic/assets/img-temp/200x115/img1.jpg"
                                    alt="Image Description">
                            ...
                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-gray-dark-v1" href="#">8 health benefits and drawbacks
                                        of coffee</a>
                                </h3>
                        ...
                        <hr class="g-brd-secondary-light-v2 g-my-25">

                        <!-- Other Articles -->
                        <article class="media">
                            <figure class="d-flex u-shadow-v25 mr-3 g-pos-rel">
                                <img class="g-width-140 g-height-80"
                                    src="blogmagazine/classic/assets/img-temp/200x115/img3.jpg"
                                    alt="Image Description">
                            ...
                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-gray-dark-v1" href="#">Top 7 Luxury places to visit
                                        around Victoria, BC</a>
                                </h3>
                    ...
                    <div class="col-md-4 g-mb-30">
                        ...
                        <article class="media">
                            <figure class="d-flex u-shadow-v25 mr-3 g-pos-rel">
                                <img class="g-width-140 g-height-80"
                                    src="blogmagazine/classic/assets/img-temp/200x115/img5.jpg"
                                    alt="Image Description">
                            ...
                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-gray-dark-v1" href="#">10 Most beautiful and popular
                                        beaches in the Wrold</a>
                                </h3>
                        ...
                        <article class="media">
                            <figure class="d-flex u-shadow-v25 mr-3 g-pos-rel">
                                <img class="g-width-140 g-height-80"
                                    src="blogmagazine/classic/assets/img-temp/200x115/img2.jpg"
                                    alt="Image Description">
                            ...
                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-gray-dark-v1" href="#">5 Best cofee places with free
                                        WiFi in Victoria, BC</a>
                                </h3>
                    ...
                    <div class="col-md-4 g-mb-30">
                        ...
                        <article class="media">
                            <figure class="d-flex u-shadow-v25 mr-3 g-pos-rel">
                                <img class="g-width-140 g-height-80"
                                    src="blogmagazine/classic/assets/img-temp/200x115/img6.jpg"
                                    alt="Image Description">
                            ...
                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-gray-dark-v1" href="#">Stylish things to do, buy one get
                                        2 free</a>
                                </h3>
                        ...
                        <article class="media">
                            <figure class="d-flex u-shadow-v25 mr-3 g-pos-rel">
                                <img class="g-width-140 g-height-80"
                                    src="blogmagazine/classic/assets/img-temp/200x115/img4.jpg"
                                    alt="Image Description">
                            ...
                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-gray-dark-v1" href="#">Top 10 Luxury Hotels - 5 Star
                                        Best Luxury Hotels</a>
                                </h3>
        ...
        <div class="container g-pt-100 g-pb-500">
            <div class="u-heading-v3-1 g-mb-30">
                <h2 class="h5 u-heading-v3__title g-color-gray-dark-v1 text-uppercase g-brd-primary">Weekly News</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100"
                                src="blogmagazine/classic/assets/img-temp/400x270/img18.jpg"
                                alt="Image Description">

                            <figcaption class="g-pos-abs g-top-20 g-left-20">
                                <a class="btn btn-xs u-btn-pink text-uppercase rounded-0" href="#">Food</a>
                            </figcaption>
                        </figure>

                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Best
                                dessert recipes for breakfast which will make your day</a>
                        </h3>
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img4.jpg"
                                alt="Image Description">
                        ...
                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Stylish
                                things to do, see and purchase only this week</a>
                        </h3>
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img9.jpg"
                                alt="Image Description">
                        ...
                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                href="#">Government plans to test new primary school pupils and teachers..</a>
                        </h3>
