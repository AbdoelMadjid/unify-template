        ...
        <div class="u-rev-slider-v2 g-overflow-hidden">
            <div id="revSliderWrapper" class="rev_slider_wrapper fullwidthbanner-container"
                ...
                <div id="revSlider" class="rev_slider fullwidthabanner" style="display: none;" data-version="5.4.1">
                    <ul>
                        <!-- SLIDE  -->
                        <li data-index="rs-41" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            data-hideslideonmobile="off" data-easein="default" data-easeout="default"
                            data-masterspeed="300" data-thumb="blogmagazine/classic/assets/img-temp/100x100/img12.jpg"
                            data-rotate="0" data-saveperformance="off" data-param1="SPORT"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                        ...
                        <li data-index="rs-47" data-transition="fade" data-slotamount="default"
                            ...
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption Video-SubTitle   tp-resizeme" id="slide-47-layer-1" data-x="10"
                                data-y="bottom" data-voffset="50" data-width="['auto']" data-height="['auto']"
                            ...
                            <!-- LAYER NR. 6 -->
                            <div class="tp-caption Video-Title   tp-resizeme" id="slide-1613-layer-2" data-x="10"
                                data-y="bottom" data-voffset="10" data-width="['auto']" data-height="['auto']"
                                data-type="text" data-responsive_offset="on"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-42-layer-1" class="tp-caption tp-resizeme" href="#" target="_self"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-43-layer-1" class="tp-caption tp-resizeme" href="#" target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                                data-fontsize="['40','40','30','25']" data-lineheight="['55','55','45','35']"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                        ...
                        <li data-index="rs-48" data-transition="fade" data-slotamount="default"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="blogmagazine/classic/assets/img-temp/1920x1080/img9.jpg" alt="Image description"
                                data-bgposition="center center" data-bgfit="cover" class="rev-slidebg"
                                data-no-retina>
                            ...
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption Video-SubTitle   tp-resizeme" id="slide-48-layer-1" data-x="10"
                                data-y="bottom" data-voffset="50" data-width="['auto']" data-height="['auto']"
                                data-type="text" data-responsive_offset="on"
                                data-frames='[{"from":"y:bottom;rZ:90deg;sX:2;sY:2;","speed":1500,"to":"o:1;tO:-20% 50%;","delay":500,"ease":"Power3.easeInOut"},{"delay":3000,"speed":1000,"to":"y:50px;opacity:0;","ease":"Power3.easeInOut"}]'
                                data-textAlign="['left','left','left','left']" data-paddingtop="[5,5,5,5]"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-46-layer-1" class="tp-caption tp-resizeme" href="#" target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                                data-fontsize="['40','40','30','25']" data-lineheight="['55','55','45','35']"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-44-layer-1" class="tp-caption tp-resizeme" href="#" target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                                data-fontsize="['40','40','30','25']" data-lineheight="['55','55','45','35']"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 2 -->
                            <a id="slide-45-layer-1" class="tp-caption tp-resizeme" href="#" target="_self"
                                style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal; font-size: 40px; line-height: 55px; font-weight: 500; color: rgba(255, 255, 255, 1); font-family: Roboto Slab; text-decoration: none;"
                                data-x="['center','center','center','center']" data-y="['top','top','top','top']"
                                data-hoffset="['0','0','0','0']" data-voffset="['200','200','180','220']"
                                data-fontsize="['40','40','30','25']" data-lineheight="['55','55','45','35']"
        ...
        <div class="container g-pt-100 g-pb-500">
            ...
            <div class="row">
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img12.jpg"
                                alt="Image Description">
                        ...
                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Exclusive
                                interview with InVision's CEO at Pixeel</a>
                        </h3>
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img15.jpg"
                                alt="Image Description">

                            <figcaption class="g-pos-abs g-top-20 g-left-20">
                                <a class="btn btn-xs u-btn-darkgray text-uppercase rounded-0" href="#">Interior
                                    Design</a>
                            </figcaption>
                        </figure>

                        <h3 class="h4 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Fashion's
                                first showcase: It is a nice idea to make great design</a>
                        </h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img14.jpg"
                                alt="Image Description">
                ...
                <div class="col-md-4 g-mb-50">
                    ...
                    <article class="g-mb-40">
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img16.jpg"
                                alt="Image Description">
