...
<head>
    ...
    <!-- Google Fonts -->
    <link rel="stylesheet"
        href="//fonts.googleapis.com/css?family=Roboto+Slab%3A400%2C300%2C700%7CPlayfair+Display%7CRoboto%7CRaleway%7CSpectral%7CRubik">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 g-hidden-md-down">
                            <a href="bm-classic-home-page-1.html" class="navbar-brand">
                                <img src="blogmagazine/classic/assets/img/logo.png" alt="Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                        ...
                        <div class="col-6 col-md-5">
                            <form class="input-group rounded">
                                <input
                                    class="form-control w-100 g-brd-secondary-light-v2 g-brd-primary--focus g-color-secondary-dark-v1 g-placeholder-secondary-dark-v1 g-bg-white g-font-weight-400 g-font-size-13 rounded g-px-20 g-py-12"
                                    type="text" placeholder="Search the entire site">
                                <span class="input-group-addon g-brd-none g-py-0 g-pr-0">
                                    <button
                                        class="btn u-btn-white g-color-primary--hover g-bg-secondary g-font-weight-600 g-font-size-13 text-uppercase rounded g-py-12 g-px-20"
                                        type="submit">
                        ...
                        <div class="col-4 col-lg-2 g-pos-rel g-px-15 ml-auto">
                            <a id="languages-dropdown-invoker"
                                ...
                                href="#!" aria-controls="languages-dropdown" aria-haspopup="true"
                                aria-expanded="false" data-dropdown-event="hover"
                                data-dropdown-target="#languages-dropdown" data-dropdown-type="css-animation"
                            ...
                            <ul id="languages-dropdown"
                                ...
                                <li>
                                    <a class="d-block g-color-secondary-dark-v1 g-color-primary--hover g-text-underline--none--hover g-py-5 g-px-20"
                                        href="#!">
                                        <svg class="mr-1 g-ml-minus-6" xmlns="http://www.w3.org/2000/svg" height="11"
                                ...
                                <li>
                                    <a class="d-block g-color-secondary-dark-v1 g-color-primary--hover g-text-underline--none--hover g-py-5 g-px-20"
                                        href="#!">
                                        <svg class="mr-1 g-ml-minus-6" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-1">
                            <a id="account-dropdown-invoker"
                                class="media align-items-center float-right g-text-underline--none--hover"
                                href="#!" aria-controls="account-dropdown" aria-haspopup="true"
                                aria-expanded="false" data-dropdown-event="hover"
                                data-dropdown-target="#account-dropdown" data-dropdown-type="css-animation"
                                data-dropdown-duration="300" data-dropdown-hide-on-scroll="false"
                                data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
                            ...
                            <ul class="navbar-nav g-font-weight-600">
                                    ...
                                    <ul id="nav-submenu--home"
                                        ...
                                        <li class="dropdown-item g-bg-secondary--hover">
                                            <a class="nav-link g-color-secondary-dark-v1"
                                                href="bm-classic-home-page-1.html">Home Default</a>
                                        </li>
                                        <li class="dropdown-item g-bg-secondary--hover">
                                            <a class="nav-link g-color-secondary-dark-v1"
                                                href="bm-classic-home-page-2.html">Home Option 2
                                                <span
                                                    class="float-right u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                                            </a>
                                        </li>
                                        <li class="dropdown-item g-bg-secondary--hover">
                                            <a class="nav-link g-color-secondary-dark-v1"
                                                href="bm-classic-home-page-3.html">Home Option 3
                                                <span
                                                    class="float-right u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                                            </a>
                                        </li>
                                        <li class="dropdown-item g-bg-secondary--hover">
                                            <a class="nav-link g-color-secondary-dark-v1"
                                                href="bm-classic-home-page-4.html">Home Option 4
                                                <span
                                                    class="float-right u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                                            </a>
                                        </li>
                                        <li class="dropdown-item g-bg-secondary--hover">
                                            <a class="nav-link g-color-secondary-dark-v1"
                                                href="bm-classic-home-page-5.html">Home Option 5
                                                <span
                                                    class="float-right u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                                            </a>
                                        </li>
                                ...
                                <li class="nav-item hs-has-sub-menu g-mx-10--lg g-mx-20--xl">
                                    ...
                                    <ul id="nav-submenu--pages"
                                        ...
                                        <li class="dropdown-item g-bg-secondary--hover">
                                            <a class="nav-link g-color-secondary-dark-v1"
                                                href="bm-classic-single-1.html">Single Page</a>
                                        </li>
                                    </ul>
                                    <!-- End Submenu -->
                                </li>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                    ...
                                    <a id="mega-menu-label-1" class="nav-link text-uppercase g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">World
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <article class="media g-mb-20">
                                                    <a class="d-flex mr-3" href="#!"><img
                                                            class="g-width-120 g-height-70"
                                                            src="blogmagazine/classic/assets/img-temp/500x320/img1.jpg"
                                                            alt="Image Description"></a>
                                                    <div class="media-body">
                                                        <h3 class="h6">
                                                            <a class="g-color-main" href="#!">8 health benefits
                                                                and drawbacks of coffee</a>
                                                        </h3>
                                                ...
                                                <article class="media g-mb-20">
                                                    <a class="d-flex mr-3" href="#!"><img
                                                            class="g-width-120 g-height-70"
                                                            src="blogmagazine/classic/assets/img-temp/500x320/img2.jpg"
                                                            alt="Image Description"></a>
                                                    <div class="media-body">
                                                        <h3 class="h6">
                                                            <a class="g-color-main" href="#!">5 Best cofee places
                                                                with free WiFi in Victoria, BC</a>
                                                        </h3>
                                                        <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                                ...
                                                <article class="media g-mb-20">
                                                    <a class="d-flex mr-3" href="#!"><img
                                                            class="g-width-120 g-height-70"
                                                            src="blogmagazine/classic/assets/img-temp/500x320/img3.jpg"
                                                            alt="Image Description"></a>
                                                    <div class="media-body">
                                                        <h3 class="h6">
                                                            <a class="g-color-main" href="#!">Top 7 Luxury places
                                                                to visit around Victoria, BC</a>
                                                        </h3>
                                                        <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                            ...
                                            <div class="col-lg-5">
                                                <article class="media g-mb-20">
                                                    ...
                                                    <div class="media-body">
                                                        <h3 class="h6">
                                                            <a class="g-color-main" href="#!">Top 10 Luxury
                                                                Hotels - 5 Star Best Luxury Hotels</a>
                                                        </h3>
                                                        <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                                ...
                                                <article class="media g-mb-20">
                                                    <a class="d-flex mr-3" href="#!"><img
                                                            ...
                                                            alt="Image Description"></a>
                                                    <div class="media-body">
                                                        <h3 class="h6"><a class="g-color-main" href="#!">10
                                                                Most beautiful beaches</a></h3>
                                                        <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                                ...
                                                <article class="media g-mb-20">
                                                    ...
                                                    <div class="media-body">
                                                        <h3 class="h6">
                                                            <a class="g-color-main" href="#!">Stylish things to
                                                                do, see and buy this week</a>
                                                        </h3>
                                                        <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                    data-animation-in="fadeIn" data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-5" class="nav-link text-uppercase g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Sport
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>

                                    <!-- Mega Menu -->
                                    <div class="hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-bg-primary g-left-15 g-right-15 g-px-30 g-mt-17 g-mt-7--lg--scrolling"
                                        aria-labelledby="mega-menu-label-5">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <ul class="list-inline text-center mb-0">
                                                    <li class="list-inline-item">
                                                        <a class="d-inline-block g-color-white-opacity-0_8 g-color-white--hover g-px-10 g-py-15"
                                                            href="#!">Transfer News</a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <a class="d-inline-block g-color-white-opacity-0_8 g-color-white--hover g-px-10 g-py-15"
                                                            href="#!">Premier League</a>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <a class="d-inline-block g-color-white-opacity-0_8 g-color-white--hover g-px-10 g-py-15"
                                                            href="#!">Rugby</a>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                    data-animation-in="fadeIn" data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-3" class="nav-link text-uppercase g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Fashion
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                                                ...
                                                <article>
                                                    <figure class="g-pos-rel">
                                                        <img class="img-fluid w-100 g-mb-20"
                                                            src="blogmagazine/classic/assets/img-temp/900x600/img7.jpg"
                                                            alt="Image Description">
                                                    </figure>
                                                    <h3 class="h4 g-mb-10"><a class="g-color-gray-dark-v2"
                                                            href="#!">Love the mother nature</a>
                                                    </h3>
                                                    <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                                        <li class="list-inline-item">
                                                            <a class="g-color-gray-dark-v4 g-text-underline--none--hover"
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                    data-animation-in="fadeIn" data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-4" class="nav-link text-uppercase g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Hi-Tech
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                                        ...
                                        <div class="row">
                                                ...
                                                <article class="u-block-hover">
                                                    ...
                                                    <header class="g-pos-abs g-bottom-10 g-left-20 g-right-20">
                                                        <small class="g-color-white">
                                                            <i class="icon-clock g-pos-rel g-top-1 g-mr-2"></i> July
                                                            26, 2016
                                                        </small>
                                                        <h3 class="h4 g-font-weight-600 g-mt-5">
                                                            <a class="g-color-white g-color-white--hover"
                                                                href="#!">Be ready, fashion of the year is coming
                                                                this year</a>
                                                        </h3>
                                                    </header>
                                                </article>
                                            ...
                                            <div class="col-lg-4">
                                                <article class="u-block-hover">
                                                    ...
                                                    <header class="g-pos-abs g-bottom-10 g-left-20 g-right-20">
                                                        ...
                                                        <h3 class="h4 g-font-weight-600 g-mt-5">
                                                            <a class="g-color-white g-color-white--hover"
                                                                href="#!">Must be visited places in the USA -
                                                                Florida Beaches</a>
                                                        </h3>
                                                    </header>
                                                </article>
                                            ...
                                            <div class="col-lg-4">
                                                <article class="u-block-hover">
                                                    ...
                                                    <header class="g-pos-abs g-bottom-10 g-left-20 g-right-20">
                                                        <small class="g-color-white">
                                                            <i class="icon-clock g-pos-rel g-top-1 g-mr-2"></i> July 8,
                                                            2016
                                                        </small>
                                                        <h3 class="h4 g-font-weight-600 g-mt-5">
                                                            <a class="g-color-white g-color-white--hover"
                                                                href="#!">Why your next glass of juice will cost
                                                                you more</a>
                                                        </h3>
                                                    </header>
                                                </article>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                    data-animation-in="fadeIn" data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-5" class="nav-link text-uppercase g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Archive
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl"
                                    data-animation-in="fadeIn" data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-6" class="nav-link text-uppercase g-px-0" href="#!"
                                                ...
                                                <article class="u-block-hover">
                                                    ...
                                                    <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                                        ...
                                                        <h3 class="h5 g-font-weight-300 g-mb-0">
                                                            <a class="g-color-white g-color-white--hover"
                                                                href="#!">Best work places around the World for
                                                                your company</a>
                                                        </h3>
                                                    </div>
                                                </article>
                                            ...
                                            <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                                <article class="u-block-hover">
                                                    ...
                                                    <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                                        ...
                                                        <h3 class="h5 g-font-weight-300 g-mb-0">
                                                            <a class="g-color-white g-color-white--hover"
                                                                href="#!">Top 10 bust be used iOS apps for your
                                                                next project</a>
                                                        </h3>
                                                    </div>
                                                </article>
                                            ...
                                            <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                                <article class="u-block-hover">
                                                    ...
                                                    <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                                        ...
                                                        <h3 class="h5 g-font-weight-300 g-mb-0">
                                                            <a class="g-color-white g-color-white--hover"
                                                                href="#!">Discussing the project details is good
                                                                step with team mates</a>
                                                        </h3>
                                                    </div>
                                                </article>
                                            </div>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-ml-15--xl"
                                    data-animation-in="fadeIn" data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-7" class="nav-link text-uppercase g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Life
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i></a>

                                    <!-- Mega Menu -->
                                    <div class="hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-left-15 g-right-15 g-pa-30 g-mt-17 g-mt-7--lg--scrolling"
                                        aria-labelledby="mega-menu-label-7">
                                        <div class="row">
                                            <div class="col-lg-3 g-mb-20 g-mb-0--lg">
                                                <!-- Article -->
                                                <article>
                                                    <div class="g-font-size-12 g-mb-5">
                                                        <i class="icon-clock g-pos-rel g-top-1 g-mr-2"></i> Aug 16,
                                                        2016
                                                    </div>

                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">You've been making
                                                            French Pie all wrong - Until Now</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                                ...
                                                <article>
                                                    <div class="g-font-size-12 g-mb-5">
                                                        <i class="icon-clock g-pos-rel g-top-1 g-mr-2"></i> Aug 02,
                                                        2016
                                                    </div>

                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">Unify facts, study
                                                            finds - sensitive to gluten without having coeliac
                                                            disease</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                            ...
                                            <div class="col-lg-3 g-mb-20 g-mb-0--lg">
                                                ...
                                                <article>
                                                    <div class="g-font-size-12 g-mb-5">
                                                        <i class="icon-clock g-pos-rel g-top-1 g-mr-2"></i> July 18,
                                                        2016
                                                    </div>

                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">Why your next cup of
                                                            cofee with milk will cost you more</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                                ...
                                                <article>
                                                    <div class="g-font-size-12 g-mb-5">
                                                        <i class="icon-clock g-pos-rel g-top-1 g-mr-2"></i> July 12,
                                                        2016
                                                    </div>

                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">Incredible product and
                                                            quality: Unify best template of the year</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                            </div>
                                            ...
                                            <div class="col-lg-3 g-mb-20 g-mb-0--lg">
                                                ...
                                                <article>
                                                    ...
                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">Some post title will be
                                                            implimented here and It's cool!</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                                ...
                                                <article>
                                                    ...
                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">Wireframe approach for
                                                            the news blocks and pages</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                            </div>
                                            ...
                                            <div class="col-lg-3 g-mb-20 g-mb-0--lg">
                                                ...
                                                <article>
                                                    ...
                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">Over thousands of
                                                            components help you to boost your project</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                                ...
                                                <article>
                                                    ...
                                                    <h3 class="h6">
                                                        <a class="g-color-main" href="#!">How to run a ticket:
                                                            Best 10 point approaches for people who stands..</a>
                                                    </h3>
                                                </article>
                                                <!-- End Article -->
                                            </div>
                ...
                <div class="row">
                        ...
                        <article class="g-mb-60">
                                ...
                                <ul class="list-inline text-uppercase mb-0">
                                    ...
                                    <li class="list-inline-item g-mr-10">
                                        <a class="btn u-btn-twitter g-font-size-12 rounded g-px-20--sm g-py-10"
                                            href="#!">
                                            <i class="fa fa-twitter g-mr-5--sm"></i> <span
                                                class="g-hidden-xs-down">Tweet on Twitter</span>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                            ...
                            <div class="g-font-size-16 g-line-height-1_8 g-mb-30">
                                <figure class="u-shadow-v25 g-mb-30">
                                    <img class="img-fluid w-100"
                                        src="blogmagazine/classic/assets/img-temp/900x600/img1.jpg"
                                        alt="Image Description">
                                </figure>

                                <p class="g-color-gray-dark-v2">Aliquam ante ipsum, maximus in orci ut, blandit aliquam
                                    ipsum. Phasellus sed tortor non magna lobortis faucibus. Mauris pharetra convallis
                                    urna, eu porttitor velit pretium eget. Vestibulum vehicula quis felis eget
                                    imperdiet. Sed vulputate tincidunt facilisis. Morbi eu suscipit dolor. Quisque nec
                                    turpis quis ante gravida placerat non at turpis. Phasellus tincidunt nisi eget
                                    posuere porta.</p>

                                <div class="text-center g-width-70x--md mx-auto g-my-40">
                                    <h3 class="text-uppercase g-color-primary">If you can design one thing, you can
                                        design everything. Just believe it.</h3>
                                </div>

                                <p class="g-color-gray-dark-v2">Consectetur adipiscing elit. In risus neque, semper sed
                                    congue eget, ultricies et tortor. Duis lorem libero, dapibus lacinia tellus id,
                                    pulvinar rutrum diam. Cras tempor lectus quis erat facilisis, a commodo mi volutpat.
                                    Sed vitae libero libero. Vestibulum non leo lobortis, placerat est a, laoreet
                                    mauris. Aenean vitae erat interdum, dignissim tellus quis, pellentesque libero.
                                    Nullam feugiat magna non justo sodales mattis. Phasellus mattis velit justo, non
                                    hendrerit felis tincidunt vitae. In at mi finibus, finibus sem dictum, convallis
                                    libero. In condimentum euismod nunc id dapibus. Praesent sagittis posuere felis et
                                    viverra. Mauris eros dui, malesuada nec risus nec, placerat porta sem.</p>

                                <p class="g-color-gray-dark-v2">Cras sit amet mi eros. Pellentesque auctor, massa at
                                    laoreet lobortis, mi lorem commodo enim, non mollis arcu erat ac augue. Class aptent
                                    taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
                                    Mauris maximus enim in mauris ornare bibendum. Cras bibendum, nibh non interdum
                                    lacinia, sem augue convallis nibh, sit amet eleifend lacus felis quis turpis.
                                    Suspendisse potenti.</p>

                                <figure class="text-center text-md-left float-md-left g-pr-30--sm g-py-20 mb-0">
                                    <img class="u-shadow-v25 img-fluid g-width-300"
                                        src="blogmagazine/classic/assets/img-temp/500x650/img1.jpg"
                                        alt="Image Description">
                                ...
                                <p class="g-color-gray-dark-v2">Proin laoreet massa vitae pulvinar accumsan. Aenean
                                    auctor ipsum mauris, et sodales odio tristique non. Quisque eget diam a mi
                                    condimentum ullamcorper imperdiet sed urna. Pellentesque cursus convallis blandit.
                                    Mauris lorem eros, consequat et rutrum id, vestibulum quis felis. Proin non mollis
                                    eros. Curabitur vel laoreet mauris.</p>

                                <p class="g-color-gray-dark-v2">Curabitur dolor elit, egestas eget lectus vel, pretium
                                    semper tellus. Nunc urna lectus, vulputate ut tellus aliquam, pharetra consectetur
                                    enim. Nunc scelerisque libero diam, nec tempor justo hendrerit eu. Donec sed diam
                                    mattis, ullamcorper eros eu, aliquam dui. Maecenas rutrum suscipit risus sed
                                    posuere. Vestibulum imperdiet turpis mauris, sit amet consectetur ex porttitor ut.
                                    Duis sit amet auctor nunc. Praesent ultrices, enim a varius condimentum, nunc elit
                                    rhoncus ligula, quis fringilla risus augue sit amet enim. Mauris et porttitor diam.
                                    In semper volutpat mauris, ac fermentum orci commodo vitae. Curabitur ut feugiat
                                    tellus. Quisque consequat pharetra massa ultricies auctor. Sed mollis vulputate
                                    sapien eget tincidunt. Curabitur tempus lacus a sapien rutrum, feugiat blandit nunc
                                    tincidunt. Donec nec ornare tellus nunc elit rhoncus ligula.</p>

                                <p class="g-color-gray-dark-v2">In neque ipsum, auctor eu bibendum cursus, fringilla
                                    sed magna. Vestibulum lobortis libero et lectus congue efficitur. Suspendisse varius
                                    varius finibus. Maecenas luctus convallis euismod.</p><br>

                                <h3 class="h5 g-color-gray-dark-v1 g-font-weight-600 g-mb-10">Unify Template v2</h3>

                                <p class="g-color-gray-dark-v2">Praesent ultrices, enim a varius condimentum, nunc elit
                                    rhoncus ligula, quis fringilla risus augue sit amet enim. Curabitur dolor elit,
                                    egestas eget lectus vel, pretium semper tellus. Nunc urna lectus, vulputate ut
                                    tellus aliquam, pharetra consectetur enim. Nunc scelerisque libero diam, nec tempor
                                    justo hendrerit eu. Donec sed diam mattis, ullamcorper eros eu, aliquam dui.
                                    Maecenas rutrum suscipit risus sed posuere. Vestibulum imperdiet turpis mauris, sit
                                    amet consectetur ex porttitor ut. Duis sit amet auctor nunc.</p>

                                <div class="g-width-70x--md g-my-40">
                                    <blockquote
                                        class="blockquote g-brd-left g-brd-2 g-brd-gray-light-v4 g-brd-primary--hover text-uppercase g-font-size-22 g-transition-0_2 g-pl-20 g-mb-30">
                                        <p class="g-color-primary">The best ideas come as jokes. Make your thinking as
                                            funny as possible and use them in your projects.</p>
                                        <footer class="blockquote-footer g-font-size-12">John Doe</footer>
                                    </blockquote>
                                </div>

                                <p class="g-color-gray-dark-v2">Adipiscing elit, in risus neque, semper sed congue
                                    eget, ultricies et tortor. Duis lorem libero, dapibus lacinia tellus id, pulvinar
                                    rutrum diam. Cras tempor lectus quis erat facilisis, a commodo mi volutpat. Sed
                                    vitae libero libero. Vestibulum non leo lobortis, placerat est a, laoreet mauris.
                                    Aenean vitae erat interdum, dignissim tellus quis, pellentesque libero. Nullam
                                    feugiat magna non justo sodales mattis. Phasellus mattis velit justo, non hendrerit
                                    felis tincidunt vitae. In at mi finibus, finibus sem dictum, convallis libero. In
                                    condimentum euismod nunc id dapibus. Praesent sagittis posuere felis et viverra.
                                    Mauris eros dui, malesuada nec risus nec, placerat porta sem. Suspendisse id quam in
                                    ante lobortis fringilla. Aenean euismod ante eget auctor fringilla. Morbi consequat
                                    ut felis a scelerisque. Aliquam purus sem, rutrum sit amet ligula a, tristique
                                    porttitor mauris.</p>

                                <figure class="text-center g-my-40">
                                    <img class="u-shadow-v25 img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/430x270/img1.jpg"
                                        alt="Image Description">
                                    <figcaption class="figure-caption g-font-size-12 g-color-gray-dark-v4 g-mt-5">
                                        <em>A caption for the above image.</em>
                                    </figcaption>
                                ...
                                <p class="g-color-gray-dark-v2">Curabitur dolor elit, egestas eget lectus vel, pretium
                                    ...
                                    mattis, ullamcorper eros eu, aliquam dui. Maecenas rutrum suscipit risus sed
                                    posuere. Vestibulum imperdiet turpis mauris, sit amet consectetur ex porttitor ut.
                                    Duis sit amet auctor nunc.</p><br>

                                <h3 class="h5 g-color-gray-dark-v1 g-font-weight-600 g-mb-10">Now and Future</h3>

                                <p class="g-color-gray-dark-v2">Praesent sagittis posuere felis et viverra. Mauris eros
                                    dui, malesuada nec risus nec, placerat porta sem. Suspendisse id quam in ante
                                    lobortis fringilla. Aenean euismod ante eget auctor fringilla. Morbi consequat ut
                                    felis a scelerisque. Aliquam purus sem, rutrum sit amet ligula a, tristique
                                    porttitor mauris.</p>
                                ...
                                <ul class="list-unstyled g-font-size-16 g-my-30">
                                    <li class="g-mb-15">
                                        <h4 class="h6 d-flex align-items-baseline">
                                            ...
                                            <span>Wrapbootstrap Marketplace egestas eget lectus vel, pretium semper
                                                tellus</span>
                                        </h4>
                                    </li>
                                    <li class="g-mb-15">
                                        <h4 class="h6 d-flex align-items-baseline">
                                            <i class="fa fa-angle-right g-color-gray-dark-v5 g-mr-10"></i>
                                            <span>Google Adwords &amp; Adsense purus sem, rutrum sit amet ligula a,
                                                tristique port</span>
                                        </h4>
                                    </li>
                                    <li class="g-mb-15">
                                        <h4 class="h6 d-flex align-items-baseline">
                                            <i class="fa fa-angle-right g-color-gray-dark-v5 g-mr-10"></i>
                                            <span>Web Design with UX/UI enim a varius condimentum, nunc elit
                                                rhoncus</span>
                                        </h4>
                                    </li>
                                    <li class="g-mb-15">
                                        <h4 class="h6 d-flex align-items-baseline">
                                            <i class="fa fa-angle-right g-color-gray-dark-v5 g-mr-10"></i>
                                            <span>Digital Marketing scelerisque libero diam, nec tempor justo
                                                hendreri</span>
                                        </h4>
                                    </li>
                                    <li class="g-mb-15">
                                    ...
                                    <li>
                                        <h4 class="h6 d-flex align-items-baseline">
                                            <i class="fa fa-angle-right g-color-gray-dark-v5 g-mr-10"></i>
                                            <span>Unify Template Pages eros duiesuada nec risus nec, placerat porta
                                                sem</span>
                                        </h4>
                                    </li>
                                </ul>
                                ...
                                <p class="g-color-gray-dark-v2">Praesent ultrices, enim a varius condimentum, nunc elit
                                    ...
                                    egestas eget lectus vel, pretium semper tellus. Nunc urna lectus, vulputate ut
                                    tellus aliquam, pharetra consectetur enim. Nunc scelerisque libero diam, nec tempor
                                    justo hendrerit eu.</p>

                                <div class="text-center g-width-70x--md mx-auto g-my-40">
                                    <h3 class="text-uppercase g-color-primary">Finding ways to help tell your story
                                        through video is a powerful tool.</h3>
                                </div>

                                <p class="g-color-gray-dark-v2">Mauris et porttitor diam. In semper volutpat mauris, ac
                                    fermentum orci commodo vitae. Curabitur ut feugiat tellus. Quisque consequat
                                    pharetra massa ultricies auctor. Sed mollis vulputate sapien eget tincidunt.
                                    Curabitur tempus lacus a sapien rutrum, feugiat blandit nunc tincidunt. Donec nec
                                    ornare tellus. In neque ipsum, auctor eu bibendum cursus, fringilla sed magna.
                                    Vestibulum lobortis libero et lectus congue efficitur. Suspendisse varius varius
                                    finibus. Maecenas luctus convallis euismod. Praesent ultrices, enim a varius
                                    condimentum, nunc elit rhoncus ligula, quis fringilla risus augue sit amet enim.</p>
                            </div>
                            ...
                            <div class="g-mb-40">
                                <div class="u-heading-v3-1 g-mb-30">
                                    <h2
                                        class="h5 u-heading-v3__title g-color-gray-dark-v1 text-uppercase g-brd-primary">
                                        Related Articles</h2>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6 g-mb-30">
                                        <article>
                                            <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                                <img class="img-fluid w-100"
                                                    src="blogmagazine/classic/assets/img-temp/400x270/img2.jpg"
                                                    alt="Image Description">
                                            ...
                                            <h3 class="g-font-size-16 g-mb-10">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Clark Valberg is a new CEO of InVision..</a>
                                            </h3>
                                        </article>
                                    </div>
                                    <!-- End Article Video -->
                                    ...
                                    <div class="col-lg-4 col-sm-6 g-mb-30">
                                        <article>
                                            <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                                <img class="img-fluid w-100"
                                                    src="blogmagazine/classic/assets/img-temp/400x270/img3.jpg"
                                                    alt="Image Description">
                                            ...
                                            <h3 class="g-font-size-16 g-mb-10">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">How to run a ticket: Best 10 point..</a>
                                            </h3>
                                        </article>
                                    </div>
                                    <!-- End Article Video -->
                                    ...
                                    <div class="col-lg-4 col-sm-6 g-mb-30">
                                        <article>
                                            <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                                <img class="img-fluid w-100"
                                                    src="blogmagazine/classic/assets/img-temp/400x270/img8.jpg"
                                                    alt="Image Description">
                                            ...
                                            <h3 class="g-font-size-16 g-mb-10">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Skyscrapers from blocking sunlight..</a>
                                            </h3>
                                        </article>
                                    </div>
                                    <!-- End Article Video -->
                                    ...
                                    <div class="col-lg-4 col-sm-6 g-mb-30 g-mb-0--sm">
                                        <article>
                                            <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                                <img class="img-fluid w-100"
                                                    src="blogmagazine/classic/assets/img-temp/400x270/img15.jpg"
                                                    alt="Image Description">
                                            ...
                                            <h3 class="g-font-size-16 g-mb-10">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Architects plan to from blocking out sunlight..</a>
                                            </h3>
                                        </article>
                                    </div>
                                    <!-- End Article Video -->
                                    ...
                                    <div class="col-lg-4 col-sm-6 g-mb-30 g-mb-0--sm">
                                        <article>
                                            <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                                <img class="img-fluid w-100"
                                                    src="blogmagazine/classic/assets/img-temp/400x270/img12.jpg"
                                                    alt="Image Description">
                                            ...
                                            <h3 class="g-font-size-16 g-mb-10">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Cooltex is one of the best technology company..</a>
                                            </h3>
                                        </article>
                                    </div>
                                    <!-- End Article Video -->
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <article>
                                            <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                                <img class="img-fluid w-100"
                                                    src="blogmagazine/classic/assets/img-temp/400x270/img13.jpg"
                                                    alt="Image Description">
                                            ...
                                            <h3 class="g-font-size-16 g-mb-10">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Cameron's silence on defence is shameful..</a>
                                            </h3>
                                        </article>
                                    </div>
                                    <!-- End Article Video -->
                                ...
                                <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-30 g-mb-20">
                                    ...
                                    <div class="media-body">
                                        <h4 class="g-color-gray-dark-v1 g-mb-15">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">Marina Olsson</a>
                                        </h4>

                                        <div class="g-mb-15">
                                            <p class="g-color-gray-dark-v2">About my site amet nibh libero, in gravida
                                                nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio,
                            ...
                            <div class="g-mb-60">
                                ...
                                <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-30 g-mb-20">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="g-mb-15">
                                            <p class="g-color-gray-dark-v2">Cras sit amet nibh libero, in gravida
                                                nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio,
                                ...
                                <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-30 g-mb-20">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="g-mb-15">
                                            <p class="g-color-gray-dark-v2">Sit amet nibh libero, in gravida nulla.
                                ...
                                <div class="text-center g-mt-30">
                                    <a class="btn u-btn-outline-primary g-font-size-12 text-uppercase g-px-25 g-py-13"
                                        href="#!">
                                        <i
                                            class="icon-finance-206 u-line-icon-pro align-middle g-pos-rel g-top-1 mr-2"></i>
                                        Load More Comments
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="g-mb-60">
                                ...
                                <form>
                                    ...
                                    <a class="btn u-btn-primary g-font-size-12 text-uppercase g-px-25 g-py-13"
                                        href="#!">
                                        <i
                                            class="icon-finance-206 u-line-icon-pro align-middle g-pos-rel g-top-1 mr-2"></i>
                                        Add a Comment
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="u-shadow-v25 u-bg-overlay g-bg-img-hero g-bg-white-gradient-opacity-v2--after g-py-40 g-px-20 g-mb-50"
                            style="background-image: url(blogmagazine/classic/assets/img-temp/500x600/img1.jpg);">
                            <div class="u-bg-overlay__inner text-center">
                                ...
                                <div class="input-group rounded">
                                    <input class="form-control g-brd-none g-px-13" type="email"
                                        placeholder="Your Email">
                                    <div class="input-group-btn">
                                        <button class="btn u-btn-primary text-uppercase g-px-20 g-py-14"
                                            type="submit">
                        ...
                        <div class="g-mb-30">
                            ...
                            <article class="media g-mb-30">
                                <a class="d-flex u-shadow-v25 mr-3" href="#!">
                                    <img class="g-width-60 g-height-60"
                                        src="blogmagazine/classic/assets/img-temp/100x100/img4.jpg"
                                        alt="Image Description">
                                </a>
                                ...
                                <div class="media-body">
                                    <h3 class="h6">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Best dessert recipes for breakfast which will..</a>
                                    </h3>
                            ...
                            <article class="media g-mb-30">
                                <a class="d-flex u-shadow-v25 mr-3" href="#!">
                                    <img class="g-width-60 g-height-60"
                                        src="blogmagazine/classic/assets/img-temp/100x100/img5.jpg"
                                        alt="Image Description">
                                </a>
                            ...
                            <article class="media g-mb-30">
                                <a class="d-flex u-shadow-v25 mr-3" href="#!">
                                    <img class="g-width-60 g-height-60"
                                        src="blogmagazine/classic/assets/img-temp/100x100/img6.jpg"
                                        alt="Image Description">
                                </a>
                            ...
                            <article class="media">
                                <a class="d-flex u-shadow-v25 mr-3" href="#!">
                                    <img class="g-width-60 g-height-60"
                                        src="blogmagazine/classic/assets/img-temp/100x100/img7.jpg"
                                        alt="Image Description">
                                </a>
                                ...
                                <div class="media-body">
                                    <h3 class="h6">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Top 10 Luxury Hotels - 5 Star Best Luxury Hotels</a>
                                    </h3>
                        ...
                        <div class="g-mb-50">
                            <article class="g-pos-rel">
                                <figure class="u-shadow-v25 g-bg-img-hero g-min-height-400"
                                    style="background-image: url(blogmagazine/classic/assets/img-temp/500x650/img2.jpg);">
                                </figure>
                                ...
                                <span
                                    class="u-icon-v3 g-font-size-18 g-bg-white g-color-black g-bg-gray-dark-v2--hover g-color-white--hover g-rounded-50 g-cursor-pointer g-absolute-centered">
                        ...
                        <div id="stickyblock-start" class="js-sticky-block g-sticky-block--lg g-pt-20"
                            ...
                            <div class="g-mb-40">
                                ...
                                <article>
                                    ...
                                    <h3 class="h6">
                                        <a class="g-color-gray-dark-v1" href="#!">Architects plan to stop
                                            skyscrapers from blocking out sunlight</a>
                                    </h3>
                                </article>
                                <!-- End Article -->
                                ...
                                <article>
                                    ...
                                    <h3 class="h6">
                                        <a class="g-color-gray-dark-v1" href="#!">Cooltex is one of the best
                                            technology company of our age and future</a>
                                    </h3>
                                </article>
                                <!-- End Article -->
                                ...
                                <article>
                                    ...
                                    <h3 class="h6">
                                        <a class="g-color-gray-dark-v1" href="#!">Some text goes here with
                                            plain English and much more other texts go there..</a>
                                    </h3>
                                </article>
                                <!-- End Article -->
                            </div>
                            ...
                            <div class="g-mb-40">
                                ...
                                <article class="media g-mb-35">
                                    <img class="d-flex u-shadow-v25 g-width-40 g-height-40 rounded-circle mr-3"
                                        src="blogmagazine/classic/assets/img-temp/100x100/img1.jpg"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <h4 class="g-font-size-16">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">Htmlstream</a> <small
                                                class="g-color-gray-dark-v4">@Htmlstream</small>
                                        </h4>
                                        <p class="g-color-gray-dark-v2">Sed ultrices velit vitae tortor posuere and
                                ...
                                <article class="media g-mb-35">
                                    <img class="d-flex u-shadow-v25 g-width-40 g-height-40 rounded-circle mr-3"
                                        src="blogmagazine/classic/assets/img-temp/100x100/img3.jpg"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <h4 class="g-font-size-16 g-color-gray-dark-v1">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">Pixeel</a> <small
                                                class="g-color-gray-dark-v4">@Pixeeluk</small>
                                        </h4>
                                        <p class="g-color-gray-dark-v2">This is where we sit down, grab a cup of
                                ...
                                <article class="media">
                                    <img class="d-flex u-shadow-v25 g-width-40 g-height-40 rounded-circle mr-3"
                                        src="blogmagazine/classic/assets/img-temp/100x100/img2.jpg"
                                        alt="Image Description">
                                    <div class="media-body">
                                        <h4 class="g-font-size-16 g-color-gray-dark-v1">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">WrapBootstrap</a> <small
                                                class="g-color-gray-dark-v4">@WrapBootstrap</small>
                                        </h4>
                                        <p class="g-color-gray-dark-v2">Ulvinar leo ultricies ut, grab a cup of coffee
                                            and dial in the details.</p>
                                        <a class="btn u-btn-outline-primary g-font-size-11 text-uppercase"
                                            href="#!">Follow</a>
                                    </div>
                                </article>
        ...
        <footer class="g-bg-secondary">
            <div class="g-brd-bottom g-brd-secondary-light-v2 g-py-50 g-mb-50">
                <div class="container">
                    ...
                    <div class="js-carousel g-mx-minus-10" data-infinite="true" data-slides-show="4"
                     ...
                     "slidesToShow": 1
                        ...
                        <div class="js-slide g-px-10">
                            ...
                            <article class="media g-bg-white g-pa-10">
                                <figure class="d-flex g-width-70 g-height-70 mr-3">
                                    <img class="img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/230x230/img5.jpg"
                                        alt="Image Description">
                                </figure>
                        ...
                        <div class="js-slide g-px-10">
                            ...
                            <article class="media g-bg-white g-pa-10">
                                <figure class="d-flex g-width-70 g-height-70 g-pos-rel mr-3">
                                    <img class="img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/230x230/img6.jpg"
                                        alt="Image Description">
                        ...
                        <div class="js-slide g-px-10">
                            ...
                            <article class="media g-bg-white g-pa-10">
                                <figure class="d-flex g-width-70 g-height-70 mr-3">
                                    <img class="img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/230x230/img7.jpg"
                                        alt="Image Description">
                                </figure>
                        ...
                        <div class="js-slide g-px-10">
                            ...
                            <article class="media g-bg-white g-pa-10">
                                <figure class="d-flex g-width-70 g-height-70 mr-3">
                                    <img class="img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/230x230/img8.jpg"
                                        alt="Image Description">
                                </figure>
                                ...
                                <div class="media-body">
                                    ...
                                    <h4 class="g-font-size-13 mb-0"><a
                                            class="u-link-v5 g-color-main g-color-primary--hover"
                                            href="#!">Apple video explain how iOS work on MacBook</a></h4>
                                </div>
                            </article>
                            <!-- End Article -->
                        </div>
                        ...
                        <div class="js-slide g-px-10">
                            ...
                            <article class="media g-bg-white g-pa-10">
                                <figure class="d-flex g-width-70 g-height-70 mr-3">
                                    <img class="img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/230x230/img9.jpg"
                                        alt="Image Description">
                                </figure>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="g-pl-10--md">
                                ...
                                <!-- Carousel -->
                                <div class="js-carousel g-mx-minus-5" data-infinite="true" data-slides-show="2"
