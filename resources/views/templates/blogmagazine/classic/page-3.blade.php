...
<head>
    <!-- Title -->
    <title>Blog and Magazine Page Layout 4 | Unify - Responsive Website Template</title>
    ...
    <main>
        ...
        <div class="u-rev-slider-v1 g-overflow-hidden">
            <div id="revSliderWrapper" class="rev_slider_wrapper fullwidthbanner-container"
                style="margin: 0 auto; background: #000000; padding: 0; margin-top: 0;margin-bottom: 0;"
                    ...
                    <ul>
                        ...
                        <li data-index="rs-41" data-transition="fade" data-slotamount="default"
                            ...
                            <div id="slide-41-layer-1" class="tp-caption tp-resizeme"
                                ...
                                data-x="['left','left','left','center']" data-y="['top','top','top','top']"
                                data-hoffset="['150','150','90','0']" data-voffset="['155','155','145','145']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                <span class="g-color-white g-font-weight-400 text-capital g-opacity-0_5">August 17,
                                    2017</span>
                            </div>
                            ...
                            <a id="slide-41-layer-1" class="tp-caption tp-resizeme" href="#" target="_self"
                                ...
                                data-x="['left','left','left','center']" data-y="['top','top','top','top']"
                                data-hoffset="['150','150','90','0']" data-voffset="['200','200','180','180']"
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 3 -->
                            <div id="slide-41-layer-3" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 15px; line-height: 30px; font-weight: 500; color: rgba(255,255,255,0.6); font-family: Roboto Slab;"
                                data-x="['left','left','left','center']"
                                data-y="['center','center','center','center']" data-hoffset="['150','150','90','0']"
                                data-voffset="['85','85','75','45']" data-fontsize="['15','15','15','13']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                aluminum hardtail mountain bike returns, with Boost 148mm rear axle spacing and
                                clearance for up to 29x2.4” or 27.5x3.0” tires. Geometry also sees an update with a
                                longer reach, shorter chainstays, steeper seat tube and a slacker headtube angle, which
                                Niner has dubbed [R]EVOLUTION Trail Geometry.
                            </div>

                            <!-- LAYER NR. 4 -->
                            <div id="slide-41-layer-4" class="tp-caption tp-resizeme"
                                data-x="['left','left','left','center']"
                                data-y="['bottom','bottom','bottom','bottom']" data-hoffset="['150','150','90','0']"
                                data-voffset="['120','120','90','120']" data-fontsize="['15','15','15','13']"
                                data-lineheight="['30','30','30','25']" data-width="['600','550','350','260']"
                                data-height="none" data-whitespace="normal" data-type="text" data-basealign="slide"
                                data-responsive_offset="on"
                                data-frames='[
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 3 -->
                            <div id="slide-42-layer-3" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 15px; line-height: 30px; font-weight: 500; color: rgba(255,255,255,0.6); font-family: Roboto Slab;"
                                data-x="['left','left','left','center']"
                                data-y="['center','center','center','center']" data-hoffset="['150','150','90','0']"
                                data-voffset="['85','85','75','45']" data-fontsize="['15','15','15','13']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]">
                                <span class="g-color-white g-font-size-35">M</span> any of us fantasise about living
                                in the perfect white box – a light-suffused dream home with sleek surfaces, invisible
                                cabling and minimal clutter. Danish media mogul Mads Munk wanted all of that, but he
                                wasn’t looking for serenity: he was on a quest for a blank canvas. Or rather, a gallery.
                            </div>
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 3 -->
                            <div id="slide-43-layer-3" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 15px; line-height: 30px; font-weight: 500; color: rgba(255,255,255,0.6); font-family: Roboto Slab;"
                                data-x="['left','left','left','center']"
                                data-y="['center','center','center','center']" data-hoffset="['150','150','90','0']"
                                data-voffset="['85','85','75','45']" data-fontsize="['15','15','15','13']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]">
                                <span class="g-color-white g-font-size-35">B</span> rian Conley is the tenth celebrity
                                contestant confirmed for the brand new series of Strictly Come Dancing. The 15th series
                                of the BAFTA award-winning entertainment show produced by BBC Studios will return in the
                                autumn on BBC One putting the sparkle back into Saturday and Sunday nights.
                            </div>
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 3 -->
                            <div id="slide-46-layer-3" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 15px; line-height: 30px; font-weight: 500; color: rgba(255,255,255,0.6); font-family: Roboto Slab;"
                                data-x="['left','left','left','center']"
                                data-y="['center','center','center','center']" data-hoffset="['150','150','90','0']"
                                data-voffset="['85','85','75','45']" data-fontsize="['15','15','15','13']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]">
                                <span class="g-color-white g-font-size-35">C</span> onstruction has begun on Penn
                                Station’s fast-tracked Moynihan Train Hall project has begun, announced New York State
                                Governor Andrew Cuomo in a press conference.
                            </div>
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 3 -->
                            <div id="slide-44-layer-3" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 15px; line-height: 30px; font-weight: 500; color: rgba(255,255,255,0.6); font-family: Roboto Slab;"
                                data-x="['left','left','left','center']"
                                data-y="['center','center','center','center']" data-hoffset="['150','150','90','0']"
                                data-voffset="['85','85','75','45']" data-fontsize="['15','15','15','13']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]">
                                <span class="g-color-white g-font-size-35">S</span> tephen K. Bannon has come full
                                circle. Following his ouster from the White House on Friday, he will return to managing
                                the right-wing media outlet Breitbart News — just as he was doing before he joined the
                                campaign last year and then the staff of the West Wing.
                            </div>
                     ...
                     {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                            ...
                            <!-- LAYER NR. 3 -->
                            <div id="slide-45-layer-3" class="tp-caption tp-resizeme"
                                style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 15px; line-height: 30px; font-weight: 500; color: rgba(255,255,255,0.6); font-family: Roboto Slab;"
                                data-x="['left','left','left','center']"
                                data-y="['center','center','center','center']" data-hoffset="['150','150','90','0']"
                                data-voffset="['85','85','75','45']" data-fontsize="['15','15','15','13']"
                       ...
                       {"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"}
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]">
                                <span class="g-color-white g-font-size-35">W</span> endy Dent has a dream. The
                                Australian founder, chief executive and sole employee of Cinemmerse wants to change the
                                way folks think about how they watch everything from advertisements to art films.
                            </div>
        ...
        <div class="container g-pt-100 g-pb-70">
            ...
            <div class="row g-mb-70">
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    <!-- Article -->
                    <article>
                        <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img17.jpg"
                            alt="Image Description">

                        <div class="g-brd-around g-brd-secondary-light-v2 g-bg-white g-pa-20">
                            <h3 class="g-font-size-16"><a class="u-link-v5 g-color-main g-color-primary--hover"
                ...
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    <!-- Article -->
                    <article>
                        <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img11.jpg"
                            alt="Image Description">

                        <div class="g-brd-around g-brd-secondary-light-v2 g-bg-white g-pa-20">
                            <h3 class="g-font-size-16"><a class="u-link-v5 g-color-main g-color-primary--hover"
                                    href="#">How to pursue happiness?</a></h3>
                            <p class="g-font-size-13">We aim high at being focused on building relationships with
                                clients.</p>
                ...
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    <!-- Article -->
                    <article>
                        <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img18.jpg"
                            alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    <!-- Article -->
                    <article>
                        <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img6.jpg"
                            alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    <!-- Article -->
                    <article>
                        <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img5.jpg"
                            alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    <!-- Article -->
                    <article>
                        <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img13.jpg"
                            alt="Image Description">

                        <div class="g-brd-around g-brd-secondary-light-v2 g-bg-white g-pa-20">
                            <h3 class="g-font-size-16"><a class="u-link-v5 g-color-main g-color-primary--hover"
                                    href="#">Cameron's silence on defence</a></h3>
                            <p class="g-font-size-13">We aim high at being focused on building relationships with
                                clients.</p>
            ...
            <!-- Recent Videos -->
            <div class="u-heading-v3-1 g-mb-30">
                <h2 class="h5 u-heading-v3__title g-color-gray-dark-v1 text-uppercase g-brd-primary">Recent Videos
                </h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-4 col-lg-3 g-mb-30">
                    <article>
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img2.jpg"
                                alt="Image Description">
                ...
                <div class="col-6 col-md-4 col-lg-3 g-mb-30">
                    <article>
                        ...
                        <h3 class="g-font-size-16 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">How to
                                run a ticket: Best 10 point..</a>
                        </h3>
                    </article>
                </div>
                <!-- End Article Video -->
                ...
                <div class="col-6 col-md-4 col-lg-3 g-mb-30">
                    <article>
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img7.jpg"
                                alt="Image Description">
                ...
                <div class="col-6 col-md-4 col-lg-3 g-mb-30">
                    <article>
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100" src="blogmagazine/classic/assets/img-temp/400x270/img8.jpg"
                                alt="Image Description">
                    ...
                    <article>
                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                            <img class="img-fluid w-100"
                                src="blogmagazine/classic/assets/img-temp/400x270/img10.jpg"
                                alt="Image Description">
                ...
                <div class="col-6 col-md-4 col-lg-3 g-mb-30">
                    <article>
                        ...
                        <h3 class="g-font-size-16 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Must be
                                visited places in the USA - Florida Beaches</a>
                        </h3>
                    </article>
                </div>
                <!-- End Article Video -->
                    ...
                    <article>
                        ...
                        <h3 class="g-font-size-16 g-mb-10">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#">Stylish
                                things to do, buy one get 2 free</a>
                        </h3>
                    </article>
                </div>
                <!-- End Article Video -->
