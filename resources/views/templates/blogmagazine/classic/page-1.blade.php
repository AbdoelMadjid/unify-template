                ...
                <div class="row no-gutters">
                    <div class="col-lg-6 g-pr-1--lg g-mb-30 g-mb-2--lg">
                        ...
                        <article class="u-block-hover">
                            ...
                            <div class="g-pos-abs g-bottom-30 g-left-30 g-right-30">
                                ...
                                <h3 class="h4 g-my-10">
                                    <a class="g-color-white g-color-white--hover" href="#!">Our goal is to be the
                                        next billion company. In order to do that, we should work hard.</a>
                                </h3>
                    ...
                    <div class="col-lg-6 g-pl-1--lg g-mb-30 g-mb-2--lg">
                        ...
                        <article class="u-block-hover">
                            <figure class="u-shadow-v25 g-bg-cover g-bg-white-gradient-opacity-v1--after">
                                <img class="img-fluid w-100 u-block-hover__main--zoom-v1"
                                    src="blogmagazine/classic/assets/img-temp/430x270/img2.jpg"
                                    alt="Image Description">
                            </figure>
                            ...
                            <div class="g-pos-abs g-bottom-30 g-left-30 g-right-30">
                                ...
                                <h3 class="h4 g-my-10">
                                    <a class="g-color-white g-color-white--hover" href="#!">Why your customer
                                        support is very important? Learn the next 10 best tips.</a>
                                </h3>
                    ...
                    <div class="col-lg-4 g-pr-1--lg g-mb-30 g-mb-0--lg">
                        ...
                        <article class="u-block-hover">
                            ...
                            <div class="w-100 text-center g-absolute-centered g-px-30">
                                ...
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white" href="#!">Be ready, fashion of the year is coming
                                        this year</a>
                                </h3>
                                <small class="g-color-white">
                    ...
                    <div class="col-lg-4 g-px-1--lg g-mb-30 g-mb-0--lg">
                        ...
                        <article class="u-block-hover">
                            <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                                <img class="u-block-hover__main--zoom-v1 img-fluid w-100"
                                    src="blogmagazine/classic/assets/img-temp/400x270/img1.jpg"
                                    alt="Image Description">
                            </figure>
                            ...
                            <div class="w-100 text-center g-absolute-centered g-px-30">
                                ...
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white" href="#!">Must be visited places in the USA -
                                        Florida Beaches</a>
                                </h3>
                                <small class="g-color-white">
                    ...
                    <div class="col-lg-4 g-pl-1--lg">
                        ...
                        <article class="u-block-hover">
                            ...
                            <div class="w-100 text-center g-absolute-centered g-px-30">
                                ...
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white" href="#!">Why your next glass of juice will cost you
                                        more</a>
                                </h3>
                                <small class="g-color-white">
                            ...
                            <div class="row">
                                    ...
                                    <article>
                                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                            <img class="img-fluid w-100"
                                                src="blogmagazine/classic/assets/img-temp/500x450/img7.jpg"
                                                alt="Image Description">
                                        ...
                                        <h3 class="h4 g-mb-10">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">Exclusive interview with InVision's CEO</a>
                                        </h3>
                                        ...
                                        <p class="g-color-gray-dark-v2">Clark Valberg is the founder and CEO of
                                            InVision. If you are a designer, you have probably gotten. If you are a
                                            designer, you have probably gotten.</p>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <article class="media">
                                        <a class="d-flex u-shadow-v25 align-self-center mr-3" href="#!">
                                            <img class="g-width-80 g-height-80"
                                                src="blogmagazine/classic/assets/img-temp/230x230/img1.jpg"
                                                alt="Image Description">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            <h3 class="h6">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Best dessert recipes for breakfast which will make
                                                    your day</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        <a class="d-flex u-shadow-v25 align-self-center mr-3" href="#!">
                                            <img class="g-width-80 g-height-80"
                                                src="blogmagazine/classic/assets/img-temp/230x230/img2.jpg"
                                                alt="Image Description">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            <h3 class="h6">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Stylish things to do, see and purchase only this
                                                    week</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        <a class="d-flex u-shadow-v25 align-self-center mr-3" href="#!">
                                            <img class="g-width-80 g-height-80"
                                                src="blogmagazine/classic/assets/img-temp/230x230/img4.jpg"
                                                alt="Image Description">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            <h3 class="h6">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Government plans to test new primary school pupils
                                                    and teachers..</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        <a class="d-flex u-shadow-v25 align-self-center mr-3" href="#!">
                                            <img class="g-width-80 g-height-80"
                                                src="blogmagazine/classic/assets/img-temp/230x230/img3.jpg"
                                                alt="Image Description">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            <h3 class="h6">
                                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                    href="#!">Things to do - see and purchase only stylish stuff
                                                    this week</a>
                                            </h3>
                        ...
                        <div class="g-mb-60">
                            ...
                            <div class="row g-mb-30">
                                ...
                                <div class="col-md-7 align-self-center">
                                    <h3 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">10 Best Tips for UX/UI Designers in 2017</a>
                                    </h3>
                                    ...
                                    <p class="g-color-gray-dark-v2">Pellentesque turpis lacus, a pulvinar leo
                                        ultricies ut. Ut fringilla lectus tellusimp imperdiet molestie est volutpat at.
                                        Sed viverra cursus nibh. Sed ultrices velit vitae tortor posuere ultrices.</p>
                                    <a class="g-font-size-12" href="#!">Read More..</a>
                                </div>
                                <!-- End Article Content -->
                            </div>
                            ...
                            <div class="row g-mb-60">
                                <div class="col-lg-6 g-mb-30 g-mb-0--lg">
                                    ...
                                    <article class="g-mb-30">
                                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                            <img class="img-fluid w-100"
                                                src="blogmagazine/classic/assets/img-temp/500x450/img3.jpg"
                                                alt="Image Description">
                                        ...
                                        <p class="g-color-gray-dark-v2">How to run a ticket: Best 10 point approaches
                                            for people who stands. Clark Valberg is the founder and CEO of InVision. If
                                            you are a designer, you have probably gotten.</p>
                                        <a class="g-font-size-12" href="#!">Read More..</a>
                                    </article>
                                    <!-- End Article -->
                                    ...
                                    <article>
                                        <span class="g-font-size-12">
                                            <a class="u-link-v5 g-color-gray-dark-v4" href="#!">Evan
                                                Bartlett</a>
                                        </span>
                                        <h3 class="h6">
                                            <a class="g-color-gray-dark-v1" href="#!">Cameron's silence on
                                                defence is shameful</a>
                                        </h3>
                                    </article>
                                    <!-- End Article -->
                                    ...
                                    <article>
                                        <span class="g-font-size-12">
                                            <a class="u-link-v5 g-color-gray-dark-v4" href="#!">Jonathan
                                                Owen</a>
                                        </span>
                                        <h3 class="h6">
                                    ...
                                    <article>
                                        ...
                                        <h3 class="h6">
                                            <a class="g-color-gray-dark-v1" href="#!">Cooltex is one of the
                                                best technology company of our age and future</a>
                                        </h3>
                                    </article>
                                    <!-- End Article -->
                                    ...
                                    <article>
                                        <span class="g-font-size-12">
                                            <a class="u-link-v5 g-color-gray-dark-v4" href="#!">Albert
                                                Coolmen</a>
                                        </span>
                                        <h3 class="h6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <article class="g-mb-30">
                                        <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                            <img class="img-fluid w-100"
                                                src="blogmagazine/classic/assets/img-temp/500x450/img4.jpg"
                                                alt="Image Description">
                                        ...
                                        <p class="g-color-gray-dark-v2">Architects plan to stop skyscrapers from
                                            blocking out sunlight. Clark Valberg is the founder and CEO of InVision. If
                                            you are a designer, you have probably gotten.</p>
                                        <a class="g-font-size-12" href="#!">Read More..</a>
                                    </article>
                                    <!-- End Article -->
                                    ...
                                    <article>
                                        ...
                                        <h3 class="h6">
                                            <a class="g-color-gray-dark-v1" href="#!">Fashion's first selfies:
                                                It was a 16th century German..</a>
                                        </h3>
                                    </article>
                                    <!-- End Article -->
                                    ...
                                    <article>
                                        <span class="g-font-size-12">
                                            <a class="u-link-v5 g-color-gray-dark-v4" href="#!">John
                                                Rentoul</a>
                                        </span>
                                        <h3 class="h6">
                                            <a class="g-color-gray-dark-v1" href="#!">How to run a ticket: Best
                                                10 point approaches for people who stands..</a>
                                        </h3>
                                    </article>
                                    <!-- End Article -->
                                    ...
                                    <article>
                                        ...
                                        <h3 class="h6">
                                            <a class="g-color-gray-dark-v1" href="#!">Skyscrapers from blocking
                                                cameron's silence on defence shameful</a>
                                        </h3>
                                    </article>
                                    <!-- End Article -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6 g-mb-30">
                                <article>
                                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                        <img class="img-fluid w-100"
                                            src="blogmagazine/classic/assets/img-temp/400x270/img6.jpg"
                                            alt="Image Description">
                            ...
                            <div class="col-lg-4 col-sm-6 g-mb-30">
                                <article>
                                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                        <img class="img-fluid w-100"
                                            src="blogmagazine/classic/assets/img-temp/400x270/img7.jpg"
                                            alt="Image Description">
                            ...
                            <div class="col-lg-4 col-sm-6 g-mb-30 g-mb-0--sm">
                                <article>
                                    <figure class="u-shadow-v25 g-pos-rel g-mb-20">
                                        <img class="img-fluid w-100"
                                            src="blogmagazine/classic/assets/img-temp/400x270/img9.jpg"
                                            alt="Image Description">
                        ...
                        <div class="u-shadow-v25 u-bg-overlay g-bg-img-hero g-bg-white-gradient-opacity-v2--after g-py-40 g-px-20 g-mb-50"
                            ...
                            <div class="u-bg-overlay__inner text-center">
                                ...
                                <div class="input-group rounded">
                                    <input class="form-control g-brd-none g-font-size-13 g-px-13 g-py-11"
                                        type="email" placeholder="Your Email">
                                    <div class="input-group-btn">
                                        <button class="btn u-btn-primary text-uppercase g-px-20 g-py-11"
                                            type="submit">
                            ...
                            <div class="g-mb-50">
                                <article class="g-pos-rel">
                                    ...
                                    <span class="text-center g-pos-abs g-top-20 g-left-0">
                                        <a class="btn u-btn-red text-uppercase rounded-0"
                                            href="#!">Discover</a>
                ...
                <div class="row no-gutters g-mb-60">
                        ...
                        <article class="u-block-hover">
                            <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                                <img class="u-block-hover__main--zoom-v1 img-fluid"
                                    src="blogmagazine/classic/assets/img-temp/500x450/img5.jpg"
                                    alt="Image Description">
                            </figure>

                            <div class="w-100 text-center g-absolute-centered g-px-20">
                                <a class="btn btn-xs u-btn-deeporange text-uppercase rounded-0"
                                    href="#!">Photography</a>
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white" href="#!">Be ready, fashion of the year is coming
                                        this year</a>
                    ...
                    <div class="col-lg-4 g-px-1--lg g-mb-30 g-mb-0--lg">
                        ...
                        <article class="u-block-hover">
                            <figure class="u-shadow-v25 u-bg-overlay g-bg-white-gradient-opacity-v1--after">
                                <img class="u-block-hover__main--zoom-v1 img-fluid"
                                    src="blogmagazine/classic/assets/img-temp/500x450/img6.jpg"
                                    alt="Image Description">
                            </figure>
                            <div class="w-100 text-center g-absolute-centered g-px-20">
                        ...
                        <article class="u-block-hover">
                            ...
                            <div class="w-100 text-center g-absolute-centered g-px-20">
                                <a class="btn btn-xs u-btn-darkred text-uppercase rounded-0"
                                    href="#!">Office</a>
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white" href="#!">Why your next glass of juice will cost
                                        you more</a>
                                </h3>
                                <small class="g-color-white">
                                    <i class="icon-clock g-pos-rel g-top-1 g-mr-2"></i> July 5, 2017
                            ...
                            <div class="row">
                                <div class="col-lg-6 g-mb-50 g-mb-0--lg">
                                    ...
                                    <article class="g-mb-40">
                                        ...
                                        <h3 class="h4 g-mb-10">
                                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                                href="#!">10 Best tips and resources for UX/UI Designers in
                                                2017</a>
                                        </h3>
                                    ...
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="g-font-size-16">
                                                <a class="g-color-gray-dark-v1" href="#!">8 health benefits and
                                                    drawbacks of coffee</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="g-font-size-16">
                                                <a class="g-color-gray-dark-v1" href="#!">Top 7 Luxury places
                                                    to visit around Victoria, BC</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="g-font-size-16">
                                                <a class="g-color-gray-dark-v1" href="#!">Top 10 Luxury Hotels
                                                    - 5 Star Best Luxury Hotels</a>
                                            </h3>
                                ...
                                <div class="col-lg-6 g-mb-50 g-mb-0--lg">
                                    ...
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="g-font-size-16">
                                                <a class="g-color-gray-dark-v1" href="#!">10 Most beautiful and
                                                    popular beaches in the Wrold</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="g-font-size-16">
                                                <a class="g-color-gray-dark-v1" href="#!">5 Best cofee places
                                                    with free WiFi in Victoria, BC</a>
                                            </h3>
                                    ...
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="g-font-size-16">
                                                <a class="g-color-gray-dark-v1" href="#!">Stylish things to do,
                                                    buy one get 2 free</a>
                                            </h3>
                        ...
                        <div class="g-mb-60">
                            ...
                            <div class="row g-mb-30">
                                ...
                                <div class="col-md-7 align-self-center">
                                    <h3 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Exclusive interview with InVision's CEO at Pixeel Ltd.</a>
                                    </h3>
                            ...
                            <div class="row g-mb-30">
                                ...
                                <div class="col-md-7 align-self-center">
                                    <h3 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">10 Best Festivals Around the World in 2017</a>
                                    </h3>
                            ...
                            <div class="row g-mb-30">
                                ...
                                <div class="col-md-7 align-self-center">
                                    <h3 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Fashion's first showcase: It is a nice idea to make great
                                            design</a>
                                    </h3>
                                    ...
                                    <p class="g-color-gray-dark-v2">Ulvinar leo ultricies fringilla lectus tellusimp
                                        imperdiet molestie. Sed viverra cursus nibh. Sed ultrices velit vitae tortor
                                        posuere.</p>
                                    <a class="g-font-size-12" href="#!">Read More..</a>
                                </div>
                                <!-- End Article Content -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 align-self-center">
                                    <h3 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Ice Cream drinks for all in 2017</a>
                                    </h3>
