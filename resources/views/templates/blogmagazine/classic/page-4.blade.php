    ...
    <main>
        ...
        <div class="clearfix">
            <div class="row no-gutters">
                <div class="col-md-6">
                    <!-- Article -->
                    <div class="g-flex-centered g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-primary-opacity-0_2--after text-center g-px-50 g-px-100--lg"
                        style="background-image: url(blogmagazine/classic/assets/img-temp/500x450/img8.jpg);"
                        data-calc-target="#js-header">
                        <article class="g-pos-rel g-z-index-1">
                            <span
                                class="d-inline-block g-color-white g-font-weight-600 g-font-size-16 text-uppercase mb-3">Art</span>
                            <h1 class="h1 g-color-white g-font-weight-700 g-mb-35">A Room Gets Colored After More Than
                                5 Years of its Existing</h1>
                ...
                <div class="col-md-6">
                    <!-- Article -->
                    <div class="g-flex-centered g-bg-size-cover g-bg-pos-center g-bg-cover g-bg-primary-opacity-0_2--after text-center g-px-50 g-px-100--lg"
                        style="background-image: url(blogmagazine/classic/assets/img-temp/500x450/img9.jpg);"
                        data-calc-target="#js-header">
                        <article class="g-pos-rel g-z-index-1">
                            <span
                                class="d-inline-block g-color-white g-font-weight-600 g-font-size-16 text-uppercase mb-3">Travel</span>
                            <h2 class="h1 g-color-white g-font-weight-700 g-mb-35">What the Mystery Writer S.Grafton
                                Can’t Travel Without</h2>
                            <a class="btn u-btn-primary g-color-white g-font-weight-700 g-font-size-13 text-uppercase rounded g-py-12 g-px-20"
                                href="bm-classic-single-2.html">Read More</a>
                        </article>
                    </div>
        ...
        <div class="container g-pt-100 g-pb-50">
            <div class="row">
                ...
                <div class="col-lg-9 g-mb-50 g-mb-0--lg">
                    ...
                    <article class="text-center g-mb-100">
                            ...
                            <figcaption class="w-100 g-pos-abs g-bottom-0 g-left-0 g-pa-15">
                                <ul class="d-flex justify-content-start list-inline mb-0">
                                    <li class="list-inline-item mx-0">
                                        <a class="d-inline-block g-brd-around g-brd-white-opacity-0_3 g-brd-primary-opacity-0_6--hover g-color-white g-bg-primary-opacity-0_6--hover g-text-underline--none--hover rounded-left g-px-15 g-py-4"
                                            href="#">
                                    ...
                                    <li class="list-inline-item g-ml-minus-1 mr-0">
                                        <a class="d-inline-block g-brd-around g-brd-white-opacity-0_3 g-brd-primary-opacity-0_6--hover g-color-white g-bg-primary-opacity-0_6--hover g-text-underline--none--hover rounded-right g-px-15 g-py-4"
                                            href="#">
                                    ...
                                    <li class="list-inline-item ml-auto mr-0">
                                        <a class="d-inline-block g-color-white g-font-size-15 g-text-underline--none--hover g-px-15 g-py-4"
                        ...
                        <ul
                            ...
                            <li class="list-inline-item g-mr-10">
                                <i
                                    class="align-middle g-color-primary mr-1 icon-communication-020 u-line-icon-pro"></i>
                        ...
                        <div class="g-px-50 g-px-100--md mb-4">
                            <h2 class="h3 mb-4"><a class="u-link-v5 g-color-main g-color-primary--hover"
                                    href="#">Editta Sherman Gets Her Due at the New-York Historical Society</a>
                            </h2>
                            <p>The name Editta Sherman may not ring a bell, but she was the blithe spirit who flitted
                                through “Bill Cunningham New York,” about the New York Times’s street-fashion
                                photographer, who died in 2016.</p>
                        </div>
                        <!-- End Info -->

                        <div class="g-mb-25">
                            <a class="g-font-weight-600 g-font-size-13 text-uppercase"
                                href="bm-classic-single-2.html">Read More</a>
                        </div>
                    ...
                    <article class="text-center g-mb-100">
                        <figure class="g-pos-rel mb-5">
                            <img class="img-fluid" src="blogmagazine/classic/assets/img-temp/900x450/img1.jpg"
                                alt="Image Description">
                        ...
                        <div class="g-px-50 g-px-100--md mb-4">
                            <h2 class="h3 mb-4"><a class="u-link-v5 g-color-main g-color-primary--hover"
                                    href="#">The 2018 Specialized Enduro has officially landed</a></h2>
                            <p>The top line is that both platforms have been lengthened, and the 27.5 version has had a
                                top tube tweak to give it a look more in keeping with the 29er version.</p>
                        </div>
                        <!-- End Info -->
                    ...
                    <article class="text-center g-mb-100">
                        <figure class="g-pos-rel mb-5">
                            <div class="js-carousel g-mx-minus-10" data-infinite="true"
                                ...
                                <div class="js-slide">
                                    <img class="img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/900x450/img2.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="js-slide">
                                    <img class="img-fluid"
                                        src="blogmagazine/classic/assets/img-temp/900x450/img4.jpg"
                                        alt="Image Description">
                                </div>
                            </div>
                        ...
                        <div class="g-px-50 g-px-100--md mb-4">
                            ...
                            <p>Originally created by Carole Bamford in the English Cotswolds, the Bamford Haybarn brand
                                has migrated across the pond, with a new 4500sq ft spa in Miami Beach.</p>
                        </div>
                        <!-- End Info -->
                    ...
                    <article class="text-center g-mb-100">
                        <figure class="g-pos-rel mb-5">
                            <img class="img-fluid" src="blogmagazine/classic/assets/img-temp/900x450/img5.jpg"
                                alt="Image Description">
                        ...
                        <div class="g-px-50 g-px-100--md mb-4">
                            <h2 class="h3 mb-4"><a class="u-link-v5 g-color-main g-color-primary--hover"
                                    href="#">Attacks Are Nation’s Deadliest in Decade; Driver of Van Sought</a>
                            </h2>
                            <p>BARCELONA, Spain — Largely spared the Islamic State attacks that have plagued Europe in
                                recent years, Spaniards were confronted on Friday with the aftermath of a devastating
                                terrorist plot, involving an explosives factory and two vehicular assaults, that swept
                                through Barcelona and a seaside resort town leaving at least 14 dead and scores wounded.
                            </p>
                        </div>
                        <!-- End Info -->
                    ...
                    <article class="text-center g-mb-100">
                        <figure class="g-pos-rel mb-5">
                            <img class="img-fluid" src="blogmagazine/classic/assets/img-temp/900x450/img6.jpg"
                                alt="Image Description">
                    ...
                    <div id="stickyblock-start" class="js-sticky-block g-sticky-block--lg g-pt-20"
                        ...
                        <div class="g-mb-40">
                            ...
                            <article>
                                ...
                                <h3 class="h6">
                                    <a class="g-color-gray-dark-v1" href="#">Some text goes here with plain
                                        English and much more other texts go there..</a>
                                </h3>
                            </article>
                            <!-- End Article -->
                        </div>
