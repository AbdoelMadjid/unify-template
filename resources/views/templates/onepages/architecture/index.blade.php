...
<body>
    <main>
                ...
                <div class="container text-center g-max-width-750">
                    <div class="text-uppercase u-heading-v2-4--bottom u-promo-title g-brd-primary">
                        <h3 class="h3 g-letter-spacing-7 g-font-size-12 g-font-weight-400 g-color-white g-mb-25">
                            Architecture company</h3>
                        <h2
                            class="u-heading-v2__title g-line-height-1 g-letter-spacing-3 g-font-size-75 g-color-white mb-0">
                            We are Unify</h2>
                    </div>
                </div>
            </div>
        ...
        <section id="about" class="g-pt-100 g-pb-100--md">
            <div class="container text-center g-max-width-750 g-mb-70">
                <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary">
                    <h3 class="h3 g-letter-spacing-5 g-font-size-12 g-font-weight-400 g-color-primary g-mb-25">What we
                        offer</h3>
                    <h2
                        class="u-heading-v2__title g-line-height-1 g-letter-spacing-2 g-font-size-30 g-font-size-40--md mb-0">
                        All for your comfort</h2>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="g-bg-img-hero" style="background-image: url(assets/img-temp/1024x683/img1.jpg);">
                            <div
                                ...
                                <h3 class="text-uppercase g-line-height-1_2 g-font-weight-700 g-color-white g-mb-25">
                                    Exterior <br> Design</h3>
                                <p class="g-font-size-13 g-color-white-opacity-0_7 g-mb-30">Lorem ipsum dolor sit amet,
                                    consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Omom
                                    sociis natoque penatibus.</p>
                                <a href="#!"
                                    class="text-uppercase g-font-weight-700 g-font-size-11 g-text-underline--none--hover">Read
                                    More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container text-center g-max-width-750 g-mb-70">
                <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-30">
                    <h3 class="h3 g-letter-spacing-5 g-font-size-12 g-font-weight-400 g-color-primary g-mb-25">What we
                        do</h3>
                    <h2
                        class="u-heading-v2__title g-line-height-1 g-letter-spacing-2 g-font-size-30 g-font-size-40--md g-color-white mb-0">
                        We create amazing things</h2>
                </div>

                <p class="g-color-white-opacity-0_5 mb-0">Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam
                ...
                <div class="js-carousel" data-infinite="true"
                    ...
                    <div class="js-slide">
                        ...
                        <div class="container text-center g-max-width-550">
                            <h4 class="h6 text-uppercase g-font-weight-700 g-color-white g-mb-20">Projects of
                                resdential buildings</h4>
                            <p class="g-font-size-default g-color-white-opacity-0_8 g-mb-40">Nullam quis ante. Etiam
                                sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet
                                nibh. Donec sodales sagittis magna.</p>
                            <a href="#!"
                                class="text-uppercase g-font-weight-700 g-font-size-11 g-text-underline--none--hover">View
                                project</a>
                        </div>
                    </div>
                    ...
                    <div class="js-slide">
                        ...
                        <div class="container text-center g-max-width-550">
                            <h4 class="h6 text-uppercase g-font-weight-700 g-color-white g-mb-20">Donec sodales
                                sagittis magna</h4>
                            <p class="g-font-size-default g-color-white-opacity-0_8 g-mb-40">Nullam quis ante. Etiam
                                sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet
                                nibh. Donec sodales sagittis magna.</p>
                    ...
                    <div class="js-slide">
                        ...
                        <div class="container text-center g-max-width-550">
                            <h4 class="h6 text-uppercase g-font-weight-700 g-color-white g-mb-20">Etiam sit amet orci
                                eget</h4>
                            <p class="g-font-size-default g-color-white-opacity-0_8 g-mb-40">Nullam quis ante. Etiam
                                sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet
                                nibh. Donec sodales sagittis magna.</p>
        ...
        <section id="projects" class="g-pt-100 g-pb-100--md">
            <div class="container text-center g-max-width-750 g-mb-70">
                <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary">
                    <h3 class="h3 g-letter-spacing-5 g-font-size-12 g-font-weight-400 g-color-primary g-mb-25">Our
                        works</h3>
                    <h2
                        class="u-heading-v2__title g-line-height-1 g-letter-spacing-2 g-font-size-30 g-font-size-40--md mb-0">
                        What we did</h2>
                ...
                <div class="row no-gutters">
                    <div
                        ...
                        <div class="text-center text-uppercase g-pa-30">
                            <h4
                                class="g-letter-spacing-5 g-font-size-11 g-font-weight-400 g-color-gray-dark-v5 g-color-primary--parent-hover g-mb-10 g-transition-0_2 g-transition--ease-in">
                                Buildings</h4>
                            <h3
                                class="h6 g-letter-spacing-2 g-font-weight-700 g-color-white--parent-hover mb-0 g-transition-0_2 g-transition--ease-in">
                                Architectural, beautiful Exteriors</h3>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="text-center text-uppercase g-pa-30">
                            ...
                            <h3
                                class="h6 g-letter-spacing-2 g-font-weight-700 g-color-white--parent-hover mb-0 g-transition-0_2 g-transition--ease-in">
                                Architecture in the business district</h3>
                        </div>
                    </div>
        ...
        <section id="team" class="g-theme-bg-blue-dark-v1 g-py-100">
            <div class="container text-center g-max-width-750 g-mb-70">
                <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-30">
                    <h3 class="h3 g-letter-spacing-5 g-font-size-12 g-font-weight-400 g-color-primary g-mb-25">Our team
                    </h3>
                    <h2
                        class="u-heading-v2__title g-line-height-1 g-letter-spacing-2 g-font-size-30 g-font-size-40--md g-color-white mb-0">
            ...
            <div class="container">
                ...
                <div class="g-mx-minus-9--sm">
                    <div class="js-carousel" data-slides-show="3" data-infinite="true"
                        data-arrows-classes="u-arrow-v1 g-pos-abs g-top-35x g-width-45 g-height-45 g-color-white g-theme-bg-blue-dark-v2 g-bg-primary--hover g-rounded-50x g-transition-0_2 g-transition--ease-in"
                        ...
                        <div class="js-slide g-px-5">
                            ...
                            <figure class="text-center">
                                ...
                                <div class="text-uppercase g-mb-20">
                                    <h4 class="g-letter-spacing-2 g-font-size-11 g-theme-color-gray-dark-v3 g-mb-10">
                                        Technical supervisor</h4>
        ...
        <section id="processes" class="g-py-100">
            <div class="container text-center g-max-width-750 g-mb-70">
                <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary">
                    <h3 class="h3 g-letter-spacing-5 g-font-size-12 g-font-weight-400 g-color-primary g-mb-25">Work
                        process</h3>
                    <h2
                        class="u-heading-v2__title g-line-height-1 g-letter-spacing-2 g-font-size-30 g-font-size-40--md mb-0">
                        How we work</h2>
            ...
            <div class="container">
                <div id="processesTabs" class="tab-content container g-width-630 g-pb-50 g-pb-100--md">
                    <div class="tab-pane fade show active" id="discuss" role="tabpanel">
                        <div class="js-carousel g-pb-40" data-infinite="true"
                            ...
                            <div class="js-slide">
                                ...
                                <div class="container text-center g-max-width-550">
                                    <h4 class="text-uppercase g-font-weight-700 g-font-size-18 g-mb-15">Projects of
                                        resdential buildings</h4>
                                    <p class="g-font-size-default mb-0">Nullam quis ante. Etiam sit amet orci eget eros
                                        faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales
                                        sagittis magna. Etiam sit amet orci eget eros.</p>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="creativeConcept" role="tabpanel">
                        ...
                        <div class="container text-center g-max-width-550">
                            <h4 class="text-uppercase g-font-weight-700 g-font-size-18 g-mb-15">Projects of resdential
                                buildings</h4>
                            <p class="g-font-size-default mb-0">Nullam quis ante. Etiam sit amet orci eget eros
                                faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis
                                magna. Etiam sit amet orci eget eros.</p>
                        </div>
                    </div>
                ...
                <ul class="nav nav-fill text-center justify-content-center flex-md-nowrap u-nav-v8-2" role="tablist"
                    data-target="nav-8-2-primary-hor-center" data-tabs-mobile-type="slide-up-down"
                    data-btn-classes="btn btn-md u-btn-primary btn-block">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#discuss" role="tab">
                            <span
                                class="u-nav-v8__icon u-icon-v3 u-icon-size--lg g-font-size-20 g-rounded-50x g-brd-around g-brd-4 g-brd-white">
                                <i class="fa fa-coffee"></i>
                            </span>
                            <strong class="text-uppercase u-nav-v8__title g-font-size-13 g-mb-5">Discuss</strong>
                            <em class="u-nav-v8__description g-color-white-opacity-0_5">Lorem ipsum dolor sit
                                amet.</em>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#creativeConcept" role="tab">
                            ...
                            <strong class="text-uppercase u-nav-v8__title g-font-size-13 g-mb-5">Creative
                                concept</strong>
                            <em class="u-nav-v8__description g-color-white-opacity-0_5">Lorem ipsum dolor sit
                                amet.</em>
                        </a>
        ...
        <section id="technologies" class="g-theme-bg-blue-dark-v1 g-py-100">
            <div class="container text-center g-max-width-750 g-mb-50">
                ...
                <p class="g-color-white-opacity-0_5 mb-0">Etiam rhoncus. Maecenas tempus, tellus eget condimentum
                    rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum.</p>
            </div>

            <div class="container-fluid px-0">
                <div class="js-carousel g-pb-10" data-slides-show="3" data-slides-scroll="3" data-infinite="true"
                    ...
                    <div class="js-slide">
                        ...
                        <div class="text-center g-pa-40">
                            <h4 class="h6 text-uppercase g-font-weight-700 g-color-white g-mb-15">Projects of
                                resdential buildings</h4>
                            <p class="g-font-size-default g-color-white-opacity-0_5 mb-0">Nullam quis ante. Etiam sit
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 text-center g-mb-30 g-mb-0--lg">
                        ...
                        <p class="g-mb-30">Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam
                            semper libero, sit amet adipiscing sem neque sed ipsum.Etiam rhoncus. Maecenas tempus,
                            tellus eget condimentum rhoncus, sem quam semper libero.</p>
                        <p class="mb-0"> Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero,
                            sit amet adipiscing sem neque sed ipsum.Etiam rhoncus.</p>
                    </div>
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-md-4 text-center g-mb-30 g-mb-0--md">
                                ...
                                <div class="text-uppercase g-mb-20">
                                    <h4
                                        class="g-letter-spacing-1 g-font-size-11 g-font-weight-400 g-color-gray-dark-v5 g-mb-10">
                                        Best eco design</h4>
                                    <h2 class="g-letter-spacing-2 g-font-weight-600 g-font-size-18 g-mb-25">Eco style
                                        2015</h2>
                                </div>

                                <a href="#!"
                                    class="text-uppercase g-font-weight-700 g-font-size-11 g-text-underline--none--hover"
                                    tabindex="0">View project</a>
                            </div>
                            ...
                            <div class="col-md-4 text-center g-mb-30 g-mb-0--md">
                                ...
                                <div class="text-uppercase g-mb-20">
                                    <h4
                                        class="g-letter-spacing-1 g-font-size-11 g-font-weight-400 g-color-gray-dark-v5 g-mb-10">
                                        Global design</h4>
                                    <h2 class="g-letter-spacing-2 g-font-weight-600 g-font-size-18 g-mb-25">Modernica
                                        2016</h2>
                                </div>
                            ...
                            <div class="js-slide">
                                ...
                                <div class="text-center">
                                    <p class="g-font-size-default g-color-white-opacity-0_5 g-mb-25">Nullam quis ante.
                                        Etiam sit amet orci eget eros faucibus tincidunt. Nullam quis ante. Etiam sit
                                        amet orci.</p>
                                    <h4 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-white g-mb-7">
                                        Vanessa Igrek</h4>
                                    <h6 class="text-uppercase g-font-size-9 g-color-white-opacity-0_5 mb-0">Gray
                                        consultant corp</h6>
                                </div>
                            </div>
        ...
        <footer>
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group g-mb-30">
                                    <input id="inputGroup1_1"
                                        class="form-control g-font-size-14 g-theme-bg-gray-light-v2 g-brd-none g-rounded-1 g-py-14 g-px-10"
                        ...
                        <div class="col-md-3">
                            <address class="row text-center">
                                <div class="col-sm-4 col-md-12 g-mb-30">
                                    <i
                                        class="icon-directions icon d-inline-block g-font-size-20 g-color-primary g-mb-7"></i>
                                    <h3
                                        class="text-uppercase g-font-size-12 g-color-gray-dark-v5 g-font-weight-400 g-mb-5">
                                        Address</h3>
                                ...
                                <div class="col-sm-4 col-md-12 g-mb-30">
                                    <i
                                        class="icon-call-in icon d-inline-block g-font-size-20 g-color-primary g-mb-7"></i>
                                    <h3
                                        class="text-uppercase g-font-size-12 g-color-gray-dark-v5 g-font-weight-400g-mb-5">
                                        Phone number</h3>
                                ...
                                <div class="col-sm-4 col-md-12">
                                    <i
                                        class="icon-envelope-open icon d-inline-block g-font-size-20 g-color-primary g-mb-7"></i>
                                    <h3
                                        class="text-uppercase g-font-size-12 g-color-gray-dark-v5 g-font-weight-400 g-mb-5">
                                        Email</h3>
                                    <a class="g-color-black g-color-black--hover" href="mailto:info@unify.com"><strong
                                            class="g-font-size-14">info@unify.com</strong></a>
                                </div>
                            </address>
                        </div>
                    </div>
            ...
            <div class="g-pos-rel g-height-400">
                <div id="gMap7" class="js-g-map g-pos-abs w-100 h-100" data-type="custom" data-lat="40.674"
                    data-lng="-73.946" data-zoom="12" data-title="Architecture"
                    data-styles='[
