    ...
    <main class="g-pt-130 g-pt-140--md g-pt-170--lg">
                ...
                <nav class="navbar navbar-expand-lg py-0">
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-mr-40--sm" id="navBar">
                            <ul id="js-scroll-nav"
                                class="navbar-nav text-uppercase g-font-weight-700 g-py-10--md mr-auto">
                                <li class="nav-item g-mr-15--lg g-mb-7 g-mb-0--lg active">
                                    <a href="#home" class="nav-link g-color-primary--hover p-0">Home <span
                        ...
                        <div class="g-hidden-md-down text-uppercase g-valign-middle">
                            <a href="#!"
                                class="btn btn-md text-uppercase u-btn-primary g-font-weight-700 g-font-size-12 g-brd-none g-rounded-4 g-py-12 g-px-15">Get
                                a Quote</a>
                        </div>
                        <!-- End Search -->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-5 align-self-center">
                            <div class="g-bg-white g-rounded-5 g-pa-15 g-pa-30--md">
                                <h3 class="h6 g-color-black g-font-weight-600 text-uppercase text-center g-mb-25">
                                ...
                                <form>
                                    <div class="form-group g-mb-10 g-mb-20--md">
                                        <input
                                            class="form-control g-theme-color-gray-light-v10 g-placeholder-inherit g-brd-gray-light-v5 g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-px-10 g-py-12"
                                    ...
                                    <div class="form-group g-mb-10 g-mb-20--md">
                                        <select
                                            class="js-custom-select u-select-v1 g-theme-color-gray-light-v10 g-brd-gray-light-v5 g-bg-gray-light-v5 g-rounded-4 g-pa-10"
                                            style="width: 100%;" data-placeholder="Cargo Type"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group g-mb-10 g-mb-20--md">
                                                <input
                                                    class="form-control g-brd-gray-light-v5 g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-px-10 g-py-12"
                        ...
                        <div class="col-md-6 col-lg-7 g-hidden-sm-down align-self-center g-color-white">
                            <h2
                                class="text-uppercase g-line-height-1 g-font-weight-700 g-font-size-40 g-font-size-56--md g-color-white g-mb-30">
                                Planning
                                <br>&amp; Shiping
                            </h2>
                            <h3 class="text-uppercase g-font-weight-700 g-font-size-18 g-color-white g-mb-20">
                                Delivering anything to anywhere</h3>
                            <p class="g-font-size-default g-color-white-opacity-0_8 g-mb-35">Maecenas lacus magna,
                                pretium in congue a, pharetra at lacus. Nulla neque justo, sodales vitae dui non,
                                imperdiet luctus libero.</p>
                            <a class="btn btn-md text-uppercase u-btn-primary g-font-weight-700 g-font-size-12 g-brd-none g-rounded-4 g-py-12 g-px-25"
                                href="#!">Learn more</a>
                        </div>
        ...
        <div id="about">
                ...
                <div class="container text-center text-md-left g-max-width-960">
                    <div class="row justify-content-md-around">
                        <div class="col-md-8 align-self-md-center">
                            <h2 class="text-uppercase g-line-height-1_1 g-font-weight-700 g-font-size-32">Order now and
                                get
                                <span class="g-color-primary">20% off</span>
                            </h2>
                            <p class="g-mb-20 g-mb-0--md">Raecenas lacus magna, pretium in congue a, pharetra at lacus
                                imperdiet luctus libero</p>
                        </div>

                        <div class="col-md-4 align-self-md-center text-md-center">
                            <a class="btn btn-md text-uppercase u-btn-darkgray g-font-weight-700 g-font-size-12 g-brd-none g-rounded-4 g-py-15 g-px-15 g-px-35--md"
                                href="#!">Calculate and order</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="row no-gutters">
                    <div class="col-md-4 g-brd-around g-brd-top-none g-brd-gray-light-v4">
                        ...
                        <article class="u-block-hover">
                            ...
                            <div class="text-center g-pa-40">
                                ...
                                <p>Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in blandit
                                    dolor. Vivamus a fringilla lorem</p>
                                <a class="text-uppercase g-font-weight-600 g-font-size-12" href="#!">Learn
                                    More</a>
                            </div>
                        </article>
                        <!-- End Article -->
                    ...
                    <div
                        class="col-md-4 g-brd-around g-brd-top-none g-brd-gray-light-v4 g-ml-minus-1--md g-mr-minus-1--md">
                        <!-- Article -->
                        <article class="u-block-hover">
                            <figure
                                class="u-bg-overlay g-bg-black-opacity-0_4--after g-overflow-hidden g-ml-minus-1--md g-mr-minus-1--md">
            ...
            <section class="g-pt-100">
                <div class="container g-width-760 g-mb-70">
                    <div class="text-center mx-auto u-heading-v2-2--bottom g-brd-primary g-mb-30">
                        ...
                        <p class="mb-0">Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas
                                ...
                                <div class="info-v3-3__description u-link-v2 g-flex-middle">
                                    <div class="g-flex-middle-item g-pa-30">
                                        <h4 class="h3 text-uppercase g-line-height-1 g-font-weight-700 g-mb-20">
                                            <a class="info-v3-3__title g-color-gray-dark-v2 g-color-white--parent-hover g-text-underline--none--hover g-transition-0_3"
                                                href="#!">
                                        ...
                                        <em
                                            class="info-v3-3__category g-font-style-normal g-font-size-11 text-uppercase">Shipping
                                            & package</em>

                                        <div class="info-v3-3__content g-opacity-0_7">
                                            <p class="g-color-white--parent-hover mb-0">Maecenas tempus, tellus eget
        ...
        <section id="services" class="u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_6--after g-py-85"
            ...
            <div class="container u-bg-overlay__inner g-width-760">
                <div class="text-center mx-auto u-heading-v2-2--bottom g-brd-primary g-mb-70">
                    <h2
                        class="text-uppercase g-line-height-1_1 g-font-weight-700 g-font-size-26 g-color-white g-mb-15">
                        Tour services</h2>
                    <p class="g-color-white-opacity-0_8 mb-0">Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam
                ...
                <div class="row">
                    <div class="col-md-4 g-mb-80">
                        ...
                        <div class="u-info-v2-2 h-100 g-color-white text-center">
                            <div
                                class="u-info-v2-2__item h-100 g-brd-around g-brd-top-none g-brd-white-opacity-0_2 g-px-20 g-pb-30">
                                ...
                                <h3 class="h6 text-uppercase g-font-weight-700 g-color-white g-mt-minus-35 g-mb-15">
                                    International Shiping</h3>
                                <p class="g-color-white-opacity-0_8 mb-0">Fusce mauris eros, ullamcorper in gravida a,
                                    feugiat in mauris. Curabitur ac scelerisque nisi. Vivamus accumsan in purus et
                                    egestas.</p>
                            </div>
                        </div>
                        <!-- End Icon Blocks -->
        ...
        <section id="skills">
            <div class="g-py-85">
                <div class="container text-center g-width-760 u-heading-v2-2--bottom g-brd-primary g-mb-40">
                    <h2 class="text-uppercase g-line-height-1_1 g-font-weight-700 g-font-size-26 g-mb-15">Our skills
                    </h2>
                    <p class="mb-0">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia
                        Curae; Maecenas ac nulla vehicula risus pulvinar feugiat ullamcorper sit amet mi.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 text-center g-mb-50 g-mb-0--lg">
                            <div class="js-pie g-font-weight-600 g-mb-35" data-circles-value="84"
                                ...
                                data-circles-fg-color="#f00" data-circles-radius="80" data-circles-stroke-width="10"
                                data-circles-duration="2000" data-circles-scroll-animate="true"
                                data-circles-font-size="20" data-circles-color="#000">
                            </div>
                            ...
                            <p class="mb-0">Integer accumsan maximus leo, et consectetur metus vestibulum in.
                                Vestibulum viverra justo odio maximus efficitur</p>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3 text-center g-mb-50 g-mb-0--lg">
                            ...
                            <p class="mb-0">Quisque vestibulum sem eget nibh commodo, non elementum nibh pulvinar.
                                Duis mattis venenatis tortor iaculis ultricies</p>
                        </div>
                        <!-- End Counter Pie Chart -->
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="g-theme-bg-gray-light-v1 g-py-70 g-px-35">
                            <h2 class="text-uppercase g-font-weight-700 g-font-size-26 g-mb-15">Packing fragile items
                            </h2>
                            <p class="g-mb-30">Aenean volutpat erat quis mollis accumsan. Mauris at cursus ipsum.
                                Praesent molestie imperdiet purus in finibus. Pellentesque elit enim, malesuada a varius
                                elementum, sodales id turpis. Maecenas interdum enim egestas risus semper, consectetur
                                auctor metus rhoncus.</p>
                            <p class="mb-0">Proin tempus tincidunt nunc sed pellentesque. Vivamus suscipit, tellus
                                nec auctor egestas, urna augue hendrerit est, vel luctus nisl leo ut sem. Suspendisse
                                sed tincidunt risus.</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 g-mb-30">
                                    <div class="media">
                                        <div class="d-flex mr-4">
                                            <span
                                                class="d-block g-font-size-30 g-font-weight-700 g-line-height-1 g-color-primary">01.</span>
                                        </div>

                                        <div class="media-body">
                                            <h3 class="h5 text-uppercase g-font-weight-700 g-mb-15">Fusce accumsan
                                                faucibus</h3>
                                            <p class="mb-0">Curabitur sit amet fringilla mi. Etiam ac massa sit amet
                                                nulla eleifend rutrum vitae non sem. Fusce accumsan faucibus laoreet.
                                                Maecenas auctor mauris erat quis mollis.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 g-mb-30">
                                    <div class="media">
                                        <div class="d-flex mr-4">
                                            <span
                                                class="d-block g-font-size-30 g-font-weight-700 g-line-height-1 g-color-primary">02.</span>
                                        </div>

                                        <div class="media-body">
                                            <h3 class="h5 text-uppercase g-font-weight-700 g-mb-15">Maecenas auctor
                                                mauris</h3>
                                            <p class="mb-0">Aenean volutpat erat quis mollis accumsan. Mauris at
                                                cursus ipsum. Praesent molestie imperdiet purus in finibus. Pellentesque
                                                elit enim, malesuada a varius elementum.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 g-mb-30">
                                    <div class="media">
                                        <div class="d-flex mr-4">
                                            <span
                                                class="d-block g-font-size-30 g-font-weight-700 g-line-height-1 g-color-primary">03.</span>
                                        </div>

                                        <div class="media-body">
                                            <h3 class="h5 text-uppercase g-font-weight-700 g-mb-15">Suspendisse
                                                pharetra elit ac</h3>
                                            <p class="mb-0">Maecenas interdum enim egestas risus semper, consectetur
                                                auctor metus rhoncus. Proin tempus tincidunt nunc sed pellentesque.
                                                Vivamus suscipit, tellus nec</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 g-mb-30">
                                    <div class="media">
                                        <div class="d-flex mr-4">
                                            <span
                                                class="d-block g-font-size-30 g-font-weight-700 g-line-height-1 g-color-primary">04.</span>
                                        </div>

                                        <div class="media-body">
                                            <h3 class="h5 text-uppercase g-font-weight-700 g-mb-15">Vestibulum
                                                fringilla risus ege</h3>
                                            <p class="mb-0">Suspendisse sed tincidunt risus. Nam vehicula nunc vel
                                                metus rutrum, eu venenatis nulla porttitor. Nam iaculis nunc eu
                                                tincidunt consectetur. Nullam et ex at velit tempor.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 g-mb-30 g-mb-0--lg">
                                    <div class="media">
                                        <div class="d-flex mr-4">
                                            <span
                                                class="d-block g-font-size-30 g-font-weight-700 g-line-height-1 g-color-primary">05.</span>
                                        </div>

                                        <div class="media-body">
                                            <h3 class="h5 text-uppercase g-font-weight-700 g-mb-15">Enim egestas risus
                                                semper</h3>
                                            <p class="mb-0">Maecenas interdum enim egestas risus semper, consectetur
                                                auctor metus rhoncus. Proin tempus tincidunt nunc sed pellentesque.
                                                Vivamus suscipit, tellus nec</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="media">
                                        <div class="d-flex mr-4">
                                            <span
                                                class="d-block g-font-size-30 g-font-weight-700 g-line-height-1 g-color-primary">06.</span>
                                        </div>

                                        <div class="media-body">
                                            <h3 class="h5 text-uppercase g-font-weight-700 g-mb-15">Eu venenatis nulla
                                                porttitor</h3>
                                            <p class="mb-0">Suspendisse sed tincidunt risus. Nam vehicula nunc vel
                                                metus rutrum, eu venenatis nulla porttitor. Nam iaculis nunc eu
                                                tincidunt consectetur. Nullam et ex at velit tempor.</p>
        ...
        <section id="offers" class="g-theme-bg-gray-light-v1 g-py-100">
            <div class="container text-center g-width-760 u-heading-v2-2--bottom g-brd-primary g-mb-70">
                ...
                <p class="mb-0">Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus,
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 g-mb-30">
                        ...
                        <article
                            ...
                            <div class="g-py-40 g-px-30">
                                <h4 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-black g-mb-15">Small
                                </h4>
                                <em class="d-block g-font-style-normal g-color-gray-dark-v3 g-mb-35">Dimentions:
                                    10x10x15cm</em>
                                ...
                                <a class="btn btn-md text-uppercase u-btn-primary g-font-weight-700 g-font-size-12 g-brd-none g-rounded-4 g-py-12 g-px-15"
                                    href="#!">Order Now</a>
                            </div>
                            <!-- End Article Content -->
                        </article>
                    ...
                    <div class="col-lg-3 col-sm-6 g-mb-30">
                        ...
                        <article
                            ...
                            <!-- Article Content -->
                            <div class="g-py-40 g-px-30">
                                <h4 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-black g-mb-15">
                                    Medium</h4>
                                <em class="d-block g-font-style-normal g-color-gray-dark-v3 g-mb-35">Dimentions:
                                    10x10x15cm</em>
                    ...
                    <div class="col-lg-3 col-sm-6 g-mb-30 g-mb-0--md">
                        ...
                        <article
                            ...
                            <!-- Article Content -->
                            <div class="g-py-40 g-px-30">
                                <h4 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-black g-mb-15">Large
                                </h4>
                                <em class="d-block g-font-style-normal g-color-gray-dark-v3 g-mb-35">Dimentions:
                                    10x10x15cm</em>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <article
                            ...
                            <!-- Article Content -->
                            <div class="g-py-40 g-px-30">
                                <h4 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-black g-mb-15">Extra
                                    large</h4>
                                <em class="d-block g-font-style-normal g-color-gray-dark-v3 g-mb-35">Dimentions:
                                    10x10x15cm</em>
        ...
        <section id="gallery" class="g-pt-90">
            ...
            <!-- Cube Portfolio -->
            <div class="cbp" data-layout="grid" data-animation="slideLeft" data-caption-animation="zoom"
                    ...
                    <div class="col-lg-8 d-flex align-items-center g-order-2--lg g-mb-50 g-mb-0--lg">
                        <div class="w-100">
                            <div class="u-heading-v2-2--bottom g-brd-primary g-mb-50">
                                <h2 class="text-uppercase g-line-height-1_1 g-font-weight-700 g-font-size-26 g-mb-15">
                                    FAQ</h2>
                                <p class="mb-0">Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus.
                                </p>
                            </div>
                            ...
                            <div id="FAQAccordion">
                                <div class="card g-brd-none">
                                    <div id="FAQAccordionHeading1"
                                        class="card-header u-accordion__header g-pos-rel g-bg-transparent g-brd-none rounded-0 g-py-10 g-px-30">
                                        <a class="g-font-weight-700 g-font-size-18" href="#FAQAccordionBody1"
                                            aria-expanded="true" aria-controls="FAQAccordionBody1"
                                            data-toggle="collapse" data-parent="#FAQAccordion">
                                            <span
                                                class="u-accordion__control-icon g-absolute-centered--y g-left-0 g-color-primary">
                                    ...
                                    <div id="FAQAccordionBody1" class="collapse show"
                                        aria-labelledby="FAQAccordionHeading1">
                                        <div class="card-block u-accordion__body g-py-10 g-px-30">
                                            <p class="g-line-height-1_5 mb-0">Anim pariatur cliche reprehenderit, 3
                                ...
                                <div class="card g-brd-none">
                                    <div id="FAQAccordionHeading2"
                                        class="card-header u-accordion__header g-pos-rel g-bg-transparent g-brd-none rounded-0 g-py-10 g-px-30">
                                        <a class="g-font-weight-700 g-font-size-18 collapsed"
                                    ...
                                    <div id="FAQAccordionBody2" class="collapse"
                                        aria-labelledby="FAQAccordionHeading2">
                                        <div class="card-block u-accordion__body g-py-10 g-px-30">
                                            <p class="g-line-height-1_5 mb-0">Anim pariatur cliche reprehenderit, enim
                                ...
                                <div class="card g-brd-none">
                                    ...
                                    <div id="FAQAccordionBody3" class="collapse"
                                        aria-labelledby="FAQAccordionHeading3">
                                        <div class="card-block u-accordion__body g-py-10 g-px-30">
                                            <p class="g-line-height-1_5 mb-0">3 wolf moon officia aute, non cupidatat
                                ...
                                <div class="card g-brd-none">
                                    ...
                                    <div id="FAQAccordionBody4" class="collapse"
                                        aria-labelledby="FAQAccordionHeading4">
                                        <div class="card-block u-accordion__body g-py-10 g-px-30">
                                            <p class="g-line-height-1_5 mb-0">Anim pariatur cliche reprehenderit, enim
                                                ...
                                                nesciunt laborum eiusmod. nesciunt laborum eiusmod.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card g-brd-none">
                                    ...
                                    <div id="FAQAccordionBody5" class="collapse"
                                        aria-labelledby="FAQAccordionHeading5">
                                        <div class="card-block u-accordion__body g-py-10 g-px-30">
                                            <p class="g-line-height-1_5 mb-0">Anim pariatur cliche reprehenderit, enim
                                                eiusmod high life accusamus terry richardson ad squid. 3 wolf moon
                                                officia aute.</p>
        ...
        <section id="testimonials">
            <div class="u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_5--after g-py-90"
                ...
                <div class="container u-bg-overlay__inner g-width-760">
                    <div class="text-center mx-auto u-heading-v2-2--bottom g-brd-primary g-mb-70">
                        <h2
                            class="text-uppercase g-line-height-1_1 g-font-weight-700 g-font-size-26 g-color-white g-mb-15">
                            What do people say about us?</h2>
                        <p class="g-color-white-opacity-0_8 mb-0">Curabitur ullamcorper ultricies nisi. Nam eget dui.
                            Etiam rhoncus. Nam eget dui. Etiam rhoncus. ullamcorper ultricies nisi, ullamcorper
                            ultricies nisi</p>
                    </div>
                </div>
                        ...
                        <div class="js-slide">
                            ...
                            <div class="media d-block d-md-flex">
                                ...
                                <div class="media-body align-self-center text-sm-left text-center g-color-white">
                                    <blockquote class="g-mb-25">The customisation options you implemented are
                                        countless, and I feel sorry I can't use them all. Good job, and keep going! are
                                        countless, and I feel</blockquote>
                                    <h4 class="h6 text-uppercase g-font-weight-700 g-color-white mb-0">Someone someone
                                    </h4>
                                </div>
                            </div>
            ...
            <div class="js-carousel g-brd-bottom g-brd-gray-light-v4" data-autoplay="true" data-slides-show="7"
                data-responsive='[{
               "breakpoint": 1200,
               "settings": {
                 "slidesToShow": 7
        ...
        <section id="contact" class="g-pt-80">
            ...
            <!-- Google Map -->
            <div id="gMap" class="js-g-map g-min-height-500 h-100" data-type="custom" data-lat="40.674"
                data-lng="-73.946" data-zoom="12" data-title="Travel"
                data-styles='[
            ...
            <div class="container g-py-80">
                <div class="row">
                    <div class="col-lg-4 text-uppercase">
                        ...
                        <p class="g-font-size-12 g-mb-40">Curabitur sit amet fringilla mi. Etiam ac massa sit amet
                            nulla eleifend rutrum vitae non sem.</p>
                        ...
                        <address class="g-font-size-12">
                            ...
                            <p> Email
                                <a class="g-color-gray-dark-v2"
                                    href="mailto:info@unify.com"><strong>info@unify.com</strong></a>
                            </p>
                        </address>
                    </div>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-lg-12 form-group g-mb-20">
                                    <input
                                        class="form-control g-font-size-default g-color-gray-dark-v5 g-placeholder-inherit g-bg-gray-light-v5 g-brd-gray-light-v5 g-brd-primary--focus g-color-gray-dark-v5 g-rounded-4 g-py-13 g-px-12"
