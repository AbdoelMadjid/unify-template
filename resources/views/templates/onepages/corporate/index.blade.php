...
<head>
    ...
    <!-- Google Fonts -->
    <link rel="stylesheet"
        href="//fonts.googleapis.com/css?family=Roboto%3A300%2C400%2C500%2C700%7COpen+Sans%3A300%2C400%2C600%2C700%2C800%7CPlayfair+Display%7CRaleway%7CSpectral%7CRubik">
    ...
    <main>
                        ...
                        <div class="col-sm-10 col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-md-6 g-mb-10 g-mb-30--md">
                                    <div class="media">
                                        <span
                                            class="d-flex u-icon-v1 g-width-50 g-height-50 g-color-white g-bg-white-opacity-0_1 g-font-size-26 g-line-height-1 rounded-circle g-pos-rel g-pa-12 mr-3">
        ...
        <section id="about-section" class="g-bg-secondary g-pos-rel">
            ...
            <svg class="g-pos-rel g-top-minus-120" version="1.1" preserveAspectRatio="none"
                ...
                height="140px" viewBox="20 -20 300 100">
      ...
      c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fafbfc" />
            ...
            <!-- SVG Background -->
            <svg class="g-pos-rel g-bottom-minus-20" version="1.1" preserveAspectRatio="none"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%"
      ...
      c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fff" />
        ...
        <div id="portfolio-section" class="container g-pt-70 g-pb-100">
            ...
            <div class="text-center">
                <a class="btn u-btn-outline-black g-min-width-170 g-brd-text g-color-text g-bg-main--hover g-font-weight-500 g-font-size-13 text-uppercase g-rounded-30 g-px-30 g-py-14"
                    href="#!">View All Works</a>
            </div>
        </div>
      ...
      c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fafbfc" />
                    ...
                    <div class="u-shadow-v28 g-bg-white text-left text-md-center rounded g-px-30 g-py-40">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="d-flex d-md-block justify-content-between justify-content-start g-py-15">
                                ...
                                <svg width="14" height="14" id="close" viewBox="0 0 32 32"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="row justify-content-center align-items-center no-gutters">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="g-px-30 g-px-50--lg g-py-60">
                                ...
                                <ul class="list-inline mb-3">
                                    ...
                                    <li class="list-inline-item g-mx-2">
                                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-bluegray g-bg-bluegray-opacity-0_1 g-color-bluegray--hover rounded-circle"
                                            ...
                                            <i
                                                class="g-font-size-default g-line-height-0_8 u-icon__elem-hover fa fa-github"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item g-mx-2">
                                ...
                                <a class="u-link-v5 g-color-text g-color-primary--hover g-font-weight-700"
                                    href="#!">See Projects</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="g-bg-secondary">
            <div class="container g-py-100">
                ...
                <!-- Testimonials -->
                <div class="js-carousel g-pb-60" data-infinite="true" data-autoplay="true" data-speed="7000"
                    data-lazy-load="progressive" data-slides-show="3"
            ...
            <div class="row">
                    ...
                    <article class="u-shadow-v28 g-bg-white">
                        ...
                        <div class="g-pos-rel">
                            ...
                            <svg class="g-pos-abs g-left-0 g-right-0" version="1.1" preserveAspectRatio="none"
                                ...
                                width="100%" height="140px" viewBox="20 -20 300 100" style="top: -70%;">
                                <path d="M30.913,43.944c0,0,42.911-34.464,87.51-14.191c77.31,35.14,113.304-1.952,146.638-4.729
              c48.654-4.056,69.94,16.218,69.94,16.218v54.396H30.913V43.944z" opacity="0.4" fill="#f0f1f3" />
                                <path d="M-35.667,44.628c0,0,42.91-34.463,87.51-14.191c77.31,35.141,113.304-1.952,146.639-4.729
              c48.653-4.055,69.939,16.218,69.939,16.218v54.396H-35.667V44.628z" opacity="0.4" fill="#f0f1f3" />
              ...
              c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fff" />
                            ...
                            <div class="g-pos-rel g-z-index-1 g-pa-30">
                                <h3 class="h5 mb-3">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Free
                                        virtual conference to take your agile ux skills to the next level</a>
                                </h3>
                                <a class="u-link-v5 g-color-text g-color-primary--hover g-font-weight-500"
                                    href="#!">Read More</a>
                            </div>
                        </div>
                    </article>
              ...
              c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fff" />
                            ...
                            <div class="g-pos-rel g-z-index-1 g-pa-30">
                                <h3 class="h5 mb-3">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">More than
                                        a look, design is functional.</a>
                                </h3>
                                <a class="u-link-v5 g-color-text g-color-primary--hover g-font-weight-500"
                                    href="#!">Read More</a>
                            </div>
                ...
                <div class="col-sm-6 col-lg-3 g-mb-50">
                    ...
                    <form class="input-group g-rounded-30 g-mb-50 g-mb-30--sm">
                        ...
                        <span class="input-group-addon g-brd-secondary-light-v2 g-brd-left-none">
                            <button class="btn g-bg-white g-color-main g-color-primary--hover g-font-size-12 g-pa-10"
                    ...
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item g-mx-2">
                            <a class="u-icon-v3 g-width-35 g-height-35 g-color-main g-bg-secondary g-color-white--hover g-bg-primary--hover g-font-size-13 rounded-circle"
                                href="https://www.facebook.com/htmlstream">
