...
<head>
    ...
    <!-- Google Fonts -->
    <link rel="stylesheet"
        href="//fonts.googleapis.com/css?family=Montserrat%3A300%2C400%2C500%2C600%2C700%2C900%7COpen+Sans%3A300%2C400%2C500%2C600%2C700%2C800%7CPlayfair+Display%7CRoboto%7CRaleway%7CSpectral%7CRubik">
...
<body class="g-overflow-x-hidden">
    <main class="g-pt-105">
        ...
        <header id="js-header" class="u-header u-header--sticky-top u-header--change-appearance g-z-index-9999"
            ...
            <div class="u-header__section g-bg-white g-transition-0_3 g-py-16" data-header-fix-moment-exclude="g-py-16"
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
                            <ul id="js-scroll-nav"
                                ...
                                <li class="nav-item g-mr-10--lg g-mb-7 g-mb-0--lg active">
                                    <a href="#masterslider" class="nav-link p-0">Home <span
        ...
        <div class="master-slider" id="masterslider">
            <div class="ms-slide">
                ...
                <div class="ms-layer text-center g-pos-rel" data-type="text" data-delay="10"
                    ...
                    data-offset-x="-100" data-offset-y="-15" data-resize="true">
                    <i class="icon-food-026 g-font-size-60 g-color-white-opacity-0_7 g-mb-10"></i>
                    <h2
                        class="text-uppercase g-line-height-1_2 g-font-weight-700 g-font-size-30 g-font-size-56--md g-color-white g-mb-10 g-mb-15--md">
                        Meat dishes</h2>
                    <p
                    ...
                    <p
                        class="g-line-height-1_1 g-font-weight-100 g-font-size-default g-color-white g-mb-10 g-mb-20--md">
                    ...
                    <div class="col-lg-6 g-flex-centered g-bg-primary g-pa-40">
                        <div class="text-center">
                            <div
                                ...
                                <h4 class="g-font-weight-700 g-font-size-12 g-color-white-opacity-0_7 g-mb-15">About us
                                </h4>
                                <h2
                                    class="u-heading-v5__title g-line-height-1_2 g-font-weight-700 g-font-size-32 g-font-size-40--md g-color-white g-bg-white--before g-pb-40">
                                    We are the best</h2>
                            </div>

                            <p class="g-color-white-opacity-0_7 g-mb-15">Sed feugiat porttitor nunc, non dignissim
                            ...
                            <p class="g-color-white-opacity-0_7 mb-0">Fringilla lorem, vel faucibus ante. Nunc
        ...
        <section id="menu" class="g-py-100">
            ...
            <div class="container g-width-560">
                <!-- Nav tabs -->
                <ul class="nav justify-content-center text-uppercase u-nav-v5-3 u-nav-primary g-line-height-1_4 g-font-weight-700 g-font-size-default g-brd-bottom--md g-brd-gray-light-v4 g-mb-80--md"
                    ...
                    <li class="nav-item g-mx-10--md">
                        <a class="nav-link g-theme-color-gray-dark-v1 g-color-primary--hover g-pb-25--md active"
                            data-toggle="tab" href="#breakfast" role="tab">Breakfast</a>
                    </li>
                    <li class="nav-item g-mx-10--md">
                        <a class="nav-link g-theme-color-gray-dark-v1 g-color-primary--hover g-pb-25--md"
                            data-toggle="tab" href="#lunch" role="tab">Lunch</a>
                    </li>
                    <li class="nav-item g-mx-10--md">
                        <a class="nav-link g-theme-color-gray-dark-v1 g-color-primary--hover g-pb-25--md"
                            data-toggle="tab" href="#dinner" role="tab">Dinner</a>
                    </li>
                </ul>
                <!-- End Nav tabs -->
            </div>
        ...
        <section id="special" class="g-bg-primary g-py-100">
            <div class="container">
                <section class="js-carousel" data-vertical="true"
                    ...
                    <div class="js-slide">
                        ...
                        <article class="row flex-items-middle text-center">
                            <div class="col-lg-6 align-self-center g-mb-50">
                                <div
                                    class="text-uppercase text-center u-heading-v5-3 u-heading-v5-color-primary u-heading-v5-rounded-50x g-mb-20">
                                    <h4 class="g-font-weight-700 g-font-size-12 g-color-white-opacity-0_7 g-mb-15">From
                                        chef</h4>
                                    <h2
                                        class="u-heading-v5__title g-line-height-1_2 g-font-weight-700 g-font-size-32 g-font-size-40--md g-color-white g-bg-white--before g-pb-40">
                                ...
                                <div class="g-px-70--md">
                                    <p class="g-color-white-opacity-0_7 g-mb-25">Sed feugiat porttitor nunc, non
                                        dignissim ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla
                                        lorem, vel faucibus ante.</p>
                                </div>
                            ...
                            <div class="col-lg-6 align-self-center g-mb-50">
                                <div
                                    ...
                                    <h4 class="g-font-weight-700 g-font-size-12 g-color-white-opacity-0_7 g-mb-15">From
                                        chef</h4>
                                    <h2
                                        class="u-heading-v5__title g-line-height-1_2 g-font-weight-700 g-font-size-40 g-color-white g-bg-white--before g-pb-40">
                                        Spaghetti</h2>
                                </div>
        ...
        <section id="ourFood" class="g-pt-100">
            <div class="container text-uppercase g-mb-30">
                ...
                <h2 class="g-line-height-1_2 g-font-weight-700 g-font-size-32 g-font-size-40--md g-bg-primary--before">
                    Try this yummy</h2>
            </div>
            ...
            <div class="g-brd-top--md g-theme-brd-gray-light-v1">
                <div class="container">
                    <ul class="nav text-uppercase u-nav-v2-1 u-nav-primary g-mt-minus-1" role="tablist"
                        data-target="ourFoodTabs" data-tabs-mobile-type="slide-up-down"
                        data-btn-classes="btn btn-md btn-block text-uppercase g-font-weight-700 u-btn-outline-primary">
                        <li class="nav-item">
                            <a class="nav-link g-py-15--md g-py-35--lg g-px-10--md g-px-30--lg active" href="#meat"
                                role="tab" data-toggle="tab">Meat</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-py-15--md g-py-35--lg g-px-10--md g-px-30--lg" href="#fish"
                                role="tab" data-toggle="tab">Fish</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-py-15--md g-py-35--lg g-px-10--md g-px-30--lg" href="#fastFood"
                                role="tab" data-toggle="tab">Fast food</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-py-15--md g-py-35--lg g-px-10--md g-px-30--lg" href="#pizza"
                                role="tab" data-toggle="tab">Pizza</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-py-15--md g-py-35--lg g-px-10--md g-px-30--lg"
                                href="#vegeterianDishes" role="tab" data-toggle="tab">Vegeterian dishes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-py-15--md g-py-35--lg g-px-10--md g-px-30--lg" href="#desserts"
                                role="tab" data-toggle="tab">Desserts</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-py-15--md g-py-35--lg g-px-10--md g-px-30--lg" href="#drinks"
                                role="tab" data-toggle="tab">Drinks</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4">
                                        ...
                                        <article class="text-center">
                                            ...
                                            <!-- Article Content -->
                                            <div
                                                class="g-brd-around g-theme-brd-gray-light-v1 g-py-20 g-px-10 g-mt-minus-1">
                                                <em
                                                    class="d-block text-uppercase font-weight-bold g-color-primary g-font-style-normal g-font-size-11 g-mb-7">Steak</em>
                                                <h4
                                                    class="text-uppercase font-weight-bold h6 g-color-black-dark-v1 g-mb-10">
                                                    Steak + Potatoes</h4>
                                                <p class="g-mb-10">Sed nec iaculis libero, vel ornare dui. Curabitur
                                                    vitae nisl lorem.</p>
                                    ...
                                    <div class="js-slide">
                                        ...
                                        <article
                                            ...
                                            <div
                                                ...
                                                <strong
                                                    class="d-block g-font-size-20 g-color-primary g-mb-3">$9.50</strong>
                                                <h3
                                                    class="text-uppercase g-font-weight-700 g-font-size-26 g-color-white g-mb-10">
                                                    Steak with special sauce</h3>
                                                <p class="g-font-size-16 g-color-white-opacity-0_8">Lorem ipsum dolor
                                    ...
                                    <div class="js-slide">
                                        ...
                                        <article
                                            ...
                                            <div
                                                class="u-bg-overlay__inner g-pos-abs g-left-0 g-bottom-0 g-z-index-1 w-100 g-font-size-16 g-color-white-opacity-0_8 g-px-30 g-pb-100--sm g-pb-70">
                                                <strong
                                                    class="d-block g-font-size-20 g-color-primary g-mb-3">$10.30</strong>
                                                <h3
                                                    class="text-uppercase g-font-weight-700 g-font-size-26 g-color-white g-mb-10">
                                                    Steak with vegetables</h3>
                                                <p class="g-font-size-16 g-color-white-opacity-0_8">Lorem ipsum dolor
                                                    sit amet, consectetur adipiscing elit.</p>
                                            </div>
                                            <!-- End Article Content -->
            ...
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 g-mb-40 g-mb-0--lg">
                        ...
                        <p class="g-font-size-default mb-0">Nunc ligula nulla, efficitur et eros ut, vulputate gravida
                            leo. Vestibulum ante ipsum primis in faucibus orci luctus et.</p>
                    </div>
        ...
        <section id="gallery" class="g-bg-primary g-pt-100">
            <div class="container g-max-width-780 text-center g-mb-60">
                <div
                    ...
                    <h2
                        class="u-heading-v5__title g-line-height-1_2 g-font-weight-700 g-font-size-32 g-font-size-40--md g-color-white g-bg-white--before g-pb-40">
                        Look at these dishes</h2>
                </div>
            </div>

            <div class="cbp" data-layout="grid" data-animation="slideLeft" data-caption-animation="fadeIn"
                        ...
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <p
                                        class="cbp-l-caption-pretitle text-uppercase g-font-size-11 g-color-white-opacity-0_7 g-mb-15">
                                        Fish</p>
                                    <h2
                                        class="cbp-l-caption-title text-uppercase g-font-weight-700 g-font-size-16 g-color-white g-mb-15">
                                        Tim Burton</h2>
                                    <p class="g-font-size-default g-color-white-opacity-0_7 mb-0 g-px-10">Nam
                                        ullamcorper mauris ex, ut efficitur est convallis nec</p>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <section id="ourTeem" class="g-py-100">
            ...
            <div class="container">
                <!-- Carousel -->
                <section class="js-carousel g-pb-90 g-mx-minus-15" data-slides-show="4" data-slides-scroll="4"
                   ...
                   "slidesToScroll": 1
                    ...
                    <div class="js-slide g-px-15">
                        ...
                        <figure class="text-center g-pos-rel">
                            ...
                            <!-- Figure Caption -->
                            <figcaption
                                class="g-pos-abs g-top-0 g-left-0 d-flex w-100 h-100 g-bg-primary-opacity-0_9 opacity-0 g-opacity-1--hover g-transition-0_2 g-transition--ease-in">
                                <div class="align-self-center g-pa-20">
                                    <p class="text-uppercase g-font-size-11 g-color-white-opacity-0_7 g-mb-15">Chef
                                    </p>
                                    <h2 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-white g-mb-15">
                                        George Freeman</h2>
                                    <p class="g-font-size-default g-color-white-opacity-0_7 g-mb-20 g-px-10">Lorem
                                        ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    <ul class="list-inline g-mb-0">
                                        <li class="list-inline-item g-mx-1">
                                            <a href="#!"
                                                class="u-icon u-icon-v3 g-width-35 g-height-35 g-font-size-default g-color-white g-color-primary--hover g-bg-white-opacity-0_5 g-bg-white--hover">
        ...
        <section id="bookingForm" class="g-theme-bg-gray-light-v4 g-py-100">
            <div class="container g-max-width-780 text-center g-mb-60">
                ...
                <p class="mb-0">Etiam ultrices lacus ut ligula vestibulum, sit amet mattis nunc elementum. Nam arcu
                    enim, euismod nec purus non, aliquam congue ante. Nulla faucibus enim mauris, fringilla mollis
                    ligula sollicitudin mollis.</p>
            </div>

            <div class="container">
                <section class="js-carousel g-mx-minus-15" data-slides-show="4"
                    ...
                    <div class="js-slide g-px-15 g-pb-10">
                        ...
                        <article class="u-shadow-v10 g-bg-white g-color-gray-light-v28">
                            ...
                            <div class="g-py-30 g-px-25">
                                <em
                                    class="d-block text-uppercase font-weight-bold g-color-primary g-font-style-normal g-font-size-11 g-mb-7">Steak</em>
                                <h4 class="text-uppercase font-weight-bold h6 g-color-black-dark-v1 g-mb-10">Steak +
                                    Potatoes</h4>
                                <p class="g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla.
        ...
        <div id="contact">
            ...
            <section class="text-center g-color-white g-bg-primary g-py-80">
                <div class="container g-max-width-780">
                    <div class="text-center text-uppercase u-heading-v7-3 g-mb-30">
                        <h3 class="g-font-weight-700 g-font-size-12 g-color-white-opacity-0_7 g-mb-20">Booking from
                        </h3>
                        <h2
                            class="u-heading-v7__title g-font-weight-700 g-font-size-32 g-font-size-40--md g-color-white g-mb-30">
                            Reservation with open table</h2>
                    ...
                    <p class="g-color-white-opacity-0_7 g-mb-75">Etiam ultrices lacus ut ligula vestibulum, sit amet
                        mattis nunc elementum. Nam arcu enim, euismod nec purus non, aliquam congue ante. Nulla faucibus
                        enim mauris, fringilla mollis ligula sollicitudin mollis.</p>
                </div>
                ...
                <div class="container">
                    <form>
                        <div class="row g-mb-40">
                            <div class="col-md-4">
                                <div class="form-group g-pos-rel">
                                    <input
                                        class="form-control u-theme-shadow-v1 g-font-size-default g-color-white g-placeholder-inherit g-theme-bg-primary-dark-v1 g-brd-none rounded-0 g-px-25 g-py-13"
                                        type="text" placeholder="Reservation date">

                                    <div
                                        class="g-pos-abs g-top-0 g-right-0 g-flex-centered g-width-40 h-100 g-color-white">
                        ...
                        <button
                            class="btn text-uppercase u-btn-white g-font-weight-700 g-font-size-11 g-theme-color-gray-dark-v2 g-brd-none rounded-0 g-px-30 g-py-25"
                            type="submit" role="button">Book now</button>
                    </form>
                </div>
            </section>
            <!-- End Section Content -->
            ...
            <section class="text-center g-pos-rel g-height-600">
                <div id="gMap3" class="js-g-map g-pos-abs w-100 h-100" data-lat="-34.397"
                            ...
                            <div class="col-sm-6 d-flex g-color-white g-bg-primary g-pa-20">
                                <div class="align-self-center w-100">
                                    <address>
                                        <div class="g-mb-20">
                                            <h3
                                                class="text-uppercase g-font-size-11 g-color-white-opacity-0_7 g-mb-5">
                                                Address</h3>
