...
<head>
    ...
    <!-- Google Fonts -->
    <link rel="stylesheet"
        href="//fonts.googleapis.com/css?family=Roboto%3A400%2C700%7COpen+Sans%3A300%2C400%2C600%2C700%2C800%7CPlayfair+Display%7CRaleway%7CSpectral%7CRubik">
    ...
    <main>
        ...
        <header id="js-header" class="u-header u-header--sticky-top u-header--change-appearance"
            ...
            <div class="u-header__section g-theme-bg-blue-dark-v1-opacity-0_9 g-transition-0_3 g-py-25"
                data-header-fix-moment-exclude="g-py-25" data-header-fix-moment-classes="g-py-20">
                <nav class="navbar navbar-expand-lg py-0">
                    <div class="container g-pos-rel">
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row" id="navBar">
                            <ul id="js-scroll-nav"
                                class="navbar-nav text-uppercase g-letter-spacing-2 g-font-size-11 g-pt-20 g-pt-0--lg ml-auto">
                                <li class="nav-item g-mr-10--lg g-mr-15--xl g-mb-7 g-mb-0--lg active">
                                    <a href="#home" class="nav-link g-color-white p-0">Home <span
                        ...
                        <button
                            class="navbar-toggler btn g-line-height-1 g-brd-none g-pa-0 g-pos-abs g-top-10 g-right-0"
                    ...
                    <div class="info-v3-4 g-theme-bg-blue-dark-v1-opacity-0_9 g-pa-40 g-pa-60--md">
                        <div class="g-pos-rel g-z-index-3">
                            <h3 class="h3 text-uppercase g-letter-spacing-3 g-font-size-default g-color-white g-mb-10">
                                We are Unify</h3>
                            <h2
                                class="h2 text-uppercase g-color-white g-letter-spacing-5 g-font-weight-400 g-font-size-25 g-font-size-35--md g-mb-20">
                                Business &amp; Corporation</h2>
                            <p class="g-line-height-1_8 g-letter-spacing-3 g-color-white g-mb-20">Sed feugiat porttitor
                                nunc, non dignissim
                                <br> ipsum vestibulum in. Donec in blandit dolor.
                            </p>
                ...
                <div class="col-md-6 col-lg-4 g-flex-centered g-theme-bg-blue-dark-v1">
                    <div class="text-center g-color-gray-light-v2 g-pa-30">
                        <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                            <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-2 g-color-primary g-mb-20">
                                About us</h4>
                            <h2
                                class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-color-white g-mb-minus-10">
                                Help make
                                <br> money
                            </h2>
                        </div>

                        <p class="g-color-gray-light-v2 mb-0">Sed feugiat porttitor nunc, non dignissim ipsum
                            vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc
                            ullamcorper, justo a iaculis elementum, enim orci viverra eros, fringilla porttitor lorem
                            eros vel odio. Praesent egestas ac arcu ac convallis. Donec ut diam risus purus.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 g-theme-bg-blue-dark-v2">
                    <div class="js-carousel g-pb-90" data-infinite="true" data-slides-show="true"
                        ...
                        <div class="js-slide">
                            ...
                            <div class="g-pa-30">
                                <h3 class="text-uppercase g-font-weight-700 g-font-size-20 g-color-white g-mb-10">Since
                                    2008</h3>
                                <p class="g-color-gray-light-v2 g-mb-10">Etiam consectetur placerat gravida.
                                    Pellentesque ultricies mattis est, quis elementum neque pulvinar at.</p>
                                <p class="g-color-gray-light-v2 mb-0">Aenean odio ante, varius vel tempor sed Ut
                                    condimentum ex ac enim ullamcorper volutpat. Integer arcu nisl, finibus vitae
                                    sodales vitae, malesuada ultricies sapien.</p>
                            </div>
                        </div>
                        ...
                        <div class="js-slide">
                            ...
                            <div class="g-pa-30">
                                <h3 class="text-uppercase g-font-weight-700 g-font-size-20 g-color-white g-mb-10">Past
                                    2012</h3>
                                <p class="g-color-gray-light-v2 g-mb-10">Etiam consectetur placerat gravida.
                                    Pellentesque ultricies mattis est, quis elementum neque pulvinar at.</p>
                                <p class="g-color-gray-light-v2 mb-0">Aenean odio ante, varius vel tempor sed Ut
        ...
        <section id="services" class="g-py-80">
            <div class="container">
                <div class="text-uppercase text-center u-heading-v2-4--bottom g-brd-primary g-mb-80">
                    <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-2 g-color-primary g-mb-20">Our
                        services</h4>
                    <h2
                        class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">
                        What we do</h2>
                </div>
                ...
                <div class="row no-gutters">
                    <div
                        class="col-md-6 col-lg-3 g-parent g-brd-around g-brd-gray-light-v4 g-brd-bottom-primary--hover g-brd-bottom-2--hover g-mb-30 g-mb-0--lg g-transition-0_2 g-transition--ease-in">
                        <!-- Icon Blocks -->
                        <div
                            class="text-center g-px-10 g-px-30--lg g-py-40 g-pt-25--parent-hover g-transition-0_2 g-transition--ease-in">
                            <span class="d-block g-color-primary g-font-size-40 g-mb-15">
                                <i class="icon-fire"></i>
                            </span>
                            <h3 class="h5 text-uppercase g-color-black g-mb-10">Analisys</h3>
                            <p class="g-color-gray-dark-v4">Donec id elit non mi porta gravida at eget metus id elit mi
                                egetine. Fusce dapibus</p>
                    ...
                    <div
                        class="col-md-6 col-lg-3 g-parent g-brd-around g-brd-gray-light-v4 g-brd-bottom-primary--hover g-brd-bottom-2--hover g-mb-30 g-mb-0--lg g-ml-minus-1 g-transition-0_2 g-transition--ease-in">
                        <!-- Icon Blocks -->
                        <div
                            class="text-center g-px-10 g-px-30--lg g-py-40 g-pt-25--parent-hover g-transition-0_2 g-transition--ease-in">
                            <span class="d-block g-color-primary g-font-size-40 g-mb-15">
                            ...
                            <p class="g-color-gray-dark-v4">Donec id elit non mi porta gravida at eget metus id elit mi
                                egetine usce dapibus elit nondapibus</p>
        ...
        <section id="processes" class="g-theme-bg-blue-dark-v1 g-py-80">
            <div class="container text-center g-width-780 g-color-gray-light-v2 g-mb-60">
                <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                    <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-2 g-color-primary g-mb-20">Work
                        process</h4>
                    <h2
                        class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-color-white g-mb-minus-10">
                        Step by step</h2>
                ...
                <p class="g-color-gray-light-v2 mb-0">Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in.
                    Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper, justo a
                    iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel odio.</p>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 g-px-30 g-mb-40">
                        ...
                        <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                            ...
                            <h3 class="h5 text-uppercase g-font-size-16 g-color-gray-light-v2 g-mb-10">Step 1. Analisys
                            </h3>
                            <p class="g-color-gray-light-v2 mb-0">Sed feugiat porttitor nunc, non dignissim ipsum
                    ...
                    <div class="col-lg-6 g-px-30 g-mb-40">
                        ...
                        <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                            ...
                            <h3 class="h5 text-uppercase g-font-size-16 g-color-gray-light-v2 g-mb-10">Step 2. Creative
                                concept</h3>
                            <p class="g-color-gray-light-v2 mb-0">We strive to embrace and drive change in our industry
                ...
                <div class="row g-mb-50">
                    <div class="col-lg-6 g-px-30 g-mb-40">
                        ...
                        <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                            ...
                            <h3 class="h5 text-uppercase g-font-size-16 g-color-gray-light-v2 g-mb-10">Step 3.
                                Production</h3>
                            <p class="g-color-gray-light-v2 mb-0">We strive to embrace and drive change in our industry
                                which allows us to keep our clients relevant.</p>
                        </div>
                    ...
                    <div class="col-lg-6 g-px-30 g-mb-40">
                        ...
                        <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
                            ...
                            <h3 class="h5 text-uppercase g-font-size-16 g-color-gray-light-v2 g-mb-10">Step 4. Happy
                                client</h3>
                            <p class="g-color-gray-light-v2 mb-0">We strive to embrace and drive change in our industry
                                which allows us to keep our clients relevant.</p>
                        </div>
                ...
                <div class="text-center">
                    <p class="g-color-gray-light-v2 g-mb-35">Sed eget aliquet nisl. Proin laoreet accumsan nisl non
                        vestibulum. Donec molestie, lorem nec sollicitudin elementum
                        <br> tristique senectus et netus et malesuada fames ac turpis egestas.
                    </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-xl-4 g-mb-40 g-mb-0--lg">
                        ...
                        <p class="g-mb-10">Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in
                            blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper, justo a
                            iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel odio.</p>
                        <p class="mb-0">In rutrum tellus vitae blandit lacinia. Phasellus eget sapien odio. Phasellus
                            eget sapien odio. Vivamus at risus quis leo tincidunt scelerisque non et erat.</p>
                    </div>

                    <div class="col-lg-7 col-xl-8">
                        <div class="js-carousel" data-infinite="true" data-speed="5000" data-rows="2"
                            data-slides-show="2"
                                ...
                                <div class="g-parent g-pos-rel g-overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-white mb-0">
                                            The moon ltd</h3>
                                        <p class="g-font-size-12 g-color-gray-light-v4 mb-0">Quisque rhoncus euismod
                                            pulvinar. Nulla non arcu at lectus. Vestibulum fringilla velit.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="js-slide g-pa-5">
                                <div class="g-parent g-pos-rel g-overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <p class="g-font-size-12 g-color-gray-light-v4 mb-0">Sed feugiat porttitor
                                            nunc, non dignissim ipsum vestibulum in nulla non arcu at lectus.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="js-slide g-pa-5">
                                <div class="g-parent g-pos-rel g-overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-white mb-0">
                                            Boston global</h3>
                                        <p class="g-font-size-12 g-color-gray-light-v4 mb-0">In rutrum tellus vitae
                                            blandit lacinia. Phasellus eget sapien odio. Phasellus eget sapien odio.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="js-slide g-pa-5">
                                <div class="g-parent g-pos-rel g-overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-uppercase g-font-weight-700 g-font-size-16 g-color-white mb-0">
                                            Marketing group</h3>
                                        <p class="g-font-size-12 g-color-gray-light-v4 mb-0">Nunc ullamcorper, justo a
                                            iaculis elementum, enim orci viverra eros, fringilla porttitor.</p>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="howWeWork" class="row no-gutters">
            ...
            <div class="col-xl-7 col-lg-8 g-theme-bg-blue-dark-v1 g-pt-100 g-pb-80 g-px-15 g-px-40--md">
                <header class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                    <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-2 g-color-primary g-mb-20">How we
                        work</h4>
                    <h2
                        class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-color-white g-mb-minus-10">
                        Do all the best</h2>
                ...
                <p class="g-color-white-opacity-0_7 g-mb-65">Sed feugiat porttitor nunc, non dignissim ipsum vestibulum
                    in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper, justo a
                    iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel odio.</p>
                ...
                <div class="row align-items-stretch">
                    <div class="col-sm-6 g-mb-30">
                        <!-- Article -->
                        <article
                            class="h-100 g-flex-middle g-brd-left g-brd-3 g-brd-primary g-brd-white--hover g-theme-bg-blue-dark-v2 g-transition-0_3 g-pa-20">
                            <div class="g-flex-middle-item">
                                <h4 class="h6 g-color-white g-font-weight-600 text-uppercase g-mb-10">Agency Search
                                </h4>
                                <p class="g-color-white-opacity-0_7 mb-0">Quisque rhoncus euismod pulvinar. Nulla non
                                    arcu at lectus. Vestibulum ipsum vestibulum velit.</p>
                            </div>
                        </article>
                        <!-- End Article -->
                    </div>
                    ...
                    <div class="col-sm-6 g-mb-30">
                        ...
                        <article
                            class="h-100 g-flex-middle g-brd-left g-brd-3 g-brd-primary g-brd-white--hover g-theme-bg-blue-dark-v2 g-transition-0_3 g-pa-20">
                            <div class="g-flex-middle-item">
                                <h4 class="h6 g-color-white g-font-weight-600 text-uppercase g-mb-10">Management &amp;
                                    Marketing</h4>
                                <p class="g-color-white-opacity-0_7 mb-0">Quisque rhoncus euismod pulvinar. Nulla non
                                    arcu at lectus. Vestibulum ipsum vestibulum velit.</p>
                            </div>
                ...
                <div class="row align-items-stretch">
                    <div class="col-sm-6 g-mb-30">
                        ...
                        <article
                            class="h-100 g-flex-middle g-brd-left g-brd-3 g-brd-primary g-brd-white--hover g-theme-bg-blue-dark-v2 g-transition-0_3 g-pa-20">
                            <div class="g-flex-middle-item">
                                <h4 class="h6 g-color-white g-font-weight-600 text-uppercase g-mb-10">Coaching &amp;
                                    Planning</h4>
                                <p class="g-color-white-opacity-0_7 mb-0">Quisque rhoncus euismod pulvinar. Nulla non
                                    arcu at lectus. Vestibulum ipsum vestibulum velit.</p>
                            </div>
                    ...
                    <div class="col-sm-6 g-mb-30">
                        ...
                        <article
                            class="h-100 g-flex-middle g-brd-left g-brd-3 g-brd-primary g-brd-white--hover g-theme-bg-blue-dark-v2 g-transition-0_3 g-pa-20">
                            <div class="g-flex-middle-item">
                                <h4 class="h6 g-color-white g-font-weight-600 text-uppercase g-mb-10">Consulation
                                    Services</h4>
                                <p class="g-color-white-opacity-0_7 mb-0">Quisque rhoncus euismod pulvinar. Nulla non
                                    arcu at lectus. Vestibulum ipsum vestibulum velit.</p>
                            </div>
            ...
            <div class="container">
                <div class="container text-center g-width-780 g-mb-60">
                    <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-45">
                        ...
                        <h2
                            class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">
                            Best offers for you</h2>
                    </div>

                    <p class="mb-0">Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in blandit
                        dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper, justo a iaculis
                        elementum, enim orci viverra eros, fringilla porttitor lorem eros vel odio.</p>
                </div>
                ...
                <div class="row no-gutters">
                    <div class="col-md-4 g-mb-30 g-mb-0--md">
                        ...
                        <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                            <div class="g-bg-gray-light-v5 g-pa-30">
                                <!-- Article Title -->
                                <h4 class="text-uppercase h5 g-color-gray-dark-v3 g-font-weight-500 g-mb-10">Starter
                                </h4>
                                <!-- End Article Title -->
                                ...
                                <ul class="list-unstyled g-mb-25">
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12">Vivamus a fringilla lorem, vel
                                        faucibus ante. Nunc ullamcorper justo..</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>10%</b> In hac habitasse
                                        platea</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>10gb</b> Praesent egestas
                                        ac arcu</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>25</b> emails Sed eget
                                        aliquet nisl</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>No</b> Proin laoreet
                                        accumsan nisl non</li>
                                </ul>
                                <a class="btn btn-md text-uppercase u-btn-primary rounded-0 g-px-15"
                                    href="#!">Order Now</a>
                            </div>
                        </article>
                        <!-- End Article -->
                    ...
                    <div class="col-md-4 g-mb-30 g-mb-0--md">
                        <!-- Article -->
                        <article
                            class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10 g-mt-minus-20">
                            <div class="g-bg-gray-light-v5 g-py-50 g-px-30">
                                <!-- Article Title -->
                                <h4 class="text-uppercase h5 g-color-gray-dark-v3 g-font-weight-500 g-mb-10">Advanced
                                </h4>
                                <!-- End Article Title -->
                                <em class="g-font-style-normal">ed feugiat porttitor nunc, non</em>
                                ...
                                <ul class="list-unstyled g-mb-25">
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12">Sed feugiat porttitor nunc,
                                        non dignissim ipsum vestibulum in...</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>20%</b> In hac habitasse
                                        platea</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>20gb</b> Praesent egestas
                                        ac arcu</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>50</b> emails Sed eget
                                        aliquet nisl</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>YES</b> Proin laoreet
                                        accumsan nisl non</li>
                                </ul>
                                <a class="btn btn-md text-uppercase u-btn-primary rounded-0 g-px-15"
                                    href="#!">Order Now</a>
                    ...
                    <div class="col-md-4">
                        ...
                        <article class="text-center g-brd-around g-color-gray g-brd-gray-light-v5 g-pa-10">
                            <div class="g-bg-gray-light-v5 g-pa-30">
                                <!-- Article Title -->
                                <h4 class="text-uppercase h5 g-color-gray-dark-v3 g-font-weight-500 g-mb-10">
                                    Professional</h4>
                                <!-- End Article Title -->
                                <em class="g-font-style-normal">ed feugiat porttitor nunc, non</em>
                                ...
                                <ul class="list-unstyled g-mb-25">
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12">Vivamus a fringilla lorem, vel
                                        faucibus ante. Nunc ullamcorper justo..</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>30%</b> In hac habitasse
                                        platea</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>40gb</b> Praesent egestas
                                        ac arcu</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>100</b> emails Sed eget
                                        aliquet nisl</li>
                                    <li class="g-brd-bottom g-brd-gray-light-v3 g-py-12"><b>YES</b> Proin laoreet
                                        accumsan nisl non</li>
                                </ul>
        ...
        <section id="news" class="g-theme-bg-blue-dark-v1 g-pt-80">
            <div class="container text-center g-width-780 g-color-gray-light-v2 g-mb-60">
                <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                    <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-2 g-color-primary g-mb-20">From our
                        blog</h4>
                    <h2
                        class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-color-gray-light-v2 g-mb-minus-10">
                        Latest news</h2>
                </div>
            ...
            <div class="container-fluid px-0">
                <div class="js-carousel g-line-height-0" data-infinite="true" data-autoplay="true" data-speed="5000"
                    data-rows="2" data-slides-show="4"
                    data-responsive='[{
                 "breakpoint": 1200,
                 "settings": {
                   "slidesToShow": 4
                        ...
                        <div class="g-parent g-pos-rel g-overflow-hidden">
                            ...
                            <div
                                ...
                                <div class="g-flex-middle-item--bottom">
                                    <header class="g-mb-5">
                                        <h4 class="g-font-weight-700 g-font-size-12 g-color-gray-light-v4 g-mb-5">May
                                            20, 2017</h4>
        ...
        <section class="text-center g-py-80">
            <div class="container">
                ...
                <div class="js-carousel g-mb-60" data-autoplay="true" data-infinite="true" data-slides-show="6"
                    data-responsive='[{
                 "breakpoint": 1200,
                 "settings": {
                   "slidesToShow": 5
                ...
                <p class="g-mb-35">Sed eget aliquet nisl. Proin laoreet accumsan nisl non vestibulum. Donec molestie,
                    lorem nec sollicitudin elementum
                    <br> tristique senectus et netus et malesuada fames ac turpis egestas.
                </p>
        ...
        <footer>
            <div id="contact" class="text-center g-color-gray-light-v2 g-theme-bg-blue-dark-v1 g-py-80">
                <div class="container g-width-780 g-mb-60">
                    ...
                    <p class="g-color-gray-light-v2 mb-0">Sed feugiat porttitor nunc, non dignissim ipsum vestibulum
                        in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper,
                        justo a iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel odio.</p>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-md-3 g-px-15 g-py-30 g-py-0--md">
                            ...
                            <h3
                                class="text-uppercase g-font-size-default g-color-white-opacity-0_5 g-letter-spacing-1 g-mb-5">
                                Address</h3>
                            <strong class="g-font-size-default g-color-white">61 Oxford str., London, 3DG</strong>
                        </div>

                        <div
                            class="col-sm-6 col-md-3 g-brd-top g-brd-top-none g-brd-left--md g-brd-primary g-px-15 g-py-30 g-py-0--md">
                        ...
                        <div
                            ...
                            <h3
                                class="text-uppercase g-font-size-default g-color-white-opacity-0_5 g-letter-spacing-1 g-mb-5">
                                Email</h3>
                            <a class="g-font-size-default g-color-white"
                                href="mailto:info@unify.com"><strong>mail@htmlstream.com</strong></a>
                        </div>
            ...
            <ul class="row no-gutters list-inline g-mb-0">
                <li class="col list-inline-item g-mr-0">
                    <a class="d-block g-theme-bg-blue-dark-v3 g-color-gray-dark-v5 g-bg-primary--hover g-color-white--hover g-font-size-default text-center g-pa-15"
                        href="#!">
                        <i class="fa fa-twitter"></i>
                    </a>
                </li>
                <li class="col list-inline-item g-mr-0">
                    <a class="d-block g-theme-bg-blue-dark-v2 g-color-gray-dark-v5 g-bg-primary--hover g-color-white--hover g-font-size-default text-center g-pa-15"
                        href="#!">
            ...
            <div class="g-pos-rel g-height-500">
                <div id="gMap10" class="js-g-map g-pos-abs w-100 h-100" data-type="custom" data-lat="40.674"
                    data-lng="-73.946" data-zoom="12" data-title="Business"
                    data-styles='[
            ...
            <div class="text-center g-color-gray-dark-v3 g-pa-30">
                <div class="g-width-600 mx-auto">
                    <h4 class="g-font-size-17 g-font-weight-400 g-letter-spacing-1 g-mb-15">subscribe
                        <span class="text-uppercase">on our offers</span>
                    </h4>

                    <form>
                        <div class="form-group g-pos-rel g-mb-15">
                            <input
                                class="form-control g-placeholder-gray-light-v1 g-font-size-default g-color-gray-dark-v3 g-placeholder-inherit g-brd-gray-light-v4 g-brd-gray-light-v4--focus rounded-0 g-pa-12 g-pr-40"
                                type="text" placeholder="Enter Your Email">

                            <div
                                class="g-pos-abs g-top-0 g-right-0 g-flex-centered g-width-40 h-100 g-color-gray-light-v1">
                    ...
                    <p class="g-font-size-12 mb-0">© 2017 All right reserved. Unify developed by
                        <a href="#!" class="g-color-primary">Htmlstream</a>
                    </p>
                </div>
            </div>
        </footer>
