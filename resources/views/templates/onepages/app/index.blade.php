    ...
    <main>
                    ...
                    <div class="container g-pos-rel">
                        ...
                        <div id="navBar" class="collapse navbar-collapse">
                            ...
                            <div class="navbar-collapse align-items-center flex-sm-row">
                                <ul id="js-scroll-nav"
                                    class="navbar-nav g-flex-right--xs text-uppercase w-100 g-font-weight-700 g-font-size-11 g-pt-20 g-pt-0--lg">
                            ...
                            <a class="btn btn-lg text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-rounded-10 g-px-13 g-py-10 mb-0 g-ml-25--lg"
                                href="#!">Try trail version</a>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-5 ml-lg-auto d-flex text-center text-md-left g-font-size-16">
                        <div class="align-self-center">
                            <h2 class="text-uppercase g-line-height-1_3 g-font-size-36 g-mb-20 g-mb-30--lg">We created
                                <br><strong>revolution in app</strong>
                            </h2>
                            <p class="g-mb-20 g-mb-35--lg">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                                Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis
                                dis parturient montes, nascetur ridiculus mus.</p>
                            <a href="#!"
                                class="btn btn-md u-btn-primary g-font-weight-700 text-uppercase text-left g-rounded-10 g-py-10 g-mb-15 g-mx-10 g-mx-0--md g-mr-30--md">
                                <span class="float-right g-font-size-13">
                                    Download App
                                    <span class="d-block g-font-size-10 g-font-weight-400 g-opacity-0_6">From App
                                        Store</span>
                                </span>
                                <i class="fa fa-apple float-left g-font-size-26 g-mr-15"></i>
                            </a>
                            <a href="#!"
                                class="btn btn-md u-btn-darkpurple g-font-weight-700 text-uppercase text-left g-rounded-10 g-py-10 g-mb-15 g-mx-10 g-mx-0--md">
                                <span class="float-right g-font-size-13">
                                    Download App
                                    <span class="d-block g-font-size-10 g-font-weight-400 g-opacity-0_6">From Play
                                        Market</span>
                                </span>
        ...
        <section id="about" class="g-pt-90">
            <div class="container text-center g-max-width-750 g-font-size-16 g-mb-30">
                <div class="text-uppercase g-line-height-1_3 g-mb-20">
                    <h4 class="g-font-weight-700 g-font-size-11 g-mb-15"><span class="g-color-primary">01.</span>
                        About app</h4>
                ...
                <div class="row no-gutters">
                    <div class="col-sm-6 col-lg-3 g-bg-primary">
                        ...
                        <article class="u-block-hover">
                            ...
                            <div class="g-color-white g-py-40 g-px-30">
                                <h3 class="text-uppercase g-font-weight-700 g-font-size-22 g-color-white g-mb-25">
                                    Innovative</h3>
                                <p class="g-color-white-opacity-0_8 mb-0">Aliquam lorem ante, dapibus in, viverra quis,
                    ...
                    <div class="col-sm-6 col-lg-3 g-bg-darkpurple">
                        ...
                        <article class="u-block-hover">
                            ...
                            <div class="g-color-white g-py-40 g-px-30">
                                <h3 class="text-uppercase g-font-weight-700 g-font-size-22 g-color-white g-mb-25">Easy
                                </h3>
                                <p class="g-color-white-opacity-0_8 mb-0">Aliquam lorem ante, dapibus in, viverra quis,
                                    feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum.
                                </p>
        ...
        <section id="benefits" class="g-py-90">
            <div class="container text-center g-max-width-750 g-font-size-16 g-mb-65">
                <div class="text-uppercase g-line-height-1_3 g-mb-20">
                    <h4 class="g-font-weight-700 g-font-size-11 g-mb-15"><span class="g-color-primary">02.</span> Our
                        benefits
                    </h4>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 g-mb-30">
                        <div class="text-center g-bg-gray-light-v5 g-py-40 g-px-30" data-animation="fadeIn"
                            data-animation-duration="1500">
                            <span class="u-icon-v1 g-font-size-36 g-color-primary g-mb-30"><i
                                    class="fa fa-search"></i></span>
                            <h4 class="text-uppercase g-font-weight-700 g-font-size-11 g-color-black g-mb-20">Look for
                                your favorite<br> music easily
                            </h4>
                            <p class="mb-0">Fusce mauris eros, ullamcorper in gravida a, feugiat in mauris. Curabitur
                                ac scelerisque nisi. Vivamus accumsan in purus et egestas.</p>
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 g-mb-30">
                        <div class="text-center g-bg-gray-light-v5 g-py-40 g-px-30" data-animation="fadeIn"
                            data-animation-delay="300" data-animation-duration="1500">
                            <span class="u-icon-v1 g-font-size-36 g-color-primary g-mb-30"><i
                                    class="fa fa-sliders"></i></span>
                            <h4 class="text-uppercase g-font-weight-700 g-font-size-11 g-color-black g-mb-20">Many
                                different filters for<br> easy music search
                            </h4>
                            <p class="mb-0">Fusce mauris eros, ullamcorper in gravida a, feugiat in mauris. Curabitur
                                ac scelerisque nisi. Vivamus accumsan in purus et egestas.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-30">
                        <div class="text-center g-bg-gray-light-v5 g-py-40 g-px-30" data-animation="fadeIn"
                            ...
                            <h4 class="text-uppercase g-font-weight-700 g-font-size-11 g-color-black g-mb-20">All your
                                music on our<br> cloud hosting
                            </h4>
                            <p class="mb-0">Fusce mauris eros, ullamcorper in gravida a, feugiat in mauris. Curabitur
                                ac scelerisque nisi. Vivamus accumsan in purus et egestas.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-30 g-mb-0--lg">
                        <div class="text-center g-bg-gray-light-v5 g-py-40 g-px-30" data-animation="fadeIn"
                            data-animation-delay="600" data-animation-duration="1500">
                            <span class="u-icon-v1 g-font-size-36 g-color-primary g-mb-30"><i
                                    class="fa fa-mobile"></i></span>
                            <h4 class="text-uppercase g-font-weight-700 g-font-size-11 g-color-black g-mb-20">Offline
                                playlist on your<br> phone
                            </h4>
                            <p class="mb-0">Fusce mauris eros, ullamcorper in gravida a, feugiat in mauris. Curabitur
                                ac scelerisque nisi. Vivamus accumsan in purus et egestas.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
                        <div class="text-center g-bg-gray-light-v5 g-py-40 g-px-30" data-animation="fadeIn"
                            data-animation-delay="800" data-animation-duration="1500">
                            <span class="u-icon-v1 g-font-size-36 g-color-primary g-mb-30"><i
                                    class="fa fa-user"></i></span>
                            <h4 class="text-uppercase g-font-weight-700 g-font-size-11 g-color-black g-mb-20">Share
                                your mucis and<br> playlists with friends
                            </h4>
                            <p class="mb-0">Fusce mauris eros, ullamcorper in gravida a, feugiat in mauris. Curabitur
                                ac scelerisque nisi. Vivamus accumsan in purus et egestas.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="text-center g-bg-gray-light-v5 g-py-40 g-px-30" data-animation="fadeIn"
                            data-animation-delay="1000" data-animation-duration="1500">
                            <span class="u-icon-v1 g-font-size-36 g-color-primary g-mb-30"><i
                                    class="fa fa-lock"></i></span>
                            <h4 class="text-uppercase g-font-weight-700 g-font-size-11 g-color-black g-mb-20">high
                                level of protection of<br> your personal data
                            </h4>
                            <p class="mb-0">Fusce mauris eros, ullamcorper in gravida a, feugiat in mauris. Curabitur
                                ac scelerisque nisi. Vivamus accumsan in purus et egestas.</p>
                        </div>
                ...
                <div class="container align-self-center g-max-width-750 g-font-size-16">
                    <div class="text-uppercase g-line-height-1_3 g-mb-20">
                        <h4 class="g-font-weight-700 g-font-size-11 g-color-white g-mb-15">
                            <span class="g-color-primary">03.</span> Presentation
                        </h4>
                        <h2 class="g-line-height-1_3 g-font-size-36 g-color-white mb-0">Watch <strong>our
                                presentation</strong></h2>
                    </div>

                    <p class="g-color-gray-dark-v5 g-mb-65">Vestibulum ante ipsum primis in faucibus orci luctus et
                        ultrices posuere cubilia Curae; Maecenas ac nulla vehicula risus pulvinar feugiat ullamcorper
                        sit amet mi. Nam placerat efficitur dui, quis mattis magna.</p>

                    <a class="js-fancybox-media btn u-btn-primary g-pos-rel g-width-70 g-height-70 g-rounded-50"
                        href="javascript:;" data-src="//vimeo.com/58363288" data-animate-in="fadeIn"
        ...
        <section id="whatsNew" class="g-py-90">
            <div class="container text-center g-max-width-750 g-mb-45">
                <div class="text-uppercase g-line-height-1_3 g-mb-20">
                    <h4 class="g-font-weight-700 g-font-size-11 g-mb-15"><span class="g-color-primary">04.</span>
                        What's new
                    </h4>
            ...
            <div class="container">
                <!-- Carousel -->
                <div class="js-carousel g-pb-20" data-infinite="true" data-slides-show="4" data-slides-scroll="4"
                        ...
                        <div class="align-self-center">
                            <div class="text-uppercase g-mb-20">
                                <h4 class="g-font-weight-700 g-font-size-11 g-mb-15">
                                    <span class="g-color-primary">05.</span> Awesome features
                                </h4>
                                <h2 class="g-line-height-1_3 g-font-size-36 mb-0"><strong>Just try</strong> and
                                    <strong>use always</strong>
                                </h2>
                            </div>

                            <p class="g-font-size-16 g-mb-65">Integer ut sollicitudin justo. Class aptent taciti
                            ...
                            <div class="media d-block d-md-flex text-center text-md-left g-mb-40">
                                <div class="d-md-flex align-self-center g-mb-30 g-mb-0--md g-mr-30--md">
                                    <span
                                        class="u-icon-v2 u-icon-size--lg g-font-size-26 g-color-primary g-rounded-50x"><i
                                            class="fa fa-flask"></i></span>
                                </div>

                                <div class="media-body align-self-center">
                                    <h4 class="h6 text-uppercase g-font-weight-700 g-color-black g-mb-15">Awesome
                                        features</h4>
                                    <p class="mb-0">Vestibulum vulputate lobortis tortor non tempus. Proin in ex
                                        blandit velit imperdiet tincidunt sit amet at quam. Nam ac ultrices urna, sit
                            ...
                            <div class="media d-block d-md-flex text-center text-md-left">
                                ...
                                <div class="media-body align-self-center">
                                    <h4 class="h6 text-uppercase g-font-weight-700 g-color-black g-mb-15">Beautiful and
                                        modern design</h4>
                                    <p class="mb-0">Araesent blandit hendrerit justo sed egestas. Proin tincidunt
                                        purus in tortor cursus fermentum. Proin laoreet erat vitae dui blandit, vitae
                                        faucibus lacus auctor. Proin ornare sit amet arcu at aliquam.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-7 d-flex g-mb-30 g-mb-0--lg">
                        <div class="align-self-center">
                            <div class="text-uppercase g-line-height-1_3 g-mb-20">
                                <h4 class="g-font-weight-700 g-font-size-11 g-mb-15">
                                    <span class="g-color-primary">06.</span> Why our app
                                </h4>
                                <h2 class="g-line-height-1_3 g-font-size-36 mb-0">Only <strong>just try</strong></h2>
                            </div>

                            <p class="g-font-size-16 g-mb-65">Praesent blandit hendrerit justo sed egestas. Proin
                                tincidunt purus in tortor cursus fermentum. Proin laoreet erat vitae dui blandit, vitae
                                faucibus lacus auctor. Proin ornare sit amet arcu at aliquam.</p>

                            <div id="whyOurAppAccordion" class="u-accordion" role="tablist"
                                ...
                                <div class="card rounded-0 g-bg-primary g-color-white g-brd-none">
                                    <div id="awesomeFeatures" class="u-accordion__header g-pa-20" role="tab">
                                        <h5 class="mb-0 text-uppercase g-font-weight-700">
                                            <a class="g-color-white g-text-underline--none--hover"
                                                href="#awesomeFeaturesBody" data-toggle="collapse"
                                                data-parent="#whyOurAppAccordion" aria-expanded="true"
                                    ...
                                    <div id="awesomeFeaturesBody" class="collapse show" role="tabpanel"
                                        aria-labelledby="awesomeFeatures">
                                        <div class="u-accordion__body g-pa-0-20-20">Anim pariatur cliche reprehenderit,
                                ...
                                <div class="card rounded-0 g-bg-primary-dark-v2 g-color-white g-brd-none">
                                    <div id="modernAndCreativeDesign" class="u-accordion__header g-pa-20"
                                        role="tab">
                                        <h5 class="mb-0 text-uppercase g-font-weight-700">
                                            <a class="collapsed g-color-white g-text-underline--none--hover"
                                                aria-expanded="false" aria-controls="modernAndCreativeDesignBody"
                                                href="#modernAndCreativeDesignBody" data-toggle="collapse"
                                    ...
                                    <div id="modernAndCreativeDesignBody" class="collapse" role="tabpanel"
                                        aria-labelledby="modernAndCreativeDesign">
                                        <div class="u-accordion__body g-pa-0-20-20">Anim pariatur cliche reprehenderit,
                                            enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon
                                            officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
                                            nesciunt laborum eiusmod.</div>
                                ...
                                <div class="card rounded-0 g-bg-primary g-color-white g-brd-none">
                                    <div id="regularUpdates" class="u-accordion__header g-pa-20" role="tab">
                                        <h5 class="mb-0 text-uppercase g-font-weight-700">
                                            <a class="collapsed g-color-white g-text-underline--none--hover"
                                                href="#regularUpdatesBody" aria-expanded="false"
                                                aria-controls="regularUpdatesBody" data-toggle="collapse"
                                                data-parent="#whyOurAppAccordion">
                                                <span class="u-accordion__control-icon g-mr-10">
                                                    <i class="fa fa-plus"></i>
                                                    <i class="fa fa-minus"></i>
                                    ...
                                    <div id="regularUpdatesBody" class="collapse" role="tabpanel"
                                        aria-labelledby="regularUpdates">
                                        <div class="u-accordion__body g-pa-0-20-20">Anim pariatur cliche reprehenderit,
                                            enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon
                                            officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
                                            nesciunt laborum eiusmod.</div>
                                ...
                                <!-- Card -->
                                <div class="card rounded-0 g-bg-primary-dark-v2 g-color-white g-brd-none">
                                    <div id="professionalSupport24x7" class="u-accordion__header g-pa-20"
                                        role="tab">
                                        <h5 class="mb-0 text-uppercase g-font-weight-700">
                                            <a class="collapsed g-color-white g-text-underline--none--hover"
                                                href="#professionalSupport24x7Body" aria-expanded="false"
                                                aria-controls="professionalSupport24x7Body" data-toggle="collapse"
                                                data-parent="#whyOurAppAccordion">
                                                <span class="u-accordion__control-icon g-mr-10">
                                                    <i class="fa fa-plus"></i>
                                                    <i class="fa fa-minus"></i>
                                    ...
                                    <div id="professionalSupport24x7Body" class="collapse" role="tabpanel"
                                        aria-labelledby="professionalSupport24x7">
                                        <div class="u-accordion__body g-pa-0-20-20">Anim pariatur cliche reprehenderit,
                                            enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon
                                            officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
                                            nesciunt laborum eiusmod.</div>
        ...
        <section id="howItWorks" class="g-bg-primary g-py-90">
            <div class="container text-center g-max-width-750 g-font-size-16 g-mb-65">
                <div class="text-uppercase g-line-height-1_3 g-mb-20">
                    ...
                    <h2 class="g-line-height-1_3 g-font-size-36 g-color-white mb-0">One time used — <strong>use
                            forever</strong></h2>
                </div>

                <p class="g-color-white mb-0">Integer ut sollicitudin justo. Class aptent taciti sociosqu ad litora
                ...
                <div class="js-carousel" data-infinite="true"
                    ...
                    <div class="js-slide">
                        <div class="container text-center g-max-width-750">
                            ...
                            <p class="g-color-white-opacity-0_8 g-mb-30">Sed feugiat porttitor nunc, non dignissim
                                ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem.</p>
                            <a class="btn btn-lg text-uppercase u-btn-white g-font-weight-700 g-font-size-12 g-rounded-10 g-px-25 g-py-12 mb-0"
                                href="#!">Learn more</a>
                        </div>
                    </div>
                    ...
                    <div class="js-slide">
                        <div class="container text-center g-max-width-750">
                            ...
                            <p class="g-color-white-opacity-0_8 g-mb-30">Sed feugiat porttitor nunc, non dignissim
                                ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus
                                ante. Nunc ullamcorper, justo a iaculis elementum, enim orci viverra eros, fringilla
                    ...
                    <div class="js-slide">
                        <div class="container text-center g-max-width-750">
                            ...
                            <h4 class="h6 text-uppercase g-font-weight-700 g-color-white g-mb-15">Usability and
                                progresion</h4>
                            <p class="g-color-white-opacity-0_8 g-mb-30">Sed feugiat porttitor nunc, non dignissim
                                ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus
                                ante. Nunc ullamcorper.</p>
                            <a class="btn btn-lg text-uppercase u-btn-white g-font-weight-700 g-font-size-12 g-rounded-10 g-px-25 g-py-12 mb-0"
                                href="#!">Learn more</a>
                        </div>
                    </div>
        ...
        <section id="appScreens" class="g-py-90">
            <div class="container text-center g-max-width-750 g-mb-65">
                <div class="text-uppercase g-line-height-1_3 g-mb-20">
                    <h4 class="g-font-weight-700 g-font-size-11 g-mb-15"><span class="g-color-primary">08.</span> App
                        screens
                    </h4>
            ...
            <div class="container">
                ...
                <ul id="appScreensCubePortfolioFilter"
                    class="nav justify-content-center d-block d-md-flex u-nav-v5-1 text-uppercase g-line-height-1_4 g-font-weight-700 g-font-size-11 g-nowrap g-brd-bottom--md g-brd-gray-light-v4 g-mb-20 g-mb-70--md">
                    <li class="cbp-filter-item nav-item cbp-filter-item-active" data-filter="*">
                        <span class="nav-link g-px-0--md g-pb-15--md g-mr-30--md">Everything</span>
                    </li>
                    <li class="cbp-filter-item nav-item" data-filter=".login">
                        <span class="nav-link g-px-0--md g-pb-15--md g-mr-30--md">Login</span>
                    </li>
                    <li class="cbp-filter-item nav-item" data-filter=".sign-up">
                        <span class="nav-link g-px-0--md g-pb-15--md g-mr-30--md">Sign up</span>
                    </li>
                    <li class="cbp-filter-item nav-item" data-filter=".home">
                        <span class="nav-link g-px-0--md g-pb-15--md g-mr-30--md">Home</span>
                    </li>
                    <li class="cbp-filter-item nav-item" data-filter=".calender">
                        <span class="nav-link g-px-0--md g-pb-15--md g-mr-30--md">Calendar</span>
                    </li>
                    <li class="cbp-filter-item nav-item" data-filter=".list">
                        <span class="nav-link g-px-0--md g-pb-15--md g-mr-30--md">List</span>
                    </li>
                </ul>

                <div id="appScreensCubePortfolio" class="cbp" data-controls="#appScreensCubePortfolioFilter"
                    data-layout="grid" data-animation="slideLeft" data-caption-animation="fadeIn" data-x-gap="30"
                    data-y-gap="30"
                    data-media-queries='[
                 {"width": 800, "cols": 4},
                 {"width": 500, "cols": 2},
        ...
        <section id="subscribe" class="g-theme-bg-gray-light-v1 g-pt-90">
            <div class="container text-center g-max-width-750 g-font-size-16 g-mb-65">
                <div class="text-uppercase g-line-height-1_3 g-mb-20">
                    <h4 class="g-font-weight-700 g-font-size-11 g-mb-15"><span class="g-color-primary">09.</span>
                        Subscribe</h4>
                    <h2 class="g-font-size-36 mb-0">Only <strong>actual information</strong></h2>
                </div>

                <p class="g-mb-65">Integer ut sollicitudin justo. Class aptent taciti sociosqu ad litora torquent per
                ...
                <form class="g-px-70--md g-mb-70">
                    <div class="input-group input-group-md g-brd-white g-brd-primary--focus g-rounded-10">
                        <input class="form-control g-brd-none g-rounded-10 g-py-14 g-px-20" type="email"
                            placeholder="Enter your email">

                        <div class="input-group-btn g-ml-minus-10">
                            <button
                                class="btn h-100 u-btn-primary text-uppercase g-font-weight-700 g-font-size-12 g-rounded-10 g-px-25"
        ...
        <section id="FAQ" class="g-py-90">
            <div class="container">
                <div class="g-px-50--lg">
                    <div class="text-uppercase g-line-height-1_3 g-mb-20">
                        <h4 class="g-font-weight-700 g-font-size-11 g-mb-15"><span class="g-color-primary">10.</span>
                            FAQ</h4>
                        <h2 class="g-font-size-36 mb-0">Have some <strong>problems?</strong></h2>
                    </div>

                    <p class="g-font-size-16 g-mb-65">Integer ut sollicitudin justo. Class aptent taciti sociosqu ad
                    ...
                    <ul class="nav u-nav-v5-1 text-uppercase g-line-height-1_4 g-font-weight-700 g-font-size-11 g-brd-bottom--md g-brd-gray-light-v4"
                        role="tablist" data-target="FAQTabs" data-tabs-mobile-type="slide-up-down"
                        data-btn-classes="btn btn-md u-btn-primary btn-block rounded-0 u-btn-outline-lightgray">
                        <li class="nav-item">
                            <a class="nav-link g-px-0--md g-pb-15--md g-mr-30--md active" data-toggle="tab"
                                href="#everything" role="tab">Everything</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link g-px-0--md g-pb-15--md g-mr-30--md" data-toggle="tab" href="#security"
                                role="tab">Security</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-px-0--md g-pb-15--md g-mr-30--md" data-toggle="tab"
                                href="#privacyPolicy" role="tab">Privacy policy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-px-0--md g-pb-15--md g-mr-30--md" data-toggle="tab" href="#support"
                                role="tab">Support</a>
                        </li>
                    </ul>
                    <!-- End Nav tabs -->
                    ...
                    <div id="FAQTabs" class="tab-content g-pt-20">
                        <div class="tab-pane fade show active" id="everything" role="tabpanel">
                            <div class="g-brd-bottom g-theme-brd-gray-light-v1 g-py-40">
                                <h4 class="h6 text-uppercase g-font-weight-700 g-mb-10">Integer ut sollicitudin justo
                                </h4>
                                <p class="g-mb-30">Vivamus imperdiet condimentum diam, eget placerat felis consectetur
                                    id. Donec eget orci metus, ac adipiscing nunc. Pellentesque fermentum ivamus
                                    imperdiet condimentum diam, eget placerat felis consectetur id. Donec eget orci
                                    metus, ac adipiscing nunc.</p>
                                <a class="text-uppercase g-font-size-11" href="#!"><strong>Read more</strong></a>
                            </div>

                            <div class="g-brd-bottom g-theme-brd-gray-light-v1 g-py-40">
                                <h4 class="h6 text-uppercase g-font-weight-700 g-mb-10">Vestibulum ante ipsum primis in
                                    faucibus orci luctus et ultrices</h4>
                                <p class="g-mb-30">Vivamus imperdiet condimentum diam, eget placerat felis consectetur
                                    id. Donec eget orci metus, ac adipiscing nunc. Pellentesque fermentum ivamus
                                    imperdiet condimentum diam, eget placerat felis consectetur id. Donec eget orci
                                    metus, ac adipiscing nunc.</p>
                            ...
                            <div class="g-brd-bottom g-theme-brd-gray-light-v1 g-py-40">
                                <h4 class="h6 text-uppercase g-font-weight-700 g-mb-10">Maecenas ac nulla vehicula
                                    risus pulvinar feugiat ullamcorper sit amet mi</h4>
                                <p class="g-mb-30">Vivamus imperdiet condimentum diam, eget placerat felis consectetur
                                    id. Donec eget orci metus, ac adipiscing nunc. Pellentesque fermentum ivamus
                                    imperdiet condimentum diam, eget placerat felis consectetur id. Donec eget orci
                                    metus, ac adipiscing nunc.</p>
                            ...
                            <div class="g-brd-bottom g-theme-brd-gray-light-v1 g-py-40">
                                <h4 class="h6 text-uppercase g-font-weight-700 g-mb-10">Praesent blandit hendrerit
                                    justo sed egestas</h4>
                                <p class="g-mb-30">Vivamus imperdiet condimentum diam, eget placerat felis consectetur
                                    id. Donec eget orci metus, ac adipiscing nunc. Pellentesque fermentum ivamus
                                    imperdiet condimentum diam, eget placerat felis consectetur id. Donec eget orci
                                    metus, ac adipiscing nunc.</p>
                ...
                <div class="row">
                    <div class="col-lg-5 g-mb-20 g-mb-0--lg">
                        <div class="text-uppercase g-mb-20">
                            ...
                            <h2 class="g-font-size-36 g-color-white mb-0">Answers to <strong>your questions</strong>
                            </h2>
                        </div>

                        <p class="g-font-size-16 g-color-white mb-0">Integer ut sollicitudin justo. Class aptent taciti
                                ...
                                <div class="col-md-6">
                                    <div class="form-group g-mb-30">
                                        <input id="inputGroup1_1"
                                            class="form-control g-color-white g-placeholder-inherit g-bg-transparent g-bg-transparent--focus g-brd-white g-rounded-10 g-px-20 g-py-10"
        ...
        <footer>
            <ul class="list-inline d-table w-100 mb-0">
                <li class="list-inline-item d-table-cell g-width-1x">
                    <a class="btn btn-lg u-btn-indigo btn-block rounded-0 g-py-20" href="#!"><i
                            class="fa fa-facebook"></i></a>
                </li>
                <li class="list-inline-item d-table-cell g-width-1x">
                    <a class="btn btn-lg u-btn-pink btn-block rounded-0 g-py-20" href="#!"><i
                            class="fa fa-pinterest"></i></a>
                </li>
                <li class="list-inline-item d-table-cell g-width-1x">
                    <a class="btn btn-lg u-btn-purple btn-block rounded-0 g-py-20" href="#!"><i
                            class="fa fa-dribbble"></i></a>
                </li>
                <li class="list-inline-item d-table-cell g-width-1x">
                    <a class="btn btn-lg u-btn-teal btn-block rounded-0 g-py-20" href="#!"><i
                            class="fa fa-instagram"></i></a>
                </li>
                <li class="list-inline-item d-table-cell g-width-1x">
                    <a class="btn btn-lg u-btn-blue btn-block rounded-0 g-py-20" href="#!"><i
