...
<head>
    ...
    <!-- Google Fonts -->
    <link rel="stylesheet"
        href="//fonts.googleapis.com/css?family=Open+Sans%3A300%2C400%2C600%2C700%2C800%7CLeckerli+One%7CPlayfair+Display%7CRoboto%7CRaleway%7CSpectral%7CRubik">
    ...
    <main>
        ...
        <section id="home"
            ...
            <div class="u-bg-overlay__inner g-absolute-centered--y w-100">
                <div class="container text-center g-max-width-750">
                    <h3
                        class="d-inline-block text-uppercase g-font-weight-700 g-font-size-22 g-color-white g-brd-bottom g-brd-3 g-brd-primary g-mb-10">
                        Hot summer</h3>
                    <h1 class="g-line-height-1_5 g-font-weight-700 g-font-size-50 g-color-white g-mb-15">Relaxing
                        Massage</h1>
            ...
            <div class="container-fluid px-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 d-flex align-items-center text-center g-pa-50">
                        <div class="w-100">
                            <div class="g-mb-25">
                                <h4 class="g-font-weight-700 g-font-size-20 g-theme-h-v1 g-color-primary g-mb-25">About
                                    Spa</h4>
                                <h2 class="text-uppercase g-font-weight-600 g-font-size-22 mb-0">Perfect place for your
                                    relaxation</h2>
                            </div>

                            <p class="g-mb-35">Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 g-mb-30 g-mb-0--lg">
                            ...
                            <article
                                ...
                                <!-- Article Content -->
                                <div
                                    class="u-block-hover__additional u-bg-overlay__inner g-pos-abs g-flex-middle g-brd-around g-brd-2 g-brd-white-opacity-0_3 g-pa-15 g-ma-20">
                                    <div class="text-uppercase g-flex-middle-item">
                                        <h3
                                            class="d-inline-block g-font-weight-700 g-font-size-18 g-color-white g-brd-bottom g-brd-2 g-brd-primary g-mb-20">
                                            Face massage</h3>
                                        <strong
                                            class="d-block text-uppercase g-line-height-1 g-font-weight-700 g-font-size-40 g-mb-30">40%
                                            Off</strong>
                                        <a class="btn btn-md text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-brd-none rounded-0 g-py-10 g-px-25"
                                            href="#!">Contact us</a>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 g-mb-30 g-mb-0--lg">
                            ...
                            <article
                                ...
                                <div
                                    class="u-block-hover__additional u-bg-overlay__inner g-pos-abs g-flex-middle g-brd-around g-brd-2 g-brd-white-opacity-0_3 g-pa-15 g-ma-20">
                                    <div class="text-uppercase g-flex-middle-item">
                                        <h3 class="g-font-weight-700 g-font-size-16 g-color-white g-mb-5">20% Discount
                                        </h3>
                                        <strong
                                            class="d-block text-uppercase g-line-height-1 g-font-weight-700 g-font-size-28 g-mb-10">Products
                                            of spa</strong>
                                        <h3 class="g-font-weight-700 g-font-size-16 g-color-white mb-0">When you buy
                                            over 100$</h3>
                                    </div>
                                </div>
                                <!-- End Article Content -->
                        ...
                        <div class="col-lg-4">
                            ...
                            <article class="text-center u-block-hover g-color-white g-bg-primary g-mb-30">
                                <div class="g-brd-around g-brd-2 g-brd-white-opacity-0_3 g-pa-30 g-ma-20">
                                    <div class="g-flex-middle-item">
                                        <h3
                                            class="text-uppercase g-font-weight-700 g-font-size-18 g-color-white g-mb-10">
                                            Relaxing massage</h3>
                                        <p class="g-font-size-12 g-color-white-opacity-0_6 mb-0">Morbi ex urna,
                                            porttitor vel consequat non</p>
                                    </div>
                                </div>
                            </article>
                            <!-- End Article -->
                            ...
                            <article
                                ...
                                <div
                                    ...
                                    <div class="g-flex-middle-item">
                                        <h3
                                            class="text-uppercase g-font-weight-700 g-font-size-18 g-color-white g-mb-5">
                                            1+1=1</h3>
                                        <p class="g-font-size-12 g-color-white-opacity-0_6 mb-0">Morbi ex urna,
                                            porttitor vel consequat non</p>
                                    </div>
                        ...
                        <article class="text-center g-bg-white">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <div
                                    ...
                                    <div
                                        class="g-pos-rel g-height-70 g-line-height-0_8 g-color-primary g-bg-white g-py-15">
                                        <span class="g-absolute-centered">30% <small
                                                class="g-font-size-12">save</small></span>
                                    </div>
                                </div>
                            </div>
                            <!-- End Article Image -->
                            ...
                            <div class="u-shadow-v9 g-pa-30">
                                <header class="g-mb-15">
                                    <div class="js-rating d-inline-block g-font-size-12 g-color-primary g-mr-10"
                                        data-rating="5"></div>
                                    <strong
                                        class="d-inline-block text-uppercase g-font-size-10 g-theme-color-gray-dark-v1">12
                                        Reviews</strong>
                                </header>

                                <!-- Article Info -->
                                <h3 class="h6 text-uppercase g-line-height-1_8 g-font-weight-700 g-mb-20">Wine fusce
                                    dolor libero, efficitur et lobortis at,
                                    <br> faucibus nec nunc
                                </h3>
                        ...
                        <article class="text-center g-bg-white">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <div
                                    ...
                                    <div
                                        class="g-pos-rel g-height-70 g-line-height-0_8 g-color-primary g-bg-white g-py-15">
                                        <span class="g-absolute-centered">20% <small
                                                class="g-font-size-12">save</small></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="u-shadow-v9 g-pa-30">
                                <header class="g-mb-15">
                                    <div class="js-rating d-inline-block g-font-size-12 g-color-primary g-mr-10"
                                        data-rating="5"></div>
                                    <strong
                                        class="d-inline-block text-uppercase g-font-size-10 g-theme-color-gray-dark-v1">20
                                        Reviews</strong>
                                </header>

                                <!-- Article Info -->
                                <h3 class="h6 text-uppercase g-line-height-1_8 g-font-weight-700 g-mb-20">Mauris
                                    sodales tellus vel felis dapibus, sit amet
                                    <br> porta nibh egestas.
                                </h3>
                        ...
                        <article class="text-center g-bg-white">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <div
                                    ...
                                    <div
                                        class="g-pos-rel g-height-60 g-line-height-0_8 g-color-primary g-bg-white g-py-15">
                                        <span class="g-absolute-centered">30% <small
                                                class="g-font-size-12">save</small></span>
                                    </div>
                                </div>
                            ...
                            <div class="u-shadow-v9 g-py-30 g-px-20">
                                <header class="g-mb-15">
                                    <div class="js-rating d-inline-block g-font-size-12 g-color-primary g-mr-10"
                                        data-rating="3"></div>
                                    <strong
                                        class="d-inline-block text-uppercase g-font-size-10 g-theme-color-gray-dark-v1">18
                                        Reviews</strong>
                                </header>

                                <!-- Article Info -->
                                <h3 class="text-uppercase g-line-height-1_8 g-font-weight-700 g-font-size-12 g-mb-20">
                                    Wine fusce dolor libero,
                                    <br> efficitur et lobortis
                                </h3>
                        ...
                        <article class="text-center g-bg-white">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <div
                                    ...
                                    <div
                                        class="g-pos-rel g-height-60 g-line-height-0_8 g-color-primary g-bg-white g-py-15">
                                        <span class="g-absolute-centered">40% <small
                                                class="g-font-size-12">save</small></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="u-shadow-v9 g-py-30 g-px-20">
                                ...
                                <!-- Article Info -->
                                <h3 class="text-uppercase g-line-height-1_8 g-font-weight-700 g-font-size-12 g-mb-20">
                                    Vestibulum semper, urnaeu
                                    <br> vulputate egestas
                                </h3>
                        ...
                        <article class="text-center g-bg-white">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <div
                                    ...
                                    <div
                                        class="g-pos-rel g-height-60 g-line-height-0_8 g-color-primary g-bg-white g-py-15">
                                        <span class="g-absolute-centered">15% <small
                                                class="g-font-size-12">save</small></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row no-gutters">
                    <div class="col-md-6 d-flex align-items-center text-center g-pa-50">
                        <div class="w-100">
                            ...
                            <p class="g-mb-35">Morbi massa justo, gravida sollicitudin tortor vel, dignissim viverra
                                lectus. In varius blandit condimentum. Pellentesque rutrum mauris ornare libero.</p>
                            <a class="btn btn-md text-uppercase u-btn-outline-primary g-font-weight-700 g-font-size-11 g-brd-2 rounded-0 g-py-10 g-px-25"
                                href="#!">View more</a>
                        </div>
                    </div>
        ...
        <section id="advices" class="g-bg-primary g-py-90">
            <div class="container text-center g-width-590 g-mb-60">
                <h4 class="g-font-weight-700 g-font-size-20 g-theme-h-v1 g-color-white-opacity-0_6 g-mb-25">Some
                    Advices</h4>
                <h2 class="text-uppercase g-font-weight-600 g-font-size-22 g-color-white mb-0">We care about our
                    clients</h2>
            </div>

            <div class="container">
                <div class="js-carousel g-pb-80" data-infinite="true" data-slides-show="4"
                            ...
                            <div class="g-pa-25">
                                ...
                                <header class="row">
                                    <div class="col-md-6 d-flex align-self-center">
                                        <h4
                                            class="text-uppercase g-font-weight-700 g-font-size-11 g-theme-color-gray-dark-v1 mb-0">
                                            Face care</h4>
                                    </div>
                                ...
                                <div class="text-center g-flex-middle g-pos-rel g-min-height-275 g-py-30">
                                    <div class="g-flex-middle-item">
                                        <h3
                                            class="text-uppercase g-line-height-1_8 g-font-weight-700 g-font-size-12 mb-0">
                                            Morbi ex urna, porttitor vel consequat non, rhoncus nec nibh efficitur est
                                            ut justo viverra dapibus aliquet iaculis</h3>
                                    </div>

                                    <div class="u-block-hover__additional--fade g-bg-white g-flex-middle">
                                        <div class="g-flex-middle-item">
                                            <p class="g-font-size-13 g-theme-color-gray-dark-v1 mb-0">Morbi ex urna,
                                                porttitor vel consequat non, rhoncus nec nibh. Sed euismod, lectus
                                                posuere euismod lobortis, velit enim sollicitudin orci, et interdum
                                                justo nisl facilisis nibh.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Article Info -->
                                ...
                                <footer class="d-flex justify-content-between g-font-size-13">
                                    <a class="g-font-weight-700 g-color-gray-dark-v5 g-text-underline--none--hover"
                                        href="#!">
                            ...
                            <div class="g-pa-25">
                                ...
                                <div class="text-center g-flex-middle g-pos-rel g-min-height-275 g-py-30">
                                    <div class="g-flex-middle-item">
                                        <h3
                                            class="text-uppercase g-line-height-1_8 g-font-weight-700 g-font-size-12 mb-0">
                                            Duis ultricies augue purus, sed venenatis velit blandit sed porttitor turpis
                                        </h3>
                                    </div>
                                    ...
                                    <div class="u-block-hover__additional--fade g-bg-white g-flex-middle">
                                        <div class="g-flex-middle-item">
                                            <p class="g-font-size-13 g-theme-color-gray-dark-v1 mb-0">Morbi ex urna,
                                                porttitor vel consequat non, rhoncus nec nibh. Sed euismod, lectus
                                                posuere euismod lobortis, velit enim sollicitudin orci, et interdum
                                                justo nisl facilisis nibh. Pellentesque molestie ac massa vel fringilla.
                                                Aliquam at risus metus. Praesent velit nunc, interdum quis turpis
                                                sodales, varius ultrices lorem.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Article Info -->
                            ...
                            <div class="g-pa-25">
                                ...
                                <div class="text-center g-flex-middle g-pos-rel g-min-height-275 g-py-30">
                                    <div class="g-flex-middle-item">
                                        <h3
                                            class="text-uppercase g-line-height-1_8 g-font-weight-700 g-font-size-12 mb-0">
                                            Praesent augue mi, placerat vel finibus at, semper sit amet nisl</h3>
                                    </div>
                            ...
                            <div class="g-pa-25">
                                ...
                                <div class="text-center g-flex-middle g-pos-rel g-min-height-275 g-py-30">
                                    <div class="g-flex-middle-item">
                                        <h3
                                            class="text-uppercase g-line-height-1_8 g-font-weight-700 g-font-size-12 mb-0">
                                            Tiam ullamcorper luctus nibh, eu malesuada tortor interdum et Donec eu
                                            tortor id ipsum</h3>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex align-items-center g-pt-50 g-pl-50--lg">
                        <div class="w-100">
                            <div class="g-mb-25">
                                <h4 class="g-font-weight-700 g-font-size-20 g-theme-h-v1 g-color-primary g-mb-25">
                                    Subscribe</h4>
                                <h2 class="text-uppercase g-font-weight-600 g-font-size-22 mb-0">Only fresh information
                                </h2>
                            </div>

                            <p class="g-color-gray-dark-v5 g-mb-35">Donec pede justo, fringilla vel, aliquet nec,
                                vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo.
                            </p>

                            <form role="form">
                                <div class="input-group rounded-0">
                                    <input class="form-control g-theme-bg-gray-light-v1 g-brd-none g-py-14 g-px-12"
                                        type="text" placeholder="Your name">

                                    <div class="input-group-btn">
                                        <button
                                            class="btn btn-md h-100 text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-brd-none rounded-0 g-py-12 g-px-25"
        ...
        <section id="products" class="g-theme-bg-gray-light-v1 g-py-80">
            <div class="container text-center g-width-590 g-mb-50">
                ...
                <p class="mb-0">Fusce dolor libero, efficitur et lobortis at, faucibus nec nunc. Proin fermentum
                    turpis eget nisi facilisis lobortis. Praesent malesuada facilisis maximus.</p>
            </div>

            <div class="container">
                <div class="g-mx-minus-15">
                    <div class="js-carousel g-pb-40" data-infinite="true" data-slides-show="4"
                ...
                <div class="row">
                    <div class="col-md-9 g-mb-40 g-mb-0--md">
                        <form>
                            <div class="form-group g-mb-25">
                                <input
                                    class="form-control g-color-gray-dark-v5 g-placeholder-inherit g-theme-bg-gray-light-v1 g-brd-none rounded-0 g-pa-12"
                                    type="text" placeholder="Your name">
                            </div>
                            ...
                            <div class="form-group g-mb-25">
                                <textarea
                                    class="form-control g-resize-none g-color-gray-dark-v5 g-placeholder-inherit g-theme-bg-gray-light-v1 g-brd-none rounded-0 g-py-6 g-px-12"
                                    rows="5" placeholder="Message"></textarea>
                            </div>

                            <button
                                class="btn btn-md text-uppercase btn-block u-btn-outline-primary g-font-weight-700 g-font-size-11 g-brd-2 rounded-0 g-py-19 g-px-20"
                    ...
                    <div class="col-md-3 text-center text-md-left g-mb-40--md">
                        ...
                        <div>
                            ...
                            <strong class="d-block"><a href="#!"
                                    class="g-color-main">info@unify.com</a></strong>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer>
            <!-- Google Map -->
            <div id="gMap" class="js-g-map g-min-height-450 h-100" data-type="custom" data-lat="40.674"
            ...
            <div class="container-fluid text-center g-color-gray-dark-v5 g-py-40">
                ...
                <ul class="list-inline d-inline-block g-mb-30">
                    <li class="list-inline-item g-mr-10">
                        <a class="u-icon-v3 g-width-35 g-height-35 g-font-size-15 g-color-gray-dark-v2 g-color-white--hover g-bg-white g-bg-primary--hover g-transition-0_2 g-transition--ease-in"
