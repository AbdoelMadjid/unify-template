                            ...
                            <div class="g-brd-around g-brd-gray-light-v4 rounded g-pa-30">
                                <div class="g-mb-50">
                                    <h3 class="h5 mb-3">Address 1
                                        <label
                                            class="u-ribbon-v1 g-color-white g-bg-primary rounded ml-3">Default</label>
                                    </h3>
                                    <span class="d-block g-color-gray-dark-v3 g-font-weight-600 mb-2">James
                                        Collins</span>
                                ...
                                <ul class="d-flex align-items-center list-inline mb-0">
                                    <li class="list-inline-item">
                                        <a class="u-icon-v1 g-font-size-16 g-text-underline--none--hover"
                                            href="#!" title="Edit" data-toggle="tooltip"
                                            data-placement="top">
                                            <i class="icon-finance-023 u-line-icon-pro"></i>
                                        </a>
                                    </li>
                                    <li
                                        class="list-inline-item g-width-1 g-height-16 g-bg-gray-light-v2 g-pr-1 ml-2 mr-3">
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="u-icon-v1 g-font-size-16 g-text-underline--none--hover"
                        ...
                        <div class="col-md-6 g-mb-30">
                            ...
                            <div class="g-brd-around g-brd-gray-light-v4 rounded g-pa-30">
                                ...
                                <ul class="d-flex align-items-center list-inline mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <label
                                            class="form-check-inline u-check d-block u-link-v5 g-color-text g-pl-30 mb-0">
