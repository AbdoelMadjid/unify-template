                    ...
                    <div class="row align-items-center">
                        <div class="col-3">
                            <div id="carouselCus2" class="js-carousel text-center u-carousel-v3" data-infinite="true"
                                data-center-mode="true" data-vertical="true" data-slides-show="3"
                                data-is-thumbs="true" data-nav-for="#carouselCus1">
                                <div class="js-slide g-cursor-pointer g-py-5">
                                    <img class="img-fluid" src="assets/img-temp/250x170/img1.jpg"
                                        alt="Image Description">
                                </div>

                                <div class="js-slide g-cursor-pointer g-py-5">
                                    <img class="img-fluid" src="assets/img-temp/250x170/img2.jpg"
                                        alt="Image Description">
                                </div>

                                <div class="js-slide g-cursor-pointer g-py-5">
                                    <img class="img-fluid" src="assets/img-temp/250x170/img3.jpg"
                                        alt="Image Description">
                                </div>
                        ...
                        <div class="col-9">
                            ...
                            <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10" data-infinite="true"
                                ...
                                <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                                    <img class="img-fluid w-100" src="assets/img-temp/700x1145/img1.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                                    <img class="img-fluid w-100" src="assets/img-temp/700x1145/img2.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                                    <img class="img-fluid w-100" src="assets/img-temp/700x1145/img3.jpg"
                                        alt="Image Description">
                                </div>
                            </div>
                        </div>
