    ...
    <main>
            ...
            <div class="row">
                <div class="col-lg-7 g-mb-30 g-mb-0--lg">
                    <div class="row align-items-center">
                        <div class="col-3">
                            <div id="carouselCus2" class="js-carousel text-center u-carousel-v3" data-infinite="true"
                                data-center-mode="true" data-vertical="true" data-slides-show="3" data-is-thumbs="true"
                        ...
                        <div class="col-9">
                            <!-- Carousel -->
                            <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10" data-infinite="true"
                                data-fade="true"
                                ...
                                <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                                    <img class="img-fluid w-100" src="ecommerce/assets/img-temp/700x1145/img1.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                                    <img class="img-fluid w-100" src="ecommerce/assets/img-temp/700x1145/img2.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                                    <img class="img-fluid w-100" src="ecommerce/assets/img-temp/700x1145/img3.jpg"
                                        alt="Image Description">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="accordion-01" role="tablist" aria-multiselectable="true">
                            ...
                            <div id="accordion-01-body-01" class="collapse" role="tabpanel"
                                ...
                                <div class="g-py-10">
                                    ...
                                    <p class="g-font-size-12 mb-2">(Navy: Avoid contact with light coloured fabrics
                                        and upholstery especially whilst damp.)</p>
                                </div>
                            </div>
                        </div>
                        <!-- End Accordion -->
        ...
        <div class="container">
            <div class="g-brd-y g-brd-gray-light-v3 g-py-100">
                <!-- Nav tabs -->
                <ul class="nav g-max-width-200 text-center mx-auto" role="tablist"
                    data-target="nav-1-2-accordion-default-hor-left-underline" data-tabs-mobile-type="accordion"
                    data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-primary g-mb-20">
                    <li class="nav-item text-center mx-auto g-pb-10">
                        <a class="nav-link active g-brd-around g-brd-primary--active g-color-text g-color-primary--parent-active g-font-size-16 rounded"
                            data-toggle="tab" href="#nav-1-2-accordion-default-hor-left-underline--1"
                            role="tab">Description</a>
                    </li>
                    <li class="nav-item text-center mx-auto g-pb-10">
                        <a class="nav-link g-brd-around g-brd-primary--active g-color-text g-color-primary--parent-active g-font-size-16 rounded"
                            data-toggle="tab" href="#nav-1-2-accordion-default-hor-left-underline--2"
                            role="tab">Review</a>
                    </li>
                </ul>
                <!-- End Nav tabs -->
                ...
                <div id="nav-1-2-accordion-default-hor-left-underline" class="tab-content">
                    <div class="tab-pane fade show active g-pt-50"
                        id="nav-1-2-accordion-default-hor-left-underline--1" role="tabpanel">
                        <h2 class="h4 mb-3">Description</h2>

                        <div class="row">
                            <div class="col-md-4 g-mb-30">
                                <p>The streak started in late October. Canelas 2010, an unheralded amateur soccer team,
                                    suddenly could not stop winning.</p>
                                <p>It went 10 straight matches without dropping a point, without so much as conceding a
                                    goal, a surge that brought the prospect of promotion out of its local league and
                                    into the comparative big time of the national third division.</p>
                            </div>
                    ...
                    <div class="tab-pane fade g-pt-50" id="nav-1-2-accordion-default-hor-left-underline--2"
                        role="tabpanel">
                                ...
                                <div class="g-brd-bottom g-brd-gray-light-v4 g-pb-30 g-mb-50">
                                    ...
                                    <div class="media g-mb-30">
                                        <img class="d-flex g-width-60 g-height-60 rounded-circle g-mt-3 g-mr-20"
                                            src="ecommerce/assets/img-temp/100x100/img1.jpg" alt="Image Description">
                                        <div class="media-body">
                                            <div class="d-flex align-items-start g-mb-15 g-mb-10--sm">
                                                <div class="d-block">
                                                    ...
                                                    <span class="d-block g-color-gray-dark-v5 g-font-size-11">June 7,
                                                        2017</span>
                                                </div>
                                                <div class="ml-auto">
                                            ...
                                            <p>The time has come to bring those ideas and plans to life. This is where
                                                we really begin to visualize your napkin sketches and make them into
                                                beautiful pixels. Whether through commerce or just an experience to tell
                                                your brand's story, the time has come to start using development
                                                languages that fit your projects needs.</p>
                                            ...
                                            <ul class="list-inline my-0">
                                                <li class="list-inline-item g-mr-20">
                                                    <a class="g-color-gray-dark-v5 g-text-underline--none--hover"
                                                        href="#!">
                                                        <i
                                                            class="g-pos-rel g-top-1 g-mr-3 icon-medical-022 u-line-icon-pro"></i>
                                                        5
                                                    </a>
                                                </li>
                                                <li class="list-inline-item g-mr-20">
                                    ...
                                    <div class="media g-brd-top g-brd-gray-light-v4 g-pt-30 g-ml-40 g-mb-30">
                                        <img class="d-flex g-width-60 g-height-60 rounded-circle g-mt-3 g-mr-15"
                                            src="ecommerce/assets/img-temp/100x100/img2.jpg" alt="Image Description">
                                        <div class="media-body">
                                            <div class="d-flex align-items-start g-mb-15 g-mb-10--sm">
                                                <div class="d-block">
                                            ...
                                            <p>Now that your brand is all dressed up and ready to party, it's time to
                                    ...
                                    <div class="media g-brd-top g-brd-gray-light-v4 g-pt-30 g-mb-30">
                                        <img class="d-flex g-width-60 g-height-60 rounded-circle g-mt-3 g-mr-15"
                                            src="ecommerce/assets/img-temp/100x100/img3.jpg" alt="Image Description">
                                        <div class="media-body">
                                            <div class="d-flex align-items-start g-mb-15 g-mb-10--sm">
                                                <div class="d-block">
                                            ...
                                            <p>We get it, you're busy and it's important that someone keeps up with
                                                marketing and driving people to your brand. We've got you covered.</p>
                                            ...
                                            <ul class="list-inline my-0">
                                                ...
                                                <li class="list-inline-item g-mr-20">
                                                    <a class="g-color-gray-dark-v5 g-text-underline--none--hover"
                                                        href="#!">
                                                        <i
                                                            class="g-pos-rel g-top-1 g-mr-3 icon-finance-206 u-line-icon-pro"></i>
                                                        0
                                                    </a>
                                                </li>
                                            </ul>
