                ...
                <div class="col-lg-7">
                    ...
                    <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10" data-infinite="true" data-fade="true"
                        ...
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="ecommerce/assets/img-temp/650x750/img1.jpg" alt="Image Description">
                        </div>
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="ecommerce/assets/img-temp/650x750/img2.jpg" alt="Image Description">
                        </div>
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="ecommerce/assets/img-temp/650x750/img3.jpg" alt="Image Description">
                        </div>
                    </div>
                    ...
                    <div id="carouselCus2" class="js-carousel text-center u-carousel-v3 g-mx-minus-5"
                        ...
                        <div class="js-slide g-cursor-pointer g-px-5">
                            <img class="img-fluid" src="ecommerce/assets/img-temp/250x170/img1.jpg" alt="Image Description">
                        </div>

                        <div class="js-slide g-cursor-pointer g-px-5">
                            <img class="img-fluid" src="ecommerce/assets/img-temp/250x170/img2.jpg" alt="Image Description">
                        </div>

                        <div class="js-slide g-cursor-pointer g-px-5">
                            <img class="img-fluid" src="ecommerce/assets/img-temp/250x170/img3.jpg" alt="Image Description">
                        </div>
            ...
            <div class="g-brd-y g-brd-gray-light-v4 g-pt-100 g-pb-70">
                ...
                <div class="row">
                    <div class="col-md-4 g-mb-30">
                        <p>The streak started in late October. Canelas 2010, an unheralded amateur soccer team, suddenly
                            could not stop winning.</p>
                        <p>It went 10 straight matches without dropping a point, without so much as conceding a goal, a
                            surge that brought the prospect of promotion out of its local league and into the
                            comparative big time of the national third division.</p>
                    </div>
                        ...
                        <div class="g-brd-bottom g-brd-gray-light-v4 g-pb-30 g-mb-50">
                            ...
                            <div class="media g-mb-30">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>The time has come to bring those ideas and plans to life. This is where we really
                                        begin to visualize your napkin sketches and make them into beautiful pixels.
                                        Whether through commerce or just an experience to tell your brand's story, the
                                    ...
                                    <ul class="list-inline my-0">
                                        <li class="list-inline-item g-mr-20">
                                            <a class="g-color-gray-dark-v5 g-text-underline--none--hover"
                                                href="#!">
                                                <i
                                                    class="icon-medical-022 u-line-icon-pro g-pos-rel g-top-1 g-mr-3"></i>
                                                5
                                            </a>
                                        </li>
                                        <li class="list-inline-item g-mr-20">
                            ...
                            <div class="media g-brd-top g-brd-gray-light-v4 g-pt-30 g-ml-40 g-mb-30">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Now that your brand is all dressed up and ready to party, it's time to release it
                            ...
                            <div class="media g-brd-top g-brd-gray-light-v4 g-pt-30 g-mb-30">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>We get it, you're busy and it's important that someone keeps up with marketing
                                        and driving people to your brand. We've got you covered.</p>
            ...
            <div class="row">
                <div class="col-6 col-lg-3 g-mb-30">
                    ...
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img1.jpg" alt="Image Description">
                ...
                <div class="col-6 col-lg-3 g-mb-30">
                    <!-- Product -->
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img2.jpg" alt="Image Description">
                ...
                <div class="col-6 col-lg-3 g-mb-30">
                    <!-- Product -->
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img3.jpg" alt="Image Description">
                ...
                <div class="col-6 col-lg-3 g-mb-30">
                    <!-- Product -->
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img4.jpg" alt="Image Description">
                    </figure>
