                ...
                <div class="col-lg-7">
                    ...
                    <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10" data-infinite="true" data-fade="true"
                        ...
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="assets/img-temp/650x750/img1.jpg"
                                alt="Image Description">
                        </div>
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="assets/img-temp/650x750/img2.jpg"
                                alt="Image Description">
                        </div>
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="assets/img-temp/650x750/img3.jpg"
                                alt="Image Description">
                        </div>
                    </div>
                    ...
                    <div id="carouselCus2" class="js-carousel text-center u-carousel-v3 g-mx-minus-5"
                        ...
                        data-focus-on-select="true" data-nav-for="#carouselCus1">
                ...
                <div class="col-lg-5">
                    <div class="g-px-40--lg g-pt-70">
                        ...
                        <div id="accordion-01" role="tablist" aria-multiselectable="true">
                            <div id="accordion-01-heading-01" class="g-brd-y g-brd-gray-light-v3 py-3"
                                role="tab">
                        ...
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                ...
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    ...
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img1.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img2.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img3.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
                                        ...
                                        <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                            ...
                                            <div class="js-slide mx-auto">
                                                <label class="form-check-inline u-check g-pl-17">
                                                    <input class="g-hidden-xs-up" name="radInline3_1"
                                                        type="radio">
                                                    <span
                        ...
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                ...
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    ...
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img4.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img5.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img6.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
                        ...
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                ...
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    data-infinite="true" data-fade="true" data-autoplay="true">
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img7.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img8.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
                        ...
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                ...
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    ...
                                    data-arrow-right-classes="fa fa-angle-right g-right-5">
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img9.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="assets/img-temp/650x900/img10.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
