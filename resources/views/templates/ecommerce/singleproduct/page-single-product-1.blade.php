                ...
                <div class="col-lg-7">
                    ...
                    <div id="carouselCus1" class="js-carousel g-pt-10 g-mb-10" data-infinite="true" data-fade="true"
                        ...
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="ecommerce/assets/img-temp/650x750/img1.jpg"
                                alt="Image Description">
                        </div>
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="ecommerce/assets/img-temp/650x750/img2.jpg"
                                alt="Image Description">
                        </div>
                        <div class="js-slide g-bg-cover g-bg-black-opacity-0_1--after">
                            <img class="img-fluid w-100" src="ecommerce/assets/img-temp/650x750/img3.jpg"
                                alt="Image Description">
                        </div>
                    </div>

                    <div id="carouselCus2" class="js-carousel text-center u-carousel-v3 g-mx-minus-5"
                        data-center-mode="true" data-slides-show="3" data-is-thumbs="true" data-focus-on-select="true"
                        data-nav-for="#carouselCus1">
                        <div class="js-slide g-cursor-pointer g-px-5">
                            <img class="img-fluid" src="ecommerce/assets/img-temp/250x170/img1.jpg"
                                alt="Image Description">
                        </div>

                        <div class="js-slide g-cursor-pointer g-px-5">
                            <img class="img-fluid" src="ecommerce/assets/img-temp/250x170/img2.jpg"
                                alt="Image Description">
                        </div>

                        <div class="js-slide g-cursor-pointer g-px-5">
                            <img class="img-fluid" src="ecommerce/assets/img-temp/250x170/img3.jpg"
                                alt="Image Description">
                        </div>
                    </div>
                    <!-- End Carousel -->
                ...
                <div class="col-lg-5">
                    <div class="g-px-40--lg g-pt-70">
                        ...
                        <div class="g-mb-30">
                            ...
                            <p>Dress is the "rain mac" version of our beloved essential the Unify Parka. Crafted from a
                                water resistant fluid memory fabric to create an elegant draped effect when thrown on,
                                this lightweight shell will take you from season to season and protect you from that
                                unexpected shower.</p>
                        </div>
                        <!-- End Product Info -->
                        ...
                        <!-- Price -->
                        <div class="g-mb-30">
                            <h2 class="g-color-gray-dark-v5 g-font-weight-400 g-font-size-12 text-uppercase mb-2">Price
                            </h2>
                        ...
                        <ul class="nav d-flex justify-content-between g-font-size-12 text-uppercase" role="tablist"
                            ...
                            <li class="nav-item g-brd-bottom g-brd-gray-dark-v4">
                                <a class="nav-link active g-color-primary--parent-active g-pa-0 g-pb-1"
                        ...
                        <div id="nav-1-1-default-hor-left" class="tab-content">
                            <div class="tab-pane fade show active g-pt-30" id="nav-1-1-default-hor-left--3"
                                role="tabpanel">
                                <p class="g-color-gray-dark-v4 g-font-size-13 mb-0">You can return/exchange your
                                ...
                                <table>
                                    <thead
                                        ...
                                        <tr>
                                            ...
                                            <th class="g-width-140 g-font-weight-500 g-pa-0 g-pb-10">Delivery type
                                            </th>
                                            <th class="g-width-150 g-font-weight-500 g-pa-0 g-pb-10">Delivery time
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="g-color-gray-dark-v4 g-font-size-12">
                                            ...
                                            <td class="align-top g-font-size-11 g-py-10">Order before 12pm monday -
                                                thursday and receive it the next day</td>
                                            <td class="align-top text-right g-py-10">$9.5</td>
                                        </tr>
                                        <tr class="g-color-gray-dark-v4 g-font-size-12">
                                            <td class="align-top g-py-10"></td>
                                            <td class="align-top g-py-10">Saturday delivery</td>
                                            <td class="align-top g-font-size-11 g-py-10">Saturday delivery for orders
                                                placed before 12pm on friday</td>
                    ...
                    <div class="col-md-4 mx-auto g-py-15">
                        <div class="media g-px-50--lg">
                            ...
                            <div class="media-body">
                                <span class="d-block g-font-weight-400 g-font-size-default text-uppercase">Free
                                    Shipping</span>
            ...
            <div class="row no-gutters g-min-height-100vh">
                <div class="col-md-6 align-self-center">
                    <div class="g-width-60x mx-auto g-px-50--lg g-py-100">
                        ...
                        <p>Dress is the "rain mac" version of our beloved essential the Unify Parka. Crafted from a
                            water resistant fluid memory fabric to create an elegant draped effect when thrown on, this
                            lightweight shell will take you from season to season and protect you from that unexpected
                            shower.</p>
                    </div>
                </div>

                <div class="col-md-6 g-bg-size-cover g-min-height-300"
                    data-bg-img-src="ecommerce/assets/img-temp/900x900/img1.jpg"></div>
            </div>
        </div>
        <!-- End Details -->
            ...
            <div class="row no-gutters g-min-height-100vh">
                <div class="col-md-6 order-md-2 align-self-center">
                    <div class="g-width-60x mx-auto g-px-50--lg g-py-100">
                        ...
                        <p>We believe in redefining classic silhouettes into modern pieces that function for busy people
                            with busy lives. We want to create clothing that people will love and treasure for years to
                            come – to become that trusty go-to you can't live without.</p>
                    </div>
                </div>

                <div class="col-md-6 order-md-1 g-bg-size-cover g-min-height-300"
                    data-bg-img-src="ecommerce/assets/img-temp/900x900/img2.jpg"></div>
            </div>
        </div>
        <!-- End Craftmanship -->
            ...
            <div class="row no-gutters g-min-height-100vh">
                <div class="col-md-6 align-self-center">
                    <div class="g-width-60x mx-auto g-px-50--lg g-py-100">
                        ...
                        <p>Crafted from a water resistant fluid memory fabric to create an elegant draped effect when
                            thrown on, this lightweight shell will take you from season to season and protect you from
                            that unexpected shower.</p>
                    </div>
                </div>

                <div class="col-md-6 g-bg-size-cover g-min-height-300"
                    data-bg-img-src="ecommerce/assets/img-temp/900x900/img3.jpg"></div>
            </div>
        </div>
        <!-- End Caring -->
                        ...
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                ...
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    ...
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img1.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img2.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img3.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
                                ...
                                <div class="text-center g-pos-abs g-bottom-20 g-left-0 g-right-0">
                                    ...
                                    <ul class="list-inline g-ml-minus-10 mb-1">
                                        <li class="list-inline-item g-mx-10">
                                            <label class="form-check-inline u-check">
                                                ...
                                                <span
                                                    class="d-block u-check-icon-checkbox-v4 g-brd-transparent g-brd-white--checked rounded-circle g-absolute-centered--y g-left-0">
                                                    <i
                                                        class="d-block g-absolute-centered g-width-10 g-height-10 g-bg-bluegray rounded-circle"></i>
                                                </span>
                                            </label>
                                        </li>
                                        <li class="list-inline-item g-mx-10">
                                            <label class="form-check-inline u-check">
                                                ...
                                                <span
                                                    class="d-block u-check-icon-checkbox-v4 g-brd-transparent g-brd-white--checked rounded-circle g-absolute-centered--y g-left-0">
                                                    <i
                                                        class="d-block g-absolute-centered g-width-10 g-height-10 g-bg-white rounded-circle"></i>
                                                </span>
                                            </label>
                                        </li>
                                        <li class="list-inline-item g-mx-10">
                                            <label class="form-check-inline u-check">
                                                ...
                                                <span
                                                    class="d-block u-check-icon-checkbox-v4 g-brd-transparent g-brd-white--checked rounded-circle g-absolute-centered--y g-left-0">
                                                    <i
                                                        class="d-block g-absolute-centered g-width-10 g-height-10 g-bg-brown rounded-circle"></i>
                                                </span>
                                            </label>
                                        </li>
                                    </ul>
                                    ...
                                    <h2 class="g-color-white-opacity-0_8 g-font-weight-400 g-font-size-13">
                                        <a class="u-link-v5 g-color-white-opacity-0_8 g-color-primary--hover g-cursor-pointer"
                                            href="#!">Unstructured Jacket</a>
                                    </h2>
                            ...
                            <div class="g-bg-white g-pa-20">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-7">
                                        <!-- Checkbox -->
                                        <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                            data-infinite="true" data-autoplay="true" data-slides-show="3">
                                            <div class="js-slide mx-auto">
                                                <label class="form-check-inline u-check g-pl-17">
                                                    ...
                                                    <span
                                                        class="d-block u-check-icon-checkbox-v4 g-brd-none g-color-primary--hover g-font-size-10 g-absolute-centered--y g-left-0 mt-1">
                                                        XL
                                                    </span>
                                                </label>
                                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3 g-px-10 g-mb-30">
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                <!-- Product Image -->
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    data-infinite="true" data-fade="true" data-autoplay="true">
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img4.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img5.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img6.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
                                ...
                                <div class="text-center g-pos-abs g-bottom-20 g-left-0 g-right-0">
                                        ...
                                        <li class="list-inline-item g-mx-10">
                                            <label class="form-check-inline u-check">
                                                ...
                                                <span
                                                    class="d-block u-check-icon-checkbox-v4 g-brd-transparent g-brd-white--checked rounded-circle g-absolute-centered--y g-left-0">
                                                    <i
                                                        class="d-block g-absolute-centered g-width-10 g-height-10 g-bg-black rounded-circle"></i>
                                                </span>
                                            </label>
                                        </li>
                                    </ul>
                                    ...
                                    <h2 class="g-color-white-opacity-0_8 g-font-weight-400 g-font-size-13">
                                        <a class="u-link-v5 g-color-white-opacity-0_8 g-color-primary--hover g-cursor-pointer"
                                            href="#!">Exclusive Coat by Milano</a>
                                    </h2>
                        ...
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                ...
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    data-infinite="true" data-fade="true" data-autoplay="true">
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img7.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img8.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
                                        ...
                                        <li class="list-inline-item g-mx-10">
                                            <label class="form-check-inline u-check">
                                                ...
                                                <span
                                                    class="d-block u-check-icon-checkbox-v4 g-brd-transparent g-brd-white--checked rounded-circle g-absolute-centered--y g-left-0">
                                                    <i
                                                        class="d-block g-absolute-centered g-width-10 g-height-10 g-bg-beige rounded-circle"></i>
                                                </span>
                                            </label>
                                        </li>
                                        <li class="list-inline-item g-mx-10">
                                            <label class="form-check-inline u-check">
                                                ...
                                                <span
                                                    class="d-block u-check-icon-checkbox-v4 g-brd-transparent g-brd-white--checked rounded-circle g-absolute-centered--y g-left-0">
                                                    <i
                                                        class="d-block g-absolute-centered g-width-10 g-height-10 g-bg-blue rounded-circle"></i>
                                                </span>
                                            </label>
                                        </li>
                                    </ul>
                        ...
                        <div class="u-shadow-v21">
                            <div class="g-pos-rel">
                                ...
                                <div class="js-carousel text-center g-rounded-50 g-bg-gray-light-v5 g-py-3"
                                    ...
                                    data-arrow-right-classes="fa fa-angle-right g-right-5">
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img9.jpg"
                                            alt="Image Description">
                                    </div>
                                    <div class="js-slide">
                                        <img class="img-fluid" src="ecommerce/assets/img-temp/650x900/img10.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                                <!-- End Product Image -->
