            ...
            <div class="row">
                ...
                <div class="col-lg-3 g-mb-50">
                    <aside class="g-brd-around g-brd-gray-light-v4 rounded g-px-20 g-py-30">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="g-pb-3">
                                <a class="d-block active align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover g-color-primary--parent-active g-bg-gray-light-v5--active rounded g-pa-3"
                ...
                <div class="col-lg-9 g-mb-50">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v4 rounded g-px-30 g-pt-30">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-sm-4 g-mb-30">
                                <div class="g-bg-gray-dark-v3 text-center rounded g-px-20 g-py-30">
                                    <span
                                        class="d-block g-color-white g-font-weight-600 g-font-size-25 mb-1">$74.57</span>
                                    <span class="d-block g-color-white-opacity-0_8 g-font-size-18">Available
                                        Balance</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 g-mb-30">
                                <div class="g-bg-primary text-center rounded g-px-20 g-py-30">
                                    <span
                                        class="d-block g-color-white g-font-weight-600 g-font-size-25 mb-1">$5.00</span>
                                    <span class="d-block g-color-white-opacity-0_8 g-font-size-18">Reward
                                        Balance</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 g-mb-30">
                                <div class="g-bg-lightred text-center rounded g-px-20 g-py-30">
                                    <span
                                        class="d-block g-color-white g-font-weight-600 g-font-size-25 mb-1">$0.00</span>
                                    <span class="d-block g-color-white-opacity-0_8 g-font-size-18">Pending
                                        Balance</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="g-mb-50">
                            <button
                                class="btn g-brd-around g-brd-gray-light-v3 g-color-gray-dark-v3 g-bg-gray-light-v5 g-bg-gray-light-v4--hover g-font-size-13 rounded g-px-18 g-py-9"
                                type="button">
                            ...
                            <div class="col-sm-8 g-mb-30">
                                ...
                                <div class="media g-mb-30">
                                    <div class="d-flex mr-4">
                                        <span
                                            class="u-icon-v2 u-icon-size--sm g-brd-gray-dark-v5 g-color-main rounded-circle">
                                            <i class="icon-finance-009 u-line-icon-pro"></i>
                                        </span>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="h6 mb-1">Prime Rewards</h4>
                                        <p class="mb-1">Cardmembers earn 3.2% Back at Unify.com with a Prime Credit
                                            Card. Earn 1.7% rewards on your debit spending with Prime Reload.</p>
