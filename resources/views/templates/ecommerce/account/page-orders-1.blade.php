                    ...
                    <aside class="g-brd-around g-brd-gray-light-v4 rounded g-px-20 g-py-30">
                        ...
                        <div class="text-center g-pos-rel g-mb-30">
                            <div class="g-width-100 g-height-100 mx-auto mb-3">
                                <img class="img-fluid rounded-circle" src="ecommerce/assets/img-temp/100x100/img1.jpg"
                                    alt="Image Decor">
                            </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-4 col-sm-3 g-mb-30">
                                            <img class="img-fluid" src="ecommerce/assets/img-temp/150x150/img9.jpg"
                        ...
                        <div class="g-pa-20">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-4 col-sm-3 g-mb-30">
                                            <img class="img-fluid" src="ecommerce/assets/img-temp/150x150/img3.jpg"
                                                alt="Image Description">
                                        </div>
