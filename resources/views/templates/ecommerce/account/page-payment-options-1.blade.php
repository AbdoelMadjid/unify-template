                        ...
                        <div class="col-md-8 col-lg-6 g-mb-70 g-mb-0--md">
                            <div class="mb-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <img class="g-width-40" src="assets/img-temp/50x35/img1.jpg"
                                        alt="Image Description">
                                    <span class="g-font-size-13">**** **** **** 5021</span>

                                    <div class="ml-auto">
                                        <!-- Delete -->
                                        <a class="u-icon-v1 u-icon-size--xs g-color-gray-dark-v5 g-color-primary--hover g-font-size-16 g-text-underline--none--hover"
                                ...
                                <form class="row justify-content-between g-mb-30">
                                    ...
                                    <div class="col-5 col-sm-4">
                                        ...
                                        <div class="input-group g-pos-rel">
                                            ...
                                            <div
                                                class="g-brd-gray-light-v3 g-pos-abs g-top-5 g-right-5 g-z-index-3 p-0">
                                                <img class="g-width-30" src="assets/img-temp/50x25/img1.jpg"
                                                    alt="Image Description">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-lg-6">
                            ...
                            <div id="accordion-12" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div class="card g-brd-none rounded-0 g-mb-15">
                                    <div id="accordion-12-heading-01" class="u-accordion__header g-pa-0"
                                        role="tab">
                                        <h5 class="mb-0">
                                            <a class="d-block g-font-size-13 g-text-underline--none--hover p-0"
                                    ...
                                    <div id="accordion-12-body-01" class="collapse" role="tabpanel"
                                        ...
                                        <div
                                            ...
                                            <div class="row g-mx-minus-5 mb-3">
                                                ...
                                                <div class="col-4 col-md-12 col-lg-4 g-px-5 g-mb-20">
                                                    <h4 class="h6 g-color-black g-font-weight-400 mb-3">Card Number
                                                    </h4>
                                                    <div class="input-group g-pos-rel">
                                                        <input
                                                            class="form-control u-form-control g-brd-around g-brd-gray-light-v3 g-brd-primary--focus g-font-size-13 g-rounded-3 g-rounded-left-0 g-pr-40 g-ml-minus-1"
                                        ...
                                        <div class="g-pl-20">
                                            <button class="btn u-btn-primary g-font-size-13 rounded g-px-18 g-py-10"
