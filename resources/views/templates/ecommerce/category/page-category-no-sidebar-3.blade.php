    ...
    <main>
        ...
        <section
            ...
            <div class="divimage dzsparallaxer--target w-100 g-bg-pos-top-center g-bg-cover g-bg-black-opacity-0_1--after"
                style="height: 140%; background-image: url(ecommerce/assets/img-temp/1920x1080/img3.jpg);"></div>
                ...
                <div class="row g-mb-0 g-mb-30--md">
                    ...
                    <div class="col-sm-6 col-lg-3 g-mb-30 g-mb-50--sm">
                        ...
                        <div id="rangeSlider1" class="u-slider-v1-3" data-result-container="rangeSliderAmount3"
                            data-range="true" data-default="125, 375" data-min="0" data-max="500">
                        </div>
                        <!-- End Pricing -->
                    </div>
        ...
        <div class="container g-pb-100">
            <!-- Banner -->
            <div class="g-bg-size-cover g-bg-pos-center g-py-40 g-mt-60"
