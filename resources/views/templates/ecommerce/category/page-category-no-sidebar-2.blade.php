    ...
    <main>
        ...
        <section
            ...
            <div class="divimage dzsparallaxer--target w-100"
                style="height: 140%; background-image: url(ecommerce/assets/img-temp/1920x1080/img4.jpg);"></div>
                    ...
                    <div class="col-lg-7">
                        <div class="g-bg-white g-pa-40 rounded">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-6 g-mb-30 g-mb-50--sm">
                                    ...
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item mr-2">
                                            <label
                                                class="form-check-inline u-check d-block u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-pl-25">
                                ...
                                <div class="col-sm-6 col-lg-6 g-mb-30 g-mb-50--sm">
                                    <!-- Pricing -->
                                    <h4 class="h6 text-center g-mb-30">$(<span id="rangeSliderAmount3">0</span>)
                                    </h4>
                                    <div id="rangeSlider1" class="u-slider-v1-3"
                                        data-result-container="rangeSliderAmount3" data-range="true"
                                        data-default="125, 375" data-min="0" data-max="500">
                                    </div>
                                    <!-- End Pricing -->
                                </div>
        ...
        <div class="container g-pb-100">
            ...
            <div class="g-bg-size-cover g-bg-pos-center g-py-40 g-mt-50"
                style="background-image: url(ecommerce/assets/img-temp/900x450/img1.jpg);">
                ...
                <div class="g-mr-60">
                    ...
                    <div class="d-inline-block btn-group">
                        ...
                        <div class="dropdown-menu rounded-0">
                            ...
                            <a class="dropdown-item g-color-gray-dark-v4 g-font-weight-300"
                                href="#!">Trending</a>
                            <a class="dropdown-item g-color-gray-dark-v4 g-font-weight-300" href="#!">Price low
                                to high</a>
            ...
            <div class="row g-pt-30 g-mb-50">
                ...
                <div class="col-6 col-lg-3 g-mb-30">
                    <!-- Product -->
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img5.jpg" alt="Image Description">
                ...
                <div class="col-6 col-lg-3 g-mb-30">
                    <!-- Product -->
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img6.jpg" alt="Image Description">
                    </figure>
                ...
                <div class="col-6 col-lg-3 g-mb-30">
                    <!-- Product -->
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img7.jpg" alt="Image Description">
                ...
                <div class="col-6 col-lg-3 g-mb-30">
                    <!-- Product -->
                    <figure class="g-pos-rel g-mb-20">
                        <img class="img-fluid" src="ecommerce/assets/img-temp/480x700/img8.jpg" alt="Image Description">
                    </figure>
