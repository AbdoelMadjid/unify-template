        ...
        <div class="container g-py-100">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 g-mb-50">
                    ...
                    <button class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25 g-mb-50"
                        type="submit">Add to Bag</button>
                </div>
            </div>

            <h3>Treat someone with a Gift</h3>
            <p>Shopping for someone else but not sure what to give them? Give them the gift of choice with a Unify gift
                card.</p>
            <p>Our gift cards are delivered by email, which you can then print or forward directly to a lucky recipient.
                They never expire and can be used over multiple purchases. We'll automatically apply your balance to
                eligible orders when you checkout. If you would rather not use your balance, you can deselect it in the
                Payment Selection step of checkout.</p>
            <p><span class="g-font-weight-700">Limitations:</span> Your Gift Card Balance cannot be transferred to
                other accounts or used to purchase other gift cards.</p>
