                                        ...
                                        <tbody>
                                            ...
                                            <tr class="g-brd-bottom g-brd-gray-light-v3">
                                                <td class="text-left g-py-25">
                                                    <img class="d-inline-block g-width-100 mr-4"
                                                        src="ecommerce/assets/img-temp/150x150/img6.jpg"
                                            ...
                                            <tr>
                                                <td class="text-left g-pt-25">
                                                    <img class="d-inline-block g-width-100 mr-4"
                                                        src="ecommerce/assets/img-temp/150x150/img7.jpg"
                                                        alt="Image Description">
                                                    <div class="d-inline-block align-middle">
                                    ...
                                    <div class="col-sm-6 g-mb-20">
                                        <div class="form-group">
                                            ...
                                            <input id="inputGroup6"
                                                class="form-control u-form-control g-placeholder-gray-light-v1 rounded-0 g-py-15"
                                                name="email" type="email" placeholder="alex@gmail.com" required
                                                data-msg="This field is mandatory" data-error-class="u-has-error-v1"
                                                data-success-class="u-has-success-v1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 g-mb-20">
                                        <div class="form-group">
                                            ...
                                            <input id="inputGroup10"
                                                class="form-control u-form-control g-placeholder-gray-light-v1 rounded-0 g-py-15"
                                                name="phoneNumber" type="text" placeholder="+01 (00) 555 666 77"
                                                required data-msg="This field is mandatory"
                                                data-error-class="u-has-error-v1"
                                                data-success-class="u-has-success-v1">
                                        </div>
                                ...
                                <ul class="list-unstyled mb-5">
                                    <li class="g-brd-bottom g-brd-gray-light-v3 pb-3 my-3">
                                        <label
                                            ...
                                            Pay with
                                            <img class="g-width-70 ml-2"
                                                src="ecommerce/assets/img-temp/200x55/img1.jpg"
                                                alt="Image Description">
                                        </label>
                                    </li>
                                    <li class="my-3">
                                        <label
                                            ...
                                            <img class="g-width-50 ml-2"
                                                src="ecommerce/assets/img-temp/200x55/img2.jpg"
                                                alt="Image Description">
                                        </label>
                                    </li>
                                </ul>
