    ...
    <main>
                        ...
                        <div class="col-sm-auto g-hidden-sm-down">
                            ...
                            <ul class="list-inline g-py-14 mb-0">
                                <li class="list-inline-item">
                                    <a class="g-color-white-opacity-0_8 g-color-primary--hover g-pa-3" href="#!"><i
                                ...
                                <div class="g-py-10 g-px-6">
                                    <a href="#!" id="basket-bar-invoker"
                                        ...
                                        <span
                                            ...
                                            style="top: 7px !important; right: 3px !important;">0</span>
                                        <i class="icon-hotel-restaurant-105 u-line-icon-pro"></i>
                                    </a>
                                </div>

                                <div id="basket-bar"
                                    class="u-basket__bar u-dropdown--css-animation u-dropdown--hidden g-text-transform-none g-bg-white g-brd-around g-brd-gray-light-v4 g-z-index-3"
                                    ...
                                    <div class="js-scrollbar g-height-200">
                                        <div class="text-center g-pt-40">
                                            ...
                                            <span class="d-block g-color-text g-font-size-15">Your cart is currently
                                                empty</span>
                                    ...
                                    <div class="clearfix g-px-15">
                                        <div
                                            ...
                                            <div class="col">
                                                <strong
                                                    class="d-block g-py-10 g-color-main g-font-weight-500 g-py-10">$0.00</strong>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="container text-center g-py-100">
            <div class="mb-5">
                ...
                <p>Before proceed to checkout you must add some products to your shopping cart.<br>You will find a lot
                    of interesting products on our "Shop" page.</p>
            </div>
            <a class="btn u-btn-primary g-font-size-12 text-uppercase g-py-12 g-px-25" href="#!">Start
                Shopping</a>
        </div>
