...
<body>
    <main>
        ...
        <div id="GMapCustomized-light" class="js-g-map embed-responsive embed-responsive-21by9 g-height-400"
            ...
            data-pin="true" data-pin-icon="assets/img/icons/pin/img1.png">
        </div>
        <!-- End Google Map -->
        ...
        <div class="container g-py-100">
            ...
            <div class="row g-mb-100">
                <div class="col-md-6 col-lg-4 mx-auto g-py-15">
                    ...
                    <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-40">
                        ...
                        <div class="media-body">
                            <span class="d-block g-font-weight-500 g-font-size-default text-uppercase mb-2">Phone
                                Numbers</span>
                            <ul class="list-unstyled mb-0">
                ...
                <div class="col-md-6 col-lg-4 mx-auto g-py-15">
                    ...
                    <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-40">
                        ...
                        <div class="media-body">
                            <span
                                class="d-block g-font-weight-500 g-font-size-default text-uppercase mb-2">Location</span>
                            <span class="d-block g-color-gray-dark-v4">972 Sylvan Street South Angelina, NL
                                S0B2V9</span>
                        </div>
                    </div>
                    <!-- End Media -->
                ...
                <div class="col-md-6 col-lg-4 mx-auto g-py-15">
                    <div class="media g-brd-around g-brd-gray-light-v4 rounded g-pa-40">
                        ...
                        <div class="media-body text-left">
                            <span class="d-block g-font-weight-500 g-font-size-default text-uppercase mb-2">Office
                                Hours</span>
                            <ul class="list-unstyled mb-0">
            ...
            <div class="g-max-width-645 text-center mx-auto g-mb-70">
                ...
                <p class="g-font-size-17 mb-0">Fill up the form and hit the "Send Message". One of our representatives
