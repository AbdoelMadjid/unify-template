            ...
            <div class="row">
                ...
                <div class="col-lg-9 g-mb-50">
                    ...
                    <div class="g-brd-around g-brd-gray-light-v4 rounded g-pa-30 g-mb-30">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <form class="ml-auto">
                                <label class="form-check-inline u-check mb-0">
                                    <input class="g-hidden-xs-up g-pos-abs g-top-0 g-right-0" name="radGroup1_1"
                                        type="checkbox">
                        ...
                        <!-- Security Settings -->
                        <div class="d-flex mb-3">
                            <span class="g-color-text g-font-size-13">Make a payment from your Android Pay
                                wallet</span>
                        ...
                        <!-- Security Settings -->
                        <div class="d-flex mb-3">
                            <span class="g-color-text g-font-size-13">Receive email confirmations of your each
                                order</span>
