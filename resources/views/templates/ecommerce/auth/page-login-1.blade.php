            ...
            <div class="row justify-content-between">
                <div class="col-md-6 col-lg-5 order-lg-2 g-mb-80">
                        ...
                        <form class="g-py-15">
                            ...
                            <div class="row justify-content-between mb-5">
                                ...
                                <div class="col align-self-center text-right">
                                    <a class="g-font-size-13" href="page-password-recovery-1.html">Forgot
                                        password?</a>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <p class="g-color-gray-dark-v5 mb-0">Don't have an account?
                            <a class="g-font-weight-600" href="page-signup-1.html">signup</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 order-lg-1 g-mb-80">
                    <div class="mb-5">
                        ...
                        <p class="g-color-gray-dark-v4">The time has come to bring those ideas and plans to life. This
