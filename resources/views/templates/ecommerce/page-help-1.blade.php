                            ...
                            <div class="d-inline-block g-valign-middle">
                                <div class="g-py-10 g-pl-15">
                                    <a href="#!"
                                        ...
                                        aria-haspopup="true" aria-expanded="false" data-dropdown-event="hover"
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item hs-has-sub-menu g-mx-10--lg g-mx-15--xl">
                                    ...
                                    <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-min-width-220 g-brd-top g-brd-primary g-brd-top-2 g-mt-17"
                                        ...
                                        <li class="dropdown-item">
                                            <a class="nav-link g-color-gray-dark-v4"
                                                href="page-contact-1.html">Contact Us
                                                <span
                                                    class="u-label g-rounded-3 g-font-size-10 g-bg-lightred g-py-3 g-pos-rel g-top-minus-1 g-ml-5">New</span>
                                            </a>
                                        </li>
                                    ...
                                    <div class="w-100 hs-mega-menu u-shadow-v11 g-text-transform-none g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-pa-30 g-mt-17"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-3 g-mb-30 g-mb-0--sm">
                                                ...
                                                <!-- Links -->
                                                <span
                                                    class="d-block g-font-weight-500 text-uppercase mb-2">Shoes</span>
                                            ...
                                            <div class="col-sm-6 col-md-3 g-mb-30 g-mb-0--sm">
                                                <!-- Links -->
                                                <span
                                                    class="d-block g-font-weight-500 text-uppercase mb-2">Mixed</span>
        ...
        <div class="container g-pt-100 g-pb-70">
            <div class="row g-mb-20">
                <div class="col-md-4 g-mb-30">
                    ...
                    <!-- Nav tabs -->
                    <ul class="nav flex-column u-nav-v5-3 u-nav-primary g-bg-gray-light-v5 rounded g-pa-20"
                        role="tablist" data-target="nav-5-3-primary-ver" data-tabs-mobile-type="slide-up-down"
                        data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-primary">
                        <li class="nav-item">
                            <a class="nav-link active g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--1" role="tab">Recommended Topics</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--2" role="tab">Where's My Stuff?</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--3" role="tab">Managing Your Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--4" role="tab">Account Settings &amp; Payment
                                Methods</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--5" role="tab">Returns &amp; Refunds</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--6" role="tab">Shipping Policies</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--7" role="tab">Other Topics</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link g-brd-bottom-none g-color-primary--hover" data-toggle="tab"
                                href="#nav-5-3-primary-ver--8" role="tab">Need more help?</a>
                        </li>
                    </ul>
                    <!-- End Nav tabs -->
                </div>
                ...
                <div class="col-md-8 g-mb-30">
                    ...
                    <form class="g-pos-rel g-mb-50">
                        ...
                        <input
                            ...
                            type="search" placeholder="Type to find answer">
                    </form>
                    <!-- End Search Form -->
                        ...
                        <div class="tab-pane fade show active" id="nav-5-3-primary-ver--1" role="tabpanel">
                            ...
                            <div id="accordion-12-1" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-1-body-06" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-1-heading-06">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-1-body-07" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-1-heading-07">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            Sifting through teaspoons of clay and sand scraped from the floors of caves,
                                            German researchers have managed to isolate ancient human DNA — without
                                            turning up a single bone.
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            ...
                                            data-parent="#accordion-12-1" aria-expanded="false"
                                            aria-controls="accordion-12-1-body-07">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                        ...
                        <div class="tab-pane fade" id="nav-5-3-primary-ver--2" role="tabpanel">
                            ...
                            <div id="accordion-12-2" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-2-body-01" class="collapse" role="tabpanel"
                        ...
                        <div class="tab-pane fade" id="nav-5-3-primary-ver--3" role="tabpanel">
                            ...
                            <div id="accordion-12-3" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-3-body-01" class="collapse" role="tabpanel"
                        ...
                        <div class="tab-pane fade" id="nav-5-3-primary-ver--4" role="tabpanel">
                            ...
                            <div id="accordion-12-4" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-4-body-01" class="collapse" role="tabpanel"
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="g-color-primary g-text-underline--none--hover g-pa-10"
                                            ...
                                            data-parent="#accordion-12-4" aria-expanded="false"
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-4-heading-02"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">2.</span>
                                    ...
                                    <div id="accordion-12-4-body-02" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-4-heading-02">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            This is where we sit down, grab a cup of coffee and dial in the details.
                                            Understanding the task at hand and ironing out the wrinkles is key. Now that
                                            we've aligned the details, it's time to get things mapped out and organized.
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-4-body-02" data-toggle="collapse"
                                            data-parent="#accordion-12-4" aria-expanded="false"
                                            aria-controls="accordion-12-4-body-02">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-4-heading-03"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">3.</span>
                                    ...
                                    <div id="accordion-12-4-body-03" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-4-heading-03">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-4-body-03" data-toggle="collapse"
                                            data-parent="#accordion-12-4" aria-expanded="false"
                                            aria-controls="accordion-12-4-body-03">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                        ...
                        <div class="tab-pane fade" id="nav-5-3-primary-ver--5" role="tabpanel">
                            ...
                            <div id="accordion-12-5" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-5-body-01" class="collapse" role="tabpanel"
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-5-heading-03"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">3.</span>
                                    ...
                                    <div id="accordion-12-5-body-03" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-5-heading-03">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-5-body-03" data-toggle="collapse"
                                            data-parent="#accordion-12-5" aria-expanded="false"
                                            aria-controls="accordion-12-5-body-03">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                        ...
                        <div class="tab-pane fade" id="nav-5-3-primary-ver--6" role="tabpanel">
                            ...
                            <div id="accordion-12-6" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-6-body-01" class="collapse" role="tabpanel"
                        ...
                        <div class="tab-pane fade" id="nav-5-3-primary-ver--7" role="tabpanel">
                            ...
                            <div id="accordion-12-7" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-7-body-01" class="collapse" role="tabpanel"
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-7-heading-03"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">3.</span>
                                    ...
                                    <div id="accordion-12-7-body-03" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-7-heading-03">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-7-body-03" data-toggle="collapse"
                                            data-parent="#accordion-12-5" aria-expanded="false"
                                            aria-controls="accordion-12-5-body-03">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-7-heading-04"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">4.</span>
                                    ...
                                    <div id="accordion-12-7-body-04" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-7-heading-04">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-7-body-04" data-toggle="collapse"
                                            data-parent="#accordion-12-5" aria-expanded="false"
                                            aria-controls="accordion-12-5-body-04">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-7-heading-05"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">5.</span>
                                    ...
                                    <div id="accordion-12-7-body-05" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-7-heading-05">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-7-body-05" data-toggle="collapse"
                                            data-parent="#accordion-12-5" aria-expanded="false"
                                            aria-controls="accordion-12-5-body-05">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-7-heading-06"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">6.</span>
                                    ...
                                    <div id="accordion-12-7-body-06" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-7-heading-06">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-7-body-06" data-toggle="collapse"
                                            data-parent="#accordion-12-5" aria-expanded="false"
                                            aria-controls="accordion-12-5-body-06">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                                ...
                                <div
                                    class="card g-brd-none g-brd-bottom g-brd-gray-light-v3 rounded-0 g-pb-30 g-mb-30">
                                    <div id="accordion-12-7-heading-07"
                                        class="u-accordion__header g-color-gray-dark-v4 g-font-weight-500 g-font-size-16 g-pa-0"
                                        role="tab">
                                        <span
                                            class="g-color-primary g-font-weight-700 g-font-size-16 g-line-height-1_2">7.</span>
                                    ...
                                    <div id="accordion-12-7-body-07" class="collapse" role="tabpanel"
                                        aria-labelledby="accordion-12-7-heading-07">
                                        <div class="u-accordion__body g-color-gray-dark-v4">
                                            The time has come to bring those ideas and plans to life. Sifting through
                                            teaspoons of clay and sand scraped from the floors of caves, German
                                            researchers have managed to isolate ancient human DNA — without turning up a
                                    ...
                                    <h5 class="g-font-weight-400 g-font-size-13 g-pl-8 mt-3 mb-0">
                                        <a class="collapsed g-color-primary g-text-underline--none--hover g-pa-10"
                                            href="#accordion-12-7-body-07" data-toggle="collapse"
                                            data-parent="#accordion-12-5" aria-expanded="false"
                                            aria-controls="accordion-12-5-body-07">
                                            <span class="u-accordion__control-icon">
                                                <i class="g-font-style-normal">Read More
                                                    <span class="ml-2 fa fa-caret-up"></span>
                                                </i>
                        ...
                        <div class="tab-pane fade" id="nav-5-3-primary-ver--8" role="tabpanel">
                            ...
                            <div id="accordion-12-8" class="u-accordion u-accordion-color-primary" role="tablist"
                                ...
                                <div
                                    ...
                                    <div id="accordion-12-8-body-01" class="collapse" role="tabpanel"
                ...
                <div class="col-md-4 g-mb-30">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <a class="u-link-v5 g-color-main g-color-primary--hover g-font-weight-600"
                                href="#!">Can't find answer?</a>
