                ...
                <div class="col-md-6 col-lg-4 g-mb-30">
                    ...
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item mr-2">
                            <label
                                class="form-check-inline u-check d-block u-link-v5 g-color-text g-color-primary--hover g-pl-25 mb-0">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-3 col-md-2 g-mb-30">
                        ...
                        <div class="d-inline-block btn-group">
                            <button type="button"
                                class="btn btn-secondary dropdown-toggle h6 align-middle g-brd-none g-color-text g-color-primary--hover g-bg-transparent g-pa-0 g-ma-0"
                    ...
                    <div class="col-sm-3 col-md-2 g-mb-30">
                        ...
                        <div class="d-inline-block btn-group">
                            ...
                            <div class="dropdown-menu rounded-0">
                                ...
                                <a class="dropdown-item g-color-gray-dark-v4 g-font-weight-300"
                                    href="#!">Trending</a>
                                <a class="dropdown-item g-color-gray-dark-v4 g-font-weight-300" href="#!">Price
                                    low to high</a>
                                <a class="dropdown-item g-color-gray-dark-v4 g-font-weight-300" href="#!">price
                                    high to low</a>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                        ...
                        <div class="row g-pt-30">
                            ...
                            <div class="col-6 col-sm-7 col-lg-8 g-mb-15">
                                ...
                                <div class="g-mb-30">
                                    ...
                                    <p>Alongside our classic parka, we make modern clothing and outerwear that
                                        withstands the weather and the changes in fashion. We use only the best fabrics
                                        to keep you warm and dry, while the designs look good now and tomorrow. In
                                        essence, our coats are built to last.</p>
                                </div>
                                <!-- End Product Info -->
                    ...
                    <div class="g-brd-bottom g-brd-gray-light-v4 g-pb-70 g-mb-60">
                        <div class="row g-pt-30">
                            <figure class="col-6 col-sm-5 col-lg-4 g-mb-30">
                                <img class="img-fluid" src="assets/img-temp/480x700/img9.jpg"
                                    alt="Image Description">

                                <span
                                    class="u-ribbon-v1 g-width-40 g-height-40 g-color-white g-bg-primary g-font-size-13 text-center text-uppercase g-rounded-50x g-top-10 g-right-0 g-px-2 g-py-10">-40%</span>
                            </figure>
