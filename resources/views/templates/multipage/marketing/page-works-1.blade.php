...
<head>
    <!-- Title -->
    <title>Multipage - Marketing Works Page | Unify - Responsive Website Template</title>
    ...
    <main>
        ...
        <div class="g-min-height-450 g-flex-centered g-bg-img-hero g-bg-pos-top-center g-bg-size-cover g-pt-80"
            ...
            <div class="container g-pos-rel g-z-index-1">
                <span class="d-block text-uppercase g-color-primary g-font-weight-500 g-font-size-13 mb-4">More Than a
                    Look</span>
                <h2 class="h1 g-color-white g-font-size-60--lg mb-0">Unify Marketing Works</h2>
            </div>
        </div>
        <!-- End Promo Banner -->
        ...
        <div class="container">
            <div class="row g-pt-100 g-pb-30--lg">
                <div class="col-lg-6 g-mb-100">
                    ...
                    <div class="g-pos-rel">
                        <!-- Carousel -->
                        <div id="carouselCus2" class="js-carousel u-carousel-v12" data-infinite="true"
                            data-slides-show="1"
                        ...
                        <div class="g-pos-abs g-bottom-minus-30 g-right-0 g-right-minus-20--sm">
                            <a class="js-fancybox d-flex g-text-underline--none--hover" href="javascript:;"
                                ...
                                <span class="g-color-main g-font-weight-500 g-font-size-13 mt-auto mr-4">Watch
                                    Transforming Video</span>
                                <span
                ...
                <div class="col-lg-6 g-mb-100">
                    <div class="g-pl-40--lg">
                        <div class="mb-5">
                            <h3 class="mb-4">Transforming Uur World, the Campaign for Bancroft</h3>
                            <p class="g-line-height-2">Margaret Bancroft founded the nation's first private schools for
                                children with developmental disabilities in 1883 based on her ideals of altering
                                perceptions, valuing each person and respecting diversity.</p>
                        </div>

                        <!-- List of Related Topics -->
                        <h4 class="text-uppercase g-font-weight-600 g-font-size-13 mb-3">Related Topics</h4>

                        <ul class="list-inline mb-0">
                            <li class="list-inline-item g-py-12">
                                <a class="u-link-v5 g-brd-around g-brd-gray-light-v4 g-bg-secondary g-color-text g-color-main--hover g-bg-primary--hover g-font-weight-500 g-font-size-13 rounded g-px-20 g-py-8"
                                    href="#">Marketing</a>
                            </li>
                            <li class="list-inline-item g-py-12">
                                <a class="u-link-v5 g-brd-around g-brd-gray-light-v4 g-bg-secondary g-color-text g-color-main--hover g-bg-primary--hover g-font-weight-500 g-font-size-13 rounded g-px-20 g-py-8"
            ...
            <div class="row g-pt-100">
                    ...
                    <div class="g-pos-rel">
                        ...
                        <div class="g-pos-abs g-bottom-minus-30 g-right-0 g-right-minus-20--sm">
                            <a class="js-fancybox d-flex g-text-underline--none--hover" href="javascript:;"
                                ...
                                data-caption="Video Popup">
                                <span class="g-color-main g-font-weight-500 g-font-size-13 mt-auto mr-4">Watch
                                    Expanding Possibilities Video</span>
                                <span
                                    class="u-icon-v3 u-icon-size--lg g-color-white g-bg-primary g-bg-main--hover rounded g-pos-rel g-z-index-1 g-cursor-pointer">
                                    <i class="g-font-size-17 g-pos-rel g-left-2 fa fa-play"></i>
                                </span>
                ...
                <div class="col-lg-6 order-lg-1 g-mb-100">
                    <div class="g-pr-40--lg">
                        <div class="mb-5">
                            <h3 class="mb-4">Expanding Possibilities, the Campaign for Community College of Europe
                            </h3>
                            <p class="g-line-height-2">More and more students are enrolling in Community College of
                                Philadelphia to pursue their path to possibilities. As a result, the School's enrollment
                                has grown from 1,200 students in September 1965 to almost 34,000 today.</p>
                        </div>
            ...
            <div class="row g-pt-100 g-pb-30--lg">
                    ...
                    <div class="g-pos-rel">
                        ...
                        <div class="g-pos-abs g-bottom-minus-30 g-right-0 g-right-minus-20--sm">
                            <a class="js-fancybox d-flex g-text-underline--none--hover" href="javascript:;"
                                data-src="//www.youtube.com/embed/BNpiwOkKIJ8?autoplay=1" data-speed="350"
                                data-caption="Video Popup">
                                <span class="g-color-main g-font-weight-500 g-font-size-13 mt-auto mr-4">Watch Building
                ...
                <div class="col-lg-6 g-mb-100">
                    <div class="g-pl-40--lg">
                        <div class="mb-5">
                            <h3 class="mb-4">Building Community Together</h3>
                            <p class="g-line-height-2">YMCAs are important cornerstones of any community. Central Bucks
                                County in Pennsylvania is one of the fastest growing communities in its region. The
                                expanding population over 122 square miles is reason to ensure excellent youth programs,
                                day care facilities and health and fitness opportunities are available for every family.
                            </p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 g-mb-30">
                    ...
                    <article class="g-pos-rel">
                        ...
                        <div class="g-bg-white-gradient-opacity-v1 g-pos-abs g-bottom-0 g-left-0 g-right-0 g-pa-30">
                            <h3><a class="u-link-v5 g-color-white g-color-primary--hover" href="#">Learn how
                                    we're building a more diverse and inclusive Unify Marketing</a></h3>
                            <a class="u-link-v6 g-color-white g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3"
                                href="page-hire-us-1.html">
                                Read More
                ...
                <div class="col-lg-6 g-mb-30">
                    ...
                    <article class="g-pos-rel">
                        ...
                        <div class="g-bg-white-gradient-opacity-v1 g-pos-abs g-bottom-0 g-left-0 g-right-0 g-pa-30">
                            <h3><a class="u-link-v5 g-color-white g-color-primary--hover" href="#">Uncover the
                                    philosophy behind our employee benefits</a></h3>
                            <a class="u-link-v6 g-color-white g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3"
                                href="page-hire-us-1.html">
                                Read More
                                <span class="u-link-v6-arrow g-font-size-18">&rightarrow;</span>
        ...
        <div class="container g-pb-100">
            ...
            <div id="carouselCus3" class="js-carousel u-carousel-v12" data-infinite="true" data-is-thumbs="true"
