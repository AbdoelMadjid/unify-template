                        ...
                        <ul class="list-inline d-flex align-items-center g-mb-0">
                            ...
                            <li class="list-inline-item g-pos-rel ml-lg-auto">
                                <a id="language-dropdown-invoker"
                                    ...
                                    data-dropdown-target="#language-dropdown" data-dropdown-type="css-animation"
                            ...
                            <li class="list-inline-item g-pos-rel">
                                <a id="jump-to-dropdown-invoker"
                                    ...
                                    href="#" aria-controls="jump-to-dropdown" aria-haspopup="true"
                                    aria-expanded="false" data-dropdown-event="hover"
                                    data-dropdown-target="#jump-to-dropdown" data-dropdown-type="css-animation"
                                    data-dropdown-duration="0" data-dropdown-hide-on-scroll="true"
                                    data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
                                    Jump To
                                    <i class="g-ml-3 fa fa-angle-down"></i>
                    ...
                    <nav class="js-mega-menu navbar navbar-expand-lg g-px-0 g-py-5 g-py-0--lg">
                        ...
                        <div id="navBar" class="collapse navbar-collapse">
                            <ul class="navbar-nav align-items-lg-center g-py-30 g-py-0--lg ml-auto">
                                <!-- Pages - Mega Menu -->
                                <li class="nav-item hs-has-mega-menu" data-animation-in="fadeIn"
                ...
                <div class="col-lg-9 g-mb-50">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-4 g-mb-40">
                            <!-- Research Article -->
                            <article>
                                <img class="img-fluid g-mb-20" src="assets/img-temp/600x350/img16.jpg"
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            <!-- Research Article -->
                            <article>
                                <img class="img-fluid g-mb-20" src="assets/img-temp/600x350/img17.jpg"
                                    alt="Image Description">
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            <!-- Research Article -->
                            <article>
                                <img class="img-fluid g-mb-20" src="assets/img-temp/600x350/img18.jpg"
                                    alt="Image Description">
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            <!-- Research Article -->
                            <article>
                                <img class="img-fluid g-mb-20" src="assets/img-temp/600x350/img19.jpg"
                                    alt="Image Description">
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            <!-- Research Article -->
                            <article>
                                <img class="img-fluid g-mb-20" src="assets/img-temp/600x350/img22.jpg"
                                    alt="Image Description">
                        ...
                        <div class="col-6 col-md-4 g-mb-40">
                            <!-- Research Article -->
                            <article>
                                <img class="img-fluid g-mb-20" src="assets/img-temp/600x350/img23.jpg"
                                    alt="Image Description">
            ...
            <div class="container g-pt-100 g-pb-80">
                ...
                <div class="card-group d-block d-md-flex g-mx-minus-15">
                    <div class="card u-shadow-v36 g-brd-none g-mx-15 g-mb-30">
                        ...
                        <article>
                            <div class="g-pos-rel">
                                <img class="img-fluid" src="assets/img-temp/600x350/img20.jpg"
                                    alt="Image Description">
                    ...
                    <div class="card u-shadow-v36 g-brd-none g-mx-15 g-mb-30">
                        ...
                        <article>
                            <div class="g-pos-rel">
                                <img class="img-fluid" src="assets/img-temp/600x350/img10.jpg"
                                    alt="Image Description">
                                <a class="js-fancybox g-absolute-centered" href="javascript:;"
                                    data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350"
                                    data-caption="Video">
                    ...
                    <div class="card u-shadow-v36 g-brd-none g-mx-15 g-mb-30">
                        ...
                        <article>
                            <div class="g-pos-rel">
                                <img class="img-fluid" src="assets/img-temp/600x350/img21.jpg"
                                    alt="Image Description">
                                <a class="js-fancybox g-absolute-centered" href="javascript:;"
                                    data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350"
                                    data-caption="Video">
        ...
        <div class="container g-pt-100 g-pb-70">
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article>
                        <div class="g-pos-rel">
                            <img class="img-fluid mb-3" src="assets/img-temp/600x350/img2.jpg"
                                alt="Image Description">
                            <a class="js-fancybox g-absolute-centered" href="javascript:;"
                                data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350"
                                data-caption="Video">
                ...
                <div class="col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article>
                        <div class="g-pos-rel">
                            <img class="img-fluid mb-3" src="assets/img-temp/600x350/img11.jpg"
                                alt="Image Description">
                            <a class="js-fancybox g-absolute-centered" href="javascript:;"
                                data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350"
                                data-caption="Video">
