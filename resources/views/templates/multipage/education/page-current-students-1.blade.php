                   ...
                   "slidesToShow": 1
                        ...
                        <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                            <div class="g-width-150 g-height-150 mx-auto mb-4">
                                <img class="img-fluid u-info-v11-1-img rounded-circle"
                                    src="assets/img-temp/150x150/img1.jpg" alt="Image Description">
                            </div>
                            <div class="mb-5">
                    ...
                    <div class="js-slide g-mx-4 g-mb-8">
                        <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                            <div class="g-width-150 g-height-150 mx-auto mb-4">
                                <img class="img-fluid u-info-v11-1-img rounded-circle"
                                    src="assets/img-temp/150x150/img5.jpg" alt="Image Description">
                            </div>
                            <div class="mb-5">
                    ...
                    <div class="js-slide g-mx-4 g-mb-8">
                        <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                            <div class="g-width-150 g-height-150 mx-auto mb-4">
                                <img class="img-fluid u-info-v11-1-img rounded-circle"
                                    src="assets/img-temp/150x150/img4.jpg" alt="Image Description">
                            </div>
                            <div class="mb-5">
                    ...
                    <div class="js-slide g-mx-4 g-mb-8">
                        <div class="u-info-v11-1 g-bg-white text-center rounded g-px-40 g-py-50">
                            <div class="g-width-150 g-height-150 mx-auto mb-4">
                                <img class="img-fluid u-info-v11-1-img rounded-circle"
                                    src="assets/img-temp/150x150/img2.jpg" alt="Image Description">
                            </div>
                            <div class="mb-5">
