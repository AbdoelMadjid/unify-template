                ...
                <div class="row">
                    <div class="col-lg-7 g-mb-50">
                        ...
                        <div
                            ...
                            <iframe src="https://www.youtube.com/embed/FxiskmF16gU?rel=0&amp;showinfo=0"
            ...
            <div class="js-sticky-block container u-secondary-navigation u-shadow-v19 g-bg-white g-line-height-1_3 g-py-20 g-pos-abs g-top-0 g-left-0 g-right-0"
                ...
                <ul id="js-scroll-nav"
                    ...
                    <li class="nav-item g-brd-right--sm g-brd-gray-light-v4 g-color-primary--active">
                        <a href="#carouseDetails"
                            class="nav-link g-font-weight-500 g-font-size-default g-px-20">Course Details</a>
                    </li>
                    <li class="nav-item g-brd-right--sm g-brd-gray-light-v4 g-color-primary--active">
                    ...
                    <li class="nav-item g-brd-right--sm g-brd-gray-light-v4 g-color-primary--active">
                        <a href="#similarCourses"
                            class="nav-link g-font-weight-500 g-font-size-default g-px-20">Similar Courses</a>
                    </li>
