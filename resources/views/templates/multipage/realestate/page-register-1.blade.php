...
<body>
    ...
    <main>
        ...
        <div class="g-max-width-645 text-center g-pt-100 mx-auto g-mb-80">
            ...
            <p class="lead">Tailor your experience with England’s greatest property resource. Access the best market
                insights and comprehensive auction results.</p>
        </div>
        <!-- End Login - Heading -->
        ...
        <div class="container g-pb-30">
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 text-center g-mb-70">
                    ...
                    <p class="g-font-size-12">Please view our <a class="g-color-text g-text-underline"
                            href="#">Personal Information Collection Statement</a></p>
                </div>
