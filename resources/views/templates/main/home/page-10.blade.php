...
<body>
    <main>
        ...
        <!-- Promo Block -->
        <section
            class="g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after g-min-height-100vh g-flex-centered g-py-100"
            ...
            <div class="container g-color-white text-center g-z-index-1">
                ...
                <a class="js-go-to btn u-btn-outline-white g-color-white g-bg-white-opacity-0_1 g-color-black--hover g-bg-white--hover g-font-weight-600 text-uppercase g-rounded-50 g-px-30 g-py-13"
                    href="#!" data-target="#content">Get Started</a>
            </div>
        </section>
        <!-- End Promo Block -->
        ...
        <div class="row no-gutters g-brd-bottom--lg g-brd-gray-light-v4">
            <div class="col-lg-4 g-pa-60">
                ...
                <div class="text-center">
                    <span
                        class="d-inline-block u-icon-v3 u-icon-size--xl g-font-size-36 g-bg-primary g-color-white rounded-circle g-mb-20">
            ...
            <div class="container">
                <header class="text-center g-width-60x--md mx-auto g-mb-60">
                    <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                        <h2 class="h3 u-heading-v2__title g-color-gray-dark-v2 text-uppercase g-font-weight-600">About
                            Our Company</h2>
                    </div>
                    <p class="lead">Unify <strong>creative</strong> technology company providing key digital
                        services. Focused on helping our clients to build a <strong>successful</strong> business on web
                        and mobile.</p>
                </header>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-center g-pl-30--lg g-mb-50 g-mb-0--lg">
                        <p class="g-mb-30">Unify <strong>creative</strong> technology company providing key digital
                            services. Focused on helping our clients to build a <strong>successful</strong> business on
                            web and mobile.</p>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <ul class="list-unstyled g-color-gray-dark-v4 g-mb-30 g-mb-0--sm">
                                    <li class="d-flex g-mb-10">
                                        <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Based
                                        on Botostrap 4
                                    </li>
                                    <li class="d-flex g-mb-10">
                                    ...
                                    <li class="d-flex g-mb-10">
                                        <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Great
                                        SASS Architecture
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <ul class="list-unstyled g-color-gray-dark-v4">
                                    <li class="d-flex g-mb-10">
                                        <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Over
                                        2000+ UI Components
                                    </li>
                                    <li class="d-flex g-mb-10">
                                        <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i>
                                    ...
                                    <li class="d-flex g-mb-10">
                                        <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Over
                                        30+ Thematic Examples
                                    </li>
                                    <li class="d-flex g-mb-10">
                                        <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Comes
        ...
        <section class="g-bg-secondary g-py-100">
            <div class="container">
                <header class="text-center g-width-60x--md mx-auto g-mb-60">
                    <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                        <h2 class="h3 u-heading-v2__title g-color-gray-dark-v2 text-uppercase g-font-weight-600">Our
                            Pricing</h2>
                    </div>
                    <p class="lead">Unify <strong>creative</strong> technology company providing key digital
                        services. Focused on helping our clients to build a <strong>successful</strong> business on web
                    ...
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="row g-mr-20--md g-mb-30--lg">
                            <div class="col-lg-6 g-mb-40">
                                <i
                                    class="icon-finance-257 u-line-icon-pro d-block g-font-size-55 g-line-height-1 g-color-primary g-mb-15"></i>
                                <h4 class="h4 g-color-gray-dark-v2 g-mb-10">Best Index Funds</h4>
                                <p class="mb-0">Curabitur sit amet fringilla mi. Etiam ac massa sit amet nulla
                                    eleifend rutrum vitae non sem.</p>
                            </div>

                            <div class="col-lg-6 g-mb-40">
                                <i
                                    class="icon-finance-223 u-line-icon-pro d-block g-font-size-55 g-line-height-1 g-color-primary g-mb-15"></i>
                        ...
                        <div class="row g-mr-20--md">
                            <div class="col-lg-6 g-mb-40 g-mb-0--lg">
                                <i
                                    class="icon-finance-035 u-line-icon-pro d-block g-font-size-55 g-line-height-1 g-color-primary g-mb-15"></i>
                            ...
                            <div class="col-lg-6 g-mb-40 g-mb-0--lg">
                                <i
                                    class="icon-finance-114 u-line-icon-pro d-block g-font-size-55 g-line-height-1 g-color-primary g-mb-15"></i>
                    ...
                    <div class="col-lg-4 col-md-5">
                        ...
                        <article class="u-shadow-v25 g-bg-white text-center g-rounded-5">
                            ...
                            <div class="g-px-20 g-pt-20 g-pb-40">
                                ...
                                <a class="btn btn-xl u-btn-primary g-font-size-12 text-uppercase g-rounded-50 g-font-weight-600"
                                    href="#!">Order Now</a>
                            </div>
                            <!-- End Article Content -->
                        </article>
        ...
        <!-- Clients -->
        <section>
            <div class="js-carousel g-brd-top g-brd-bottom g-brd-gray-light-v4" data-autoplay="true"
                ...
                <div class="row">
                    <div class="col-lg-4 g-mb-60 g-mb-0--lg">
                        ...
                        <div class="g-brd-around g-brd-gray-light-v4 text-center rounded g-px-30 g-pb-30">
                            <span
                                class="u-icon-v3 u-icon-size--lg g-color-white g-bg-primary g-pull-50x-up rounded-circle">
                                <i class="icon-finance-167 u-line-icon-pro"></i>
                            </span>
                            <h3 class="h4 g-color-gray-dark-v2 g-mb-10">More Income</h3>
                            <p class="g-mb-15">Curabitur ut augue at mi eleifend lobortis. Ut tincidunt lacinia nisi
                                pharetra.</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 g-mb-50 g-mb-0--lg">
                        <!-- Testimonials -->
                        <blockquote class="lead u-blockquote-v1 rounded g-pl-60 g-pr-30 g-py-30 g-mb-40">Dear
                            Htmlstream team, I just bought the Unify template some weeks ago. The template is really
                            nice and offers quite a large set of options.</blockquote>
                        <div class="media">
                            <img class="d-flex align-self-center rounded-circle g-width-60 g-height-60 g-brd-around g-brd-3 g-brd-white mr-3"
                    ...
                    <div class="col-md-6">
                        <!-- Testimonials -->
                        <blockquote class="lead u-blockquote-v1 rounded g-pl-60 g-pr-30 g-py-30 g-mb-40">Hi there
                ...
                <div class="row">
                        ...
                        <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-bluegray-opacity-0_3--after">
                                <img class="img-fluid w-100 u-block-hover__main--zoom-v1"
                                    src="assets/img-temp/500x600/img1.jpg" alt="Image description">
                            </figure>
                            ...
                            <span
                                class="u-icon-v3 g-bg-black-opacity-0_5 g-bg-black--hover g-color-white g-rounded-50x g-cursor-pointer g-absolute-centered">
                            ...
                            <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                ...
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white g-color-white--hover" href="#!">Must be visited
                                        places in the USA - Florida Beaches</a>
                                </h3>
                    ...
                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                        ...
                        <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-bluegray-opacity-0_3--after">
                                <img class="img-fluid w-100 u-block-hover__main--zoom-v1"
                                    src="assets/img-temp/500x600/img2.jpg" alt="Image description">
                            </figure>
                            ...
                            <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                ...
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white g-color-white--hover" href="#!">Holidays are
                                        coming, prepare your gifts to your...</a>
                                </h3>
                    ...
                    <div class="col-lg-4">
                        ...
                        <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-bluegray-opacity-0_3--after">
                                <img class="img-fluid w-100 u-block-hover__main--zoom-v1"
                                    src="assets/img-temp/500x600/img3.jpg" alt="Image description">
                            </figure>
                            ...
                            <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                ...
                                <h3 class="h4 g-mt-10">
                                    <a class="g-color-white g-color-white--hover" href="#!">Best 10 breakfast
                                        receipts for your awesome morning day</a>
                                </h3>
