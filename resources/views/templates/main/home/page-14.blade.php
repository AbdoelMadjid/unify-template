...
<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>Home Page 14 | | Unify - Responsive Website Template</title>
                ...
                <div id="rev_slider_26_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;"
                    ...
                    <ul>
                        ...
                        <li data-index="rs-73" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption rev-btn  tp-resizeme" id="slide-73-layer-4"
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-73-layer-1"
                                ...
                                <img src="assets/img-temp/900x600/img5.jpg" alt=""
                                    data-ww="['1000px','1000px','800px','500px']"
                                    data-hh="['563px','563px','450','281']" width="1200" height="675"
                                    data-no-retina>
                            </div>
                        ...
                        <li data-index="rs-74" data-transition="fade" data-slotamount="default"
                            ...
                            <img src="assets/img/bg/transparent2.png"
                                ...
                                style='background:linear-gradient(120deg, #b7ebf6 0%, rgba(228, 97, 210, 0.7) 100%)'
                                alt="" data-bgposition="center center" data-bgfit="cover"
                                data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-74-layer-1"
                                ...
                                <img src="assets/img-temp/900x600/img6.jpg" alt=""
                                    data-ww="['1000px','1000px','800px','500px']"
                                    data-hh="['563px','563px','450px','281px']" width="1200" height="675"
                                    data-no-retina>
                            </div>
                            ...
                            <div class="tp-caption rev-btn  tp-resizeme" id="slide-74-layer-4"
                                ...
                                data-y="['middle','middle','middle','middle']"
                                data-voffset="['150','150','150','110']" data-width="none" data-height="none"
                ...
                <div class="row">
                    <div class="col-md-6 align-self-center g-mb-50--md g-mb-0--md">
                        <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
                            <h2 class="h1 u-heading-v2__title g-color-gray-dark-v2 text-uppercase g-font-weight-700">
                                We Are Unify Agency</h2>
                        </div>
                        ...
                        <a href="#!"
                            class="btn u-btn-primary u-shadow-v21 g-font-size-12 text-uppercase g-font-weight-600 g-rounded-50 g-py-15 g-px-25 g-mr-15 g-mb-10 g-mb-0--sm">
                    ...
                    <div class="col-md-6 align-self-center text-center g-overflow-hidden">
                        <img class="img-fluid w-75" src="assets/img-temp/350x600/img1.png" alt="Image Description"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 align-self-center">
                        <div class="u-heading-v2-3--bottom g-brd-white g-mb-30">
                            <h2 class="h1 u-heading-v2__title text-uppercase g-font-weight-700">Focused on Product
                            </h2>
                        </div>
                        ...
                        <a href="#!"
                            class="btn u-shadow-v21 g-bg-white-opacity-0_2 g-color-white g-brd-white--hover g-color-purple--hover g-bg-white--hover g-font-size-12 text-uppercase g-font-weight-600 g-rounded-50 g-py-15 g-px-25 g-mr-15 g-mb-10 g-mb-0--sm">
                            <i class="icon-wallet g-pos-rel g-top-1 g-mr-5"></i> Buy Full Version
                        </a>
                        <small class="d-block d-sm-inline-block g-color-white-opacity-0_8 g-font-size-12">*Exclusive
                            item on Wrapboostrap Marketpalce</small>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="g-bg-pink g-color-white g-py-100">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 align-self-center">
                        <div class="u-heading-v2-3--bottom g-brd-white g-mb-30">
                            <h2 class="h1 u-heading-v2__title text-uppercase g-font-weight-700">Our Vision and Mission
                            </h2>
                        </div>
                        ...
                        <a href="#!"
                            class="btn u-shadow-v21 g-bg-white-opacity-0_2 g-color-white g-brd-white--hover g-color-pink--hover g-bg-white--hover g-font-size-12 text-uppercase g-font-weight-600 g-rounded-50 g-py-15 g-px-25 g-mr-15 g-mb-10 g-mb-0--sm">
