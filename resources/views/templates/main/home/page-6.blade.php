...
<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>Home Page 6 | | Unify - Responsive Website Template</title>
    ...
    <main>
        ...
        <div class="container g-pt-100">
            <div class="row justify-content-center text-center g-mb-100">
                <div class="col-lg-8">
                    <h2 class="h1 g-color-black g-font-weight-600 mb-0">We are a
                        <span class="d-inline-block g-brd-bottom g-brd-2 g-brd-primary g-color-primary">creative</span>
                        studio focusing on culture, luxury,
                        <span class="d-inline-block g-brd-bottom g-brd-2 g-brd-primary g-color-primary">editorial</span>
                        &amp; art.
                    </h2>
                </div>
            </div>
            ...
            <ul id="filterControls" class="d-block list-inline text-center g-mb-50">
                <li class="list-inline-item cbp-filter-item g-color-black g-color-primary--active g-font-weight-600 g-font-size-13 text-uppercase pr-2 mb-2"
                    role="button" data-filter="*">Show All
                </li>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5 g-mb-50">
                        ...
                        <div class="u-heading-v6-2 g-mb-60">
                            <h2 class="u-heading-v6__title g-color-black g-font-weight-600 g-mb-30">The Benefits<br>of
                                Using Unify Template
                            </h2>
                            <p class=" g-pl-90">The time has come to bring those ideas and plans to life. This is
                                where we really begin to visualize your napkin sketches and make them into beautiful
                                pixels.</p>
                        </div>
                        <!-- End Heading -->
                    </div>
        ...
        <div class="g-bg-secondary">
            <div class="container g-pt-100 g-pb-70">
                <div class="u-heading-v6-2 text-center g-mb-60">
                    <span class="d-block g-color-gray-dark-v4 g-font-weight-600 g-font-size-13 text-uppercase">Follow
                        the</span>
                    <h2 class="h1 u-heading-v6__title g-brd-black g-color-black g-font-weight-600 mb-0">Daily News
                    </h2>
                </div>
            ...
            <div class="container g-pos-rel g-z-index-1 g-pt-50 g-pb-30">
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-8 g-mb-20">
                        ...
                        <h2 class="g-color-white g-font-weight-700 text-uppercase mb-0">The best people for your
                            project?</h2>
                    </div>

                    <div class="col-lg-4 text-right g-mb-20">
                        <a class="btn u-btn-outline-white g-brd-2 g-font-weight-700 g-font-size-13 g-rounded-50 text-uppercase g-py-15 g-px-30"
        ...
        <section class="container g-py-100">
            <div class="u-heading-v6-2 text-center g-mb-60">
                <span class="d-block g-color-gray-dark-v4 g-font-weight-600 g-font-size-13 text-uppercase">Our
                    valuable</span>
        ...
        <!-- Mock-Up -->
        <div class="text-center g-pos-rel g-overflow-hidden g-pt-100 g-pb-200"
            style="background-image: url(assets/img-temp/1920x1080/img14.jpg);">
            <div class="g-pos-rel g-z-index-1 g-pb-100--lg g-mb-100--lg">
                <h2 class="h2 g-color-black g-font-weight-600 g-font-size-40--md text-uppercase mb-5">We are
                    <span class="g-color-primary">Unify</span> Team
                </h2>
                <a class="btn u-btn-outline-primary g-brd-2 g-font-weight-700 g-font-size-13 g-rounded-50 text-uppercase g-py-15 g-px-30"
                    href="#!">Start a project</a>
            </div>

            <div class="g-pos-abs g-bottom-0 g-left-0" data-animation="fadeInUp" data-animation-delay="100"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img13.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-bottom-0 g-right-0" data-animation="fadeInUp" data-animation-delay="300"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img14.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-bottom-0 g-left-0" data-animation="fadeInUp" data-animation-delay="600"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img15.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-bottom-0 g-left-0" data-animation="fadeInUp" data-animation-delay="800"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img16.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-bottom-0 g-left-0" data-animation="fadeInUp" data-animation-delay="1000"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img17.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-bottom-0 g-left-0" data-animation="fadeInUp" data-animation-delay="1200"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img18.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-bottom-0 g-left-0" data-animation="fadeInUp" data-animation-delay="1400"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img19.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-top-0 g-right-0" data-animation="fadeInDown" data-animation-delay="1900"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img20.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-top-0 g-right-0" data-animation="fadeInDown" data-animation-delay="1700"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img21.png" alt="Image Description">
            </div>
            <div class="g-pos-abs g-top-0 g-left-0" data-animation="fadeInLeft" data-animation-delay="2000"
                data-animation-duration="1200">
                <img class="img-fluid" src="assets/img-temp/1920x800/img22.png" alt="Image Description">
            </div>
        </div>
        <!-- End Mock-Up -->
        ...
        <div class="container text-center g-py-30">
            <p class="g-color-gray-dark-v4 g-font-size-13 mb-0">2017 © Htmlstream. All Rights Reserved.</p>
        </div>
