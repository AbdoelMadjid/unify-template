    ...
    <main>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe src="//player.vimeo.com/video/47911018" width="530" height="300"
                ...
                <div class="row no-gutters">
                    <div class="col-lg-4 g-px-40 g-mb-50 g-mb-0--lg">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="h5 g-color-gray-dark-v2 g-font-weight-600 text-uppercase mb-3">Beautiful
                                Designs</h3>
                    ...
                    <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40 g-mb-50 g-mb-0--lg">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="h5 g-color-gray-dark-v2 g-font-weight-600 text-uppercase mb-3">Unique Features
                            </h3>
                            <p class="mb-0">We strive to embrace and drive change in our industry which allows us to
                                keep our clients relevant.</p>
                        </div>
                    ...
                    <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-px-40">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="h5 g-color-gray-dark-v2 g-font-weight-600 text-uppercase mb-3">Reliable Support
                            </h3>
                            <p class="mb-0">We strive to embrace and drive change in our industry which allows us to
                                keep our clients relevant.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-50 g-mb-0--lg">
                        ...
                        <div class="u-shadow-v28 g-bg-white text-left text-md-center rounded g-py-40">
                            ...
                            <header class="text-center g-px-30 mb-5">
                                <div class="g-mb-25">
                                    <span
                                        class="u-icon-v2 u-icon-size--md g-brd-gray-light-v4 g-color-primary rounded-circle">
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-50 g-mb-0--lg">
                        ...
                        <div class="u-shadow-v29 g-bg-primary text-left text-md-center rounded g-py-40">
                            ...
                            <header class="text-center g-px-35 mb-5">
                                ...
                                <p class="g-color-white-opacity-0_9 g-font-size-13">Now that we've aligned the
                                    details, it's time to get things organized.</p>
                            </header>
                            <!-- End Services - Header -->
                        ...
                        <article class="u-block-hover u-shadow-v21 rounded">
                            <figure class="u-bg-overlay g-bg-black-opacity-0_4--after">
                                <img class="img-fluid w-100 u-block-hover__main--zoom-v1"
                                    src="assets/img-temp/400x270/img17.jpg" alt="Image description">
                            </figure>
        ...
        <section class="dzsparallaxer auto-init height-is-based-on-content use-loading"
            ...
            <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-img-hero g-bg-white-opacity-0_7--after"
                style="height: 140%; background-image: url(assets/img-temp/1920x1080/img7.jpg);"></div>
            <!-- End Parallax Image -->
        ...
        <section class="g-py-100">
            <div class="container">
                <header class="text-center g-width-60x--md mx-auto g-mb-50">
                    ...
                    <p class="g-font-size-16">Unify creative technology company providing key digital services. Keep
                        in touch with our support team to get the latest updates from us.</p>
                </header>
                ...
                <div class="row">
                        ...
                        <article class="u-shadow-v21 g-bg-white rounded">
                            <div class="g-pa-30">
                                <h3 class="g-font-weight-300 g-mb-15">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Focused
                            ...
                            <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                                ...
                                <div class="media-body align-self-center">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Kathy
                                        Reyes</a>
                                </div>
                    ...
                    <div class="col-lg-4 g-mb-30">
                        ...
                        <article class="u-shadow-v21 g-bg-white rounded">
                            <div class="g-pa-30">
                                <h3 class="g-font-weight-300 g-mb-15">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">We build
                                        your website to realise your vision, project and more</a>
                                </h3>
                                <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                                    voluptatum deleniti atque corrupti quos dolores.</p>
                            </div>
                            ...
                            <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                                ...
                                <div class="media-body align-self-center">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">William
                                        Sh.</a>
                                </div>
                    ...
                    <div class="col-lg-4 g-mb-30">
                        ...
                        <article class="u-shadow-v21 g-bg-white rounded">
                            ...
                            <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                                ...
                                <div class="media-body align-self-center">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">James
                                        Doe</a>
                                </div>
