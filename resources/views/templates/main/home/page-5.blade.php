    ...
    <main>
        ...
        <section class="u-bg-overlay g-bg-img-hero g-bg-bluegray-opacity-0_3--after"
            ...
            <div class="container u-bg-overlay__inner text-center g-pt-150 g-pb-70">
                <div class="g-mb-100">
                    <span class="d-block g-color-white g-font-size-20 text-uppercase g-letter-spacing-5 mb-4">The
                        Exhibition of</span>
                    <h1
                    ...
                    <span class="d-block lead g-color-white g-letter-spacing-2">Examples of Our Branding
                        Projects</span>
                </div>
            ...
            <div class="container g-py-100">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="js-carousel text-center g-pt-60" data-infinite="true" data-autoplay="true"
                            data-fade="true" data-speed="5000">
                            <div class="js-slide">
                                <blockquote class="lead g-color-black g-font-size-22 g-line-height-2 mb-4">Dear
                                ...
                                <span class="d-block g-color-black g-font-size-17 mb-4">Katarina Ramirez,
                                    Designer</span>
                            ...
                            <div class="js-slide">
                                <blockquote class="lead g-color-black g-font-size-22 g-line-height-2 mb-4">Hi there
                                ...
                                <span class="d-block g-color-black g-font-size-17 mb-4">Sara Anderson,
                                    Developer</span>
                                <img class="d-inline-block g-width-60 g-height-60 g-brd-around g-brd-3 g-brd-white rounded-circle"
                ...
                <div class="cbp" data-animation="quicksand" data-x-gap="30" data-y-gap="30"
                 ...
                 {"width": 300, "cols": 1}
                    ...
                    <div class="cbp-item"
                        ...
                        <div class="u-block-hover g-parent">
                            <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                                src="assets/img-temp/600x450/img2.jpg" alt="Image description">
                            <div
                                ...
                                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                            href="assets/img-temp/600x450/img2.jpg">
                    ...
                    <div class="cbp-item"
                        ...
                        <div class="u-block-hover g-parent">
                            <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                                src="assets/img-temp/600x450/img3.jpg" alt="Image description">
                            <div
                                class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                            href="assets/img-temp/600x450/img3.jpg">
                                            <i class="icon-communication-017 u-line-icon-pro"></i>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="cbp-item"
                        ...
                        <div class="u-block-hover g-parent">
                            <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                                src="assets/img-temp/600x450/img4.jpg" alt="Image description">
                            <div
                                class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                            href="assets/img-temp/600x450/img4.jpg">
                                            <i class="icon-communication-017 u-line-icon-pro"></i>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="cbp-item"
                        ...
                        <div class="u-block-hover g-parent">
                            <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                                src="assets/img-temp/600x650/img1.jpg" alt="Image description">
                            <div
                                class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                            href="assets/img-temp/600x650/img1.jpg">
                                            <i class="icon-communication-017 u-line-icon-pro"></i>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="cbp-item"
                        ...
                        <div class="u-block-hover g-parent">
                            <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                                src="assets/img-temp/600x450/img5.jpg" alt="Image description">
                            <div
                                class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                            href="assets/img-temp/600x450/img5.jpg">
                                            <i class="icon-communication-017 u-line-icon-pro"></i>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="cbp-item"
                        ...
                        <div class="u-block-hover g-parent">
                            <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                                src="assets/img-temp/600x300/img1.jpg" alt="Image description">
                            <div
                                class="d-flex w-100 u-block-hover__additional--fade u-block-hover__additional--fade-in h-100 g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                                <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                            href="assets/img-temp/600x300/img1.jpg">
                                            <i class="icon-communication-017 u-line-icon-pro"></i>
                                        </a>
                                    </li>
                                </ul>
        ...
        <section class="container g-py-100">
            <div class="g-mb-50">
                <div class="d-flex justify-content-start g-brd-bottom g-brd-gray-light-v4 pb-5">
                    <div class="d-block">
                        ...
                        <span class="d-block g-font-weight-300 g-font-size-22 mr-4 g-mb-6">See our latest News &amp;
                            Works on</span>
                    </div>
            ...
            <div class="cbp" data-controls="#filterControls1" data-animation="quicksand" data-x-gap="30"
                data-y-gap="30"
                    ...
                    <div class="u-block-hover g-parent">
                        ...
                        <div
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="assets/img-temp/400x270/img2.jpg">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="u-block-hover g-parent">
                        ...
                        <div
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="assets/img-temp/400x270/img11.jpg">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
