...
<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>Home Page 15 | | Unify - Responsive Website Template</title>
...
<body>
    <main>
        ...
        <!-- Promo Block -->
        <div class="js-carousel g-bg-gray-dark-v1" data-infinite="true" data-autoplay="true" data-lazy-load="ondemand"
            data-speed="7000" data-center-mode="true" data-center-padding="200px" data-slides-show="3"
            ...
            <div class="js-slide g-py-10 g-px-5">
                <article class="u-block-hover">
                    <figure class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                        <img class="img-fluid w-100 height-100 u-block-hover__main--mover-up"
                            data-lazy="assets/img-temp/500x650/img1.jpg" alt="Image description">
                    </figure>
                    ...
                    <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                        ...
                        <h3 class="h3 g-font-weight-300 g-mb-20">
                            <a class="g-color-white g-color-white--hover" href="#!">Best work places around the
                                World for your company</a>
                        </h3>

                        <div class="media">
                            <div class="d-flex mr-3">
                                <img class="g-width-30 g-height-30 g-rounded-50x"
            ...
            <div class="js-slide g-py-10 g-px-5">
                <article class="u-block-hover">
                    <figure class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                        <img class="img-fluid w-100 u-block-hover__main--mover-up"
                            data-lazy="assets/img-temp/500x650/img7.jpg" alt="Image description">
                    </figure>
                    ...
                    <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                        ...
                        <h3 class="h3 g-font-weight-300 g-mb-20">
                            <a class="g-color-white g-color-white--hover" href="#!">Top 10 bust be used iOS
                                apps for your next project</a>
                        </h3>
            ...
            <div class="js-slide g-py-10 g-px-5">
                <article class="u-block-hover">
                    <figure class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                        <img class="img-fluid w-100 u-block-hover__main--mover-up"
                            data-lazy="assets/img-temp/500x650/img2.jpg" alt="Image description">
                    </figure>
                    ...
                    <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                        ...
                        <h3 class="h3 g-font-weight-300 g-mb-20">
                            <a class="g-color-white g-color-white--hover" href="#!">Discussing the project
                                details is good step with team mates</a>
                        </h3>
            ...
            <div class="js-slide g-py-10 g-px-5">
                <article class="u-block-hover">
                    <figure class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                        <img class="img-fluid w-100 height-100 u-block-hover__main--mover-up"
                            data-lazy="assets/img-temp/500x650/img8.jpg" alt="Image description">
                    </figure>
            ...
            <div class="js-slide g-py-10 g-px-5">
                <article class="u-block-hover">
                    <figure class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                        <img class="img-fluid w-100 u-block-hover__main--mover-up"
                            data-lazy="assets/img-temp/500x650/img5.jpg" alt="Image description">
                    </figure>
                    ...
                    <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                        ...
                        <div class="media">
                            <div class="d-flex mr-3">
                                <img class="g-width-30 g-height-30 g-rounded-50x"
                                    data-lazy="assets/img-temp/100x100/img6.jpg" alt="Image description">
                            </div>
                            <div class="media-body align-self-center g-color-white">
                                <p class="mb-0">John Reyes</p>
                            </div>
            ...
            <div class="js-slide g-py-10 g-px-5">
                <article class="u-block-hover">
                    <figure class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                        <img class="img-fluid w-100 u-block-hover__main--mover-up"
                            data-lazy="assets/img-temp/500x650/img6.jpg" alt="Image description">
                    </figure>
        ...
        <section class="g-pt-70 g-py-100">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 g-mb-50 g-mb-0--lg">
                        ...
                        <article class="g-mb-50">
                            <figure class="g-pos-rel">
                                <img class="img-fluid w-100 g-mb-20" src="assets/img-temp/600x450/img1.jpg"
                            ...
                            <div class="g-pos-rel px-4">
                                <ul
                                    class="d-flex justify-content-start align-items-end list-inline g-color-gray-dark-v5 g-font-size-13 g-mt-minus-45 g-mb-20">
                                ...
                                <h2 class="h4">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">All
                                        about black Apple product</a>
                                </h2>

                                <p class="g-color-gray-dark-v4">Clark Valberg is the founder and CEO of InVision. If
                                    you are a designer, you have probably gotten an email from Clark or from InVision at
                                    one time or another, but if you’re not familiar with the company.</p>
                        ...
                        <div class="row g-mb-50">
                            <div class="col-lg-6 g-mb-30 g-mb-0--lg">
                                ...
                                <article>
                                    <figure class="g-pos-rel">
                                        <img class="img-fluid w-100 g-mb-20" src="assets/img-temp/400x270/img5.jpg"
                                            alt="Image description">
                                    ...
                                    <h3 class="h4 g-mb-10">
                                        <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">We
                                            Love Education</a>
                                    </h3>
                            ...
                            <div class="col-lg-6">
                                ...
                                <article>
                                    <figure class="g-pos-rel">
                                        <img class="img-fluid w-100 g-mb-20" src="assets/img-temp/400x270/img9.jpg"
                                            alt="Image description">
                        ...
                        <article class="g-mb-50">
                            <figure class="g-pos-rel">
                                <img class="img-fluid w-100 g-mb-20" src="assets/img-temp/600x450/img7.jpg"
                                    alt="Image description">
                            ...
                            <div class="g-pos-rel px-4">
                                ...
                                <p class="g-color-gray-dark-v4">At Wake, our mission has always been focused on
                                    bringing openness and transparency to the design process. We’ve always believed that
                                    by providing a space where designers can share ongoing work not only empowers them
                                    to make better products.</p>
                        ...
                        <article class="row align-items-center g-mb-30">
                            <div class="col-md-6 g-mb-30 g-mb-0--lg">
                                <figure class="g-pos-rel">
                                    <img class="img-fluid w-100" src="assets/img-temp/400x270/img6.jpg"
                                        alt="Image description">
                        ...
                        <article class="g-mb-50">
                            <figure class="g-pos-rel">
                                <img class="img-fluid w-100 g-mb-20" src="assets/img-temp/600x450/img8.jpg"
                                    alt="Image description">
                            ...
                            <div class="g-pos-rel px-4">
                                ...
                                <h2 class="h4">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">In the
                                        future, design principles won’t be about design</a>
                                </h2>

                                <p class="g-color-gray-dark-v4">In an attempt to answer those questions, I poured over
                                    the biggest collections of design principles on the internet [1][2], and came to the
                                    following conclusion: corporate design principles are a set of shared guidelines
                                    that reflect the
                    ...
                    <div class="col-lg-4">
                        <!-- Subscribe -->
                        <div class="u-bg-overlay g-bg-img-hero g-bg-white-gradient-opacity-v2--after g-pa-50 g-pt-100 g-mb-50"
                            style="background-image: url(assets/img-temp/500x600/img4.jpg);">
                            <div class="u-bg-overlay__inner text-center">
                                ...
                                <div class="input-group rounded">
                                    <input class="form-control border-0 g-px-13" type="email"
                        ...
                        <div class="g-mb-30">
                            ...
                            <article class="media g-mb-30">
                                <a class="d-flex mr-3" href="#!">
                                    <img class="rounded-circle g-width-60 g-height-60"
                                        src="assets/img-temp/100x100/img8.jpg" alt="Image description">
                                </a>

                                <div class="media-body">
                                    <h3 class="h6">
                                        <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">Best
                                            dessert recipes for breakfast which will make your
                                            day</a>
                                    </h3>
                            ...
                            <article class="media g-mb-30">
                                ...
                                <div class="media-body">
                                    <h3 class="h6">
                                        <a class="u-link-v5 g-color-black g-color-primary--hover"
                                            href="#!">Government plans to test new primary school pupils and
                                            teachers..</a>
                                    </h3>
                            ...
                            <article class="media">
                                ...
                                <div class="media-body">
                                    <h3 class="h6">
                                        <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">Top
                        ...
                        <div id="stickyblock-start">
                            <div class="js-sticky-block g-sticky-block--lg g-pt-20" data-type="responsive"
                                    ...
                                    <ul class="list-unstyled g-font-size-13 mb-0">
                                        <li class="media g-mb-35">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="g-color-gray-dark-v4">This is where we sit down, grab a cup
                                                    of coffee and dial in the details.</p>
        ...
        <footer class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll">
            <!-- Parallax Image -->
            <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_8--after g-bg-img-hero"
                style="height: 140%; background-image: url(assets/img-temp/1920x1080/img1.jpg);"></div>
            <!-- End Parallax Image -->
            ...
            <div class="container u-bg-overlay__inner g-color-white-opacity-0_8 g-pt-60 g-mb-60">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                        ...
                        <div class="g-mb-30">
                            <p>Unify is an ultra fully responsive template with modern and design and awesome features.
                            </p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                        ...
                        <article class="media">
                            <a class="d-flex g-mt-3 mr-3" href="#!">
                                <img class="g-width-60 g-height-60" src="assets/img-temp/100x100/img6.jpg"
                                    alt="Image description">
                            </a>

                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-white-opacity-0_8 g-color-white--hover" href="#!">Top 7
                                        luxury places to visit around Victoria, BC</a>
                                </h3>
                        ...
                        <article class="media">
                            <a class="d-flex g-mt-3 mr-3" href="#!">
                                <img class="g-width-60 g-height-60" src="assets/img-temp/100x100/img5.jpg"
                                    alt="Image description">
                            </a>

                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-white-opacity-0_8 g-color-white--hover" href="#!">Coding
                                        week, 10 best premium templates</a>
                                </h3>
                        ...
                        <article class="media">
                            <a class="d-flex g-mt-3 mr-3" href="#!">
                                <img class="g-width-60 g-height-60" src="assets/img-temp/100x100/img4.jpg"
                                    alt="Image description">
                            </a>

                            <div class="media-body">
                                <h3 class="h6">
                                    <a class="g-color-white-opacity-0_8 g-color-white--hover" href="#!">Top 10
                                        luxury hotels - 5 star cozy rooms</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="g-mb-30">
                            ...
                            <div class="input-group border-0 rounded">
                                <input class="form-control border-0 g-pa-12" type="email"
                                    placeholder="Email address">
                                <div class="input-group-btn p-0">
                                    <button class="btn u-btn-primary g-pa-12" type="submit"
                        ...
                        <p>Follow us if you want to be kept up to date about what’s going on, minute by minute, then
                            search for htmlstream and give us a follow!</p>
            ...
            <div class="u-bg-overlay__inner g-bg-black-opacity-0_3 g-color-white-opacity-0_8 text-center g-py-20">
                <div class="container">
                    <small class="g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017 © All Rights Reserved. Unify
                        Template by
