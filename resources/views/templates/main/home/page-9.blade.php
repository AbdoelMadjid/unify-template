...
<body>
    <main>
                ...
                <div id="rev_slider_1174_1" class="rev_slider fullscreenbanner" style="display:none;"
                    ...
                    <ul>
                        ...
                        <li data-index="rs-3238" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="assets/img/bg/transparent.png" data-bgcolor="#f9f9f9" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-8" id="slide-3238-layer-4"
                                ...
                                <img src="assets/img-temp/650x500/img1.png" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-9" id="slide-3238-layer-5"
                                ...
                                <img src="assets/img-temp/700x600/img1.png" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-10" id="slide-3238-layer-6"
                                ...
                                data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]" style="z-index: 7;border-width:0px;">
                                <img src="assets/img-temp/900x1000/img1.png" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-12" id="slide-3238-layer-9"
                                ...
                                <img src="assets/img-temp/200x300/img1.png" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-11" id="slide-3238-layer-10"
                                ...
                                data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]" style="z-index: 9;border-width:0px;">
                                <img src="assets/img-temp/300x400/img1.png" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-12" id="slide-3238-layer-11"
                                ...
                                <img src="assets/img-temp/50x100/img1.png" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-9" id="slide-3238-layer-7"
                                ...
                                <img src="assets/img-temp/730x520/img1.png" alt=""
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-11" id="slide-3238-layer-8"
                                ...
                                <img src="assets/img-temp/300x500/img1.png" alt=""
                                    data-ww="['300px','300px','300px','300px']"
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-3238-layer-1"
                                ...
                                data-voffset="['-70','-70','-70','-90']" data-fontsize="['80','80','80','40']"
                                ...
                                style="z-index: 14; white-space: nowrap; font-size: 80px; line-height: 80px; font-weight: 700; color: rgba(0, 0, 0, 1.00);border-width:0px;">
                                Be Inspired.
                            </div>
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-3238-layer-15"
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]"
                                style="z-index: 15; white-space: nowrap; font-size: 80px; line-height: 80px; font-weight: 700; color: rgba(0, 0, 0, 1.00);border-width:0px;">
                                Be Brave.
                            </div>
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-3238-layer-16"
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]"
                                style="z-index: 16; white-space: nowrap; font-size: 80px; line-height: 80px; font-weight: 700; color: rgba(0, 0, 0, 1.00);border-width:0px;">
                                Start Creating.
                            </div>
                            ...
                            <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-3238-layer-2"
                                ...
                                data-fontsize="['20','20','20','20']" data-lineheight="['20','20','20','30']"
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]"
                                style="z-index: 17; white-space: nowrap; font-size: 20px; line-height: 20px; font-weight: 400; color: rgba(68, 68, 68, 1.00); border-width: 0;">
                                We are a creative studio focusing on culture, luxury, editorial &amp; art.
                            </div>

                            <!-- LAYER NR. 14 -->
                            <div class="tp-caption rev-btn g-bg-primary rs-parallaxlevel-3" id="slide-3238-layer-3"
                                data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                ...
                                style="z-index: 18; white-space: nowrap; font-size: 14px; color: rgba(255, 255, 255, 1.00); border-color:rgba(0, 0, 0, 1.00);border-width:0px;border-radius:50px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">
                                CONTINUE
                            </div>
                ...
                <div class="col-lg-4 g-mb-30">
                    ...
                    <div class="media g-mb-15">
                        ...
                        <div class="media-body">
                            ...
                            <a class="g-color-main g-color-primary--hover g-font-weight-600 g-font-size-12 g-text-underline--none--hover text-uppercase"
                                href="#!">Learn More</a>
                        </div>
                    </div>
                    <!-- End Icon Blocks -->
            ...
            <div class="container g-pt-100 g-pb-70">
                <div class="row justify-content-between">
                    <div class="col-lg-5 g-mb-30">
                        <div class="mb-2">
                            <div
                                class="d-inline-block g-width-30 g-height-2 g-pos-rel g-top-minus-4 g-bg-primary mr-2">
                            </div>
                            <span
                        ...
                        <div id="carouselCus1" class="js-carousel js-carousel_single-item-thumbs5__slides g-pb-35"
                            data-infinite="true" data-fade="true" data-lazy-load="progressive"
                            data-animation="linear" data-pagi-classes="u-carousel-indicators-v1 g-bottom-0">
                            <div class="js-slide">
                                <p class="g-font-style-italic g-font-size-17 mb-4">Dear Htmlstream team, I just bought
                                    the Unify template some weeks ago. The template is really nice and offers quite a
                                    large set of options.</p>
                                <div class="media">
                                    <img class="d-flex align-self-center g-brd-around g-brd-3 g-brd-white g-width-50 g-height-50 rounded-circle mr-3"
                                        data-lazy="assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                    <div class="media-body align-self-center">
                                        <h4
                                            class="g-color-black g-font-weight-600 g-font-size-13 text-uppercase g-mb-0">
                                            Daniel Ramirez</h4>
                                        <span class="d-block g-color-gray-dark-v4 g-font-size-12">Lead Designer,
                                            Google Inc.</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="js-slide">
                                <p class="g-font-style-italic g-font-size-17 mb-4">Hi there purchased a couple of days
                                    ago and the site looks great, big thanks to the htmlstream guys, they gave me some
                                    great help with some fiddly setup issues.</p>
                                <div class="media">
                                    <img class="d-flex align-self-center g-brd-around g-brd-3 g-brd-white g-width-50 g-height-50 rounded-circle mr-3"
                                        data-lazy="assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                    <div class="media-body align-self-center">
                                        <h4
                                            class="g-color-black g-font-weight-600 g-font-size-13 text-uppercase g-mb-0">
                                            Sara Anderson</h4>
                            ...
                            <div class="js-slide">
                                <p class="g-font-style-italic g-font-size-17 mb-4">I'm very impressed with the theme
                                    and customer support! Thanks</p>
                                <div class="media">
                                    <img class="d-flex align-self-center g-brd-around g-brd-3 g-brd-white g-width-50 g-height-50 rounded-circle mr-3"
                                        data-lazy="assets/img-temp/100x100/img4.jpg" alt="Image Description">
                                    <div class="media-body align-self-center">
                                        <h4
                                            class="g-color-black g-font-weight-600 g-font-size-13 text-uppercase g-mb-0">
                                            Alisa Gomez</h4>
                                        <span class="d-block g-color-gray-dark-v4 g-font-size-12">HR, Airbnb
                                            Inc.</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 g-mt-50 g-mb-30">
                        <!-- Article -->
                        <article
                            class="u-shadow-v21 u-shadow-v21--hover g-pos-rel g-bg-white g-transition-0_3 g-pa-10 rounded">
                            <img class="img-fluid w-100" src="assets/img-temp/500x320/img1.jpg"
                    ...
                    <article>
                        ...
                        <div class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-30 g-mt-minus-50 mx-auto">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">At Wake, our mission has always been
                                focused on bringing openness and transparency.</p>
                ...
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    ...
                    <article>
                        ...
                        <div class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-30 g-mt-minus-50 mx-auto">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">Clark Valberg is the founder and CEO of
                                InVision. If you are a designer...</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
                        </div>
                    </article>
                    <!-- End Blog Grid Overlap Blocks -->
                ...
                <div class="col-sm-6 col-lg-4 g-mb-30">
                    ...
                    <article>
                        ...
                        <div class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-30 g-mt-minus-50 mx-auto">
                            ...
                            <h2 class="h5 g-color-black g-font-weight-600 mb-3">
                                <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer"
                                    href="#!">A UX strategy for the Ultimate Product Launch</a>
                            </h2>
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">In an attempt to answer those questions,
                                I poured over the biggest collections of design.</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
                        </div>
                    </article>
                    <!-- End Blog Grid Overlap Blocks -->
        ...
        <div class="container-fluid g-px-4 g-mb-4">
            <div class="cbp" data-controls="#filterControls1" data-animation="quicksand" data-x-gap="5"
                data-y-gap="5"
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="assets/img-temp/400x270/img8.jpg">
                    ...
                    <div class="u-block-hover g-parent">
                        ...
                        <div
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="assets/img-temp/400x270/img9.jpg">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="u-block-hover g-parent">
                        ...
                        <div
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="assets/img-temp/400x270/img10.jpg">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="cbp-item identity">
                    <div class="u-block-hover g-parent">
                        <img class="img-fluid g-transform-scale-1_1--parent-hover g-transition-0_5 g-transition--ease-in-out"
                            src="assets/img-temp/400x270/img12.jpg" alt="Image description">
                        <div
                            class="d-flex w-100 h-100 u-block-hover__additional--fade u-block-hover__additional--fade-in g-bg-bluegray-opacity-0_5 opacity-0 g-opacity-1--parent-hover g-pos-abs g-top-0 g-left-0 g-transition-0_3 g-transition--ease-in g-pa-20">
                            <div class="d-flex align-items-start flex-column mb-auto">
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="assets/img-temp/400x270/img12.jpg">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="u-block-hover g-parent">
                        ...
                        <div
                            ...
                            <ul class="align-items-end flex-column list-inline mt-auto ml-auto mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a class="cbp-lightbox u-icon-v2 u-icon-size--sm g-brd-white g-color-black g-bg-white rounded-circle"
                                        href="assets/img-temp/400x270/img16.jpg">
                                        <i class="icon-communication-017 u-line-icon-pro"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-lg-5 g-mb-30">
                        <div class="mb-2">
                            ...
                            <span
                                class="g-color-gray-dark-v3 g-font-weight-600 g-font-size-12 text-uppercase">About</span>
                        </div>

                        <div class="mb-5">
                            <h2 class="h1 g-color-black g-font-weight-600 g-mb-35"><span
                                    class="g-color-primary">What</span> We<br>are
                                <span class="g-color-primary">Good</span> at
                            </h2>
                            <p>We are a creative studio focusing on culture, luxury, editorial &amp; art. Somewhere
                                between sophistication and simplicity.</p>
                            <p>As creatives, it's important that we strive to do work outside of obligation. This lets
                                us stay ahead of the curve for our clients and internal projects.</p>
                        </div>
                        <a class="btn u-btn-primary g-font-size-default text-uppercase g-rounded-50 g-py-12 g-px-30"
                            href="#!">Purchase Now</a>
                    </div>

                    <div class="col-lg-7 g-mb-30">
                        <img class="img-fluid w-100 mb-4" src="assets/img-temp/600x360/img1.png"
                            alt="Image Description">
                    </div>
                </div>
            </div>
                    ...
                    <div class="u-info-v6-1">
                                ...
                                <div
                                    ...
                                    <ul class="list-inline text-center g-flex-middle-item">
                                        <li class="list-inline-item align-middle g-mx-3">
                                            <a class="u-icon-v2 g-width-35 g-height-35 g-color-white g-color-black--hover g-brd-white g-bg-white--hover g-font-size-default rounded-circle"
                                                href="#!">
                        ...
                        <div class="g-bg-white g-pt-25">
                            <div class="g-mb-15">
                                ...
                                <em
                                    class="d-block u-info-v6-1__item g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Technical
                                    Director</em>
                            </div>
                    ...
                    <div class="u-info-v6-1">
                        ...
                        <div class="g-bg-white g-pt-25">
                            <div class="g-mb-15">
                                ...
                                <em
                                    class="d-block u-info-v6-1__item g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Lead
                                    Designer</em>
                            </div>
                    ...
                    <div class="u-info-v6-1">
                        ...
                        <div class="g-bg-white g-pt-25">
                            <div class="g-mb-15">
                                ...
                                <em
                                    class="d-block u-info-v6-1__item g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Web
                                    Developer</em>
                            </div>
                    ...
                    <div class="u-info-v6-1">
                        ...
                        <div class="g-bg-white g-pt-25">
                            <div class="g-mb-15">
                                ...
                                <em
                                    class="d-block u-info-v6-1__item g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Support
                                    Manager</em>
                            </div>
            ...
            <div class="container text-center g-py-100">
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        ...
                        <a class="btn btn-md u-btn-outline-black g-font-size-default text-uppercase g-rounded-50 g-py-12 g-px-30 mx-1 g-mb-20"
                            href="#!">Explore More</a>
                        <a class="btn btn-md u-btn-primary g-font-size-default text-uppercase g-rounded-50 g-py-12 g-px-30 mx-1 g-mb-20"
                            href="#!">Purchase Now</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                        ...
                        <p>About Unify dolor sit amet, consectetur adipiscing elit. Maecenas eget nisl id libero
                            tincidunt sodales.</p>
                        <p class="mb-0">Duis eleifend fermentum ante ut aliquam. Cras mi risus, dignissim sed
                            adipiscing ut, placerat non arcu.</p>
                    </div>
                    <!-- End Footer Content -->
