...
<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>Home Page 4 | | Unify - Responsive Website Template</title>
...
<body>
    <main>
        ...
        <section class="g-flex-centered g-bg-pos-center g-bg-img-hero g-py-150"
            style="background-image: url(assets/img-temp/1920x1080/img2.jpg);" data-calc-target="#js-header">
            <div class="container text-center g-z-index-1">
                <div class="g-mb-50" data-animation="fadeInUp" data-animation-delay="200"
                    data-animation-duration="1500">
                    <a class="js-fancybox-media rounded-circle u-icon-v2 g-font-size-20 g-color-white g-bg-black g-brd-black g-bg-primary--hover g-brd-primary--hover g-text-underline--none--hover"
                        href="javascript:;" data-src="//vimeo.com/36031564" data-speed="1000" data-animate-in="fadeIn"
        ...
        <section class="container g-py-100">
            ...
            <div class="row">
                <div class="col-md-3 g-mb-30">
                    ...
                    <div
                        class="d-inline-block g-width-70 g-height-2 g-bg-primary g-pos-rel g-top-5 g-right-minus-25 g-mr-minus-20">
                    </div>
                ...
                <div class="col-md-6 g-mb-30">
                    <img class="img-fluid" src="assets/img-temp/900x650/img1.png" alt="Image Description">
                </div>

                <div class="col-md-3 mt-auto g-mb-30">
                    <div
                        class="d-inline-block g-width-70 g-height-2 g-bg-brown g-pos-rel g-top-5 g-left-minus-25 g-mr-minus-20">
                    </div>
        ...
        <section class="container-fluid g-pa-20">
            <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_6--after"
                ...
                <div class="dzsparallaxer--target" style="width: 100%; height: 200%;" data-forcewidth_ratio="1.77">
                    <div class="js-bg-video g-pos-abs w-100 h-100" data-hs-bgv-type="vimeo"
            ...
            <div class="row no-gutters g-mx-minus-10">
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img7.png" alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img10.png" alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-10">
                    ...
                    <article class="u-block-hover">
                        ...
                        <div class="u-block-hover__additional--partially-slide-up text-center g-z-index-1 mt-auto">
                            <div class="u-block-hover__visible g-pa-25">
                                <span
                                    class="d-block g-color-white-opacity-0_7 g-font-weight-600 g-font-size-12 mb-2">photography</span>
                                <h2 class="h4 g-color-white g-font-weight-600 mb-3">
                                    <a class="u-link-v5 g-brd-bottom g-brd-2 g-brd-white--hover g-color-white g-cursor-pointer g-pb-2"
        ...
        <footer class="container g-pt-100 g-pb-60">
            <div class="row justify-content-end">
                ...
                <div class="col-sm-4 col-lg-2 g-mb-30">
                    ...
                    <ul class="list-unstyled g-color-gray-dark-v4 g-font-size-13 mb-0">
                        <li class="my-2"><i class="mr-2 fa fa-angle-right"></i>
                            <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">Support
                                &amp; FAQ</a>
                        </li>
                        <li class="my-2"><i class="mr-2 fa fa-angle-right"></i>
                            <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover" href="#!">Jobs</a>
                        </li>
                        <li class="my-2"><i class="mr-2 fa fa-angle-right"></i>
                ...
                <div class="col-sm-4 col-lg-2 g-mb-30">
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item g-mx-2">
                            <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-teal g-bg-teal-opacity-0_1 g-color-teal--hover rounded-circle"
                                href="#!">
                        ...
                        <li class="list-inline-item g-mx-2">
                            <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-purple g-bg-purple-opacity-0_1 g-color-purple--hover rounded-circle"
                                href="#!">
