...
<body>
    <main>
            ...
            <div class="g-absolute-centered--y g-left-0 g-right-0">
                <div class="container g-z-index-1">
                    <div class="g-max-width-600">
                        <h1 class="g-color-white g-font-weight-700 g-font-size-40 g-font-size-60--md g-mb-30">Unify
                            Agency</h1>
                        <p class="h3 g-color-white g-font-weight-300 g-letter-spacing-1 mb-5">We are a creative studio
                            focusing on culture, luxury, editorial &amp; art. Somewhere between sophistication and
                            simplicity.</p>
                    </div>
                ...
                <article class="row">
                    ...
                    <div class="col-lg-6 g-mb-30">
                        <header class="u-heading-v6-2 g-mb-20">
                            ...
                            <h3
                                class="u-heading-v6__title g-color-gray-dark-v2 g-brd-primary text-uppercase g-font-weight-600 g-mb-15">
                                Quality results with us</h3>
                        </header>

                        <div class="g-pl-90--sm">
                            <p class="lead g-mb-40">Etiam dolor tortor, egestas a libero eget, sollicitudin maximus
                                nulla. Nunc vitae maximus ipsum. Vestibulum sodales nisi massa, vitae blandit massa
                                luctus id.</p>

                            <div class="d-flex">
                                <!-- Video Bock -->
                                <div class="u-shadow-v21 g-bg-img-hero g-pos-rel g-height-160 g-width-300 rounded"
                                    ...
                                    <a class="js-fancybox-media g-absolute-centered" href="javascript:;"
                                        data-src="//vimeo.com/167434033" data-speed="1000" data-animate-in="flipInX"
                                ...
                                <div
                                    class="align-self-center g-color-gray-dark-v2 text-uppercase g-font-weight-600 g-px-40">
                    ...
                    <div class="col-lg-6 align-self-center">
                        <img class="img-fluid w-100 u-shadow-v21 rounded" src="assets/img-temp/900x600/img3.jpg"
        ...
        <section class="text-center">
            <!-- Testimonials -->
            <div class="row align-items-stretch no-gutters g-bg-black-opacity-0_9 g-min-height-80vh"
                style="background-image: url('assets/img/bg/pattern3.png');">
                <div class="col-lg-6 g-bg-img-hero g-min-height-400"
                    style="background-image: url('assets/img-temp/900x900/img3.jpg');"></div>

                <div class="col-lg-6 align-self-center g-pa-100">
                    <img class="g-width-70 g-height-70 g-brd-3 g-brd-style-solid g-brd-white rounded-circle g-mb-30"
                        src="assets/img-temp/100x100/img5.jpg" alt="Image Description">

                    <blockquote class="u-blockquote-v3 g-color-white g-font-size-22 g-mb-30">Everyone knows that
                        debugging is twice as hard as writing a program in the first place. So if you're as clever as
                        you can be when you write it, how will you ever debug it.</blockquote>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-4 g-bg-pink g-color-white text-center g-pa-60">
                    ...
                    <p class="g-color-white-opacity-0_8 g-font-size-16 g-mb-20">We strive to embrace and drive change
                        in our industry which allows us to keep our clients relevant.</p>
                    <a class="btn u-shadow-v21 g-bg-white-opacity-0_2 g-color-white g-brd-white--hover g-color-pink--hover g-bg-white--hover g-font-size-12 text-uppercase g-font-weight-600 g-rounded-50 g-py-12 g-px-20"
                        href="#!">Learn More</a>
                </div>
                <!-- End Icon Blocks -->
                ...
                <div class="col-lg-4 g-bg-teal g-color-white text-center g-pa-60">
                    ...
                    <p class="g-color-white-opacity-0_8 g-font-size-16 g-mb-20">We strive to embrace and drive change
                        in our industry which allows us to keep our clients relevant.</p>
                    <a class="btn u-shadow-v21 g-bg-white-opacity-0_2 g-color-white g-brd-white--hover g-color-teal--hover g-bg-white--hover g-font-size-12 text-uppercase g-font-weight-600 g-rounded-50 g-py-12 g-px-20"
                        href="#!">Check It Now</a>
                </div>
                <!-- End Icon Blocks -->
                ...
                <div class="col-lg-4 g-bg-purple g-color-white text-center g-pa-60">
                    ...
                    <p class="g-color-white-opacity-0_8 g-font-size-16 g-mb-20">We strive to embrace and drive change
                        in our industry which allows us to keep our clients relevant.</p>
                    <a class="btn u-shadow-v21 g-bg-white-opacity-0_2 g-color-white g-brd-white--hover g-color-purple--hover g-bg-white--hover g-font-size-12 text-uppercase g-font-weight-600 g-rounded-50 g-py-12 g-px-20"
            ...
            <div class="container">
                <header class="text-center g-width-80x--md mx-auto g-mb-50">
                    <div class="u-heading-v6-2 text-center text-uppercase g-mb-20">
                        ...
                        <h2 class="h3 u-heading-v6__title g-brd-primary g-color-gray-dark-v2 g-font-weight-600">Latest
                            Posts</h2>
                    </div>
                    <p class="lead">Lorem ipsum dolor <span class="g-color-primary">sit amet consectetur</span>
                        adipiscing elit. Nam eget varius leo, at elementum eros. Fusce tristique, ipsum egestas
                        fermentum imperdiet, ex nunc iaculis sem, a semper augue turpis ut nulla.</p>
                </header>
                ...
                <div class="row g-mb-30">
                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                        <!-- Article -->
                        <article
                            class="g-brd-around g-brd-gray-light-v4 g-brd-top-2 g-brd-primary-top rounded g-pa-25">
                            <div class="u-heading-v2-6--bottom g-mb-20">
                                <h2 class="h3 u-heading-v2__title g-font-weight-300 g-mb-0">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Unify -
                                        Responsive Bootstrap Template</a>
                                </h2>
                            </div>

                            <div class="lead">
                                <p>Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus
                                    tellusimp imperdiet molestie est volutpat at.</p>
                            </div>
                    ...
                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                        ...
                        <article class="g-brd-around g-brd-gray-light-v4 g-brd-top-2 g-brd-black-top rounded g-pa-25">
                            <div class="u-heading-v2-6--bottom g-mb-20">
                                <h2 class="h3 u-heading-v2__title g-font-weight-300 g-mb-0">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Over
                                        1000 UI Components For Your Projects</a>
                                </h2>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <!-- Article -->
                        <article
                            class="g-brd-around g-brd-gray-light-v4 g-brd-top-2 g-brd-darkred-top rounded g-pa-25">
                            <div class="u-heading-v2-6--bottom g-mb-20">
                                <h2 class="h3 u-heading-v2__title g-font-weight-300 g-mb-0">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Boosting
                                        Your Project With Unify Demos</a>
                                </h2>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                        <!-- Article -->
                        <article
                            class="g-brd-around g-brd-gray-light-v4 g-brd-top-2 g-brd-darkpurple-top rounded g-pa-25">
                            <div class="u-heading-v2-6--bottom g-mb-20">
                                <h2 class="h3 u-heading-v2__title g-font-weight-300 g-mb-0">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Boosting
                                        Your Project With Unify Demos</a>
            ...
            <div class="container u-bg-overlay__inner g-color-white g-py-100">
                <div class="row text-center">
                    <div class="col-lg-3 col-sm-6 g-mb-30 g-mb-0--lg">
                        <i
                            class="icon-finance-078 u-line-icon-pro g-color-white-opacity-0_8 g-font-size-40 g-mb-25"></i>
                    ...
                    <div class="col-lg-3 col-sm-6 g-mb-30 g-mb-0--lg">
                        <i
                            class="icon-finance-053 u-line-icon-pro g-color-white-opacity-0_8 g-font-size-40 g-mb-25"></i>
                    ...
                    <div class="col-lg-3 col-sm-6 g-mb-30 g-mb-0--lg">
                        <i
                            class="icon-finance-039 u-line-icon-pro g-color-white-opacity-0_8 g-font-size-40 g-mb-25"></i>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <i
                            class="icon-finance-086 u-line-icon-pro g-color-white-opacity-0_8 g-font-size-40 g-mb-25"></i>
            ...
            <div class="container">
                <header class="text-center g-width-80x--md mx-auto g-mb-50">
                    <div class="u-heading-v6-2 text-center text-uppercase g-mb-20">
                        ...
                        <h2 class="h3 u-heading-v6__title g-brd-primary g-color-gray-dark-v2 g-font-weight-600">Work
                            With Us</h2>
                    </div>
                    <p class="lead">Lorem ipsum dolor <span class="g-color-primary">sit amet consectetur</span>
                        adipiscing elit. Nam eget varius leo, at elementum eros. Fusce tristique, ipsum egestas
                ...
                <div class="g-bg-img-hero g-pb-70" style="background-image: url(assets/img/maps/map3.png);">
                    <div class="row justify-content-center g-pt-100--md">
                        <div class="col-md-6 col-lg-4">
                            <div class="g-brd-around g-brd-3 g-brd-gray-light-v4 rounded g-py-80 g-pl-50 g-pr-80">
                                <i
                                    class="d-block g-color-primary g-font-size-40 g-line-height-0_7 g-pos-rel g-top-15 g-mb-25">“</i>
                                <blockquote class="g-color-black-opacity-0_6 g-font-size-22 g-line-height-1_8 g-mb-40">
                                    <em>Great theme maker. I wish they would create more themes</em>.
                                </blockquote>
                                <h4
                                    class="g-color-black-opacity-0_4 g-font-weight-700 g-font-size-13 text-uppercase g-mb-0">
                                    <span
                                        class="d-inline-block g-width-40 g-height-2 g-bg-black-opacity-0_4 g-pos-rel g-top-minus-3 mr-2"></span>
                                    Dan Watson
                                </h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 g-hidden-sm-down g-bg-size-cover g-min-height-300 g-pos-rel rounded g-top-minus-70 g-ml-minus-50"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 align-self-center">
                        <div class="input-group g-brd-white--focus rounded">
                            ...
                            <div
                                class="input-group-addon g-color-white g-bg-transparent g-brd-white-opacity-0_8 g-px-12">
