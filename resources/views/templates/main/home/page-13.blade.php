...
<head>
    <base href="{{ url('/') }}/">
    <!-- Title -->
    <title>Home Page 13 | | Unify - Responsive Website Template</title>
...
<body>
    <main>
        ...
        <!-- Promo Block -->
        <section class="g-flex-centered g-bg-pos-center g-bg-img-hero g-pos-rel g-z-index-1 g-overflow-hidden"
            style="background-image: url(assets/img-temp/1920x1080/img14.jpg);" data-calc-target="#js-header">
            ...
            <div class="container text-center g-z-index-1">
                <div class="mb-4">
                    <h1 class="h2 d-inline-block g-color-black g-font-weight-700 g-font-size-40 g-font-size-75--md text-uppercase g-line-height-1"
                        data-animation="fadeInDown" data-animation-delay="1000" data-animation-duration="1500">The
                    </h1>
                    <h2 class="h2 d-inline-block g-color-black g-font-weight-700 g-font-size-40 g-font-size-75--md text-uppercase g-line-height-1"
                        data-animation="fadeInDown" data-animation-delay="1200" data-animation-duration="1500">
                        Green</h2>
                    <h2 class="h2 d-inline-block g-color-primary g-font-weight-700 g-font-size-40 g-font-size-75--md text-uppercase g-line-height-1"
                        data-animation="fadeInDown" data-animation-delay="1400" data-animation-duration="1500">
                        Unify</h2>
                </div>
                ...
                <div class="mx-auto g-max-width-600 g-overflow-hidden">
                    <p class="g-color-black g-font-size-18 g-font-size-24--md g-mb-40" data-animation="fadeInDown"
                        ...
                        Unify is creative technology company providing key digital services on web and mobile. We
                        minimize the gap between technology and its audience.
                    </p>
                </div>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-4 u-bg-overlay g-bg-img-hero g-bg-cyan-opacity-0_9--after g-color-white text-center g-pa-60"
                    ...
                    <div class="u-bg-overlay__inner">
                        ...
                        <p class="g-font-size-16 g-mb-20">We strive to embrace and drive change in our industry which
        ...
        <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll">
            ...
            <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-white-gradient-opacity-v2--after"
                style="height: 160%; background-image: url(assets/img-temp/1920x1080/img5.jpg);"></div>
            <!-- End Parallax Image -->

            <div class="container u-bg-overlay__inner g-color-white text-center g-py-200">
                <h2 class="g-font-size-40 g-font-size-70--md text-uppercase g-font-weight-700 ">Unify is <span
                        class="u-text-animation u-text-animation--typing"></span></h2>
            ...
            <div class="container">
                <header class="text-center g-width-80x--md mx-auto g-mb-70">
                    <div class="u-heading-v6-2 text-center text-uppercase g-mb-20">
                        ...
                        <h2 class="h3 u-heading-v6__title g-brd-primary g-color-gray-dark-v2 g-font-weight-600">What
                            We Do</h2>
                    </div>
                        ...
                        <div class="u-shadow-v21 g-bg-white rounded g-pa-30">
                            <div class="media g-mb-15">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="g-color-gray-dark-v4 g-mb-0">We strive to embrace and drive change in
                                        our industry which allows us to keep our clients relevant.</p>
                                </div>
                            </div>
                        </div>
                        <!-- End Icon Blocks -->
                        ...
                        <div class="media">
                            <div class="g-height-140 g-width-140 g-mr-30">
                                <div class="js-pie-rtl u-chart-pie-v1 g-brd-purple g-height-140 g-width-140"
                                    data-circles-value="53" data-circles-max-value="200" data-circles-bg-color="#111"
                                    data-circles-fg-color="#9a69cb" data-circles-radius="70"
                            ...
                            <div class="media-body align-self-center g-line-height-2">
                                ...
                                <p class="mb-0 g-color-white-opacity-0_8">Sed feugiat porttitor nunc Etiam gravida ex
                                    justo ac rhoncus purus tristique ut, egestas a libero eget, sollicitudin maximus
                        ...
                        <div class="media">
                            <div class="g-height-140 g-width-140 g-mr-30">
                                <div class="js-pie-rtl u-chart-pie-v1 g-brd-pink g-height-140 g-width-140"
                                    data-circles-value="96" data-circles-max-value="200" data-circles-bg-color="#111"
                                    data-circles-fg-color="#e81c62" data-circles-radius="70"
                                    data-circles-stroke-width="2" data-circles-font-size="35"
                                    data-circles-duration="2000" data-circles-scroll-animate="true">
                                </div>
                            </div>
                            ...
                            <div class="media-body align-self-center g-line-height-2">
                                <h4 class="h5 g-font-weight-400 g-letter-spacing-1 g-mb-15">Professional Lecturers
                                </h4>
                                <p class="mb-0 g-color-white-opacity-0_8">Sed feugiat porttitor nunc Etiam gravida ex
                                    justo ac rhoncus purus tristique ut, egestas a libero eget, sollicitudin maximus
                                    nulla. Nunc vitae maximus ipsum.</p>
                        ...
                        <div class="media">
                            <div class="g-height-140 g-width-140 g-mr-30">
                                <div class="js-pie-rtl u-chart-pie-v1 g-brd-cyan g-height-140 g-width-140"
                                    data-circles-value="8" data-circles-max-value="15" data-circles-bg-color="#111"
                                    data-circles-fg-color="#00bed6" data-circles-radius="70"
                                    data-circles-stroke-width="2" data-circles-font-size="35"
                                    data-circles-duration="2000" data-circles-additional-text="k"
                        ...
                        <div class="media">
                            <div class="g-height-140 g-width-140 g-mr-30">
                                <div class="js-pie-rtl u-chart-pie-v1 g-brd-primary g-height-140 g-width-140"
                                    data-circles-value="48" data-circles-max-value="200" data-circles-bg-color="#111"
                ...
                <div class="row">
                    <div class="col-lg-4 g-mb-30">
                        ...
                        <div class="g-brd-around g-brd-blue rounded g-pa-40">
                            <blockquote class="lead text-center g-mb-40">Dear Htmlstream team, I just bought the Unify
                                template some weeks ago. The template is really nice and offers quite a large set of
                                options.</blockquote>
                            <div class="d-flex justify-content-center">
                                <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3"
                                    src="assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                <div>
                                    <h4 class="h5 align-self-center g-mb-5">Alex Peterson</h4>
                                    <div class="js-rating align-self-center g-color-yellow g-font-size-10"
                                        data-rating="5" data-spacing="3" data-backward-icons-classes="fa fa-star">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 g-mb-30">
                        ...
                        <div class="g-brd-around g-brd-pink rounded g-pa-40">
                            <blockquote class="lead text-center g-mb-40">Hi there purchased a couple of days ago and
                                the site looks great, big thanks to the htmlstream guys, they gave me some great help.
                            </blockquote>
                            <div class="d-flex justify-content-center">
                                <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3"
                    ...
                    <div class="col-lg-4 g-mb-30">
                        ...
                        <div class="g-brd-around g-brd-purple rounded g-pa-40">
                            <blockquote class="lead text-center g-mb-40">Your customer support is the best I have
                                experienced with any theme I have purchased. You have a theme that far exceeds all
                                others.</blockquote>
                            <div class="d-flex justify-content-center">
                                <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3"
