    ...
    <main>
        ...
        <section
            ...
            <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_4--after"
                style="height: 140%; background-image: url(assets/img-temp/1920x800/img6.jpg);"></div>
            <!-- End Parallax Image -->
        ...
        <section class="container g-pt-100 g-pb-40">
            <div class="row justify-content-between">
                <div class="col-lg-7 g-mb-60">
                    ...
                    <p class="g-color-gray-dark-v3 g-font-size-16">We are a creative studio focusing on culture,
                    ...
                    <form>
                        ...
                        <button
                            ...
                            type="submit" role="button">Send Enquiry</button>
                    </form>
                    <!-- End Contact Form -->
                </div>
                ...
                <div class="col-lg-4 g-mb-60">
                    ...
                    <div class="media mb-2">
                        ...
                        <div class="media-body">
                            <p class="g-color-gray-dark-v3">Call: <span class="g-color-gray-dark-v4">+32 333 444
                                    555</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <a class="g-color-main g-color-black--hover g-text-underline--none--hover" href="#!">
                        <span
                            class="align-middle u-icon-v2 u-icon-size--sm g-color-white g-bg-primary rounded-circle mr-3">
