...
<body>
    <main>
        ...
        <section class="u-bg-overlay g-bg-cover g-bg-size-cover g-bg-bluegray-opacity-0_3--after"
            style="background: url(assets/img-temp/1920x800/img8.jpg)">
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="mb-5">
                            ...
                            <h2 class="g-color-white g-font-weight-300 g-font-size-20 mb-0">Finding your questions is
                                easy now.</h2>
                        </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5 g-mb-50">
                        ...
                        <div class="text-center text-lg-left g-mb-60">
                            ...
                            <h2 class="g-color-black g-font-weight-600 mb-5">Read one of our<br>frequently asked
                                questions</h2>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6 text-center text-lg-left g-mb-50">
                                ...
                                <p class="g-color-gray-dark-v4 mb-0">We strive to embrace and drive change in our
                                    industry.</p>
                                <!-- End Icon Blocks -->
                            </div>
        ...
        <div class="container">
            <section class="text-center g-py-100">
                <span class="g-color-primary g-font-weight-700 g-font-size-90 g-line-height-1_2">100<span
                        class="g-font-size-60">k</span></span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="text-center g-mb-60">
                            ...
                            <p class="lead g-width-60x--md mx-auto">We aim high at being focused on building
