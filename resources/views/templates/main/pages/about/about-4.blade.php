                ...
                <div class="row justify-content-center g-mb-60">
                    <div class="col-lg-7">
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
                            <p class="mb-0">We are a creative studio focusing on culture, luxury, editorial &amp;
                ...
                <div class="row g-mb-30">
                    <div class="col-lg-6 g-mb-30">
                        ...
                        <a class="btn btn-md u-btn-outline-black g-font-size-default rounded-0 g-py-10 mr-2"
                            href="#!">Explore More</a>
                        <a class="btn btn-md u-btn-primary g-font-size-default rounded-0 g-py-10"
                            href="#!">Purchase Now</a>
                    </div>
                    <div class="col-lg-6">
                        <!-- End Progress Bar -->
                        ...
                        <div class="js-hr-progress-bar progress g-height-2 rounded-0">
                            <div class="js-hr-progress-bar-indicator progress-bar" role="progressbar"
                                style="width: 69%;" aria-valuenow="69" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <!-- Progress Bar -->
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 g-mb-30">
                    <div class="text-center u-block-hover">
                        ...
                        <!-- Figure Info -->
                        <em
                            class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Photographer</em>
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                    <div class="text-center u-block-hover">
                        ...
                        <!-- Figure Info -->
                        <em
                            class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Designer</em>
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                    <div class="text-center u-block-hover">
                        ...
                        <!-- Figure Info -->
                        <em
                            class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">Co-Founder</em>
