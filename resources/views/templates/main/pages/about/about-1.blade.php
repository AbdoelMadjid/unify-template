...
<body>
    <main>
        ...
        <!-- Promo Block -->
        <section
            class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_8--after"
            ...
            <div class="g-pt-120">
                <div class="container g-color-white text-center g-pos-rel g-z-index-3">
                    <h3 class="g-font-size-40 g-font-weight-600 g-font-size-130--md g-line-height-1 g-mb-50"
                        data-animation="fadeInUp" data-animation-delay="500" data-animation-duration="1500">Unify</h3>
                    ...
                    <a class="js-fancybox d-block g-mb-130" href="javascript:;" data-src="//vimeo.com/167434033"
                        data-speed="1000" data-animate-in="fadeInUp" data-animate-out="fadeOutUp"
                        data-caption="Single Image">
                        <span
                            class="u-icon-v3 u-icon-size--lg u-block-hover--scale g-bg-white g-color-black g-color-primary--hover g-font-size-18 g-rounded-50x g-cursor-pointer">
                    ...
                    <ul class="row list-inline text-center g-pb-60 mb-0">
                        <li class="col" data-animation="fadeIn" data-animation-delay="1800"
                            ...
                            <img class="g-width-100 u-block-hover__main--grayscale"
                ...
                <div class="row justify-content-center g-mb-110">
                    <div class="col-lg-8">
                        ...
                        <div class="text-center">
                            ...
                            <h2 class="h1 g-color-black g-font-weight-600 mb-5">The leading branding<br>theme for any
                                professionals</h2>
                            <p class="lead mb-5">We are a creative studio focusing on culture, luxury, editorial &amp;
                                art. Somewhere between sophistication and simplicity. This is where we sit down, grab a
                                cup of coffee and dial in the details. Understanding the task at hand and ironing
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3 g-mb-30">
                        ...
                        <article class="u-shadow-v21 u-shadow-v21--hover g-bg-white g-pos-rel g-rounded-5">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/350x230/img1.jpg"
                    ...
                    <div class="col-sm-6 col-lg-3 g-mb-30">
                        <!-- Article -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-bg-white g-pos-rel g-rounded-5">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/350x230/img2.jpg"
                                alt="Image Description">
                            <div class="g-pa-30">
                                <h3 class="h6 g-color-black g-font-weight-600 text-capitalize mb-3">
                                    <a class="g-color-black g-color-primary--hover g-text-underline--none--hover"
                                        href="#!">How can we assist?</a>
                                </h3>
                    ...
                    <div class="col-sm-6 col-lg-3 g-mb-30">
                        <!-- Article -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-bg-white g-pos-rel g-rounded-5">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/350x230/img3.jpg"
                                alt="Image Description">
                            <div class="g-pa-30">
                                <h3 class="h6 g-color-black g-font-weight-600 text-capitalize mb-3">
                                    <a class="g-color-black g-color-primary--hover g-text-underline--none--hover"
                                        href="#!">Let's talk details</a>
                                </h3>
                    ...
                    <div class="col-sm-6 col-lg-3 g-mb-30">
                        <!-- Article -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-bg-white g-pos-rel g-rounded-5">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/350x230/img4.jpg"
                                alt="Image Description">
                            <div class="g-pa-30">
                                <h3 class="h6 g-color-black g-font-weight-600 text-capitalize mb-3">
                                    <a class="g-color-black g-color-primary--hover g-text-underline--none--hover"
                                        href="#!">It's a lifestyle.</a>
                                </h3>
                ...
                <div class="masonry-grid row mb-5">
                    ...
                    <div class="masonry-grid-item col-lg-6 g-mb-100">
                        <div class="g-pr-40--lg">
                            <!-- Heading -->
                            <span
                                class="d-block g-color-primary g-font-size-17 text-uppercase mb-4">Capabilities</span>
                            <h2 class="h2 g-color-black g-font-weight-600 mb-4">A full day of design insights<br>from
                                the world's top designers</h2>
                            <p class="lead mb-5">We are a creative studio focusing on culture, luxury, editorial &amp;
                                art. Somewhere between sophistication and simplicity. This is where we sit down, grab a
                                cup of coffee and dial in the details. Understanding the task at hand and ironing
                                out the wrinkles is key.</p>
                            <a class="btn btn-xl u-btn-outline-black g-font-weight-600 g-font-size-default g-px-35"
                                href="#!">I am convinced</a>
                            <!-- End Heading -->
                        </div>
                    </div>
                    <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
                        <div
                            data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-25", mid:"0", final:"25"}]'>
                            <img class="img-fluid w-100" src="assets/img-temp/350x230/img5.jpg"
                                alt="Image Description">
                        </div>
                    </div>
                    <div class="masonry-grid-item col-sm-6 col-lg-3 mt-5 g-mb-30">
                        <div
                            data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"25", mid:"0", final:"-25"}]'>
                            <img class="img-fluid w-100" src="assets/img-temp/400x570/img1.jpg"
                                alt="Image Description">
                        </div>
                    </div>
                    <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
                        <div
                            data-parallaxanimation='[{property: "transform", value:" translate3d(0,px,0)", initial:"-45", mid:"0", final:"45"}]'>
                            <img class="img-fluid w-100" src="assets/img-temp/350x230/img6.jpg"
                                alt="Image Description">
                        </div>
                    </div>
                </div>
        ...
        <!-- Hero Info -->
        <section class="g-bg-cover g-bg-size-cover g-bg-black-opacity-0_4--after g-py-120"
            ...
            <div class="container text-center g-color-white g-pos-rel g-z-index-1">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <h2 class="g-font-weight-300 g-font-size-45 g-mb-20">Start with <span
                                class="g-color-primary g-font-weight-600">Unify</span> world</h2>
                        <p class="lead g-color-white-opacity-0_8 g-font-weight-300 g-mb-50">Look no further. You came
