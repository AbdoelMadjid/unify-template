    ...
    <main>
        ...
        <section
            ...
            <div class="container g-color-white text-center g-py-120">
                ...
                <p class="g-font-weight-300 g-font-size-22 text-uppercase">Unify is a clean and fully responsive theme
                </p>
            </div>
            <!-- Promo Block Content -->
        </section>
        ...
        <section class="container u-ns-bg-v1-bottom g-bg-white g-py-100">
            <div class="text-center">
                <h2 class="h5 g-line-height-1_8">Unify is a
                    <span class="g-brd-bottom g-brd-primary g-color-primary g-font-weight-600 pb-1">creative</span>
                    technology company providing key digital services.<br>Focused on helping our clients to build a
                    <span class="g-brd-bottom g-brd-primary g-color-primary g-font-weight-600 pb-1">successful</span>
                    business on web and mobile.
                </h2>
            </div>
        </section>
        <!-- End Heading -->
        ...
        <section class="container g-pt-100 g-pb-70">
            ...
            <div class="row g-mb-30">
                <div class="col-lg-6 g-mb-30">
                    ...
                    <a class="btn btn-md u-btn-outline-black g-font-size-default rounded-0 g-py-10 mr-2"
                        href="#!">Explore More</a>
                    <a class="btn btn-md u-btn-primary g-font-size-default rounded-0 g-py-10" href="#!">Purchase
                        Now</a>
                </div>
                <div class="col-lg-6">
                    <div class="row">
        ...
        <section class="dzsparallaxer auto-init height-is-based-on-content">
            <!-- Parallax Image -->
            <div class="dzsparallaxer--target w-100 g-bg-size-cover u-bg-overlay g-bg-black-opacity-0_3--after"
                        ...
                        <figcaption class="u-block-hover__additional--partially-slide-up g-mx-15">
                            <div class="text-center g-bg-white g-pb-20">
                                ...
                                <div class="u-block-hover__visible g-pt-20 g-pb-15 g-y-20">
                                    ...
                                    <em
                                        class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Technical
                                        Director</em>
                                </div>
                                <!-- End Info -->
                        ...
                        <figcaption class="u-block-hover__additional--partially-slide-up g-mx-15">
                            <div class="text-center g-bg-white g-pb-20">
                                ...
                                <div class="u-block-hover__visible g-pt-20 g-pb-15 g-y-20">
                                    ...
                                    <em
                                        class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Lead
                                        Designer</em>
                                </div>
                                <!-- End Info -->
                        ...
                        <figcaption class="u-block-hover__additional--partially-slide-up g-mx-15">
                            <div class="text-center g-bg-white g-pb-20">
                                ...
                                <div class="u-block-hover__visible g-pt-20 g-pb-15 g-y-20">
                                    ...
                                    <em
                                        class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Web
                                        Developer</em>
                                </div>
                                <!-- End Info -->
                        ...
                        <figcaption class="u-block-hover__additional--partially-slide-up g-mx-15">
                            <div class="text-center g-bg-white g-pb-20">
                                ...
                                <div class="u-block-hover__visible g-pt-20 g-pb-15 g-y-20">
                                    ...
                                    <em
                                        class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary">Support
                                        Manager</em>
                                </div>
                                <!-- End Info -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 g-mb-30">
                        ...
                        <div
                            ...
                            <div class="media-body">
                                <blockquote class="lead g-mb-15">Dear Htmlstream team, I just bought the Unify template
                                    some weeks ago. The template is really nice and offers quite a large set of options.
                                </blockquote>
