...
<body>
    <main>
                ...
                <div class="col-lg-8">
                    <div class="d-flex justify-content-between g-mb-10">
                        <div class="g-mb-20">
                            ...
                            <em class="d-block g-font-style-normal g-font-size-default text-uppercase g-color-primary">CEO,
                                Director</em>
                        </div>
                    ...
                    <div class="g-mb-50">
                        ...
                        <p>As creatives, it's important that I strive to do work outside of obligation. This lets us
                            ...
                            important to not let being busy distract us from having fun.
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="js-hr-progress-bar progress rounded-0 g-height-4 mb-5">
                                <div class="js-hr-progress-bar-indicator progress-bar" role="progressbar"
                                    style="width: 76%;" aria-valuenow="76" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                            <!-- End Progress Bar v2 -->
                        </div>
        ...
        <!-- Testimonials -->
        <section
            class="dzsparallaxer auto-init height-is-based-on-content use-loading g-bg-cover g-bg-white-opacity-0_9--after">
        ...
        <section class="container g-py-50">
            <div class="d-flex justify-content-between">
                <h3 class="h5 align-self-center mb-0 mr-4">Want to hire best people for your project? Look no further
                    you came to the right place!</h3>
                <a class="align-self-center btn btn-xl u-btn-outline-black g-font-weight-600 g-font-size-default g-px-35"
                    href="#!">Hire Me</a>
            </div>
        </section>
