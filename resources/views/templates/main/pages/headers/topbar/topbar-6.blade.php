                ...
                <div class="container">
                    <div class="d-lg-flex flex-md-row align-items-center g-pos-rel">
                        ...
                        <div class="col g-mt-10 g-mt-0--lg g-px-0">
                            <ul
                                class="list-inline text-uppercase g-font-weight-600 text-lg-right u-header--hidden-element g-line-height-1 g-font-size-12 g-mt-minus-10 g-mx-minus-4 g-mb-20">
                                <li class="list-inline-item g-pos-rel g-mx-4 g-mt-10">
                                    ...
                                    <a href="#!" id="languages-dropdown-invoker-2"
                                        ...
                                        data-dropdown-animation-out="fadeOut">EN
                                    </a>
                                    <ul id="languages-dropdown-2"
                                        class="list-unstyled text-left u-shadow-v23 g-pos-abs g-left-0 g-bg-white g-width-160 g-py-20 g-pb-15 g-mt-13 g-z-index-2"
                                ...
                                <li class="list-inline-item g-mx-4 g-mt-10">
                                    <a href="#!"
                                        class="g-color-gray-dark-v2 g-color-primary--hover g-text-underline--none--hover">FAQ</a>
                                </li>
                                <li class="list-inline-item g-mx-4 g-mt-10">|</li>
                                <li class="list-inline-item g-mx-4 g-mt-10">
                                    <a href="#!"
                                        class="g-color-gray-dark-v2 g-color-primary--hover g-text-underline--none--hover">Login</a>
                                </li>
                            </ul>
                            ...
                            <nav class="navbar navbar-expand-lg p-0">
                                    ...
                                    <div id="basket-bar"
                                        ...
                                        <div class="js-scrollbar g-height-280">
                                            ...
                                            <div class="u-basket__product">
                                                ...
                                                <button class="u-basket__product-remove"
                                            ...
                                            <div class="u-basket__product">
                                                <div class="row align-items-center no-gutters">
                                                    <div class="col-4 g-pr-20">
                                                        <a href="#!" class="u-basket__product-img">
                                                            <img src="assets/img-temp/150x150/img4.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                ...
                                <div class="d-inline-block g-pos-rel g-valign-middle g-pt-3">
                                    <a href="#!" class="g-font-size-18 g-color-main" aria-haspopup="true"
                                        aria-expanded="false" aria-controls="searchform-1"
                                    ...
                                    <form id="searchform-1"
                                        class="u-searchform-v1 u-dropdown--css-animation u-dropdown--hidden g-bg-white g-pa-10 g-mt-20">
                                        <div class="input-group g-brd-primary--focus">
                                            <input class="form-control rounded-0 u-form-control" type="search"
