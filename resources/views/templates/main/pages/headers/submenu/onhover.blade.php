                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <li class="nav-item hs-has-sub-menu g-mx-20--lg">
                                    <a href="#!" class="nav-link g-px-0" id="nav-link-1" aria-haspopup="true"
                                        aria-expanded="false" aria-controls="nav-submenu-1">Pages
                                    ...
                                    <ul class="hs-sub-menu list-unstyled g-text-transform-none g-brd-top g-brd-primary g-brd-top-2 g-min-width-200 g-mt-20 g-mt-10--lg--scrolling"
                                        ...
                                        <li class="dropdown-item hs-has-sub-menu active">
                                            <a id="nav-link-2" class="nav-link g-px-0" href="#!"
                                                ...
                                                aria-controls="nav-submenu-2">Page 2
                                            </a>
                                            <!-- Submenu (level 2) -->
                                            <ul class="hs-sub-menu list-unstyled g-brd-top g-brd-primary g-brd-top-2 g-min-width-200 g-my-2"
