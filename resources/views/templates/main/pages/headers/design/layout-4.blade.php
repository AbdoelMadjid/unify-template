...
<body>
    <main>
        ...
        <header id="js-header"
            ...
            <!-- Top Bar -->
            <div
                class="u-header__section u-header__section--light g-bg-white g-color-main g-brd-bottom g-brd-gray-light-v4 g-py-10">
                <div class="container">
                    <div
                        class="row flex-column flex-md-row justify-content-between align-items-center text-center g-font-size-13">
                            ...
                            <ul class="d-inline-block list-inline g-valign-middle mb-0">
                                <li class="list-inline-item g-mr-20--lg">
                                    ...
                                    <a class="g-color-main g-color-primary--hover g-text-underline--none--hover"
                                        href="mailto:#">info@htmlstream.com</a>
                                </li>
                                <li class="list-inline-item g-mr-20--lg">
                                    <i class="icon-call-in g-mt-1 g-mr-5"></i>
                                    Hotline:
                                    <a class="g-color-main g-color-primary--hover g-text-underline--none--hover"
                                        href="tel:#">(1) 396 4587 99</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-auto col-lg-6 text-lg-right">
                            <ul class="d-inline-block list-inline g-valign-middle mb-0">
                                <li class="list-inline-item">
                                    <a class="g-color-main g-color-primary--hover g-text-underline--none--hover g-pa-5"
                                        href="#!">
                                        <i class="icon-home"></i>
                                    </a>
                                </li>
            ...
            <div
                class="text-center text-lg-left u-header__section u-header__section--light u-header--hidden-element g-bg-white g-brd-bottom g-brd-gray-light-v4 g-py-20">
                <div class="container">
            ...
            <div class="u-header__section u-header__section--light g-bg-white g-py-15 g-py-0--lg"
                ...
                <nav class="navbar navbar-expand-lg py-0">
                    <div class="container">
                        ...
                        <!-- Navigation -->
                        <div class="collapse navbar-collapse align-items-center text-center flex-sm-row g-pt-10 g-pt-0--lg g-mr-40--lg"
                            id="navBar">
                        ...
                        <div class="d-inline-block g-pos-rel g-valign-middle">
                            <a href="#!"
                                class="g-font-size-18 g-color-gray-dark-v5 g-text-underline--none--hover"
                            ...
                            <form id="searchform-1"
                                class="u-searchform-v1 u-dropdown--css-animation u-dropdown--hidden g-bg-white g-pa-10 g-mt-10--lg">
