...
<body>
    <main>
        ...
        <header id="js-header" class="u-header u-header--static u-header--show-hide u-header--change-appearance"
            ...
            <div
                class="text-center text-lg-left u-header__section u-header__section--light g-bg-white g-brd-bottom g-brd-gray-light-v4 g-py-20">
                <div class="container">
                                ...
                                <div class="col-md">
                                    <ul class="list-inline mb-0 g-pa-10">
                                        <li class="list-inline-item g-valign-middle g-mx-3">
                                            <a class="d-block u-icon-v3 u-icon-size--sm g-rounded-50x g-bg-gray-light-v4 g-color-gray-light-v1 g-bg-primary--hover g-color-white--hover g-text-underline--none--hover"
                                                href="#!">
            ...
            <div class="u-header__section u-header__section--dark g-bg-gray-dark-v1 g-py-15"
                ...
                <nav class="navbar navbar-expand-lg py-0">
                    <div class="container">
                        ...
                        <!-- Navigation -->
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-0--lg g-mr-40--sm"
                            id="navBar">
                            <ul class="navbar-nav text-uppercase g-font-weight-700 mr-auto">
                                ...
                                <li class="nav-item g-pr-40--lg">
                                    <a href="#!"
                                        class="nav-link g-color-primary--hover g-py-10 g-px-0--lg">Portfolio

                                    </a>
                                </li>
                                <li class="nav-item g-pr-40--lg">
                                    <a href="#!"
                                        class="nav-link g-color-primary--hover g-py-10 g-px-0--lg">Features

                                    </a>
                                </li>
                                <li class="nav-item g-pr-40--lg active">
                                    <a href="#!"
                                        class="nav-link g-color-primary--hover g-py-10 g-px-0--lg">Shortcodes
                        ...
                        <div class="text-uppercase g-valign-middle">
                            <a href="#!" class="btn btn-md u-btn-primary g-font-size-13 g-font-weight-700">Get a
                                Quote</a>
                        </div>
                        <!-- End Search -->
                    </div>
