...
<body>
    <main>
        ...
        <button class="btn u-header-toggler u-header-toggler--bottom-right g-pa-0" id="header-toggler"
        ...
        <!-- Header -->
        <div id="js-header" class="u-header u-header--fullscreen--bottom-right" aria-labelledby="header-toggler"
