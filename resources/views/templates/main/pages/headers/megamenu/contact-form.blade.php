                                            ...
                                            <div class="col-lg-9 g-mb-25 g-mb-0--lg">
                                                <div class="row">
                                                    <div class="col-lg-6 form-group g-mb-30">
                                                        <input id="inputGroup6_1"
                                                            class="form-control g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-pa-10"
                                                            placeholder="Your name" type="text">
                                                    </div>

                                                    <div class="col-lg-6 form-group g-mb-30">
                                                        <input id="inputGroup6_2"
                                                            class="form-control g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-pa-10"
                                                            placeholder="Your phone" type="tel">
                                                    </div>

                                                    <div class="col-lg-6 form-group g-mb-30">
                                                        <input id="inputGroup6_3"
                                                            class="form-control g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-pa-10"
                                                            placeholder="Email *" type="email">
                                                    </div>

                                                    <div class="col-lg-6 form-group g-mb-30">
                                                        <input id="inputGroup6_4"
                                                            class="form-control g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-pa-10"
                                                            placeholder="Subject" type="text">
                                                    </div>

                                                    <div class="col-lg-12 form-group g-mb-30">
                                                        <textarea class="form-control g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-pa-10"
                                                ...
                                                <div class="text-center">
                                                    <button
                                                        class="btn u-btn-primary btn-lg g-line-height-1 g-font-weight-700 g-font-size-default rounded-0 g-px-25 g-py-10 mb-0"
                                            ...
                                            <div class="col-lg-3">
                                                <address class="row text-center">
                                                    <div class="col-lg-12 g-mb-30">
                                                        ...
                                                        <strong class="g-color-black g-text-transform-none">Sit amet
                                                            adipiscing</strong>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 g-mb-30">
                                                        ...
                                                        <h3 class="text-uppercase g-font-size-12 g-mb-5">Phone number
                                                        </h3>
                                                        <strong class="g-color-black g-text-transform-none">+4586 585
                                                            4580</strong>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <a class="g-color-black g-color-black--hover g-text-transform-none"
