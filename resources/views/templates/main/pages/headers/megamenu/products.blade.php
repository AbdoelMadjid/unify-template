                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    ...
                                    <a id="mega-menu-label-3" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Products-1
                                    ...
                                    <div class="w-100 hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-pa-30 g-mt-17 g-mt-7--lg--scrolling"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 g-mb-30 g-mb-0--lg">
                                                <figure class="g-px-10">
                                                    <div class="g-pos-rel g-mb-20">
                                                        <img class="img-fluid" src="assets/img-temp/480x700/img1.jpg"
                                                        ...
                                                        <ul class="list-inline media-body text-right">
                                                            <li class="list-inline-item align-middle mx-0">
                                                                <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-color-primary--hover g-font-size-15 rounded-circle"
                                                                    ...
                                                                    data-original-title="Add to Cart" tabindex="0">
                                            ...
                                            <div class="col-lg-3 g-mb-30 g-mb-0--lg">
                                                <figure class="g-px-10">
                                                    <div class="g-pos-rel g-mb-20">
                                                        <img class="img-fluid" src="assets/img-temp/480x700/img2.jpg"
                                                            alt="Image Description">
                                                    </div>
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <a class="d-inline-block g-color-gray-dark-v5 g-font-size-13"
                                                                href="#!" tabindex="0">Woman</a>
                                                            <s
                                                                class="d-block g-color-lightred g-font-weight-500 g-font-size-13">$101.00</s>
                                                            <span
                                                                class="d-block g-color-black g-font-size-17">$99.00</span>
                                                        </div>
                                                        <!-- End Product Info -->
                                            ...
                                            <div class="col-lg-3 g-mb-30 g-mb-0--lg">
                                                <figure class="g-px-10">
                                                    <div class="g-pos-rel g-mb-20">
                                                        <img class="img-fluid" src="assets/img-temp/480x700/img3.jpg"
                                                            alt="Image Description">
                                            ...
                                            <div class="col-lg-3 g-mb-30 g-mb-0--lg">
                                                <figure class="g-px-10">
                                                    <div class="g-pos-rel g-mb-20">
                                                        <img class="img-fluid" src="assets/img-temp/480x700/img4.jpg"
                                                            alt="Image Description">
                                                    </div>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    ...
                                    <a id="mega-menu-label-2" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Products-2
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-7"></i>
                                    </a>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-3" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Products-3
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-7"></i>
                                    </a>

                                    <!-- Mega Menu -->
                                    <div class="w-100 hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-mt-17 g-mt-7--lg--scrolling"
                                        aria-labelledby="mega-menu-label-3">
                                        <div class="row align-items-center no-gutters">
                                            ...
                                            <div class="col-md-5 col-lg-4 u-block-hover g-bg-size-cover g-min-height-500 g-flex-centered"
                                                ...
                                                style="background-image: url(assets/img/bg/secondary.png);">
                                                <div class="text-center">
                                                    <img class="img-fluid mb-3" src="assets/img-temp/500x320/img4.png"
                                                        alt="Image Description">
                                                    <h3
                                                        class="h5 u-link-v5 g-color-primary--hover g-font-weight-400 mb-3">
                                                        Sneaker Shoes for Man</h3>
                                                    <span
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-3" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Products-4
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-7"></i>
                                    </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 g-mb-30 g-mb-0--lg">
                                                ...
                                                <ul class="list-unstyled g-mb-25">
                                                    ...
                                                    <li class="g-mb-5">
                                                        <a class="g-color-main" href="#!">Fragrance &amp;
                                                            Beauty</a>
                                                    </li>
                                                </ul>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-3" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Products-5
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-7"></i>
                                    </a>
