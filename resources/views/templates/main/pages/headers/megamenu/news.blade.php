    ...
    <main>
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg"
                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    ...
                                    <a id="mega-menu-label-1" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">News-1
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i>
                                    </a>

                                    <!-- Mega Menu -->
                                    <div class="w-100 hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-pa-30 g-mt-17 g-mt-7--lg--scrolling"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <article class="media g-mb-20">
                                                    <a class="d-flex mr-3" href="#!">
                                                        <img class="g-width-120 g-height-70"
                                                            src="assets/img-temp/500x320/img1.jpg"
                                                ...
                                                <article class="media g-mb-20">
                                                    <a class="d-flex mr-3" href="#!">
                                                        <img class="g-width-120 g-height-70"
                                                            src="assets/img-temp/500x320/img2.jpg"
                                                            alt="Image Description">
                                                    </a>
                                                ...
                                                <article class="media g-mb-20">
                                                    <a class="d-flex mr-3" href="#!">
                                                        <img class="g-width-120 g-height-70"
                                                            src="assets/img-temp/500x320/img3.jpg"
                                                            alt="Image Description">
                                                    </a>
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <article class="media g-mb-20">
                                                    ...
                                                    <div class="media-body">
                                                        <h3 class="h6">
                                                            <a class="g-color-main" href="#!">10 Most beautiful
                                                                beaches</a>
                                                        </h3>
                                                        <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-2" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">News-2
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i>
                                    </a>
                                                ...
                                                <article>
                                                    <figure class="g-pos-rel">
                                                        <img class="img-fluid w-100 g-mb-20"
                                                            src="assets/img-temp/900x600/img7.jpg"
                                                            alt="Image Description">
                                                    </figure>

                                                    <h3 class="h4 g-mb-10">
                                                        <a class="g-color-gray-dark-v2" href="#!">Love the mother
                                                            nature</a>
                                                    </h3>
                                                    <ul class="u-list-inline g-font-size-12 g-color-gray-dark-v4">
                                                        <li class="list-inline-item">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-3" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">News-3
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i>
                                    </a>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-4" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">News-4
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i>
                                    </a>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <article class="u-block-hover">
                                                    ...
                                                    <span
                                                        class="u-icon-v3 u-icon-size--sm g-bg-white g-color-black g-bg-primary--hover g-color-white--hover g-rounded-50x g-cursor-pointer g-pos-abs g-top-20 g-right-20">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-5" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">News-5
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i>
                                    </a>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-6" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">News-6
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i>
                                    </a>
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-7" class="nav-link g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">News-7
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-5"></i>
                                    </a>
            ...
            <div class="container">
                ...
                <div class="row d-flex align-items-lg-center flex-wrap g-mb-60 g-mb-0--lg">
                    <div class="col-md-6 col-lg-8">
                        <img class="img-fluid rounded" src="assets/img-temp/900x600/img1.jpg"
                            alt="Image Description">
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="g-mt-minus-30 g-mt-0--md g-ml-minus-100--lg">
                            <div class="g-mb-20">
                                ...
                                <p class="g-font-size-16">This is where we sit down, grab a cup of coffee and dial in
        ...
        <section id="offers-section" class="g-bg-secondary">
            <div class="container g-pt-100 g-pb-130">
                ...
                <div class="row no-gutters">
                    <div class="col-sm-6 col-lg-3">
                        <div class="g-pr-40 g-mt-20">
                            <div class="g-mb-30">
                                ...
                                <p class="g-font-weight-300 g-font-size-16">The time has come to bring those ideas and
                                    plans to life. This is where we really begin to visualize your napkin sketches and
                    ...
                    <div class="col-lg-9">
                        <div id="we-provide" class="js-carousel" data-infinite="true" data-slides-show="3"
                            data-slides-scroll="3" data-center-mode="true" data-center-padding="1px"
        ...
        <section class="container g-py-100">
            <div class="text-center g-mb-50">
                ...
                <p class="lead">This is where we begin to visualize your napkin sketches and make them into pixels.
                </p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mt-auto g-mb-30">
                    <div
                        class="d-inline-block g-width-70 g-height-2 g-bg-red g-pos-rel g-top-5 g-left-minus-25 g-mr-minus-20">
                    </div>
                ...
                <div class="masonry-grid row">
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article class="u-shadow-v21 u-shadow-v21--hover g-transition-0_3">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/400x270/img1.jpg"
                                alt="Image Description">
                            ...
                            <div class="g-bg-white g-pa-30 g-rounded-bottom-5">
                                ...
                                <ul class="list-inline g-font-size-12 mb-0">
                                    ...
                                    <li class="list-inline-item g-mb-10">
                                        <a class="u-tags-v1 g-color-yellow g-bg-yellow-opacity-0_1 g-bg-yellow--hover g-color-white--hover g-rounded-50 g-py-4 g-px-15"
                                            href="#!">Design</a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                        <!-- Blog Grid Modern Blocks -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-transition-0_3">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/400x270/img2.jpg"
                                alt="Image Description">
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                        <!-- Blog Grid Modern Blocks -->
                        <article
                            class="u-shadow-v21 u-shadow-v21--hover g-transition-0_3 g-bg-primary text-center g-rounded-5 g-pa-30 g-py-100">
                            <span class="g-color-white-opacity-0_8 g-font-size-60 g-line-height-0">&#8220;</span>
                            <h2 class="h3 g-color-white g-font-weight-600 mb-4">In the future, design principles won’t
                                be about design</h2>
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                        <!-- Blog Grid Modern Blocks -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-transition-0_3">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/400x270/img3.jpg"
                                alt="Image Description">
                            ...
                            <div class="g-bg-white g-pa-30 g-rounded-bottom-5">
                                ...
                                <h2 class="h5 g-color-black g-font-weight-600 mb-4">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer"
                                        href="#!">Basic Patterns of Mobile Navigation</a>
                                </h2>

                                <ul class="list-inline g-font-size-12 mb-0">
                                    <li class="list-inline-item g-mb-10">
                                        <a class="u-tags-v1 g-color-deeporange g-bg-deeporange-opacity-0_1 g-bg-deeporange--hover g-color-white--hover g-rounded-50 g-py-4 g-px-15"
                                            href="#!">Mobile</a>
                                    </li>
                                    <li class="list-inline-item g-mb-10">
                                        <a class="u-tags-v1 g-color-teal g-bg-teal-opacity-0_1 g-bg-teal--hover g-color-white--hover g-rounded-50 g-py-4 g-px-15"
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                        <!-- Blog Grid Modern Blocks -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-transition-0_3">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/400x270/img7.jpg"
                                alt="Image Description">
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                        <!-- Blog Grid Modern Blocks -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-transition-0_3">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/400x270/img4.jpg"
                                alt="Image Description">
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                        <!-- Blog Grid Modern Blocks -->
                        <article class="u-shadow-v21 u-shadow-v21--hover g-transition-0_3">
                            <img class="img-fluid w-100 g-rounded-top-5" src="assets/img-temp/400x270/img6.jpg"
                                alt="Image Description">
                            ...
                            <div class="g-bg-white g-pa-30 g-rounded-bottom-5">
                                ...
                                <h2 class="h5 g-color-black g-font-weight-600 mb-4">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer"
                                        href="#!">Stylish office in Manhattan</a>
                                </h2>

                                <ul class="list-inline g-font-size-12 mb-0">
                                    <li class="list-inline-item g-mb-10">
                                        <a class="u-tags-v1 g-color-black g-bg-black-opacity-0_1 g-bg-black--hover g-color-white--hover g-rounded-50 g-py-4 g-px-15"
                                            href="#!">Office</a>
                                    </li>
                                    <li class="list-inline-item g-mb-10">
                                        <a class="u-tags-v1 g-color-cyan g-bg-cyan-opacity-0_1 g-bg-cyan--hover g-color-white--hover g-rounded-50 g-py-4 g-px-15"
                                            href="#!">Interior</a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="row no-gutters g-mx-minus-10">
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img1.png" alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img2.png" alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img3.png" alt="Image Description">
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img4.png" alt="Image Description">
                        <span class="g-font-weight-600 g-font-size-12 text-uppercase">Hi-tech</span>
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img5.png" alt="Image Description">
                        <span class="g-font-weight-600 g-font-size-12 text-uppercase">Others</span>
                        <h3 class="h4 g-font-weight-600 mb-0">Brochure</h3>
                        <a class="u-link-v2" href="#!"></a>
                    </div>
                ...
                <div class="col-sm-6 col-lg-4 g-px-10 g-mb-20">
                    ...
                    <div
                        ...
                        <img class="img-fluid u-block-hover__main--zoom-v1 mb-5"
                            src="assets/img-temp/425x250/img6.png" alt="Image Description">
