                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg"
                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg active" data-animation-in="fadeIn"
                                    ...
                                    <!-- Mega Menu -->
                                    <div class="hs-mega-menu u-shadow-v11 font-weight-normal g-text-transform-none g-brd-top g-brd-primary g-brd-top-2 g-mt-17 g-mt-7--lg--scrolling"
                                            ...
                                            <div class="col-lg">
                                                <section class="g-pa-20">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li>
                                                            <a href="#!"
                                                                class="nav-link active g-px-0 g-color-primary--hover">Alerts
                                                                &amp; Messages</a>
                                                        </li>
                                                        <li>
                                                            <a href="#!"
                                            ...
                                            <div class="col-lg g-brd-left--lg g-brd-gray-light-v5">
                                                <section class="g-pa-20 g-pl-5--lg">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li>
                                                            <a href="#!"
                                                                class="nav-link g-px-0 g-color-primary--hover">Brand
                                                                &amp; Social Buttons</a>
                                                        </li>
                                                        <li>
                                                            <a href="#!"
                                                                class="nav-link g-px-0 g-color-primary--hover">Loading
                                                                &amp; Hover Effects</a>
                                                        </li>
                                                        <li>
                                                            <a href="#!"
                                                        ...
                                                        <li>
                                                            <a href="#!"
                                                                class="nav-link g-px-0 g-color-primary--hover">Font
                                                                Awesome Icons</a>
                                                        </li>
                                                        <li>
                                                            <a href="#!"
                                                                class="nav-link g-px-0 g-color-primary--hover">Line
                                                                Icons</a>
                                                        </li>
                                                        <li>
                                                            <a href="#!"
                                                        ...
                                                        <li>
                                                            <a href="#!"
                                                                class="nav-link g-px-0 g-color-primary--hover">Glyphicons
                                                                Icons (Bootstrap)</a>
                                                        </li>
                                                    </ul>
                                                </section>
