                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg"
                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    ...
                                    <!-- Mega Menu -->
                                    <div class="w-100 hs-mega-menu u-shadow-v11 g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-mt-17 g-mt-7--lg--scrolling"
                                        aria-labelledby="mega-menu-label-1">
                                        <div class="row no-gutters">
                                            <div class="col-lg-4 g-min-height-400">
                                                <div id="gMap1" class="js-g-map h-100" data-type="custom"
                                            ...
                                            <div class="col-lg-4 d-flex g-bg-gray-light-v5 g-pa-30">
                                                <div class="align-self-center">
                                                    <div class="g-text-transform-none g-mb-30">
                                                        <p>Aliquam dapibus quis sapien id pharetra. Vivamus iaculis est
                                                            vitae libero tempus, in sollicitudin est consectetur
                                                            porttitor iaculis pretium</p>
                                                    </div>

                                                    <address class="g-line-height-2 g-mb-30">
                                                        <p>Email: <strong>
                                                                <a class="g-color-main"
                                                                    href="mailto:marketing@unify.com">info@htmlstream.com</a>
                                                            </strong></p>
                                                    ...
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item g-mx-5">
                                                            <a class="u-icon-v3 u-icon-size--sm g-font-size-default g-color-primary g-bg-white g-color-white--hover g-bg-primary--hover"
                                                                href="#!">
