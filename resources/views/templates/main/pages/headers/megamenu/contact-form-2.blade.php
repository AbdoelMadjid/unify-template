                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg"
                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg" data-animation-in="fadeIn"
                                    ...
                                    <!-- Mega Menu -->
                                    <div class="w-100 hs-mega-menu u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-pa-30 g-mt-17 g-mt-7--lg--scrolling"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="text-center g-overflow-hidden">
                                                    <div class="g-mx-minus-2 g-my-minus-2">
                                                        <div class="row mx-0">
                                                            <div
                                                                class="col-lg-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25">
                                                                <i
                                                                    class="icon-anchor d-inline-block g-font-size-50 g-color-primary g-mb-20"></i>
                                                                <h3 class="text-uppercase g-font-size-12 mb-10">Address
                                                                </h3>
                                                                <strong class="g-text-transform-none">Sit amet
                                                                    adipiscing</strong>
                                                            </div>
                                                            ...
                                                            <div
                                                                class="col-lg-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25">
                                                                <i
                                                                    class="icon-call-in d-inline-block g-font-size-50 g-color-primary g-mb-20"></i>
                                                                <h3 class="text-uppercase g-font-size-12 mb-10">Phone
                                                                    number</h3>
                                                                <strong class="g-text-transform-none">+402 5448
                                                                    569</strong>
                                                            </div>
                                                            ...
                                                            <div
                                                                class="col-lg-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25">
                                                                <i
                                                                    class="icon-line icon-envelope-letter d-inline-block g-font-size-50 g-color-primary g-mb-20"></i>
                                                                <h3 class="text-uppercase g-font-size-12 mb-10">Email
                                                                </h3>
                                                                <a class="g-color-gray-dark-v1 g-text-transform-none"
                                                                    href="mailto:info@unify.com">
                                                            ...
                                                            <div
                                                                class="col-lg-6 g-brd-left g-brd-bottom g-brd-gray-light-v4 g-px-15 g-py-25">
                                                                <i
                                                                    class="icon-earphones-alt d-inline-block g-font-size-50 g-color-primary g-mb-20"></i>
                                                                <h3 class="text-uppercase g-font-size-12 mb-10">Toll
                                                                    free</h3>
                                                                <strong class="g-text-transform-none">+402 5897
                                                                    660</strong>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <form>
                                                    <div class="form-group g-mb-10">
                                                        <input id="inputGroup12_1"
                                                            class="form-control g-color-gray-dark-v3 g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-px-20 g-py-13"
                                                            placeholder="Your name" type="text">
                                                    </div>

                                                    <div class="form-group g-mb-10">
                                                        <input id="inputGroup12_2"
                                                            class="form-control g-color-gray-dark-v3 g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-px-20 g-py-13"
                                                            placeholder="Your phone" type="tel">
                                                    </div>

                                                    <div class="form-group g-mb-10">
                                                        <input id="inputGroup12_3"
                                                            class="form-control g-color-gray-dark-v3 g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-px-20 g-py-13"
                                                            placeholder="Subject" type="text">
                                                    </div>

                                                    <div class="form-group g-mb-40">
                                                        <textarea id="inputGroup12_4"
                                                            class="form-control g-color-gray-dark-v3 g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-1 g-px-20 g-py-13"
                                                    ...
                                                    <div class="text-center">
                                                        <button
                                                            class="btn btn-xl text-uppercase u-btn-primary g-font-weight-700 g-font-size-12 rounded-0"
