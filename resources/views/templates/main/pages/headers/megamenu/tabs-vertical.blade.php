                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg"
                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg active" data-animation-in="fadeIn"
                                    ...
                                    <!-- Mega Menu -->
                                    <div class="w-100 hs-mega-menu u-shadow-v11 font-weight-normal g-text-transform-none g-brd-top g-brd-primary g-brd-top-2 g-pa-20 g-pb-0 g-pa-0--md g-mt-17 g-mt-7--lg--scrolling"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <ul class="nav flex-column u-nav-v1-1 u-nav-gray-light-v5 g-height-100x--md g-brd-right--md g-brd-gray-light-v4"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active g-py-10--md g-px-15--md"
                                                            href="#tab-blocks" role="tab"
                                                            data-toggle="tab">Blocks
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link g-py-10--md g-px-15--md"
                                                            href="#tab-elements" role="tab"
                                                            data-toggle="tab">Elements
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <section class="g-py-20">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li>
                                                                            <a href="#!"
                                                                                class="nav-link active g-px-0 g-color-primary--hover">Box
                                                                                Shadows</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="#!"
