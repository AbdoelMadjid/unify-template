            ...
            <div class="row no-gutters align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="js-carousel" data-autoplay="true" data-infinite="true" data-fade="true"
                        data-speed="5000">
                        <div class="js-slide g-bg-img-hero g-min-height-100vh--lg"
                        ...
                        <form class="g-py-15">
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <span class="input-group-addon g-width-45 g-brd-gray-light-v4 g-color-primary">
                                        <i
                                            class="icon-communication-128 u-line-icon-pro g-pos-rel g-top-2 g-px-5"></i>
                                    </span>
                                    <input
                                        class="form-control g-color-black g-brd-left-none g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-pl-0 g-pr-15 g-py-15"
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <span class="input-group-addon g-width-45 g-brd-gray-light-v4 g-color-primary">
                                        <i
                                            class="icon-communication-062 u-line-icon-pro g-pos-rel g-top-2 g-px-5"></i>
                                    </span>
                                    <input
                                        class="form-control g-color-black g-brd-left-none g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-pl-0 g-pr-15 g-py-15"
                            ...
                            <p class="g-font-size-13 text-center mb-0">Already have an account? <a
                                    class="g-font-weight-600" href="page-signup-11.html">Login</a>
                            </p>
                        </form>
                        <!-- End Form -->
                    </div>
