            ...
            <div class="container g-pt-100 g-pb-20">
                <div class="row justify-content-between">
                        ...
                        <div class="u-shadow-v21 g-bg-white rounded g-pa-50">
                            ...
                            <form class="g-py-15">
                                ...
                                <div class="g-mb-30">
                                    <input
                                        class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15"
                                        type="tel" placeholder="Password">
                                </div>

                                <div class="text-center mb-5">
                                    <button class="btn btn-block u-btn-primary rounded g-py-13"
                                        type="button">Signup</button>
                                </div>

                                <div class="d-flex justify-content-center text-center g-mb-30">
                                    <div
                                        class="d-inline-block align-self-center g-width-50 g-height-1 g-bg-gray-light-v1">
                                    </div>
                                ...
                                <div class="row no-gutters g-mb-40">
                                    <div class="col-6">
                                        <button class="btn btn-block u-btn-facebook rounded g-px-30 g-py-11 mr-1"
                                            type="button">Facebook</button>
                                    </div>
                                    <div class="col-6">
                                        <button class="btn btn-block u-btn-twitter rounded g-px-30 g-py-11 ml-1"
                            ...
                            <footer class="text-center">
                                <p class="g-color-gray-dark-v5 mb-0">Already have an account? <a
                                        class="g-font-weight-600" href="page-login-10.html">signin</a>
                                </p>
                            </footer>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 flex-md-first align-self-center g-mb-80">
                        <div class="mb-5">
                            <h1 class="h3 g-font-weight-600 mb-3">Profitable contracts,<br>invoices &amp; payments for
                                the best cases!</h1>
                            <p class="g-color-gray-dark-v5 g-font-size-12 text-uppercase">Trusted by 31,000+ users
                                globally</p>
                        </div>
                            ...
                            <div class="col-md-11 col-lg-9">
                                ...
                                <div class="media mb-4">
                                    ...
                                    <div class="media-body align-self-center">
                                        <p class="g-color-gray-dark-v5 mb-0">Reliable contracts, multifanctionality
                                ...
                                <!-- Testimonials -->
                                <blockquote
                                    class="u-blockquote-v1 g-color-gray-dark-v5 rounded g-pl-60 g-pr-30 g-py-25 g-mb-40">
                                    Look no further you came to the right place. Unify offers everything you have
                                    dreamed of in one package.</blockquote>
                                <div class="media">
                                    ...
                                    <div class="media-body align-self-center">
                                        ...
                                        <em class="g-color-gray-dark-v5 g-font-style-normal g-font-size-12">Web
                                            Developer</em>
                                    </div>
                                </div>
                                <!-- End Testimonials -->
