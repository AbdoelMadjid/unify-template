                        ...
                        <div class="u-shadow-v21 g-bg-white rounded g-pa-50">
                            ...
                            <form class="g-py-15">
                                ...
                                <div class="row no-gutters g-mb-40">
                                    <div class="col-6">
                                        <button class="btn btn-block u-btn-facebook rounded g-px-30 g-py-13 mr-1"
                                            type="button">Facebook</button>
                                    </div>
                                    <div class="col-6">
                                        <button class="btn btn-block u-btn-twitter rounded g-px-30 g-py-13 ml-1"
                            ...
                            <footer class="text-center">
                                <p class="g-color-gray-dark-v5 mb-0">Don't have an account? <a
                                        class="g-font-weight-600" href="page-signup-10.html">signup</a>
                                </p>
                            </footer>
                        </div>
                    </div>
