            ...
            <div class="row">
                <div class="col-lg-5 flex-lg-unordered g-mb-80">
                        ...
                        <form class="g-py-15">
                            ...
                            <div class="form-group g-mb-20">
                                <select
                                    ...
                                    style="width: 100%;" data-placeholder="Gender" data-open-icon="fa fa-angle-down"
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-12 col-lg-6 g-mb-20">
                                    <select
                                        class="js-custom-select u-select-v1 g-brd-gray-light-v3 g-color-gray-dark-v5 rounded g-py-12"
                                        style="width: 100%;" data-placeholder="Month" data-open-icon="fa fa-angle-down"
                                        data-close-icon="fa fa-angle-up">
                                        <option></option>
                            ...
                            <div class="mb-1">
                                <label
                                    class="form-check-inline u-check g-color-gray-dark-v5 g-font-size-13 g-pl-25 mb-2">
                    ...
                    <div class="text-center">
                        <p class="g-color-gray-dark-v5 mb-0">Already have an account? <a class="g-font-weight-600"
                                href="page-login-12.html">signin</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-7 flex-lg-first g-mb-80">
                    <div class="g-pr-20--lg">
                        <div class="mb-5">
                            ...
                            <p class="g-color-gray-dark-v5">The time has come to bring those ideas and plans to life.
                        ...
                        <div class="row text-center mb-5">
                            <div class="col-sm-4 g-mb-10">
                                ...
                                <div class="g-bg-gray-light-v5 g-pa-20">
                                    <div
                                        class="js-counter g-color-gray-dark-v5 g-font-weight-300 g-font-size-30 g-line-height-1">
                                        52147</div>
                        ...
                        <div class="text-center">
                            <h2 class="h4 mb-4">Join more than <span class="g-color-primary">13,000</span> members
                                worldwide</h2>
            ...
            <div class="container g-pt-25 g-pb-10">
                <div class="row justify-content-between align-items-center">
                    <div class="col-sm-6 col-md-8 g-mb-15">
                        <h3 class="h4 g-color-white g-font-weight-300 text-uppercase">Subscribe to our weekly <span
                                class="g-font-weight-600">Newsletter</span></h3>
                    </div>
