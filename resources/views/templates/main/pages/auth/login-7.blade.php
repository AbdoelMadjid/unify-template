...
<body>
    <main>
        <!-- Login -->
        <section class="g-height-100vh g-flex-centered g-bg-size-cover g-bg-pos-top-center"
            style="background-image: url(assets/img-temp/1920x1080/img45.jpg);">
                    ...
                    <div class="col-sm-8 col-lg-5">
                        <div class="g-bg-white rounded g-py-40 g-px-30">
                            ...
                            <form class="g-py-15">
                                ...
                                <div class="mb-4">
                                    <button class="btn btn-md btn-block u-btn-primary rounded g-py-13"
                            ...
                            <footer class="text-center">
                                <p class="g-color-gray-dark-v5 g-font-size-13 mb-0">Don't have an account? <a
                                        class="g-font-weight-600" href="page-signup2.html">signup</a>
                                </p>
                            </footer>
                        </div>
                    </div>
