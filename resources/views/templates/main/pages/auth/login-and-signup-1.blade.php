...
<body>
    <main>
        ...
        <section class="u-bg-overlay g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after g-py-100"
            style="background-image: url(assets/img-temp/1920x1080/img24.jpg);">
            <div class="container u-bg-overlay__inner">
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-lg-8">
                        ...
                        <p class="lead g-color-white">The time has come to bring those ideas and plans to life. This
                        ...
                        <div class="g-pa-50">
                            ...
                            <form class="g-py-15">
                                ...
                                <div class="text-center g-pos-rel pb-2 g-mb-60">
                                    ...
                                    <span
                                        class="u-icon-v2 u-icon-size--lg g-brd-white g-color-white g-bg-teal g-font-size-default rounded-circle text-uppercase g-absolute-centered g-pa-24">OR</span>
                                </div>

                                <button class="btn btn-block u-btn-facebook rounded text-uppercase g-py-13 g-mb-15"
                                    type="button">
                                    <i class="mr-3 fa fa-facebook"></i>
                                    <span class="g-hidden-xs-down">Login with</span> Facebook
                                </button>
                                <button class="btn btn-block u-btn-twitter rounded text-uppercase g-py-13"
                                    type="button">
                    ...
                    <div class="col-lg-5 g-bg-white g-rounded-right-5--lg-up">
                        <div class="g-pa-50">
                            ...
                            <form class="g-py-15">
                                ...
                                <p class="mb-4">Profitable contracts, invoices &amp; payments for the best cases!
                                </p>
