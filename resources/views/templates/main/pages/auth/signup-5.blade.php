                ...
                <div class="col-sm-10 col-md-9 col-lg-6">
                    <div class="g-brd-around g-brd-gray-light-v4 rounded g-py-40 g-px-30">
                        ...
                        <form class="g-py-15">
                            ...
                            <button class="btn btn-md btn-block u-btn-primary rounded-0 g-py-15 mb-5"
                            ...
                            <ul class="list-inline text-center mb-4">
                                ...
                                <li class="list-inline-item g-mx-2">
                                    <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-white g-bg-twitter rounded-circle"
                                        href="#!">
                                        <i
                                ...
                                <li class="list-inline-item g-mx-2">
                                    <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-white g-bg-linkedin rounded-circle"
                                        href="#!">
                                        <i
                        ...
                        <footer class="text-center">
                            <p class="g-color-gray-dark-v5 g-font-size-13 mb-0">Already have an account? <a
                                    class="g-font-weight-600" href="page-signup5.html">signin</a>
                            </p>
                        </footer>
                    </div>
                </div>
