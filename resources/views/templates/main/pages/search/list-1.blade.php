            ...
            <div class="container">
                ...
                <article>
                    <header class="g-mb-15">
                        ...
                        <span
                            class="g-color-primary">https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697?ref=htmlstream</span>
                    </header>
                ...
                <article>
                    <header class="g-mb-15">
                        <h2 class="h4 g-mb-5">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Admin UI
                                Kit - Free PSD &amp; Sketch</a>
                        </h2>
                ...
                <article>
                    <header class="g-mb-15">
                        <h2 class="h4 g-mb-5">
                            <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Pixel UI
                                Kit - Over 300 Sketch Layouts</a>
                        </h2>
