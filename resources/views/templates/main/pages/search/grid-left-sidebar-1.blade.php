                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 g-pr-40--lg g-mb-50 g-mb-0--lg">
                        ...
                        <ul class="list-unstyled g-mb-40">
                            ...
                            <li class="my-3">
                                <a class="d-flex justify-content-between u-link-v5 g-color-gray-dark-v1"
                                    href="#!">
                                    Development <span
                        ...
                        <div class="row">
                                ...
                                <article class="g-pa-25 u-shadow-v11 rounded">
                                    <h2 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Unify - Responsive Website Template</a>
                                    </h2>
                                    ...
                                    <p class="g-mb-15">Nullam elementum tincidunt massa, a pulvinar leo ultricies ut.
                                        Ut fringilla lectus tellusimp imperdiet molestie est volutpat at, sed viverra
                                        cursus nibh. At vero eos et accusamus et iusto odio dignissimos ducimus qui
                            ...
                            <div class="col-lg-6 g-mb-30">
                                ...
                                <article class="g-pa-25 u-shadow-v11 rounded">
                                    <h2 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Stream - Bootstrap 4 UI Kit Pro Freebie</a>
                                    </h2>
                        ...
                        <div class="row">
                            <div class="col-lg-6 g-mb-30">
                                ...
                                <article class="g-pa-25 u-shadow-v11 rounded">
                                    ...
                                    <ul class="list-inline d-flex justify-content-between g-mb-20">
                                        <li class="list-inline-item g-mr-10">
                                            <img class="g-height-25 g-width-25 rounded-circle g-mr-5"
                                                src="assets/img-temp/100x100/img14.jpg" alt="Image Description"> <a
                                                class="u-link-v5 g-color-main g-color-primary--hover"
                                                href="#!">David Miller</a>
                                        </li>
                                        <li class="list-inline-item">
                            ...
                            <div class="col-lg-6 g-mb-30">
                                ...
                                <article class="g-pa-25 u-shadow-v11 rounded">
                                    <h2 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Pixel UI Kit - Over 300 Sketch Layouts</a>
                                    </h2>
                        ...
                        <div class="row">
                            <div class="col-lg-6 g-mb-30">
                                ...
                                <article class="g-pa-25 u-shadow-v11 rounded">
                                    <h2 class="h4 g-mb-15">
                                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover"
                                            href="#!">Admin UI Kit - Free PSD &amp; Sketch</a>
                                    </h2>
