    ...
    <main>
        ...
        <section class="g-pt-50 g-pb-90">
            <div class="container">
                ...
                <article>
                    ...
                    <div class="d-lg-flex justify-content-between align-items-center g-mb-15">
                        ...
                        <ul class="list-inline g-mb-10 g-mb-0--lg">
                            ...
                            <li class="list-inline-item g-mr-30">
                                <i class="icon-calendar g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> 2 weeks
                                ago
                            </li>
                            <li class="list-inline-item g-mr-30">
                                ...
                                <div class="dropdown g-mb-10 g-mb-0--md">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right rounded-0 g-mt-10">
                                        <a class="dropdown-item g-px-10" href="#!">
                                            <i class="icon-directions g-font-size-12 g-color-gray-dark-v5 g-mr-5"></i>
                                            Report
                                        </a>
                                        <a class="dropdown-item g-px-10" href="#!">
                                        ...
                                        <a class="dropdown-item g-px-10" href="#!">
                                            <i class="icon-question g-font-size-12 g-color-gray-dark-v5 g-mr-5"></i>
                                            Info
                                        </a>
                                        <a class="dropdown-item g-px-10" href="#!">
                                            <i
                    ...
                    <p class="g-mb-15">Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla
                        lectus tellusimp imperdiet molestie est volutpat at, sed viverra cursus nibh. At vero eos et
                ...
                <article>
                    ...
                    <div class="d-lg-flex justify-content-between align-items-center g-mb-15">
                        ...
                        <ul class="list-inline g-mb-10 g-mb-0--lg">
                            ...
                            <li class="list-inline-item g-mr-30">
                                <i class="icon-calendar g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> 3 weeks
                                ago
                            </li>
                            <li class="list-inline-item">
                    ...
                    <p class="g-mb-15">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                        praesentium voluptatum deleniti atque corrupti quos dolores. Nullam elementum tincidunt massa, a
                        pulvinar leo ultricies ut. Ut fringilla lectus tellusimp imperdiet molestie
                ...
                <article>
                    <h2 class="h4 g-mb-15">
                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Admin UI Kit
                            - Free PSD &amp; Sketch</a>
                    </h2>
                    ...
                    <div class="d-lg-flex justify-content-between align-items-center g-mb-15">
                        ...
                        <ul class="list-inline g-mb-10 g-mb-0--lg">
                            ...
                            <li class="list-inline-item g-mr-30">
                                <i class="icon-calendar g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> 4 weeks
                                ago
                            </li>
                            <li class="list-inline-item">
                ...
                <article>
                    <h2 class="h4 g-mb-15">
                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Dribbble
                            Mockups - PSD Freebies For Themes</a>
                    </h2>
                    ...
                    <div class="d-lg-flex justify-content-between align-items-center g-mb-15">
                        ...
                        <ul class="list-inline g-mb-10 g-mb-0--lg">
                            ...
                            <li class="list-inline-item g-mr-30">
                                <i class="icon-calendar g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> 1 month
                                ago
                            </li>
                            <li class="list-inline-item">
                ...
                <article>
                    <h2 class="h4 g-mb-15">
                        <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Pixel UI Kit
                            - Over 300 Sketch Layouts</a>
                    </h2>
                        ...
                        <ul class="list-inline g-mb-10 g-mb-0--lg">
                            <li class="list-inline-item g-mr-30">
                                <img class="g-height-25 g-width-25 rounded-circle g-mr-5"
                                    ...
                                    class="u-link-v5 g-color-main g-color-primary--hover" href="#!">Pixeel</a>
                            </li>
                            <li class="list-inline-item g-mr-30">
                                <i class="icon-calendar g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> 2 months
                                ago
                            </li>
                            <li class="list-inline-item">
