                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card border-0 g-mb-40">
                            ...
                            <div
                                class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
                                <h3 class="h6 mb-0">
                                    <i class="icon-heart g-pos-rel g-top-1 g-mr-5"></i> Reviews <small>(option
                                        1)</small>
                                </h3>
                                <div class="dropdown g-mb-10 g-mb-0--md">
                                    <span class="d-block g-color-primary--hover g-cursor-pointer g-mr-minus-5 g-pa-5"
                            ...
                            <div class="card-block g-pa-0">
                                <div class="media g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-20">
                                    <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-2 g-mr-20"
                                        src="assets/img-temp/100x100/img14.jpg" alt="Image Description">
                                    <div class="media-body">
                                        <div
                                            class="d-sm-flex justify-content-sm-between align-items-sm-center g-mb-15 g-mb-10--sm">
                                        ...
                                        <p>First of all, thank you very much for making this theme! It is beautiful both
                                            when looked at in the browser and especially also when looking at the HTML,
                                            CSS etc. source code. Close too Bootstrap, great technical quality and
                                            documentation:
                                            your theme is clearly the best! And I've really looked at and compared
                                            *lots* of them! :-)</p>
                                ...
                                <div class="media g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-20">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>Thanks a lot. You have no idea how much I appreciate all your help. You are
                                            not just a great designer but an amazing human being, because so many people
                                            won't give a rat ass about what happen to their clients AFTER THE SALE, and
                                            you
                                ...
                                <a class="btn btn-block u-btn-darkgray rounded-0 g-py-10" href="#!">Load
                                    More</a>
                            </div>
                            <!-- End Panel Body -->
                        </div>
                        ...
                        <div class="card border-0 g-mb-40">
                            ...
                            <div class="card-block g-pa-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 g-mb-30">
                                        ...
                                        <div class="g-brd-around g-brd-blue g-pa-40">
                                            <blockquote class="lead text-center g-mb-40">Dear Htmlstream team, I just
                                                bought the Unify template some weeks ago. The template is really nice
                                                and offers quite a large set of options.</blockquote>
                                    ...
                                    <div class="col-lg-4 g-mb-30">
                                        ...
                                        <div class="g-brd-around g-brd-pink g-pa-40">
                                            <blockquote class="lead text-center g-mb-40">Hi there purchased a couple
                                                of days ago and the site looks great, big thanks to the htmlstream guys,
                                                they gave me some great help.</blockquote>
                                            <div class="d-flex justify-content-center">
                                                <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3"
                                    ...
                                    <div class="col-lg-4 g-mb-30">
                                        ...
                                        <div class="g-brd-around g-brd-purple g-pa-40">
                                            <blockquote class="lead text-center g-mb-40">Your customer support is the
                                                best I have experienced with any theme I have purchased. You have a
                                                theme that far exceeds all others.</blockquote>
                                            <div class="d-flex justify-content-center">
                                                <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3"
                                ...
                                <a class="btn btn-block u-btn-primary rounded-0 g-py-10" href="#!">Load
                                    More</a>
                            </div>
                            <!-- End Panel Body -->
                        </div>
