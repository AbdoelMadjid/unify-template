                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card border-0 g-mb-40">
                            ...
                            <div
                                class="card-header d-flex align-items-center justify-content-between g-bg-gray-light-v5 border-0 g-mb-15">
                                <h3 class="h6 mb-0">
                                    <i class="icon-bubbles g-pos-rel g-top-1 g-mr-5"></i> Comments <small>(option
                                        1)</small>
                                </h3>
                                <div class="dropdown g-mb-10 g-mb-0--md">
                                    <span class="d-block g-color-primary--hover g-cursor-pointer g-mr-minus-5 g-pa-5"
                            ...
                            <div class="card-block g-pa-0">
                                <div class="media g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-20">
                                    ...
                                    <div class="media-body">
                                        <div
                                            ...
                                            <h5 class="h4 g-font-weight-300 g-mr-10 g-mb-5 g-mb-0--sm">James Coolman
                                            </h5>
                                ...
                                <div class="media g-brd-around g-brd-gray-light-v4 g-pa-20 g-ml-40 g-mb-20">
                                    ...
                                    <div class="media-body">
                                        <div
                                            class="d-sm-flex justify-content-sm-between align-items-sm-center g-mb-15 g-mb-10--sm">
                                            <h5 class="h4 g-font-weight-300 g-mr-10 g-mb-5 g-mb-0--sm">Alberta Watson
                                            </h5>
                                            <div class="text-nowrap g-font-size-12">
                                        ...
                                        <ul class="list-inline g-mb-10 g-mb-20--md">
                                            <li class="list-inline-item g-mb-10 g-mb-0--md">
                                                <img class="g-width-100 g-height-100"
                                            ...
                                            <li class="list-inline-item u-bg-overlay g-bg-black-opacity-0_5--after">
                                                ...
                                                <a class="u-link-v5 u-bg-overlay__inner g-absolute-centered g-color-white g-color-primary--hover text-center"
                                                    href="#!">
                                ...
                                <a class="btn btn-block u-btn-darkgray rounded-0 g-py-13" href="#!">Load
                                    More</a>
                            </div>
                            <!-- End Panel Body -->
                        </div>
                        ...
                        <div class="card border-0 g-mb-40">
                            ...
                            <div class="card-block g-pa-0">
                                ...
                                <a class="btn btn-block u-btn-primary rounded-0 g-py-13" href="#!">Load
                                    More</a>
                            </div>
                            <!-- End Panel Body -->
                        </div>
