                    ...
                    <div class="col-lg-3 g-mb-50 g-mb-0--lg">
                        ...
                        <div class="card border-0 rounded-0 g-mb-50">
                            ...
                            <div
                                ...
                                <!-- WordPress Coding -->
                                <div class="g-mb-20">
                                    <h6 class="g-mb-10">WordPress Coding <span class="float-right g-ml-10">74%</span>
                                    </h6>
                                    <div class="js-hr-progress-bar progress g-bg-black-opacity-0_1 rounded-0 g-mb-5">
                        ...
                        <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
                            <div class="row">
                                <div class="col-lg-4 g-mb-40 g-mb-0--lg">
                                    <!-- User Image -->
                                    <div class="g-mb-20">
                                        <img class="img-fluid w-100" src="assets/img-temp/400x450/img5.jpg"
                                            alt="Image Description">
                                    </div>
                                    <!-- User Image -->

                                    <!-- User Contact Buttons -->
                                    <a class="btn btn-block u-btn-outline-primary g-rounded-50 g-py-12 g-mb-10"
                                        href="#!">
                                        <i class="icon-user-follow g-pos-rel g-top-1 g-mr-5"></i> Follow Me
                                    </a>
                                    <a class="btn btn-block u-btn-darkgray g-rounded-50 g-py-12 g-mb-10"
                                        href="#!">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <ul class="list-inline g-font-weight-300">
                                        <li class="list-inline-item g-mr-20">
                                            <i
                                                class="icon-location-pin g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i>
                                            London, UK
                                        </li>
                                        <li class="list-inline-item g-mr-20">
                                    ...
                                    <p class="lead g-line-height-1_8">About elementum tincidunt massa, a pulvinar leo
                                        ultricies ut. Ut fringilla lectus tellusimp imperdiet molestie est. Dell viverra
                                        cursus nibh volutpat at.</p>
                                    ...
                                    <div class="d-flex flex-wrap text-center">
                                        ...
                                        <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                                            <div class="js-pie g-color-purple g-mb-5" data-circles-value="54"
                                                ...
                                                data-circles-fg-color="#9b6bcc" data-circles-radius="30"
                                                data-circles-stroke-width="3" data-circles-additional-text="%"
                                        ...
                                        <!-- Counter Pie Chart -->
                                        <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                                            <div class="js-pie g-color-blue g-mb-5" data-circles-value="72"
                                                data-circles-max-value="100" data-circles-bg-color="#bee3f7"
                                                data-circles-fg-color="#3498db" data-circles-radius="30"
                                                data-circles-stroke-width="3" data-circles-additional-text="%"
                                                data-circles-duration="2000" data-circles-scroll-animate="true"
                                                data-circles-font-size="14">
                                            </div>
                                        ...
                                        <!-- Counter Pie Chart -->
                                        <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                                            <div class="js-pie g-color-lightred g-mb-5" data-circles-value="81"
                                                data-circles-max-value="100" data-circles-bg-color="#ffc2bb"
                                                data-circles-fg-color="#e74c3c" data-circles-radius="30"
                                                data-circles-stroke-width="3" data-circles-additional-text="%"
                                                data-circles-duration="2000" data-circles-scroll-animate="true"
                                                data-circles-font-size="14">
                                            </div>
                                        ...
                                        <!-- Counter Pie Chart -->
                                        <div class="g-mr-40 g-mb-20 g-mb-0--xl">
                                            <div class="js-pie g-color-primary g-mb-5" data-circles-value="83"
                                                data-circles-max-value="100" data-circles-bg-color="#c9ff97"
                                                data-circles-fg-color="#72c02c" data-circles-radius="30"
                                                data-circles-stroke-width="3" data-circles-additional-text="%"
                                                data-circles-duration="2000" data-circles-scroll-animate="true"
                                                data-circles-font-size="14">
                                            </div>
                                        ...
                                        <div class="g-mb-20 g-mb-0--lg">
                                            <div class="js-pie g-mb-5" data-circles-value="92"
                                                data-circles-max-value="100" data-circles-bg-color="#eeeeee"
                                                data-circles-fg-color="#111111" data-circles-radius="30"
                                                data-circles-stroke-width="3" data-circles-additional-text="%"
                                                data-circles-duration="2000" data-circles-scroll-animate="true"
                                                data-circles-font-size="14">
                                            </div>
                        ...
                        <div class="card border-0 rounded-0 g-mb-40">
                            ...
                            <div
                                ...
                                <ul class="row u-timeline-v2-wrap list-unstyled">
                                    <li
                                        class="col-md-12 g-brd-bottom g-brd-0--md g-brd-gray-light-v4 g-pb-30 g-pb-0--md g-mb-30 g-mb-0--md">
                                        <div class="row">
                                            <!-- Timeline Date -->
                                            <div
                                                class="col-md-3 align-self-center text-md-right g-pr-40--md g-mb-20 g-mb-0--md">
                                            ...
                                            <div class="col-md-9 align-self-center g-orientation-left g-pl-40--md">
                                                ...
                                                <div class="g-hidden-sm-down u-timeline-v2__icon g-top-35">
                                                    <i
                                                        class="d-block g-width-18 g-height-18 g-bg-primary g-brd-around g-brd-4 g-brd-gray-light-v4 rounded-circle"></i>
                                                </div>
                                                <!-- End Timeline Dot -->

                                                <article class="g-pa-10--md">
                                                    <h3 class="h4 g-font-weight-300">Pixeel Ltd.</h3>
                                                    <p class="mb-0">Winter purslane courgette pumpkin quandong
                                                        komatsuna fennel green bean cucumber. Pea cress potato sprouts
                                                        wattle seed rutabaga.</p>
                                                </article>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="d-flex g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <a class="u-icon-v3 u-icon-size--xs g-bg-facebook g-color-white rounded-circle g-mr-15"
                                                    href="#!"><i class="fa fa-facebook"></i></a>
                                                <a class="g-color-facebook" href="#!">77johndoe</a>
                                            </li>
                                            <li class="d-flex g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <a class="u-icon-v3 u-icon-size--xs g-bg-twitter g-color-white rounded-circle g-mr-15"
                                                    href="#!"><i class="fa fa-twitter"></i></a>
                                                <a class="g-color-twitter" href="#!">john-doe1977</a>
                                            </li>
                                            <li class="d-flex g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <a class="u-icon-v3 u-icon-size--xs g-bg-darkblue g-color-white rounded-circle g-mr-15"
                                                    href="#!"><i class="fa fa-paypal"></i></a>
                                                <a class="g-color-darkblue g-color-darkblue--hover"
                                                    href="#!">john.doe@htmlstream.com</a>
                                            </li>
                                            <li class="d-flex g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <a class="u-icon-v3 u-icon-size--xs g-bg-lightred g-color-white rounded-circle g-mr-15"
                                                    href="#!"><i class="fa fa-google-plus"></i></a>
                                                <a class="g-color-lightred g-color-lightred--hover"
                                                    href="#!">john_doe</a>
                                            </li>
                                            <li class="d-flex g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <a class="u-icon-v3 u-icon-size--xs g-bg-black g-color-white rounded-circle g-mr-15"
                                                    href="#!"><i class="fa fa-github"></i></a>
                                                <a class="g-color-black g-color-black--hover"
                                                    href="#!">john.doe.github</a>
                                            </li>
                                            <li class="d-flex g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <a class="u-icon-v3 u-icon-size--xs g-bg-skype g-color-white rounded-circle g-mr-15"
                                                    href="#!"><i class="fa fa-skype"></i></a>
                                                <a class="g-color-skype" href="#!">john_doe_723</a>
                                            </li>
                                            <li class="d-flex g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <a class="u-icon-v3 u-icon-size--xs g-bg-linkedin g-color-white rounded-circle g-mr-15"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card border-0 rounded-0">
                                    ...
                                    <div
                                        ...
                                        <ul class="list-unstyled">
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-facebook g-color-facebook g-pos-rel g-top-1 g-mr-10"></i>
                                                    Facebook</span>
                                                <a class="g-color-facebook" href="#!">77johndoe</a>
                                            </li>
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-twitter g-color-twitter g-pos-rel g-top-1 g-mr-10"></i>
                                                    Twitter</span>
                                                <a class="g-color-twitter" href="#!">john-doe1977</a>
                                            </li>
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-paypal g-color-darkblue g-pos-rel g-top-1 g-mr-10"></i>
                                                    PayPal</span>
                                                <a class="g-color-darkblue g-color-darkblue--hover"
                                                    href="#!">john.doe@htmlstream.com</a>
                                            </li>
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-google g-color-lightred g-pos-rel g-top-1 g-mr-10"></i>
                                                    Google Plus</span>
                                                <a class="g-color-lightred g-color-lightred--hover"
                                                    href="#!">john_doe</a>
                                            </li>
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-github g-color-black g-pos-rel g-top-1 g-mr-10"></i>
                                                    Github</span>
                                                <a class="g-color-black g-color-black--hover"
                                                    href="#!">john.doe.github</a>
                                            </li>
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-skype g-color-skype g-pos-rel g-top-1 g-mr-10"></i>
                                                    Skype</span>
                                                <a class="g-color-skype" href="#!">john_doe_723</a>
                                            </li>
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-linkedin g-color-linkedin g-pos-rel g-top-1 g-mr-10"></i>
                                                    Linkedin</span>
                                                <a class="g-color-linkedin" href="#!">john.doe77</a>
                                            </li>
                                            <li
                                                class="d-flex justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-10 g-px-15">
                                                <span class="text-nowrap g-mr-10"><i
                                                        class="fa fa-envelope g-color-lightred g-pos-rel g-top-1 g-mr-10"></i>
                                                    Gmail</span>
                                                <a class="g-color-lightred g-color-lightred--hover"
                                                    href="#!">john.doe@htmlstream.com</a>
                                            </li>
