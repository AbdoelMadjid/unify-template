                        ...
                        <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-30">
                            <div class="row">
                                <div class="col-lg-3 text-center g-mb-40 g-mb-0--lg">
                                    <!-- User Image -->
                                    <div class="g-mb-20">
                                        <img class="img-fluid" src="assets/img-temp/400x450/img1.jpg"
                                            alt="Image Description">
                                    </div>
                                    <!-- User Image -->

                                    <!-- User Contact Buttons -->
                                    <a class="btn u-btn-outline-primary d-lg-block g-rounded-50 g-py-12 g-px-20 g-mb-10 g-mr-10 g-mr-0--lg"
                                        href="#!">
                                        <i class="icon-user-follow g-pos-rel g-top-1 g-mr-5"></i> Follow Me
                                    </a>
                                    <a class="btn u-btn-darkgray d-lg-block g-rounded-50 g-py-12 g-px-20 g-mb-10"
                                        href="#!">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="lead g-line-height-1_8">
                                        <p>About elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla
                                            lectus tellusimp imperdiet molestie est. Dell viverra cursus nibh volutpat
                                            at. This is where we sit down, grab a cup of coffee and dial in the details.
                                            Understanding
                        ...
                        <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-30">
                            <div class="row">
                                <div class="col-lg-3 text-center g-mb-40 g-mb-0--lg">
                                    <!-- User Image -->
                                    <div class="g-mb-20">
                                        <img class="img-fluid" src="assets/img-temp/400x450/img6.jpg"
                                            alt="Image Description">
                                    </div>
                                    <!-- User Image -->
                        ...
                        <div class="g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-40">
                            <div class="row">
                                <div class="col-lg-3 text-center g-mb-40 g-mb-0--lg">
                                    <!-- User Image -->
                                    <div class="g-mb-20">
                                        <img class="img-fluid" src="assets/img-temp/400x450/img2.jpg"
                                            alt="Image Description">
                                    </div>
                                    <!-- User Image -->
