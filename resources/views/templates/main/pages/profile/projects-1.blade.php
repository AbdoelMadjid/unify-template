                    ...
                    <div class="col-lg-3 g-mb-50 g-mb-0--lg">
                        ...
                        <div class="list-group list-group-border-0 g-mb-40">
                            ...
                            <a href="page-profile-projects-1.html"
                                ...
                                <span
                                    class="u-label g-font-size-11 g-bg-white g-color-main g-rounded-20 g-px-10">9</span>
                            </a>
                            <!-- End My Projects -->
                    ...
                    <div class="col-lg-9">
                                ...
                                <ul class="list-unstyled">
                                    <li
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>Curabitur hendrerit dolor sit amet consectetur. Adipiscing elitut leosit
                                                amet, consectetur eleifend.</p>
                                            <span
                                    ...
                                    <li
                                        ...
                                        <div class="media-body">
                                            <div class="d-flex justify-content-between">
                                                <h5 class="h6 g-font-weight-600 g-color-black">UX/UI Design and
                                                    Backend</h5>
                                                <span class="small text-nowrap g-color-pink">16 min ago</span>
                                            </div>
                                            <p>Hac consectetur habitasse platea dictumst, adipiscing elitut leosit amet,
                        ...
                        <div class="card border-0 g-mb-40">
                            ...
                            <div
                                ...
                                <ul class="list-unstyled">
                                    <li
                                        class="g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-blue-left rounded g-pa-20 g-mb-10">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <ul class="u-list-inline">
                                                ...
                                                <li class="list-inline-item mr-0">
                                                    <a class="u-link-v4 d-inline-block g-bg-blue g-color-white g-font-weight-600 g-text-underline--none--hover rounded g-py-8 g-px-11"
                                                        href="#!">5+</a>
                                                </li>
                                            </ul>
                                            <div class="align-self-center">
                                                <a class="btn u-btn-outline-blue g-rounded-50"
                                                    href="#!">Follow</a>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li
                                        class="g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-pink-left rounded g-pa-20 g-mb-10">
                                        <div class="d-flex justify-content-start">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <ul class="u-list-inline">
                                                ...
                                                <li class="list-inline-item mr-0">
                                                    <a class="u-link-v4 d-inline-block g-bg-pink g-color-white g-font-weight-600 g-text-underline--none--hover rounded g-py-8 g-px-11"
                                                        href="#!">17+</a>
                                                </li>
                                            </ul>
                                            <div class="align-self-center">
                                                <a class="btn u-btn-outline-pink g-rounded-50"
                                                    href="#!">Follow</a>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li
                                        class="g-brd-around g-brd-gray-light-v4 g-brd-left-3 g-brd-primary-left rounded g-pa-20 g-mb-10">
                                        <div class="d-flex justify-content-start">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <ul class="u-list-inline">
                                                ...
                                                <li class="list-inline-item mr-0">
                                                    <a class="u-link-v4 d-inline-block g-bg-primary g-color-white g-font-weight-600 g-text-underline--none--hover rounded g-py-8 g-px-11"
                                                        href="#!">9+</a>
                                                </li>
                                            </ul>
                                            <div class="align-self-center">
                                                <a class="btn u-btn-outline-primary g-rounded-50"
                                                    href="#!">Follow</a>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <table class="table table-bordered u-table--v2">
                                        <thead class="text-uppercase g-letter-spacing-1">
                                            <tr>
                                                ...
                                                <th class="g-font-weight-300 g-color-black g-min-width-200">Project
                                                    Description</th>
                                                <th class="g-font-weight-300 g-color-black g-min-width-130">Status
                                                </th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="align-middle text-nowrap text-center">
                                                    <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle"
                                                        src="assets/img-temp/100x100/img3.jpg" data-toggle="tooltip"
                                                        data-placement="top" data-original-title="Pixeel Ltd"
                                                        alt="Image Description">
                                                </td>
                                                <td class="align-middle">Nulla ipsum dolor sit amet, consectetur
                                                    adipiscing elitut eleifend nisl.</td>
                                                <td class="align-middle">
                                                    <div class="js-hr-progress-bar progress rounded-0">
                                                        <div class="js-hr-progress-bar-indicator progress-bar u-progress-bar--xs"
                                                ...
                                                <td class="align-middle">
                                                    <div class="js-rating g-font-size-121 g-color-primary"
                                                        data-rating="4" data-spacing="3"></div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        <i
                                            ...
                                            <tr>
                                                <td class="align-middle text-nowrap text-center">
                                                    <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle"
                                                        src="assets/img-temp/100x100/img1.jpg" data-toggle="tooltip"
                                                        data-placement="top" data-original-title="Htmlstream"
                                                        alt="Image Description">
                                                </td>
                                                <td class="align-middle">In consectetur adipiscing hac habitasse
                                                    platea dictumst, curabitur hendrerit.</td>
                                                <td class="align-middle">
                                                    <div class="js-hr-progress-bar progress rounded-0">
                                                        <div class="js-hr-progress-bar-indicator progress-bar u-progress-bar--xs g-bg-cyan"
                                                ...
                                                <td class="align-middle">
                                                    <div class="js-rating g-color-primary" data-rating="4.5"
                                                        data-spacing="3"></div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                            ...
                                            <tr>
                                                <td class="align-middle text-nowrap text-center">
                                                    <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle"
                                                        src="assets/img-temp/100x100/img4.jpg" data-toggle="tooltip"
                                                        data-placement="top" data-original-title="Starbucks"
                                                        alt="Image Description">
                                                </td>
                                                <td class="align-middle">To a general advertiser outdoor advertising
                                                    is worthy of consideration..</td>
                                                <td class="align-middle">
                                                    <div class="js-hr-progress-bar progress rounded-0">
                                                        <div class="js-hr-progress-bar-indicator progress-bar u-progress-bar--xs g-bg-purple"
                                                ...
                                                <td class="align-middle">
                                                    <div class="js-rating g-color-primary" data-rating="2.5"
                                                        data-spacing="3"></div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                            ...
                                            <tr>
                                                <td class="align-middle text-nowrap text-center">
                                                    <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle"
                                                        src="assets/img-temp/100x100/img2.jpg" data-toggle="tooltip"
                                                        data-placement="top" data-original-title="Wrapbootstrap"
                                                        alt="Image Description">
                                                </td>
                                                <td>Create a list with all possible keywords that fit to your product,
                                                    service or business..</td>
                                                <td class="align-middle">
                                                    <div class="js-hr-progress-bar progress rounded-0">
                                                        <div class="js-hr-progress-bar-indicator progress-bar u-progress-bar--xs g-bg-lightred"
                                                ...
                                                <td class="align-middle">
                                                    <div class="js-rating g-color-primary" data-rating="5"
                                                        data-spacing="3"></div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                            ...
                                            <tr>
                                                <td class="align-middle text-nowrap text-center">
                                                    <img class="g-brd-around g-brd-gray-light-v4 g-pa-2 g-width-50 g-height-50 rounded-circle"
                                                        src="assets/img-temp/100x100/img5.jpg" data-toggle="tooltip"
                                                        data-placement="top" data-original-title="Pinterest"
                                                        alt="Image Description">
                                                </td>
                                                <td class="align-middle">Ulla consectetur ipsum dolor sit amet,
                                                    consectetur adipiscing elitut eleifend nisl.</td>
                                                <td class="align-middle">
                                                    <div class="js-hr-progress-bar progress rounded-0">
                                                        <div class="js-hr-progress-bar-indicator progress-bar u-progress-bar--xs g-bg-darkpurple"
                                                ...
                                                <td class="align-middle">
                                                    <div class="js-rating g-font-size-121 g-color-primary"
                                                        data-rating="3.5" data-spacing="3"></div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="d-flex">
                                                        <i
