                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 g-orientation-left g-pl-40--md">
                                        ...
                                        <article class="g-pos-rel g-bg-gray-light-v5 g-pa-30">
                                            ...
                                            <p class="lead g-mb-25">Winter purslane courgette pumpkin quandong
                                                komatsuna fennel green bean cucumber watercress cress avocado grape.</p>
                                            <img class="g-height-120 g-width-120 g-mb-25 g-mr-20"
                                                src="assets/img-temp/100x100/img11.jpg" alt="Image description">
                                            <img class="g-height-120 g-width-120 g-mb-25 g-mr-20"
                                                src="assets/img-temp/100x100/img12.jpg" alt="Image description">
                                            <img class="g-height-120 g-width-120 g-mb-25"
                                                src="assets/img-temp/100x100/img13.jpg" alt="Image description">
                                            <p class="lead mb-0">Pea cress potato sprouts wattle seed rutabaga okra
                                                yarrow green bean cucumber watercress cress avocado grape. Cabbage
                                                lentil cucumber chickpea sorrel gram garbanzo plantain lotus root bok
                                                choy squash cress potato.</p>
                                        </article>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 g-orientation-left g-pl-40--md">
                                        ...
                                        <article class="g-pos-rel g-bg-gray-light-v5 g-pa-30">
                                            ...
                                            <p class="lead g-mb-25">Sprouts wattle seed pumpkin quandong komatsuna
                                                fennel green bean cucumber watercress. Pea cress potato sprouts wattle
                                                seed rutabaga okra yarrow cress avocado grape.</p>
                                            <div class="row g-mb-15">
                                                <div class="col-md-5 g-mb-25 g-mb-0--md">
                                                    <img class="img-fluid w-100"
                                                        src="assets/img-temp/400x270/img9.jpg"
                                            ...
                                            <p class="lead mb-0">Cabbage lentil cucumber chickpea sorrel gram garbanzo
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 g-orientation-left g-pl-40--md">
                                        ...
                                        <article class="g-pos-rel g-bg-gray-light-v5 g-pa-30">
                                            ...
                                            <p class="lead g-mb-20">Sprouts wattle seed pumpkin quandong komatsuna
                                                fennel green bean cucumber watercress. Pea cress potato sprouts wattle
                                                seed rutabaga okra yarrow cress avocado grape.</p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex">
                                                        <span
                                                            class="u-icon-v3 g-bg-purple g-color-white g-mt-2 g-mr-15">
