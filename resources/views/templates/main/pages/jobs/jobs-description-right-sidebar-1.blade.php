            ...
            <div class="container">
                <div class="d-sm-flex text-center">
                    <div class="align-self-center">
                        <h2 class="h3 g-color-gray-dark-v1 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Jobs
                            Description</h2>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 g-mb-30 g-mb-0--lg">
                        <article class="u-shadow-v11 rounded g-pa-30">
                            ...
                            <p>Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus
                                tellusimp imperdiet molestie est volutpat at, sed viverra cursus nibh. Ut fringilla
                                lectus tellusimp imperdiet molestie. Nullam elementum tincidunt massa,
                                a pulvinar leo ultricies ut. Elementum tincidunt massa, a pulvinar leo ultricies ut. Ut
                            ...
                            <div class="g-mb-20">
                                <p>Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus
                                    tellusimp imperdiet molestie est volutpat at, sed viverra cursus nibh. Ut fringilla
                                    lectus tellusimp imperdiet molestie. Nullam elementum tincidunt massa,
                                    a pulvinar leo ultricies ut. Elementum tincidunt massa, a pulvinar leo ultricies ut.
                                </p>
                                <p>Ut fringilla lectus tellusimp imperdiet molestie. Nullam elementum tincidunt massa, a
                                    pulvinar leo ultricies ut. Fringilla lectus tellusimp imperdiet molestie est
                                    volutpat at. Sed viverra cursus nibh.</p>
                            </div>
                                ...
                                <div class="col-lg">
                                    ...
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item g-mb-10">
                                            <a class="u-tags-v1 g-font-size-13 g-color-main g-brd-around g-bg-gray-light-v5 g-bg-primary--hover g-color-white--hover rounded g-py-5 g-px-15"
                                                href="#!">Photoshop</a>
                                        </li>
                                        <li class="list-inline-item g-mb-10">
                                            <a class="u-tags-v1 g-font-size-13 g-color-main g-brd-around g-bg-gray-light-v5 g-bg-primary--hover g-color-white--hover rounded g-py-5 g-px-15"
                    ...
                    <div class="col-lg-4">
                        <aside class="u-shadow-v11 rounded g-pa-30">
                            ...
                            <!-- Google Map -->
                            <div id="gMap" class="js-g-map g-min-height-300" data-type="custom"
                                data-lat="40.674" data-lng="-73.946" data-zoom="12" data-title="Job Description"
                                data-styles='[
                     ...
                     ["water", "", [{"color":"#bac6cb"}]]
                            ...
                            <div>
                                ...
                                <!-- Holiday Offers -->
                                <div class="g-mb-20">
                                    <h6 class="g-mb-10">Holiday Offers <span class="float-right g-ml-10">78%</span>
                                    </h6>
                                    <div class="js-hr-progress-bar progress g-bg-black-opacity-0_1 rounded-0 g-mb-5">
                                ...
                                <!-- Office Facilities -->
                                <div class="g-mb-20">
                                    <h6 class="g-mb-10">Office Facilities <span class="float-right g-ml-10">84%</span>
                                    </h6>
                                    <div class="js-hr-progress-bar progress g-bg-black-opacity-0_1 rounded-0 g-mb-5">
                                        <div class="js-hr-progress-bar-indicator progress-bar u-progress-bar--xs g-bg-pink"
                                            role="progressbar" style="width: 84%;" aria-valuenow="84"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                            ...
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <li>
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="#!">
                                        <i class="icon-printer g-color-gray-dark-v5 g-pos-rel g-top-1 g-mr-5"></i>
                                        Print Job
                                    </a>
                                </li>
                            </ul>
                            ...
                            <a class="btn btn-xl btn-block u-btn-primary text-uppercase g-font-weight-600 g-font-size-12"
                                href="#!">Apply Now</a>
                        </aside>
                    </div>
                    <!-- Sidebar -->
                ...
                <div class="row g-mb-30">
                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                        ...
                        <article class="g-pa-25 u-shadow-v11 rounded">
                            <h2 class="h4 g-mb-15">
                                <a class="u-link-v5 g-color-gray-dark-v1 g-color-primary--hover" href="#!">Junior
                                    UX Designer</a>
                            </h2>
                        ...
                        <article class="g-pa-25 u-shadow-v11 rounded">
                            ...
                            <ul class="list-inline d-flex justify-content-between mb-0">
                                <li class="list-inline-item"><a
                                        class="u-tags-v1 g-font-size-12 g-color-main g-brd-around g-brd-gray-light-v3 g-bg-gray-dark-v2--hover g-brd-gray-dark-v2--hover g-color-white--hover rounded g-py-3 g-px-8"
                                        href="#!">Full-Time</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#!">See Details</a>
