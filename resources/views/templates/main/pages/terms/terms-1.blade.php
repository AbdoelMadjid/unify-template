        ...
        <section class="container g-py-150">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h2 class="g-color-black g-font-weight-700 g-font-size-50 g-line-height-1 mb-4">Terms &amp;
                        Conditions</h2>
                    <p class="mb-0">This is where we sit down, grab a cup of coffee and dial in the details.
                        Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the
                        details, it's time to get things mapped out and organized. This part is really
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div id="license" class="u-shadow-v19 g-bg-white rounded g-pa-40 g-mb-50">
                            ...
                            <p>This is where we sit down, grab a cup of coffee and dial in the details. Understanding
                                the task at hand and ironing out the wrinkles is key. Now that we've aligned the
                                details, it's time to get things mapped out and organized. This part
                            ...
                            <p>Whether through commerce or just an experience to tell your brand's story, the time has
                                come to start using development languages that fit your projects needs. Now that your
                                brand is all dressed up and ready to party, it's time to release
                                it to the world. By the way, let's celebrate already. We get it, you're busy and it's
                                important that someone keeps up with marketing and driving people to your brand. We've
                                got you covered.</p>
                        </div>
                        <!-- End License -->
