...
<!-- End Header -->
        ...
        <div class="g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-cover g-bg-black-opacity-0_5--after g-py-120"
            style="background-image: url(assets/img-temp/1920x800/img33.jpg);">
                ...
                <div class="text-center">
                    <ul class="d-inline-block list-inline g-bg-secondary g-pa-3 mb-5">
                        <li class="list-inline-item mr-0">
                            <a class="d-block active g-bg-white g-bg-primary--active g-color-black g-color-white--active g-font-weight-500 g-font-size-12 text-uppercase g-text-underline--none--hover g-px-20 g-py-10"
                                href="#">
                                Agency
                            </a>
                        </li>
                        <li class="list-inline-item mr-0">
                            <a class="d-block g-bg-white g-bg-primary--active g-color-black g-color-white--active g-font-weight-500 g-font-size-12 text-uppercase g-text-underline--none--hover g-px-20 g-py-10"
                                href="#">
                                Agency Offices
                            </a>
                        </li>
                ...
                <form>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-4 col-lg-3 g-mb-30">
                            <!-- Button Group -->
                            <select
                                class="js-custom-select w-100 u-select-v1 g-brd-gray-light-v3 g-color-black g-color-primary--hover g-bg-white g-py-12"
        ...
        <section class="g-bg-secondary">
            <div class="container g-pt-100 g-pb-130">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-9">
                        <div class="js-carousel" data-infinite="true" data-slides-show="3"
