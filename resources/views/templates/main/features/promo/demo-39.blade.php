...
<body>
    <main>
        ...
        <div class="g-bg-img-hero g-bg-cover g-bg-black-opacity-0_3--after"
            style="background-image: url(assets/img-temp/1920x1080/img55.jpg);">
                ...
                <div class="row justify-content-lg-between align-items-md-center">
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-30">
                        ...
                        <form class="u-shadow-v35 g-bg-white rounded g-px-40 g-py-50">
                            <div class="g-mb-20">
                                <label class="g-color-black g-font-weight-500 g-font-size-15 g-pl-20">Full
                                    name</label>
                                <input
                            ...
                            <div class="g-mb-20">
                                <label class="g-color-black g-font-weight-500 g-font-size-15 g-pl-20">How many
                                    seats?</label>
                                <input
                                    class="form-control g-brd-secondary-light-v2 g-bg-secondary g-bg-secondary-dark-v1--focus g-rounded-30 g-px-20 g-py-12"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-default"
                                    href="#"><i
                                        class="align-middle mr-1 icon-real-estate-027 u-line-icon-pro"></i> Get the
                                    Location</a>
                                <button type="submit"
                                    class="btn u-shadow-v32 g-color-white g-bg-primary g-bg-main--hover g-font-size-default g-rounded-30 g-px-25 g-py-7">Book</button>
                            </div>
                        </form>
                        <!-- End Contact Form -->
                    </div>
