    ...
    <main>
        ...
        <section class="g-pos-rel">
            ...
            <div class="js-carousel" data-autoplay="true" data-infinite="true" data-fade="true" data-speed="5000">
                <div class="js-slide g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-bluegray-opacity-0_5--after"
                    style="background-image: url(assets/img-temp/1920x1080/img18.jpg);" data-calc-target="#js-header">
                </div>
                <div class="js-slide g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-bluegray-opacity-0_5--after"
                    style="background-image: url(assets/img-temp/1920x1080/img19.jpg);" data-calc-target="#js-header">
                </div>
            </div>
            ...
            <div class="g-absolute-centered--y g-left-0 g-right-0 g-z-index-1">
                <div class="container text-center">
                    <h2
                        class="h2 g-color-white g-font-weight-600 g-font-size-40 g-font-size-70--md g-line-height-1 mb-5">
                        Plan your move.</h2>
                    <p class="g-color-white g-font-weight-300 g-font-size-20 g-font-size-24--md mb-5">Just select
                        where you want to move, we take care of everything.
                        <br>Enjoy your move...
                    </p>
                    <a class="btn u-btn-outline-white g-color-white g-bg-white-opacity-0_2 g-color-black--hover g-bg-white--hover g-font-weight-600 g-font-size-12 text-uppercase g-rounded-50 g-px-25 g-py-15"
