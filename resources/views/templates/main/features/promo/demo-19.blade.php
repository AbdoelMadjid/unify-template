                ...
                <div class="row justify-content-between">
                    <div class="col-md-5 align-self-center">
                        <h2 class="g-color-black g-font-size-36 text-uppercase g-line-height-1_2 g-mb-30">We created
                            <br><span class="g-font-weight-700">Revolution in App</span>
                        </h2>
                        <p class="g-color-gray-dark-v5 g-font-size-16 g-mb-35">We are a creative studio focusing on
                            culture, luxury, editorial &amp; art. Somewhere between sophistication and simplicity.</p>
                        <a class="btn btn-md u-btn-primary u-btn-hover-v1-3 g-letter-spacing-0_5 text-uppercase g-rounded-10 g-px-20 g-py-10 mx-2 g-mb-15"
                            href="#!">
                        ...
                        <a class="btn btn-md u-btn-teal u-btn-hover-v1-3 g-letter-spacing-0_5 text-uppercase g-rounded-10 g-px-20 g-py-10 mx-2 g-mb-15"
                            href="#!">
                    ...
                    <div class="col-md-6 align-self-end g-overflow-hidden">
                        <img class="img-fluid" src="assets/img/inline/inline1.png" alt="Image description"
