    ...
    <main>
        ...
        <section class="g-bg-img-hero" style="background-image: url(assets/img-temp/1920x1080/img1.jpg);">
            <div class="container g-pos-rel g-z-index-1 g-py-150">
                <div class="g-mb-40">
                    <h1
                        class="g-color-white g-font-weight-700 g-font-size-80 g-font-size-130--md g-line-height-1_2 mb-0">
                        projects</h1>
                    <span class="d-block g-color-white g-font-size-20 g-pos-rel g-top-minus-20--md ml-md-5">our
                        branding</span>
                </div>

                <div class="text-right">
                    <a class="js-fancybox g-text-underline--none--hover mb-5" href="javascript:;"
                        data-src="//www.youtube.com/embed/BNpiwOkKIJ8?autoplay=1" data-animate-in="fadeIn"
                        data-animate-out="fadeOut" data-speed="1000" data-caption="Our working process">
                        <span
                            class="align-middle u-icon-v3 g-bg-white g-color-black g-color-primary--hover g-rounded-50x mr-2">
                            <i class="g-font-size-15 g-pos-rel g-left-2 fa fa-play"></i>
                        </span>
                        <span
                            class="d-inline-block g-brd-bottom g-brd-white g-color-white g-font-weight-600 text-uppercase">Our
