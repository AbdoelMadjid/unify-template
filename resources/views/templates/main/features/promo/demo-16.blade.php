        ...
        <section class="container-fluid g-px-0">
            <div class="row no-gutters">
                <div class="col-md-6 order-md-2 g-bg-lightred">
                    <div class="g-pa-15x">
                        <div class="g-mb-100">
                            <h1 class="g-color-white g-font-weight-700 g-font-size-50 g-letter-spacing-0_5 mb-4">We
                                are Unify</h1>
                            <p class="lead g-color-white">This is where we sit down, grab a cup of coffee and dial in
                        ...
                        <div class="row">
                            <div class="col-md-7 col-lg-6 order-md-2 g-mb-50 g-mb-0--md">
                                ...
                                <ul class="list-unstyled g-color-white-opacity-0_8 g-font-size-13 mb-0">
                                    <li class="mb-3">
                                        <i class="mt-1 mr-3 icon-hotel-restaurant-235 u-line-icon-pro"></i> 795 Folsom
                                        Ave, Suite 600,
                                        <br>San Francisco, CA 94107 795
                                    </li>
                                    <li class="mb-3"><i
                                            class="mt-1 mr-3 icon-communication-033 u-line-icon-pro"></i>(+123) 456
                                        7890
                                    </li>
                                    <li class="mb-3"><i
                                            class="mt-1 mr-3 icon-communication-062 u-line-icon-pro"></i>info@htmlstream.com
                                    </li>
                                    <li><i class="mt-1 mr-3 icon-hotel-restaurant-235 u-line-icon-pro"></i>
                                        www.htmlstream.com</li>
                                </ul>
                            </div>
                ...
                <div class="col-md-6 order-md-1 g-bg-size-cover g-bg-pos-top-center g-min-height-400"
