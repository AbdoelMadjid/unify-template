...
<body>
    <main>
        ...
        <!-- Promo Block -->
        <section class="js-carousel" data-infinite="true" data-fade="true" data-speed="5000"
            data-pagi-classes="u-carousel-indicators-v1 g-absolute-centered--x g-bottom-30">
            <div class="js-slide g-min-height-600 g-flex-centered g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after"
                style="background-image: url(assets/img-temp/1920x1080/img35.jpg);">
                <!-- Promo Block Content -->
                <div class="g-flex-centered-item g-py-100" data-calc-target="#js-header">
                    <div class="container g-bg-cover__inner">
                        <h2
                            ...
                            We are Unify,
                            <br> <span class="g-font-weight-700">a creative agency</span>
                        </h2>

                        <!-- Promo Block - Label -->
                        <div class="g-mb-45">
                            <div
                                class="d-inline-flex g-font-weight-600 g-font-size-11 text-uppercase g-mr-10 g-mb-10 g-mb-0--md">
                                <span
                                    class="u-label u-triangle-v1-2 u-triangle-right g-bg-black g-px-20 g-py-14">Themes</span>
                                <span class="u-label g-color-gray-dark-v1 g-bg-primary g-px-20 g-py-14">25 000</span>
                            </div>
                            <div
                                class="d-inline-flex g-font-weight-600 g-font-size-11 text-uppercase g-mb-10 g-mb-0--md">
                                <span
                                    class="u-label u-triangle-v1-2 u-triangle-right g-bg-black g-px-20 g-py-14">Clients</span>
                                <span class="u-label g-color-gray-dark-v1 g-bg-primary g-px-20 g-py-14">36 000</span>
                            </div>
                        </div>
                        <!-- End Promo Block - Label -->

                        <p class="g-max-width-700 g-color-white g-font-size-18 g-mb-45">Now that we've aligned the
                            details, it's time to get things mapped out and organized. This part is really crucial in
                            keeping the project in line to completion.</p>
                        ...
                        <a class="btn btn-lg u-btn-primary g-color-black g-font-weight-600 g-font-size-13 text-uppercase rounded-0 g-px-25 g-py-15 ml-2 mb-3"
                            href="#!">Learn more</a>
                    </div>
                </div>
                ...
                <div class="g-flex-centered g-py-100" data-calc-target="#js-header">
                    <div class="container g-bg-cover__inner">
                        <h2
                            class="h2 g-color-white g-font-weight-600 g-font-size-40 g-font-size-65--md text-uppercase g-line-height-1_2 g-letter-spacing-1 g-mb-40">
                            Hire Unify.
                            <br> <span class="g-font-weight-700">Hire best people!</span>
                        </h2>
                        ...
                        <div class="g-mb-45">
                            <div
                                class="d-inline-flex g-font-weight-600 g-font-size-11 text-uppercase g-mr-10 g-mb-10 g-mb-0--md">
                                <span
                                    class="u-label u-triangle-v1-2 u-triangle-right g-bg-black g-px-20 g-py-14">Projects</span>
                                <span class="u-label g-color-gray-dark-v1 g-bg-primary g-px-20 g-py-14">12 999</span>
                            </div>
                            <div
                                class="d-inline-flex g-font-weight-600 g-font-size-11 text-uppercase g-mb-10 g-mb-0--md">
                                <span
                                    class="u-label u-triangle-v1-2 u-triangle-right g-bg-black g-px-20 g-py-14">Designs</span>
                                <span class="u-label g-color-gray-dark-v1 g-bg-primary g-px-20 g-py-14">27 555</span>
                            </div>
                        </div>
                        <!-- End Promo Block - Label -->

                        <p class="g-max-width-700 g-color-white-opacity-0_8 g-font-size-18 g-mb-45">The time has come
                            to bring those ideas and plans to life. This is where we really begin to visualize your
                            napkin sketches and make them into beautiful pixels.</p>

                        <a class="btn btn-lg u-btn-primary g-color-black g-font-weight-600 g-font-size-13 text-uppercase rounded-0 g-px-25 g-py-15 mx-2 mb-3"
                            href="#!">
