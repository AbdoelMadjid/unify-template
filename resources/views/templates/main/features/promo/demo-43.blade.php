                ...
                <div class="row justify-content-lg-between align-items-center">
                    <div class="col-md-6 g-mb-50 g-mb-0--md">
                        <img class="img-fluid u-shadow-v39 g-brd-around g-brd-10 g-brd-white rounded"
                            src="assets/img-temp/900x600/img9.jpg" alt="Image Description">
                    </div>

                    <div class="col-md-5">
                        <div class="mb-4">
                            <h1 class="g-color-black mb-3">$28m Funding Investment for New University of Unify
                                Research</h1>
                        ...
                        <a class="btn u-shadow-v33 g-color-white g-bg-primary g-bg-black--hover g-font-size-default g-rounded-30 g-px-35 g-py-11"
                            href="#">Read More</a>
                    </div>
                </div>
            </div>
