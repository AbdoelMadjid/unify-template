            ...
            <div class="container">
                <div class="row justify-content-between g-pt-120">
                    <div class="col-md-6 align-self-center g-mb-40 g-mb-0--md">
                        <h2
                            class="g-color-gray-dark-v3 g-font-weight-600 g-font-size-40 text-uppercase g-line-height-1_2 g-letter-spacing-1_5 g-mb-40">
                            We are Unify<br><span class="g-color-primary">A consulting company</span>
                        </h2>
                        ...
                        <div class="media g-mb-20">
                            ...
                            <div class="media-body">
                                <p class="mb-0">Now that we've aligned the details, it's time to get things mapped
                                    out and organized. This part is really crucial in keeping the project in line to
                                    completion.</p>
                            </div>
                        </div>
                        ...
                        <div class="media g-mb-20">
                            ...
                            <div class="media-body">
                                <p class="mb-0">The time has come to bring those ideas and plans to life. This is
                        ...
                        <div class="media g-mb-30">
                            ...
                            <div class="media-body">
                                <p class="mb-0">Whether through commerce or just an experience to tell your brand's
                                    story, the time has come to start using development languages that fit your projects
                                    needs.</p>
                            </div>
                        </div>
                        <!-- End Promo Block - Media -->
