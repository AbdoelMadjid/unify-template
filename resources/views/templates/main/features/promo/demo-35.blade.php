...
<body>
    <main>
        ...
        <div class="g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-cover g-bg-black-opacity-0_3--after g-py-100"
            style="background-image: url(assets/img-temp/1920x1080/img53.jpg);">
                    ...
                    <form>
                        <div class="row g-mx-0--md">
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-2 g-px-0--md g-mb-30">
                                <select
                                    class="js-custom-select w-100 u-select-v1 g-min-width-150 g-brd-left-none--md g-brd-gray-light-v3 g-color-black g-color-primary--hover g-pt-12 g-pb-13"
                        ...
                        <div class="row">
                            <div class="col-6 col-lg-3 g-mb-30">
                                ...
                                <div class="input-group-btn">
                                    <select
                                        class="js-custom-select u-select-v1 w-100 g-brd-gray-light-v3 g-color-black g-color-primary--hover g-py-12"
                                ...
                                <div class="btn-group justified-content">
                                    <label class="u-check">
                                        <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="radGroupBtn1_1"
                                            type="radio" checked="">
                                        <span
                                            class="btn btn-md btn-block u-btn-outline-white g-brd-gray-light-v3 g-brd-primary--checked g-color-black g-color-primary--checked g-font-size-default rounded-0 g-py-13">Buy</span>
                                    </label>
                                    <label class="u-check">
                                        <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="radGroupBtn1_1"
                                            type="radio">
                                        <span
                                            class="btn btn-md btn-block u-btn-outline-white g-brd-gray-light-v3 g-brd-primary--checked g-color-black g-color-primary--checked g-font-size-default rounded-0 g-py-13">Rent</span>
                                    </label>
                                </div>
                                <!-- End Radio Group -->
                            </div>
        ...
        <section class="g-bg-secondary">
            <div class="container g-pt-100 g-pb-130">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-9">
                        <div class="js-carousel" data-infinite="true" data-slides-show="3" data-slides-scroll="3"
                            data-center-mode="true" data-center-padding="1px"
