...
<body>
    <main>
        ...
        <!-- Promo Block -->
        <section
            class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_3--after"
            ...
            <div class="g-pt-120">
                <div class="container g-color-white text-center g-pos-rel g-z-index-3">
                    <h3 class="g-font-size-40 g-font-weight-600 g-font-size-130--md g-line-height-1 g-mb-50"
                        data-animation="fadeInUp" data-animation-delay="500" data-animation-duration="1500">Unify
                    </h3>
                    <div class="row justify-content-center mb-3">
                        <div class="col-md-6">
                            <p class="g-font-size-24 g-mb-40" data-animation="fadeInUp" data-animation-delay="800"
                                data-animation-duration="1500">Unify creative technology company providing key digital
                                services</p>
                        </div>
                    </div>
                    <a class="js-fancybox d-block g-mb-130" href="javascript:;" data-src="//vimeo.com/167434033"
                        data-caption="Single Image" data-animate-in="fadeInUp" data-animate-out="fadeOutUp"
                        data-speed="1000">
                        <span
                            class="u-icon-v3 u-icon-size--lg u-block-hover--scale g-bg-white g-color-black g-color-primary--hover g-rounded-50x g-cursor-pointer">
                            <i class="g-font-size-18 g-pos-rel g-left-2 fa fa-play"></i>
                        </span>
                    </a>
                    <ul class="row list-inline text-center g-pb-60 mb-0">
                        <li class="col" data-animation="fadeIn" data-animation-delay="1800"
                            data-animation-duration="1500">
                            <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3"
                                src="assets/img-temp/200x100/img1.png" alt="Image Description">
                        </li>
                        <li class="col mx-5" data-animation="fadeIn" data-animation-delay="1700"
                            data-animation-duration="1500">
                            <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3"
                                src="assets/img-temp/200x100/img2.png" alt="Image Description">
                        </li>
                        <li class="col mx-5" data-animation="fadeIn" data-animation-delay="1600"
                            data-animation-duration="1500">
                            <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3"
                                src="assets/img-temp/200x100/img3.png" alt="Image Description">
                        </li>
                        <li class="col mx-5" data-animation="fadeIn" data-animation-delay="1500"
                            data-animation-duration="1500">
                            <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3"
                                src="assets/img-temp/200x100/img4.png" alt="Image Description">
                        </li>
                        <li class="col" data-animation="fadeIn" data-animation-delay="1400"
                            data-animation-duration="1500">
                            <img class="g-width-100 g-opacity-0_6 g-opacity-1--hover g-cursor-pointer g-transition-0_3"
