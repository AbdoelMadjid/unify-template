    ...
    <main>
        ...
        <section
            ...
            <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-black-opacity-0_3--after"
                style="height: 120%; background-image: url(assets/img-temp/1920x1080/img52.jpg);"></div>
            ...
            <div class="container g-pt-100">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-6 col-lg-7 g-mb-100">
                        <!-- Content Info -->
                        <div class="mb-5">
                            <h1 class="g-color-white g-font-weight-600 g-font-size-50 mb-3">Fast. Flexible. Leaders.
                            </h1>
                            <p class="g-color-white g-font-size-18">Unify Marketing is a comprehensive, creation and
                                management solution that helps business providers manage their shifts with complete
                                accuracy. Our Unify management software Unify Marketing has earned us the position of
                                market leaders for
                                unscheduled business providers.</p>
                        </div>
                        <a class="btn u-btn-primary g-font-weight-500 g-font-size-12 text-uppercase g-px-25 g-py-13 mr-3"
                            href="#!">
                            Our Services
                            <i class="g-pos-rel g-top-minus-1 ml-2 fa fa-angle-right"></i>
                        </a>
                        <a class="btn u-btn-black g-font-weight-500 g-font-size-12 text-uppercase g-px-25 g-py-13"
                            href="#!">
                            Our Works
                            <i class="g-pos-rel g-top-minus-1 ml-2 fa fa-angle-right"></i>
                        </a>
                    ...
                    <div class="col-md-6 col-lg-4 g-mb-100">
                        ...
                        <form class="g-bg-white rounded g-px-30 g-py-40">
                            ...
                            <input class="form-control rounded g-px-20 g-py-12 mb-3" type="text"
                                placeholder="Your Name">
                            <input class="form-control rounded g-px-20 g-py-12 mb-3" type="email"
                            ...
                            <div class="g-mb-35">
                                <button
                                    class="btn btn-block u-btn-primary g-font-weight-500 g-font-size-12 text-uppercase g-px-25 g-py-13"
                            ...
                            <div class="row no-gutters">
                                <div class="col">
                                    <a class="btn btn-block u-btn-facebook g-font-weight-500 g-font-size-12 text-uppercase g-rounded-left-3 g-rounded-right-0 g-px-25 g-py-13"
                                ...
                                <div class="col">
                                    <a class="btn btn-block u-btn-twitter g-font-weight-500 g-font-size-12 text-uppercase g-rounded-left-0 g-rounded-right-3 g-px-25 g-py-13"
                                        href="page-works-1.html">
