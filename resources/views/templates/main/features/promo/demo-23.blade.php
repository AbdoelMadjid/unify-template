...
<body>
    <main>
        ...
        <!-- Promo Block -->
        <section class="g-bg-cover g-flex-centered g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after"
            style="background-image: url(assets/img-temp/1920x1080/img24.jpg);" data-calc-target="#js-header">
                ...
                <div class="row">
                    <div class="col-lg-5 align-self-center g-mb-40 g-mb-0--lg">
                        <div class="g-bg-white g-rounded-5 g-pa-40">
                            ...
                            <form>
                                ...
                                <div class="form-group g-mb-20">
                                    <select
                                        class="js-custom-select u-select-v1 form-control g-brd-gray-light-v5 g-color-gray-light-v1 g-bg-gray-light-v5 g-px-10 g-py-13"
                                        style="width: 100%;" data-placeholder="Product Type"
                                        data-control-classes="g-color-gray-dark-v2 g-bg-gray-light-v5"
                                        data-disable-search="1" data-open-icon="fa fa-angle-down"
                                ...
                                <button
                                    class="btn btn-lg btn-block u-btn-primary g-font-weight-600 g-font-size-13 text-uppercase g-rounded-5 g-py-13"
                    ...
                    <div class="col-lg-7 align-self-center g-color-white">
                        <div class="g-px-50--lg">
                            <h2
                                class="g-color-white g-font-weight-600 g-font-size-40 g-font-size-50--md text-uppercase g-line-height-1_2 g-mb-20">
                                Planning
                                <br>&amp; Delivering
                            </h2>
                            <p class="lead g-color-white-opacity-0_8 g-mb-35">This is where we sit down, grab a cup of
                                coffee and dial in the details. Understanding the task at hand and ironing out the
                                wrinkles is key.</p>
                            <a class="btn btn-lg u-btn-primary g-font-weight-600 g-font-size-13 text-uppercase g-rounded-5 g-px-25 g-py-15"
                                href="#!">Hire Unify</a>
                        </div>
                    </div>
