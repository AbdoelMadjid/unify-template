                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg"
                            ...
                            <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                ...
                                <!-- Mega Menu Item -->
                                <li class="hs-has-mega-menu nav-item g-mx-20--lg active" data-animation-in="fadeIn"
                                    data-animation-out="fadeOut" data-position="right">
                                    <a id="mega-menu-label-1" class="nav-link active g-px-0" href="#!"
                                        aria-haspopup="true" aria-expanded="false">Shortcodes
                                        <span class="sr-only">(current)</span>
                                        <i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-7"></i>
                                    </a>

                                    <!-- Mega Menu -->
                                    <div class="w-100 hs-mega-menu u-shadow-v11 font-weight-normal g-text-transform-none g-brd-top g-brd-primary g-brd-top-2 g-mt-17 g-mt-7--lg--scrolling"
                                        aria-labelledby="mega-menu-label-1">
                                        <ul class="nav justify-content-center u-nav-v5-1 u-nav-gray-light-v5 g-brd-bottom--md g-brd-gray-light-v4 g-width-auto g-mx-20"
                                            data-tabs-mobile-type="slide-up-down" data-destroy-res="768"
                                            data-btn-classes="btn btn-md btn-block u-btn-outline-black g-width-auto g-mt-20 g-mx-20">
                                            <li class="nav-item">
                                                <a class="nav-link active g-py-10--md g-px-15--md" href="#tab-blocks"
                                                    role="tab" data-toggle="tab">Blocks
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link g-py-10--md g-px-15--md" href="#tab-elements"
                                                    role="tab" data-toggle="tab">Elements
                                                </a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <section class="g-pa-20">
                                                            <ul class="list-unstyled">
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">General
                                                                        Typography</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Headings
                                                                        Options</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Dividers</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Blockquote
                                                                        Blocks</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Box
                                                                        Shadows</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Testimonials</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Tagline
                                                                        Boxes</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Grid
                                                                        Layouts</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Alerts
                                                                        &amp; Messages</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Labels
                                                                        &amp; Badges</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Audio/Videos
                                                                        &amp; Images</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link g-px-0 g-color-primary--hover">Paginations</a>
                                                                </li>
                                                            </ul>
                                                        </section>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3 g-brd-left--lg g-brd-gray-light-v5">
                                                        <section class="g-pa-20 g-pl-5--lg">
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li>
                                                                    <a href="#!"
                                                                        class="nav-link active g-px-0 g-color-primary--hover">Tagline
                                                                        Boxes</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
