                                    ...
                                    <div class="w-100 hs-mega-menu u-shadow-v11 g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-mt-17 g-mt-7--lg--scrolling"
                                        ...
                                        <div class="row no-gutters">
                                                    ...
                                                    <address class="display-6 mb-0">
                                                        <ul class="list-unstyled mb-0">
                                                            <li class="d-flex align-items-baseline g-mb-20">
                                                                ...
                                                                <p class="mb-0">Address: <strong>25, Lorem Lis
                                                                        Street, Orange California, US</strong></p>
                                                            </li>
                                                            <li class="d-flex align-items-baseline g-mb-20">
                                                                <i class="fa fa-phone g-color-primary g-mr-10"></i>
                                                                <p class="mb-0">Phone Number: <strong>800 123
                                                                        3456</strong></p>
                                                            </li>
                                                            <li class="d-flex align-items-baseline g-mb-20">
                                                                <i class="fa fa-envelope g-color-primary g-mr-10"></i>
                                                                <p class="mb-0">Email: <strong>
                                                                        <a class="g-color-inherit"
                                                                            href="mailto:inof@htmlstream.com">inof@htmlstream.com</a>
                                                                    </strong></p>
                                                            </li>
                                                            <li class="d-flex align-items-baseline">
                                                                <i
                                                                    class="fa fa-phone-square g-color-primary g-mr-10"></i>
                                                                <p class="mb-0">Tall Free: <strong>800 123
                                                                        3456</strong></p>
                                                            </li>
                                                        </ul>
                                                    </address>
                                            ...
                                            <div class="col-lg g-min-height-400">
                                                <div id="gMap" class="js-g-map h-100" data-type="custom"
