                                            ...
                                            <div class="g-max-width-780 mx-auto">
                                                <div class="row">
                                                    <div class="col-lg-5 g-mb-20 g-mb-0--lg">
                                                        <input
                                                            class="form-control form-control-lg g-font-size-default g-bg-gray-light-v5 g-bg-gray-light-v5--focus g-brd-gray-light-v5 g-rounded-30 g-px-15 g-py-13"
                                                            type="text" placeholder="Login">
                                                        <small class="d-block g-px-15 g-py-5">
                                                            <a class="g-color-main" href="#!">Create a new
                                                                account</a>
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-5 g-mb-20 g-mb-0--lg">
                                                        ...
                                                        <small class="d-block g-px-15 g-py-5">
                                                            <a class="g-color-main" href="#!">Forgotten
                                                                account?</a>
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2 text-md-right text-lg-left">
                                                        <button
                                                            class="btn u-btn-primary text-uppercase g-rounded-30 g-px-25 g-py-13"
                                        ...
                                        <div class="g-pa-30">
                                            <div class="row">
                                                <div class="col-lg-4 g-mb-25 g-mb-0--lg">
                                                    <h4 class="h6 text-uppercase g-font-weight-600 g-mb-10">Text widget
                                                    </h4>
                                                    <p class="g-mb-20">Lorem ipsum dolor sit amet, consectetur
                                                        adipiscing elit. Proin vitae est lorem. Aenean imperdiet nisi a
                                                        dolor condimentum, id ullamcorper lacus vestibulum. Praesent
                                                        pulvinar gravida. Aenean lobortis ante ac porttitor eleifend.
                                                    </p>
                                                </div>

                                                <div class="col-lg g-mb-25 g-mb-0--lg">
                                                    <h4 class="h6 text-uppercase g-font-weight-600 g-mb-10">Categories
                                                    </h4>
                                                    <ul class="list-unstyled">
                                                        <li class="g-mb-8">
                                                            <a class="g-color-main" href="#!">Proin vitae est
                                                                lorem</a>
                                                        </li>
                                                        <li class="g-mb-8">
                                                            <a class="g-color-main" href="#!">Aenean imperdiet
                                                                nisi</a>
                                                        </li>
                                                        <li class="g-mb-8">
                                                            <a class="g-color-main" href="#!">Praesent pulvinar
                                                                gravida</a>
                                                        </li>
                                                        <li>
                                                            <a class="g-color-main" href="#!">Integer commodo
                                                                est</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="col-lg g-mb-25 g-mb-0--lg">
                                                    <h4 class="h6 text-uppercase g-font-weight-600 g-mb-10">Customer
                                                        Support</h4>
                                                    <ul class="list-unstyled">
                                                        <li class="g-mb-8">
                                                            <a class="g-color-main" href="#!">Vivamus egestas
                                                                sapien</a>
                                                        </li>
                                                        <li class="g-mb-8">
                                                            <a class="g-color-main" href="#!">Sed convallis nec
                                                                enim</a>
                                                        </li>
                                                        <li class="g-mb-8">
                                                            <a class="g-color-main" href="#!">Pellentesque a
                                                                tristique risus</a>
                                                        </li>
                                                        <li>
                                                            <a class="g-color-main" href="#!">Nunc vitae libero
                                                                lacus</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="col-lg">
                                                    <h4 class="h6 text-uppercase g-font-weight-600 g-mb-10">Top Link
                                                    </h4>
                                                    <ul class="list-unstyled">
                                                        <li class="g-mb-8">
                                                            <a class="g-color-main" href="#!">Pellentesque a
