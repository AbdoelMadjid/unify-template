                ...
                <div class="container">
                    <div class="d-lg-flex flex-md-row align-items-center g-pos-rel">
                        ...
                        <div class="col g-mt-10 g-mt-0--lg g-px-0">
                            <div
                                class="row flex-row align-items-start align-items-lg-center justify-content-lg-end text-uppercase g-font-weight-600 u-header--hidden-element g-color-gray-dark-v2 g-font-size-13 text-lg-right g-mt-minus-10 g-mb-20">
                                    ...
                                    <ul id="languages-dropdown-2"
                                        ...
                                        <li>
                                            <a class="d-flex align-items-center g-color-main g-color-primary--hover g-text-underline--none--hover g-py-8 g-px-20"
                                                href="#!">
                                                <svg class="mr-2 g-ml-minus-6" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="col-auto g-px-15 g-mt-10">
                                    <ul class="list-inline mb-0 g-mx-minus-3">
                                        <li class="list-inline-item g-valign-middle g-mx-3">
                                            <a class="d-block u-icon-v3 u-icon-size--xs u-shadow-v17 g-rounded-50x g-bg-white g-color-gray-dark-v1 g-color-primary--hover g-text-underline--none--hover"
                                                href="#!">
