    ...
    <main>
        ...
        <header id="js-header"
            ...
            <div class="u-header__section u-header__section--hidden u-header__section--dark g-bg-black g-py-13">
                <div class="container">
                    <div
                        class="row flex-column flex-md-row align-items-center justify-content-between text-uppercase g-color-white g-font-size-11 g-mx-minus-15">
                        <!-- Responsive Toggle Button -->
                        <button
                            class="g-hidden-md-up d-block btn btn-xs u-btn-primary g-brd-none g-line-height-1 mx-auto"
                        ...
                        <div class="col-auto g-px-15 w-100 g-width-auto--md">
                            <ul id="dropdown-megamenu"
                                ...
                                <li class="d-block d-md-inline-block g-mx-4">
                                    <a href="#!"
                                        class="g-color-white g-color-primary--hover g-text-underline--none--hover">Contact</a>
                                </li>
                                <li class="d-block g-hidden-md-down d-md-inline-block g-mx-4">|</li>
                                <li class="d-block d-md-inline-block g-mx-4">
                                    <a href="#!"
                                ...
                                <li class="hs-has-sub-menu d-block d-md-inline-block g-pos-rel g-mx-4">
                                    <a href="#!" id="dropdown-invoker-3"
                                        ...
                                        aria-haspopup="true" aria-expanded="false" aria-controls="dropdown-3">Dropdown
                                    </a>
                                    <ul id="dropdown-3"
                                        ...
                                        <li class="g-py-10">
                                            <a href="#!"
                                                class="d-block g-text-underline--none--hover g-color-white g-color-primary--hover">Dropdown
                                                Item</a>
                                        </li>
                                        <li class="g-py-10">
                                            <a href="#!"
                                        ...
                                        <li class="hs-has-sub-menu g-py-10">
                                            <a href="#!" id="dropdown-invoker-4"
                                                class="d-block g-text-underline--none--hover g-color-white g-color-primary--hover"
                                                aria-haspopup="true" aria-expanded="false"
                                                aria-controls="dropdown-4">Dropdown Item
                                            </a>
                                            <ul id="dropdown-4"
                                                class="hs-sub-menu list-unstyled g-bg-gray-dark-v1 g-py-10 g-px-20"
                                                aria-labelledby="dropdown-invoker-4">
                                                <li class="g-py-10">
                                                    <a href="#!"
                                                        class="d-block g-text-underline--none--hover g-color-white g-color-primary--hover">Dropdown
                                                        Item</a>
                                                ...
                                                <li class="hs-has-sub-menu g-py-10">
                                                    <a href="#!" id="dropdown-invoker-5"
                                                        class="d-block g-text-underline--none--hover g-color-white g-color-primary--hover"
                                                        aria-haspopup="true" aria-expanded="false"
                                                        aria-controls="dropdown-5">Dropdown Item
                                                    </a>
                                                    <ul id="dropdown-5"
                                                        class="hs-sub-menu list-unstyled g-bg-gray-dark-v1 g-py-10 g-px-20"
                                                        aria-labelledby="dropdown-invoker-5">
                                                        <li class="g-py-10">
                                                            <a href="#!"
                                                                class="d-block g-text-underline--none--hover g-color-white g-color-primary--hover">Dropdown
                                                                Item</a>
                        ...
                        <div class="col-auto g-px-15">
                            <ul class="list-inline g-line-height-1 g-mt-minus-10 g-mx-minus-4 mb-0">
                                ...
                                <li class="list-inline-item g-mx-4 g-mt-10">
                                    ...
                                    <div class="g-pos-rel">
                                        <a href="#!"
                                            class="g-font-size-14 g-color-white g-color-primary--hover g-ml-5"
                                            aria-haspopup="true" aria-expanded="false" aria-controls="searchform-6"
                                            data-dropdown-target="#searchform-6" data-dropdown-type="css-animation"
                                        ...
                                        <!-- Search Form -->
                                        <form id="searchform-6"
                                            class="u-searchform-v1 g-bg-black g-box-shadow-none g-pa-10 g-mt-10">
                                            <div class="input-group g-brd-primary--focus">
                                                <input class="form-control rounded-0 u-form-control g-brd-white"
