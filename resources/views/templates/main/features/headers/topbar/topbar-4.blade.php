                    ...
                    <div class="row flex-column flex-md-row align-items-center justify-content-between g-color-white">
                        <div class="col-auto g-pos-rel g-px-15">
                            ...
                            <a href="#!" id="languages-dropdown-invoker"
                                ...
                                data-dropdown-event="click" data-dropdown-target="#languages-dropdown"
                            ...
                            <ul id="languages-dropdown"
                                class="list-unstyled g-pos-abs g-left-0 g-bg-gray-dark-v1 g-width-160 g-py-5 g-mt-18--lg"
                        ...
                        <div class="col-auto g-px-15">
                            ...
                            <a href="mailto:#"
                                class="g-color-white g-color-primary--hover g-text-underline--none--hover">supportix@htmlstream.com</a>
                        </div>
                    </div>
                </div>
            </div>
