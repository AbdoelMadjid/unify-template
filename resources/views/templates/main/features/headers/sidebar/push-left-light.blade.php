...
<body class="u-body--header-side-push-left">
    <main>
        ...
        <button class="btn u-btn-white u-header-toggler u-header-toggler--top-right g-pa-0" id="header-toggler"
        ...
        <!-- Sidebar Navigation -->
        <div id="js-header" class="u-header u-header--side" aria-labelledby="header-toggler" data-header-behavior="push"
            data-header-position="left" data-header-breakpoint="lg" data-header-classes="g-transition-0_5"
            data-header-body-classes="g-transition-0_5"
            data-header-overlay-classes="g-bg-black-opacity-0_8 g-transition-0_5">
            <div
                class="u-header__sections-container g-bg-white g-brd-right--lg g-brd-gray-light-v5 g-py-10 g-py-40--lg g-px-14--lg">
                            ...
                            <div class="collapse navbar-collapse align-items-center flex-sm-row w-100 g-mt-20 g-mt-0--lg g-mb-40"
                                ...
                                <ul class="navbar-nav ml-auto text-uppercase g-font-weight-600 u-sub-menu-v1">
                                    <li class="nav-item hs-has-sub-menu g-my-5">
                                        <a href="#!" class="nav-link" id="nav-link-1" aria-haspopup="true"
                                            aria-expanded="false" aria-controls="nav-submenu-1">Home
                                        ...
                                        <ul class="hs-sub-menu list-unstyled" id="nav-submenu-1"
                                            ...
                                            <li class="active hs-has-sub-menu">
                                                <a href="#!" id="nav-link-2" aria-haspopup="true"
                                                    aria-expanded="false" aria-controls="nav-submenu-2">Option 2
                                                </a>
                                                <!-- Submenu (level 2) -->
                                    ...
                                    <li class="nav-item hs-has-mega-menu g-my-5 active">
                                        <a href="#!" class="nav-link" id="nav-link-408" aria-haspopup="true"
                                            aria-expanded="false" aria-controls="nav-megamenu-408">Shortcodes
                                            <span class="sr-only">(current)</span>
                                            <i class="hs-icon hs-icon-arrow-bottom g-font-size-10 g-ml-7"></i>
                                        </a>
                                        <!-- Mega Menu -->
                                        <div class="hs-mega-menu g-font-size-13" id="nav-megamenu-408"
                                            ...
                                            <div class="h-100 row align-items-stretch">
                                                <div class="col-lg-3 g-brd-right g-brd-gray-light-v4">
                                                    <ul class="list-unstyled h-100 g-py-10">
                                                        <li>
                                                            <a href="#!"
                                                                class="d-block g-color-gray-dark-v4 g-color-primary--hover g-text-underline--none--hover g-py-5 g-px-20">Option
                                                                1</a>
                                                        </li>
                                                        <li>
                                                            <a href="#!"
                                                        ...
                                                        <li class="nav-item hs-has-sub-menu">
                                                            ...
                                                            <ul class="list-unstyled hs-sub-menu">
                                                                <li>
                                                                    <a href="#!"
                                                                        class="d-block g-color-gray-dark-v4 g-color-primary--hover g-text-underline--none--hover g-py-5 g-px-20">–
                                                                        Sub Option 2.1</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#!"
                                                ...
                                                <div class="col-lg-6">
                                                    <div id="gMap4" class="js-g-map h-100" data-type="custom"
                                                        data-lat="40.674" data-lng="-73.946" data-zoom="12"
                                                        data-title="Travel"
                                                        data-styles='[
