...
<body>
    <main>
        ...
        <header id="js-header" class="u-header u-header--static u-header--show-hide u-header--change-appearance"
            ...
            <div
                class="text-center text-lg-left u-header__section u-header__section--light g-bg-white g-brd-bottom g-brd-gray-light-v4 g-py-40">
                <div class="container">
                    <div class="row flex-lg-row align-items-center justify-content-lg-start">
                        ...
                        <div class="col-lg-6 g-mb-30 g-mb-0--lg">
                            ...
                            <form id="searchform-5" class="u-searchform-v5">
                                <div class="input-group g-brd-primary--focus g-rounded-20">
                                    <input class="form-control u-form-control u-form-control-lg" type="search"
                        ...
                        <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                            <div
                                class="d-flex flex-row align-items-center justify-content-center justify-content-lg-end g-mx-minus-15 g-mt-minus-10">
                                <div class="g-px-15 g-pt-15">
                                    <a href="#!"
                                        class="u-icon-v1 g-font-size-24 g-color-gray-light-v1 g-text-underline--none--hover g-width-30 g-height-20">
                                ...
                                <div class="g-px-15 g-pt-10">
                                    <a href="#!"
                                        class="d-flex flex-row align-items-center text-left g-color-gray-dark-v4  g-text-underline--none--hover g-line-height-1_2">
                                        <img class="g-width-50 g-height-50 g-rounded-50x g-mr-15"
            ...
            <div class="u-header__section u-header__section--light g-bg-white g-py-15 g-py-0--lg"
                ...
                <nav class="navbar navbar-expand-lg py-0">
                    <div class="container">
                        ...
                        <!-- Navigation -->
                        <div class="collapse navbar-collapse align-items-center flex-sm-row text-center"
                            id="navBar">
                            <ul
                                class="w-100 navbar-nav justify-content-between text-uppercase u-main-nav-v9 u-sub-menu-v1">
