...
<body>
    <main>
        ...
        <header id="js-header" class="u-header u-header--static u-header--show-hide u-header--has-hidden-element"
            ...
            <!-- Top Bar -->
            <div
                class="u-header__section u-header__section--light g-bg-white g-color-gray-dark-v5 g-brd-bottom g-brd-gray-light-v4 g-py-10">
                <div
                    class="row flex-column flex-md-row justify-content-between align-items-center text-center g-font-size-12 mx-0">
                    <div class="col-auto col-lg-4 text-lg-left g-px-15">
                        <ul class="d-inline-block list-inline g-font-size-16 g-valign-middle g-mr-15 mb-0">
                            <li class="list-inline-item">
                                <a class="g-color-gray-dark-v5 g-color-primary--hover g-text-underline--none--hover g-pa-5"
                                    href="#!">
                        ...
                        <a href="tel:#" class="d-inline-block g-valign-middle g-text-underline--none--hover">(1) 396
                            4587 99</a>
                    </div>
                    ...
                    <div class="col-auto col-lg-4 text-lg-right g-px-15">
                        <div class="g-mt-minus-10 g-mx-minus-10">
                            <a class="btn g-font-weight-600 u-btn-outline-primary g-rounded-50 g-valign-middle g-mx-10 g-mt-10"
                                href="#!">Subscribe</a>

                            <!-- Basket -->
                            <div class="u-basket d-inline-block g-valign-middle g-color-main g-mt-10 g-mx-10">
                                <a href="#!" id="basket-bar-invoker-9"
                                    class="g-color-gray-dark-v4 g-font-size-16 g-text-underline--none--hover g-valign-middle"
                                    aria-controls="basket-bar-9" aria-haspopup="true" aria-expanded="false"
                                    data-bage-info="12" data-dropdown-event="hover" data-dropdown-target="#basket-bar-9"
                                ...
                                <div id="basket-bar-9"
                                    class="u-basket__bar u-dropdown--css-animation u-dropdown--hidden g-brd-top g-brd-2 g-brd-primary g-color-main g-mt-20"
                                    ...
                                    <div class="js-scrollbar g-height-280">
                                            ...
                                            <div class="row align-items-center no-gutters">
                                                <div class="col-4 g-pr-20">
                                                    <a href="#!" class="u-basket__product-img">
                                                        <img src="assets/img-temp/150x150/img1.jpg"
                                                ...
                                                <div class="col-8">
                                                    <h6 class="g-font-weight-600 g-mb-0">
                                                        <a href="#!"
                                                            class="g-color-main g-color-main--hover g-text-underline--none--hover">Black
                                                            Glasses</a>
                                                    </h6>
                                                    <small class="g-color-gray-dark-v5 g-font-size-14">1 x
                                                        $400.00</small>
                                                </div>
                                            </div>
                                        ...
                                        <div class="u-basket__product">
                                            <div class="row align-items-center no-gutters">
                                                <div class="col-4 g-pr-20">
                                                    <a href="#!" class="u-basket__product-img">
                                                        <img src="assets/img-temp/150x150/img2.jpg"
                                                            alt="Image Description">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="u-basket__product">
                                            <div class="row align-items-center no-gutters">
                                                <div class="col-4 g-pr-20">
                                                    <a href="#!" class="u-basket__product-img">
                                                        <img src="assets/img-temp/150x150/img3.jpg"
                                                            alt="Image Description">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="g-brd-top g-brd-gray-light-v4 g-pa-15 g-pb-20">
                                        ...
                                        <div
                                            ...
                                            <a href="#!"
                                                class="btn u-btn-outline-primary rounded-0 g-width-120">View Cart</a>
                                            <a href="#!"
                            ...
                            <a class="d-inline-block g-color-gray-dark-v4 g-font-size-16 g-text-underline--none--hover g-valign-middle g-mx-10 g-mt-10"
                                href="#!">
                            ...
                            <ul class="d-inline-block list-inline g-color-gray-dark-v4 g-valign-middle g-mx-10 mb-0">
                                <li class="list-inline-item g-mx-2 g-mt-10">
                                    <a class="g-color-gray-dark-v4 g-color-primary--hover g-text-underline--none--hover"
                                        href="#!">Sign In</a>
                                </li>
            ...
            <div class="u-header__section u-header__section--dark g-bg-primary-opacity-0_8 g-pos-rel g-py-3">
                <!-- Search Form -->
                <form id="searchform-9"
                    class="u-searchform-v3 g-font-size-25 g-color-gray-dark-v2 g-brd-2 g-brd-y g-brd-gray-light-v4 g-bg-white g-px-15">
                    <div class="input-group g-brd-primary--focus">
                        ...
                        <div class="input-group-addon p-0">
                            <button
                                class="text-right px-0 g-color-gray-dark-v2 g-color-gray-light-v2--hover g-font-size-14 g-letter-spacing-2"
                                type="button" aria-haspopup="true" aria-expanded="false"
                                aria-controls="searchform-9" data-dropdown-type="css-animation"
                                data-dropdown-duration="300" data-dropdown-target="#searchform-9">
                ...
                <nav class="navbar navbar-expand-lg justify-content-lg-between">
                    ...
                    <div class="g-pos-rel">
                        <a href="#!"
                            class="g-color-white g-color-white-opacity-0_9--hover g-text-underline--none--hover g-pa-10">
                            <i class="icon-menu"></i>
                        </a>
                    </div>
                    ...
                    <a class="d-inline-block g-color-white g-color-white-opacity-0_9--hover g-text-underline--none--hover g-pa-10"
                        href="#!" aria-haspopup="true" aria-expanded="false" aria-controls="searchform-9"
                        data-dropdown-type="css-animation" data-dropdown-duration="300"
