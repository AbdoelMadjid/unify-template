    ...
    <main>
        ...
        <section>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <p>About Unify dolor sit amet, consectetur adipiscing elit. Maecenas eget nisl
                                            id libero tincidunt sodales.</p>
                                        <p class="mb-0">Duis eleifend fermentum ante ut aliquam. Cras mi risus,
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        <div class="u-heading-v3-1 g-brd-white-opacity-0_3 g-mb-25">
                                            <h2 class="u-heading-v3__title h6 text-uppercase g-brd-primary">Latest Posts
                                            </h2>
                                        </div>
                                        ...
                                        <article>
                                            <h3 class="h6 g-mb-2">
                                                <a class="g-color-white-opacity-0_8 g-color-white--hover"
                                                    href="#!">New terms and conditions</a>
                                            </h3>
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        <div class="u-heading-v3-1 g-brd-white-opacity-0_3 g-mb-25">
                                            <h2 class="u-heading-v3__title h6 text-uppercase g-brd-primary">Useful Links
                                            </h2>
                                        </div>
                                                ...
                                                <li class="g-pos-rel g-brd-bottom g-brd-white-opacity-0_1 g-py-10">
                                                    <h4 class="h6 g-pr-20 mb-0">
                                                        <a class="g-color-white-opacity-0_8 g-color-white--hover"
                                                            href="#!">About Us</a>
                                                        <i
                                                            class="fa fa-angle-right g-absolute-centered--y g-right-0"></i>
                                                    </h4>
                                                </li>
                                                <li class="g-pos-rel g-brd-bottom g-brd-white-opacity-0_1 g-py-10">
                                                    <h4 class="h6 g-pr-20 mb-0">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="u-heading-v3-1 g-brd-white-opacity-0_3 g-mb-25">
                                            <h2 class="u-heading-v3__title h6 text-uppercase g-brd-primary">Our
                                                Contacts</h2>
                                        </div>
                                        ...
                                        <address class="g-bg-no-repeat g-line-height-2 g-mt-minus-4"
                                            ...
                                            <br>
                                            Email:
                                            <a href="mailto:info@htmlstream.com"
                                                class="">info@htmlstream.com</a>
                                        </address>
                                    </div>
                                    <!-- End Footer Content -->
                                </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8 text-center text-md-left g-mb-15 g-mb-0--md">
                                        <div class="d-lg-flex">
                                            <small class="d-block g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017
                    ...
                    <div class="shortcode-html">
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <article class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="h6">
                                                    <a class="g-color-white-opacity-0_8 g-color-white--hover"
                                                        href="#!">Top 7 luxury places to visit around Victoria,
                                                        BC</a>
                                                </h3>
                                        ...
                                        <article class="media">
                                            <a class="d-flex g-mt-4 mr-3" href="#!">
                                                <img class="g-width-60 g-height-60"
                                                    src="assets/img-temp/100x100/img8.jpg" alt="Image Description">
                                            </a>

                                            <div class="media-body">
                                                <h3 class="h6">
                                                    <a class="g-color-white-opacity-0_8 g-color-white--hover"
                                                        href="#!">Coding week, 10 best premium templates</a>
                                                </h3>
                        ...
                        <footer class="g-bg-gray-dark-v1 g-color-white-opacity-0_8 g-py-20">
                            <div class="container">
                                <div class="row">
                                    <div
                                        class="col-md-8 align-self-center text-center text-md-left g-mb-10 g-mb-0--md">
                                        <div class="d-lg-flex">
                                            <small class="d-block g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017
                                                © All Rights Reserved.</small>
                                            <ul class="u-list-inline">
                ...
                <div id="shortcode4">
                    <div class="shortcode-html">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <div class="input-group border-0">
                                            <input class="form-control border-0 rounded-0 g-px-12 g-py-8"
                                                type="email" placeholder="Email address">
                                            <div class="input-group-addon g-brd-around-none p-0">
                                                <button class="btn u-btn-primary rounded-0 g-px-12 g-py-8"
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <article class="media">
                                            <div class="d-flex g-mt-3 mr-3">
                                                <span
                                                    class="u-icon-v3 u-icon-size--xs g-bg-white-opacity-0_1 g-color-white-opacity-0_6 rounded-circle"
                                                    href="#!">
                                                    <i class="fa fa-twitter"></i>
                                                </span>
                                            </div>
                        ...
                        <footer class="g-bg-gray-dark-v1 g-color-white-opacity-0_8 text-center g-py-20">
                            <div class="container">
                                <small class="g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017 © All Rights
                                    Reserved. Unify Template by
                                    <a href="#!">Htmlstream</a>
                                </small>
                            </div>
                        </footer>
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <ul class="u-list-inline g-font-size-12">
                                            <li class="list-inline-item g-mb-10">
                                                <a class="u-tags-v1 g-brd-around g-brd-white-opacity-0_1 g-bg-primary--hover g-brd-primary--hover g-color-white-opacity-0_8 g-rounded-50 g-py-4 g-px-15"
                                                    href="#!">Web Design</a>
                                            </li>
                                            <li class="list-inline-item g-mb-10">
                                                <a class="u-tags-v1 g-brd-around g-brd-white-opacity-0_1 g-bg-primary--hover g-brd-primary--hover g-color-white-opacity-0_8 g-rounded-50 g-py-4 g-px-15"
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <ul class="u-list-inline d-flex flex-wrap g-mr-minus-15">
                                            <li class="list-inline-item g-mr-15 g-mb-15">
                                                <a href="#!">
                                                    <img class="g-width-70 g-height-70"
                                                        src="assets/img-temp/100x100/img9.jpg"
                                            ...
                                            <li class="list-inline-item g-mr-15 g-mb-15">
                                                <a href="#!">
                                                    <img class="g-width-70 g-height-70"
                                                        src="assets/img-temp/100x100/img8.jpg"
                                                        alt="Image Description">
                                                </a>
                                            </li>
                                            <li class="list-inline-item g-mr-15 g-mb-15">
                                                <a href="#!">
                                                    <img class="g-width-70 g-height-70"
                                                        src="assets/img-temp/100x100/img10.jpg"
                                                        alt="Image Description">
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 g-mb-60 g-mb-0--lg">
                                        ...
                                        <div class="g-mb-30">
                                            <p>About Unify dolor sit amet, consectetur adipiscing elit. Maecenas eget
                                                nisl id libero tincidunt.</p>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-3">
                                        ...
                                        <ul class="list-unstyled g-mb-35">
                                            ...
                                            <li class="g-mb-5">
                                                <a class="g-color-white-opacity-0_8" href="#!">Francisco
                                                    papa</a>
                                            </li>
                                            <li>...</li>
                                        </ul>
                        ...
                        <footer class="g-bg-gray-dark-v1 g-color-white-opacity-0_8 g-py-20">
                            <div class="container">
                                <div class="row">
                                    <!-- Copyright Content -->
                                    <div
                                        class="col-md-6 align-self-center text-center text-md-left g-mb-10 g-mb-0--md">
                                        <div class="d-lg-flex">
                                            <small class="d-block g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017
                                                © All Rights Reserved.</small>
                                            <ul class="u-list-inline">
                        ...
                        <div class="g-bg-black-opacity-0_9 g-color-white-opacity-0_8 g-py-60">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 g-mb-60 g-mb-0--lg">
                                        <a class="d-block g-mb-20" href="index.html">
                                            <img class="img-fluid" src="assets/img/logo/logo-2.png"
                                                alt="Logo">
                                        </a>
                                        ...
                                        <address class="g-line-height-2 g-mt-minus-4">
                                            ...
                                            <br>
                                            Email:
                                            <a class="g-color-white-opacity-0_8" href="mailto:info@htmlstream.com"
                                                class="">info@htmlstream.com</a>
                                        </address>
                                    ...
                                    <div class="col-lg col-sm-4">
                                        ...
                                        <ul class="list-unstyled g-mb-35 g-mb-0--md">
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Help &amp;
                                                    Support</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Customer
                                                    Service</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                            ...
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Tour the New
                                                    Journey</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Registration
                                                    Requirements</a>
                                            </li>
                                            <li>...</li>
                                        </ul>
                                    ...
                                    <div class="col-lg col-sm-4">
                                        ...
                                        <ul class="list-unstyled g-mb-35">
                                            ...
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Unify
                                                    Template</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                            ...
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">UX &amp; UI
                                                    Design</a>
                                            </li>
                                            <li>...</li>
                                        </ul>
                                        ...
                                        <ul class="list-unstyled g-mb-35 g-mb-0--md">
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Flexbox
                                                    Masterclass</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">SASS
                                                    Snippets</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Video
                                                    Lessons</a>
                                            </li>
                                            <li>...</li>
                                        </ul>
                                    ...
                                    <div class="col-lg col-sm-4">
                                        ...
                                        <ul class="list-unstyled g-mb-35">
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Web
                                                    Development</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Android &amp;
                                                    iOS</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                            ...
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">PHP &amp;
                                                    MySQL</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                        ...
                                        <ul class="list-unstyled g-mb-35 g-mb-0--md">
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8"
                                                    href="#!">Wrapbootstrap.com</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8"
                                                    href="#!">Htmlstream.com</a>
                                            </li>
                                            <li class="d-flex align-items-baseline g-mb-8">
                                                <i class="fa fa-angle-right g-mr-5"></i>
            ...
            <section class="g-pt-70">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <div class="g-mb-30">
                                            <p>Unify is an ultra fully responsive template with modern and design and
                                                awesome features.</p>
                                        </div>
                                        ...
                                        <address class="mb-0">
                                            <div class="g-mb-30">
                                                ...
                                                <p class="mb-0">795 Folsom Ave, Suite 600, San Francisco, CA 94107
                                                </p>
                                            </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="g-mb-5">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                                <a class="g-color-white-opacity-0_8" href="#!">Support
                                                    Forum</a>
                                            </li>
                                            <li class="mb-0">
                                                <i class="fa fa-angle-right g-mr-5"></i>
                                    ...
                                    <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                                        ...
                                        <article class="media">
                                            <a class="d-flex g-mt-3 mr-3" href="#!">
                                                <img class="g-width-60 g-height-60 rounded"
                                                    src="assets/img-temp/100x100/img8.jpg" alt="Image Description">
                                            </a>
                                        ...
                                        <article class="media">
                                            ...
                                            <div class="media-body">
                                                <h3 class="h6">
                                                    <a class="g-color-white-opacity-0_8 g-color-white--hover"
                                                        href="#!">Top 10 luxury hotels - 5 star cozy rooms</a>
                                                </h3>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="g-mb-30">
                                            ...
                                            <div class="input-group border-0 g-rounded-30">
                                                <input class="form-control border-0 g-rounded-left-30 g-px-12 g-py-8"
                                                    type="email" placeholder="Email address">
                                                <div class="input-group-addon border-0 p-0">
                                                    <button
                                                        class="btn u-btn-primary g-rounded-right-30 g-px-12 g-py-8"
                                                        type="submit" role="button">Subscribe</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <p>Follow us if you want to be kept up to date about what’s going on, minute by
                                            minute, then search for htmlstream and give us a follow!</p>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item g-mr-10">
                ...
                <div class="g-font-size-12 g-my-30 text-center">
                    <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!"
                        data-content-target="#shortcode9" data-modal-target="#modalMarkup"
                        data-modal-effect="fadein">
                        <i class="fa fa-code"></i>
                        Show code
                    </a>
            ...
            <section class="g-pt-70">
                ...
                <div id="shortcode10">
                    <div class="shortcode-html">
                        <!-- Footer -->
                        <footer
                            class="u-bg-overlay g-bg-black-opacity-0_9--after g-color-white-opacity-0_8 g-bg-img-hero g-pt-60"
                            ...
                            <!-- Copyright Footer -->
                            <div
                                class="u-bg-overlay__inner g-bg-black-opacity-0_3 g-color-white-opacity-0_8 text-center g-py-20">
                                <div class="container">
                                    <small class="g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">2017 © All Rights
                                        Reserved. Unify Template by
                                        <a href="#!">Htmlstream</a>
            ...
            <section class="g-pt-70">
                ...
                <div id="shortcode11">
                    <div class="shortcode-html">
                        <!-- Footer -->
                        <footer
                            class="g-bg-darkgray-radialgradient-circle g-color-white-opacity-0_8 g-bg-img-hero g-pt-60">
                        ...
                        <footer id="contact-section" class="container">
                            <div class="row g-pt-80">
                                ...
                                <div class="col-sm-6 col-lg-3 g-mb-50">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="g-py-6">
                                            <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Sales
                                                Department</a>
                                        </li>
                                        <li class="g-py-6">
                                        ...
                                        <li class="g-py-6">
                                            <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Customer
                                                Department</a>
                                        </li>
                                    </ul>
                                    <!-- End Links -->
                                ...
                                <div class="col-sm-6 col-lg-3 g-mb-50">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="g-py-6">
                                            <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Apply for Unify
                                                Job</a>
                                        </li>
                                        <li class="g-py-6">
                                            <a class="u-link-v5 g-color-gray-dark-v5" href="#!">How it Works
                                                for Employees</a>
                                        </li>
                                        <li class="g-py-6">
                                            <a class="u-link-v5 g-color-gray-dark-v5" href="#!">Working
                                                Parameters</a>
                                        </li>
                                        <li class="g-py-6">
                                            <a class="u-link-v5 g-color-gray-dark-v5" href="#!">General
                                                FAQs</a>
                                        </li>
                                    </ul>
                                    <!-- End Links -->
                                ...
                                <div class="col-sm-6 col-lg-3 g-mb-50">
                                    ...
                                    <!-- Forms -->
                                    <form
                                        class="input-group g-brd-secondary-light-v2 g-brd-primary--focus g-rounded-30 g-mb-50 g-mb-30--sm">
                                        <input
                                            class="form-control g-brd-right-none g-placeholder-text g-font-size-13 g-px-25 g-py-15"
                                            type="email" placeholder="Enter your email">
                                        <span class="input-group-addon g-brd-left-none">
                                            <button
                                                class="btn g-bg-white g-color-black g-color-primary--hover g-font-size-12 g-brd-none g-pa-10"
                                                type="submit">
                            ...
                            <div class="row align-items-center g-py-35">
                                <div class="col-4">
                                    <a class="g-text-underline--none--hover" href="index.html">
                                        <img class="g-width-70" src="assets/img/logo/logo-1.png"
                                            alt="Image Description">
                                    </a>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-md-3 g-mb-30">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    <a class="u-link-v6 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3"
                                                        href="page-about-1.html">
                                                        About Unify Marketing
                                                        <span
                                                            class="u-link-v6-arrow g-font-size-18">&rightarrow;</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="u-link-v6 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-text-underline--none--hover g-py-3"
                                        ...
                                        <div class="col-6 col-md-3 g-mb-30">
                                            ...
                                            <address
                                                class="g-font-size-13 g-color-gray-dark-v3 g-font-weight-600 g-line-height-2 mb-0">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-4 text-center text-md-left g-mb-30">
                                            ...
                                            <a class="g-text-underline--none--hover mr-4" href="index.html">
                                                <img class="g-width-95" src="assets/img/logo/logo-2.png"
                                                    alt="Logo">
                                            </a>
                                            <!-- End Logo -->
                                            <p
                                                class="d-inline-block align-middle g-color-gray-dark-v5 g-font-size-13 mb-0">
                                                &#169; 2017 Htmlstream.
                                        ...
                                        <div class="col-md-4 g-mb-30 text-right">
                                            <div class="d-inline-block g-mx-15">
                                                <h4
                                                    class="g-color-gray-dark-v5 g-font-size-11 text-left text-uppercase">
                                                    Email</h4>
                        ...
                        <footer class="container g-pt-100 g-pb-70">
                            <div class="row">
                                <div class="col-md-3 text-center text-md-left g-mb-30">
                                    <!-- Logo -->
                                    <a class="d-inline-block g-text-underline--none--hover mr-4 mb-4"
                                        href="index.html">
                                    ...
                                    <div class="btn-group dropup">
                                        <button
                                            class="btn btn-black btn-lg g-brd-gray-light-v3 g-color-black g-color-primary--hover g-bg-white g-font-weight-500 g-font-size-default rounded-0"
                                        ...
                                        <div class="dropdown-menu g-brd-gray-light-v3 rounded-0">
                                            <a class="dropdown-item g-color-black g-color-white--hover g-bg-primary--hover g-bg-primary--active g-py-10"
                                                href="#">
                                                United Kingdom
                                            </a>
                                            <a class="dropdown-item g-color-black g-color-white--hover g-bg-primary--hover g-bg-primary--active g-py-10"
                                ...
                                <div class="col-md-6 text-center g-mb-30">
                                    <span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-4">&#169; Htmlstream.
                                        All Rights Reserved. 2013 - 2017</span>

                                    <!-- Footer - List -->
                                    <ul class="list-inline mb-5">
                                        <li class="list-inline-item mx-3"><a
                                                class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500"
                                                href="#">For Rent</a>
                                        </li>
                                        <li class="list-inline-item mx-3"><a
                                                class="u-link-v5 g-color-black g-color-primary--hover g-font-weight-500"
                                    ...
                                    <!-- Go to Top -->
                                    <a class="js-go-to u-go-to-v3 g-width-40 g-height-40 g-color-primary"
                                        href="#" data-offset-top="400" data-compensation="#js-header"
                                        data-show-effect="zoomIn">
                                        <i
                                            class="g-brd-gray-light-v3 g-brd-primary--hover rounded-0 fa fa-long-arrow-up"></i>
                                    </a>
                                    <!-- End Go to Top -->
                                </div>
                                ...
                                <div class="col-md-3 text-center g-mb-30">
                                    ...
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item g-mx-2">
                                            <a class="u-icon-v2 g-width-35 g-height-35 g-brd-gray-light-v3 g-brd-primary--hover g-color-gray-dark-v5 g-color-white--hover g-bg-transparent g-bg-primary--hover g-font-size-13"
                                                href="#">
                                                <i class="fa fa-facebook"></i>
                                            </a>
                                        </li>
                            ...
                            <div class="container">
                                <div class="row g-mb-40">
                                    <div class="col-6 col-md-3 g-mb-20">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                                    href="#">Future Students</a>
                                            </li>
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                    ...
                                    <div class="col-6 col-md-3 g-mb-20">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                                    href="#">Programs of Study</a>
                                            </li>
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                                    href="#">University Life</a>
                                            </li>
                                        </ul>
                                        <!-- End Footer Links -->
                                    </div>
                                    ...
                                    <div class="col-6 col-md-3 g-mb-20">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                                    href="#">Downtown Ontario Campus</a>
                                            </li>
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                                    href="#">Mississauga Campus</a>
                                            </li>
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                                    href="#">Scarborough Campus</a>
                                            </li>
                                            <li class="g-py-5"><a
                                                    class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-font-size-16"
                                                    href="#">Campus Maps</a>
