            ...
            <div class="u-header__sections-container">
                <div class="u-sidebar-navigation-inner">
                    ...
                    <ul class="js-shortcode-filter-result nav flex-column u-sidebar-navigation-list">
                        ...
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-alerts.html"
                                class="nav-link ">Alerts</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-badges.html"
                        ...
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-box-shadows.html"
                                class="nav-link ">Box Shadow</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item bases">
                        ...
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-modals.html"
                                class="nav-link ">Modals</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item bases">
                        ...
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-labels.html"
                                class="nav-link ">Labels</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-lists-group.html"
                                class="nav-link ">Lists Group</a>
                        </li>
                        ...
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-panels.html"
                                class="nav-link ">Panels</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item bases">
                        ...
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-tables.html"
                        ...
                        <li class="js-shortcode-filter__item nav-item bases">
                            <a href="../../unify-main/shortcodes/shortcode-base-tags.html"
                        ...
                        <li class="js-shortcode-filter__item nav-item blocks">
                            <a href="../../unify-main/shortcodes/portfolios/index.html"
                                class="nav-link ">Portfolios</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item blocks">
                        ...
                        <li class="js-shortcode-filter__item nav-item blocks">
                            <a href="../../unify-main/shortcodes/shortcode-blocks-counters.html"
                                class="nav-link active">Counters</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item dropdown blocks">
                            <a class="nav-link dropdown-toggle " href="#!" role="button"
                        ...
                        <li class="js-shortcode-filter__item nav-item blocks">
                            <a href="../../unify-main/shortcodes/shortcode-blocks-info-blocks.html"
                                class="nav-link ">Info Blocks</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item dropdown blocks">
                            <a class="nav-link dropdown-toggle " href="#!" role="button"
                        ...
                        <li class="js-shortcode-filter__item nav-item blocks">
                            <a href="../../unify-main/shortcodes/shortcode-blocks-tables.html"
                                class="nav-link ">Table Designs</a>
                        </li>
                        <li class="js-shortcode-filter__item nav-item dropdown blocks">
                            <a class="nav-link dropdown-toggle " href="#!" role="button"
                        ...
                        <li class="js-shortcode-filter__item nav-item blocks">
                            <a href="../../unify-main/shortcodes/shortcode-blocks-users.html"
        ...
        <section>
                            ...
                            <div class="row text-center text-uppercase">
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="g-brd-around g-brd-gray-dark-v2 g-pa-20">
                                        <div class="js-counter g-font-size-35 g-font-weight-300 g-mb-7">52147</div>
                                        <h4 class="h5 g-color-white-opacity-0_8 g-font-weight-300 g-mb-5">Code Lines
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="g-brd-around g-brd-gray-dark-v2 g-pa-20">
                                        <div class="js-counter g-font-size-35 g-font-weight-300 g-mb-7">24583</div>
                                        <h4 class="h5 g-color-white-opacity-0_8 g-font-weight-300 g-mb-5">Projects
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="g-brd-around g-brd-gray-dark-v2 g-pa-20">
                                        <div class="js-counter g-font-size-35 g-font-weight-300 g-mb-7">7348</div>
                                        <h4 class="h5 g-color-white-opacity-0_8 g-font-weight-300 g-mb-5">Working
                                            Hours</h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="g-brd-around g-brd-gray-dark-v2 g-pa-20">
                                        <div class="js-counter g-font-size-35 g-font-weight-300 g-mb-7">87904</div>
                                        <h4 class="h5 g-color-white-opacity-0_8 g-font-weight-300 g-mb-5">Job Offers
                                        </h4>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="dzsparallaxer auto-init height-is-based-on-content">
                ...
                <div class="divimage dzsparallaxer--target w-100"
                    style="height: 140%; background: url(../../assets/img/bg/pattern2.png)"></div>
                <!-- End Parallax Image -->
                        ...
                        <div class="shortcode-html">
                            <div class="row text-center text-uppercase">
                                <div class="col-md-6 col-lg-3 g-mb-30">
                                    <div
                                        class="g-bg-white g-rounded-4 g-brd-bottom g-brd-2 g-brd-gray-light-v3 g-pa-20">
            ...
            <section class="dzsparallaxer auto-init height-is-based-on-content">
                <!-- Parallax Image -->
                <div class="divimage dzsparallaxer--target w-100"
                    style="height: 160%; background: url(../../assets/img/bg/pattern3.png)"></div>
                <!-- End Parallax Image -->
                        ...
                        <div class="shortcode-html">
                            <div class="row text-center g-color-white">
                                <div class="col-md-3 col-6 d-flex justify-content-center g-mb-60">
                                    <div
                                        class="d-flex justify-content-center u-counter-v3 g-brd-primary g-bg-primary g-width-150 g-height-150 rounded-circle g-pa-20">
            ...
            <section class="dzsparallaxer auto-init height-is-based-on-content">
                <!-- Parallax Image -->
                <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover u-bg-overlay g-bg-black-opacity-0_4--after"
                    style="height: 140%; background: url(../../assets/img-temp/1920x800/img11.jpg)"></div>
                <!-- End Parallax Image -->
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode10" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="dzsparallaxer auto-init height-is-based-on-content">
                <!-- Parallax Image -->
                <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover u-bg-overlay g-bg-black-opacity-0_6--after"
                    style="height: 140%; background: url(../../assets/img-temp/1920x800/img2.jpg)"></div>
                <!-- End Parallax Image -->
            ...
            <section class="g-py-100">
                        ...
                        <div class="shortcode-html">
                            <div class="row text-center">
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-30">
                                    ...
                                    <h4 class="text-uppercase g-font-size-11 g-font-weight-600 g-mb-25">Photographers
                                    </h4>
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode13" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-color-white g-py-100">
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode14" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-py-100">
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-30">
                                    <div class="d-flex justify-content-sm-center">
                                        ...
                                        <div class="g-line-height-1">
                                            ...
                                            <div class="js-counter g-color-gray-dark-v4 g-font-size-18"
                                                data-comma-separated="true">52147</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-30">
                                    <div class="d-flex justify-content-sm-center">
                                        ...
                                        <div class="g-line-height-1">
                                            ...
                                            <div class="js-counter g-color-gray-dark-v4 g-font-size-18"
                                                data-comma-separated="true">324056</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-30">
                                    <div class="d-flex justify-content-sm-center">
                                        ...
                                        <div class="g-line-height-1">
                                            ...
                                            <div class="js-counter g-color-gray-dark-v4 g-font-size-18"
                                                data-comma-separated="true">15147</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-30">
                                    <div class="d-flex justify-content-sm-center">
                                        ...
                                        <div class="g-line-height-1">
                                            ...
                                            <div class="js-counter g-color-gray-dark-v4 g-font-size-18"
                                                data-comma-separated="true">37283</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode15" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-color-white g-py-100">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 g-mb-30">
                                    <div class="d-flex justify-content-sm-center">
                                        ...
                                        <div class="g-line-height-1">
                                            <h4 class="g-font-weight-300">Overal Visits</h4>
                                            <div class="js-counter g-color-white-opacity-0_6 g-font-size-18"
                                                data-comma-separated="true">52147</div>
                                        </div>
                                    </div>
                                </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode16" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-py-100">
                        ...
                        <div class="shortcode-html">
                            <div class="row text-center">
                                <div class="col-md-3 col-sm-6 g-mb-30">
                                    <span
                                        class="u-icon-v3 u-icon-size--xl g-bg-primary-opacity-0_1 rounded-circle g-mb-10">
                                        <i class="et-icon-wallet g-color-primary"></i>
                                    </span>

                                    <div class="js-counter g-color-primary g-font-size-40 g-font-weight-300 g-mb-7">
                                        3254</div>
                                </div>

                                <div class="col-md-3 col-sm-6 g-mb-30">
                                    <span
                                        class="u-icon-v3 u-icon-size--xl g-bg-cyan-opacity-0_1 rounded-circle g-mb-10">
                                        <i class="et-icon-genius g-color-cyan"></i>
                                    </span>

                                    <div class="js-counter g-color-cyan g-font-size-40 g-font-weight-300 g-mb-7">5389
                                    </div>
                                </div>

                                <div class="col-md-3 col-sm-6 g-mb-30">
                                    <span
                                        class="u-icon-v3 u-icon-size--xl g-bg-lightred-opacity-0_1 rounded-circle g-mb-10">
                                        <i class="et-icon-tools g-color-lightred"></i>
                                    </span>

                                    <div class="js-counter g-color-lightred g-font-size-40 g-font-weight-300 g-mb-7">
                                        7068</div>
                                </div>

                                <div class="col-md-3 col-sm-6 g-mb-30">
                                    <span
                                        class="u-icon-v3 u-icon-size--xl g-bg-teal-opacity-0_1 rounded-circle g-mb-10">
                                        <i class="et-icon-chat g-color-teal"></i>
                                    </span>

                                    <div class="js-counter g-color-teal g-font-size-40 g-font-weight-300 g-mb-7">9172
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode17" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-py-100">
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode18" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-py-100">
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode19" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-py-100">
                ...
                $(document).on('ready', function () {
                  ...
                  var counters = $.HSCore.components.HSCounter.init('[class*="js-counter"]');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode20" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-py-100">
                        ...
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-primary g-color-black g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="53" data-circles-max-value="200"
                                            data-circles-bg-color="#ffffff" data-circles-fg-color="#72c02c"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-scroll-animate="true">
                                        </div>

                                        <div class="align-self-center g-line-height-2">
                                            <h4 class="h6 text-uppercase g-font-weight-700 g-color-black g-mb-15">
                                                Courses in Our School</h4>
                                            <p class="mb-0">Sed feugiat porttitor nunc Etiam gravida ex justo ac
                                                rhoncus purus tristique ut, egestas a libero eget, sollicitudin maximus
                                                nulla. Nunc vitae maximus ipsum.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-primary g-color-black g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="96" data-circles-max-value="200"
                                            data-circles-bg-color="#ffffff" data-circles-fg-color="#72c02c"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-scroll-animate="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-primary g-color-black g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="8" data-circles-max-value="15"
                                            data-circles-bg-color="#ffffff" data-circles-fg-color="#72c02c"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-additional-text="k" data-circles-scroll-animate="true">
                                        </div>
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-primary g-color-black g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="48" data-circles-max-value="200"
                                            data-circles-bg-color="#ffffff" data-circles-fg-color="#72c02c"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-scroll-animate="true">
                ...
                $(document).on('ready', function () {
                  ...
                  var rtlItems = $.HSCore.components.HSChartPie.init('.js-pie-rtl', {
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode21" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-color-white g-py-100">
                    ...
                    <div id="shortcode22">
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-purple g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="53" data-circles-max-value="200"
                                            data-circles-bg-color="#111" data-circles-fg-color="#9a69cb"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-scroll-animate="true">
                                        </div>
                                        ...
                                        <div class="align-self-center g-line-height-2">
                                            <h4
                                                class="h5 text-uppercase g-font-weight-400 g-letter-spacing-1 g-mb-15">
                                                Courses in Our School</h4>
                                            <p class="mb-0 g-color-white-opacity-0_8">Sed feugiat porttitor nunc Etiam
                                                gravida ex justo ac rhoncus purus tristique ut, egestas a libero eget,
                                                sollicitudin maximus nulla. Nunc vitae maximus ipsum.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-pink g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="96" data-circles-max-value="200"
                                            data-circles-bg-color="#111" data-circles-fg-color="#e81c62"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-scroll-animate="true">
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-cyan g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="8" data-circles-max-value="15"
                                            data-circles-bg-color="#111" data-circles-fg-color="#00bed6"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-additional-text="k" data-circles-scroll-animate="true">
                                        </div>
                                ...
                                <div class="col-lg-6 g-mb-60">
                                    <div class="d-flex">
                                        <div class="js-pie-rtl u-chart-pie-v1 g-brd-primary g-height-140 g-width-140 g-mr-30"
                                            data-circles-value="48" data-circles-max-value="200"
                                            data-circles-bg-color="#111" data-circles-fg-color="#72c02c"
                                            data-circles-radius="70" data-circles-stroke-width="2"
                                            data-circles-font-size="35" data-circles-duration="2000"
                                            data-circles-scroll-animate="true">
                                        </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var rtlItems = $.HSCore.components.HSChartPie.init('.js-pie-rtl', {
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode22" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="text-center g-py-100">
                        ...
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="87"
                                        data-circles-max-value="100" data-circles-bg-color="#eeeeee"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="8" data-circles-font-size="40"
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-md-4 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="74"
                                        data-circles-max-value="100" data-circles-bg-color="#eeeeee"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="8" data-circles-font-size="40"
                                        data-circles-additional-text="%" data-circles-duration="2000"
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-md-4 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="65"
                                        data-circles-max-value="100" data-circles-bg-color="#eeeeee"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="8" data-circles-font-size="40"
                                        data-circles-additional-text="%" data-circles-duration="2000"
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode23" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-color-white text-center g-py-100">
                    ...
                    <div id="shortcode24">
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="87"
                                        data-circles-max-value="100" data-circles-bg-color="#222"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="8" data-circles-font-size="30"
                                        data-circles-additional-text="%" data-circles-duration="2000"
                                        data-circles-scroll-animate="true">
                                    </div>

                                    <h4 class="g-mb-15">UI Design</h4>
                                    <p class="lead g-px-10 mb-0">Sed feugiat porttitor nunc etiam gravi daex justo ac
                                        rhoncus</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-md-4 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="74"
                                        data-circles-max-value="100" data-circles-bg-color="#222"
                                        data-circles-fg-color="#e81c62" data-circles-radius="80"
                                        data-circles-stroke-width="8" data-circles-font-size="30"
                                        data-circles-additional-text="%" data-circles-duration="2000"
                                        data-circles-scroll-animate="true">
                                    </div>
                                    ...
                                    <h4 class="g-mb-15">Web Development</h4>
                                    <p class="lead g-px-10 mb-0">Libero eget sollic itudin maximus nullanunc vitae
                                        maximus</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-md-4 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="65"
                                        data-circles-max-value="100" data-circles-bg-color="#222"
                                        data-circles-fg-color="#00bed6" data-circles-radius="80"
                                        data-circles-stroke-width="8" data-circles-font-size="30"
                                        data-circles-additional-text="%" data-circles-duration="2000"
                                        data-circles-scroll-animate="true">
                                    </div>
                                    ...
                                    <h4 class="g-mb-15">JavaScript</h4>
                                    <p class="lead g-px-10 mb-0">Morem lipsum lidolor sit amet consectetur adipiscing
                                    </p>
                                </div>
                                <!-- End Counter Pie Chart -->
                            </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode24" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="text-center g-py-100">
                    ...
                    <div id="shortcode25">
                        <div class="shortcode-html">
                            <div class="row">
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="54"
                                        data-circles-max-value="100" data-circles-bg-color="#d3b6c6"
                                        data-circles-fg-color="#9b6bcc" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    </div>

                                    <h4 class="h3 g-font-weight-300 g-letter-spacing-2 g-mb-15">Consulting</h4>
                                    <p class="lead mb-0">Sed feugiat porttitor nunc etiam gravi daex justo ac rhoncus
                                    </p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="63"
                                        data-circles-max-value="100" data-circles-bg-color="#c9ff97"
                                        data-circles-fg-color="#72c02c" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    </div>
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="72"
                                        data-circles-max-value="100" data-circles-bg-color="#bee3f7"
                                        data-circles-fg-color="#3498db" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    </div>
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="81"
                                        data-circles-max-value="100" data-circles-bg-color="#ffc2bb"
                                        data-circles-fg-color="#e74c3c" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode25" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-color-white text-center g-py-100">
                    ...
                    <div id="shortcode26">
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="54"
                                        data-circles-max-value="100" data-circles-bg-color="#3f363b"
                                        data-circles-fg-color="#9b6bcc" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    ...
                                    <h4 class="h3 g-font-weight-300 g-letter-spacing-2 g-mb-15">Consulting</h4>
                                    <p class="lead g-color-white-opacity-0_8 mb-0">Sed feugiat porttitor nunc etiam
                                        gravi daex justo ac rhoncus</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="63"
                                        data-circles-max-value="100" data-circles-bg-color="#3c4c2d"
                                        data-circles-fg-color="#72c02c" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    ...
                                    <h4 class="h3 g-font-weight-300 g-letter-spacing-2 g-mb-15">Marketing</h4>
                                    <p class="lead g-color-white-opacity-0_8 mb-0">Libero eget sollic itudin maximus
                                        nullanunc porttitor</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="72"
                                        data-circles-max-value="100" data-circles-bg-color="#39444a"
                                        data-circles-fg-color="#3498db" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    ...
                                    <h4 class="h3 g-font-weight-300 g-letter-spacing-2 g-mb-15">Branding</h4>
                                    <p class="lead g-color-white-opacity-0_8 mb-0">Morem lipsum lidolor sit amet
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-mb-30" data-circles-value="81"
                                        data-circles-max-value="100" data-circles-bg-color="#4c3a38"
                                        data-circles-fg-color="#e74c3c" data-circles-radius="70"
                                        data-circles-stroke-width="2" data-circles-additional-text="%"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="30">
                                    ...
                                    <h4 class="h3 g-font-weight-300 g-letter-spacing-2 g-mb-15">Copywriting</h4>
                                    <p class="lead g-color-white-opacity-0_8 mb-0">Quisque vestibulum sem eget nibh
                                        venenatis commodo</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                            </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode26" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="text-center g-py-100">
                    ...
                    <div id="shortcode27">
                        <div class="shortcode-html">
                            <div class="row">
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-35" data-circles-value="84"
                                        data-circles-max-value="100" data-circles-bg-color="#f8f8f8"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-font-size="56">
                                    </div>

                                    <h4 class="h5 text-uppercase g-font-weight-600 g-mb-15">Happy Clients</h4>
                                    <p class="mb-0 g-line-height-2">Integer accumsan maximus leo, et consectetur metus
                                        vestibulum in</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-35" data-circles-value="34"
                                        data-circles-max-value="100" data-circles-bg-color="#f8f8f8"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-font-size="56">
                                    ...
                                    <p class="mb-0 g-line-height-2">Quisque vestibulum sem eget nibh elementum nibh
                                        pulvinar</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-35" data-circles-value="35"
                                        data-circles-max-value="100" data-circles-bg-color="#f8f8f8"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-font-size="56">
                                    ...
                                    <p class="mb-0 g-line-height-2">Nullam in diam arcuiam nisl justo tempor
                                        scelerisque vest ibulum</p>
                                </div>
                                <!-- End Counter Pie Chart -->

                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-35" data-circles-value="67"
                                        data-circles-max-value="100" data-circles-bg-color="#f8f8f8"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-font-size="56">
                                    ...
                                    <h4 class="h5 text-uppercase g-font-weight-600 g-mb-15">Happy Clients</h4>
                                    <p class="mb-0 g-line-height-2">Integer accumsan maximus metus vestibulum maximus
                                        efficitur</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                            </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode27" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="g-bg-gray-dark-v1 g-color-white text-center g-py-100">
                        ...
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-35" data-circles-value="84"
                                        data-circles-max-value="100" data-circles-bg-color="#222"
                                        data-circles-fg-color="#fff" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-font-size="56">
                                    </div>

                                    <h4 class="h5 text-uppercase g-font-weight-600 g-mb-15">Happy Clients</h4>
                                    <p class="mb-0 g-color-white-opacity-0_8 g-line-height-2">Integer accumsan maximus
                                        leo, et consectetur metus vestibulum in</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    ...
                                    <h4 class="h5 text-uppercase g-font-weight-600 g-mb-15">Completed Projects</h4>
                                    <p class="mb-0 g-color-white-opacity-0_8 g-line-height-2">Quisque vestibulum sem
                                        eget nibh elementum nibh pulvinar</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    ...
                                    <h4 class="h5 text-uppercase g-font-weight-600 g-mb-15">Our Team</h4>
                                    <p class="mb-0 g-color-white-opacity-0_8 g-line-height-2">Nullam in diam arcuiam
                                        nisl justo tempor scelerisque vest ibulum</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    ...
                                    <h4 class="h5 text-uppercase g-font-weight-600 g-mb-15">Happy Clients</h4>
                                    <p class="mb-0 g-color-white-opacity-0_8 g-line-height-2">Integer accumsan maximus
                                        metus vestibulum maximus efficitur</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                            </div>
                        </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode28" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
            ...
            <section class="text-center g-py-100">
                        ...
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-40">
                                    <div class="js-pie g-color-black g-font-weight-600 g-mb-30"
                                        data-circles-value="67" data-circles-max-value="100"
                                        data-circles-bg-color="#f8f8f8" data-circles-fg-color="#111"
                                        data-circles-radius="80" data-circles-stroke-width="10"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-additional-text="%" data-circles-font-size="20">
                                    </div>

                                    <h4 class="h6 g-color-black text-uppercase g-font-weight-600 g-mb-15">Consulting
                                    </h4>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-40">
                                    <div class="js-pie g-color-black g-font-weight-600 g-mb-30"
                                        data-circles-value="34" data-circles-max-value="100"
                                        data-circles-bg-color="#f8f8f8" data-circles-fg-color="#111"
                                        data-circles-radius="80" data-circles-stroke-width="10"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-additional-text="%" data-circles-font-size="20">
                                    ...
                                    <h4 class="h6 g-color-black text-uppercase g-font-weight-600 g-mb-15">Marketing
                                    </h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit
                                        amet, consectetur adipiscing elit.</p>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-40">
                                    <div class="js-pie g-color-black g-font-weight-600 g-mb-30"
                                        data-circles-value="35" data-circles-max-value="100"
                                        data-circles-bg-color="#f8f8f8" data-circles-fg-color="#111"
                                        data-circles-radius="80" data-circles-stroke-width="10"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-additional-text="%" data-circles-font-size="20">
                                    ...
                                    <h4 class="h6 g-color-black text-uppercase g-font-weight-600 g-mb-15">Branding
                                    </h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit
                                        amet, consectetur adipiscing elit.</p>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 g-mb-40">
                                    ...
                                    <h4 class="h6 g-color-black text-uppercase g-font-weight-600 g-mb-15">Copywriting
                                    </h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit
                                        amet, consectetur adipiscing elit.</p>
                                </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode29" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
                        <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!"
                            data-content-target="#shortcode29" data-success-text="Copied">
                            <i class="fa fa-clone"></i>
                            Copy code
                        </a>
                    </div>
            ...
            <section class="g-bg-gray-dark-v1 g-color-white text-center g-py-100">
                    ...
                    <div id="shortcode30">
                        <div class="shortcode-html">
                            <div class="row">
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-30" data-circles-value="67"
                                        data-circles-max-value="100" data-circles-bg-color="#222"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-additional-text="%"
                                        data-circles-font-size="20">
                                    </div>

                                    <h4 class="h5 text-uppercase g-font-weight-400 g-letter-spacing-2 g-mb-15">
                                        Consulting</h4>
                                    <p class="lead mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-30" data-circles-value="34"
                                        data-circles-max-value="100" data-circles-bg-color="#222"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-additional-text="%"
                                ...
                                <!-- Counter Pie Chart -->
                                <div class="col-lg-3 col-sm-6 g-mb-50">
                                    <div class="js-pie g-font-weight-600 g-mb-30" data-circles-value="35"
                                        data-circles-max-value="100" data-circles-bg-color="#222"
                                        data-circles-fg-color="#72c02c" data-circles-radius="80"
                                        data-circles-stroke-width="10" data-circles-duration="2000"
                                        data-circles-scroll-animate="true" data-circles-additional-text="%"
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode30" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
                        <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!"
                            data-content-target="#shortcode30" data-success-text="Copied">
                            <i class="fa fa-clone"></i>
                            Copy code
                        </a>
                    </div>
            ...
            <section class="text-center g-py-100">
                        ...
                        <div class="shortcode-html">
                            <div class="row">
                                ...
                                <div class="col-sm-6 g-mb-80">
                                    <div class="js-pie g-color-black g-font-weight-300 g-mb-40"
                                        data-circles-value="35" data-circles-max-value="100"
                                        data-circles-bg-color="#222" data-circles-fg-color="#e81c62"
                                        data-circles-radius="100" data-circles-stroke-width="15"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="50">
                                    </div>

                                    <h4 class="h2 g-color-black text-uppercase g-letter-spacing-3 g-mb-15">Branding
                                    </h4>
                                    <p class="lead g-px-10 mb-0">Sed feugiat porttitor nunc etiam gravi daex justo ac
                                        rhoncus. Libero eget sollic itudin maximus porttitor</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                                ...
                                <div class="col-sm-6 g-mb-80">
                                    <div class="js-pie g-color-black g-font-weight-300 g-mb-40"
                                        data-circles-value="67" data-circles-max-value="100"
                                        data-circles-bg-color="#222" data-circles-fg-color="#00bed6"
                                        data-circles-radius="100" data-circles-stroke-width="15"
                                        data-circles-duration="2000" data-circles-scroll-animate="true"
                                        data-circles-font-size="50">
                                    </div>

                                    <h4 class="h2 g-color-black text-uppercase g-letter-spacing-3 g-mb-15">MARKETING
                                    </h4>
                                    <p class="lead g-px-10 mb-0">Quisque vestibulum sem eget nibh elementum nibh
                                        pulvinar. Justo ac rhoncus itudin maximus nullanunc porttitor</p>
                                </div>
                                <!-- End Counter Pie Chart -->
                            </div>
                        </div>
                ...
                $(document).on('ready', function () {
                  ...
                  var items = $.HSCore.components.HSChartPie.init('.js-pie');
                    ...
                    <div class="g-font-size-12 g-my-30 text-center">
                        <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15"
                            href="#!" data-content-target="#shortcode31" data-modal-target="#modalMarkup"
                            data-modal-effect="fadein">
                            <i class="fa fa-code"></i>
                            Show code
                        </a>
                        <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!"
                            data-content-target="#shortcode31" data-success-text="Copied">
                            <i class="fa fa-clone"></i>
                            Copy code
                        </a>
                    </div>
                    ...
                    <div class="shortcode-html">
                        ...
                        <div class="dzsparallaxer auto-init height-is-based-on-content use-loading"
                            ...
                            <div class="divimage dzsparallaxer--target w-100 g-bg-size-cover g-bg-img-hero g-bg-cover g-bg-black-opacity-0_7--after"
                                style="height: 130%; background-image: url(../../assets/img-temp/1920x500/img2.jpg);">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-lg-3 align-items-end mt-auto g-mb-50">
                                        <div class="text-center">
                                            <span
                                                class="js-counter g-color-primary g-font-weight-600 g-font-size-60 g-line-height-0_9 mr-2">75</span>
                                            <h3
                                                class="d-inline-block g-color-white g-font-weight-600 g-font-size-22 mb-0">
                                                Clients</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3 align-items-end mt-auto g-mb-50">
                                        <div class="text-center">
                                            <span
                                                class="js-counter g-color-primary g-font-weight-600 g-font-size-60 g-line-height-0_9 mr-2">20</span>
                                            <h3
                                                class="d-inline-block g-color-white g-font-weight-600 g-font-size-22 mb-0">
                                                Products</h3>
                                        </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3 align-items-end mt-auto g-mb-50">
                                        <div class="text-center">
                                            <span
                                                class="js-counter g-color-primary g-font-weight-600 g-font-size-60 g-line-height-0_9 mr-2">15</span>
                                            <h3
                                                class="d-inline-block g-color-white g-font-weight-600 g-font-size-22 mb-0">
                                                Members</h3>
                                        </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3 align-items-end mt-auto g-mb-50">
                                        <div class="text-center">
                                            <span
                                                class="js-counter g-color-primary g-font-weight-600 g-font-size-60 g-line-height-0_9 mr-2">50</span>
                                            <h3
                                                class="d-inline-block g-color-white g-font-weight-600 g-font-size-22 mb-0">
                                                Projects</h3>
                                        </div>
              ...
              $(document).on('ready', function () {
                ...
                <div class="g-font-size-12 g-my-30 text-center">
                    <a class="js-modal-markup u-link-v5 g-color-main g-color-primary--hover g-mr-15" href="#!"
                        data-content-target="#shortcode32" data-modal-target="#modalMarkup"
                        data-modal-effect="fadein">
                        <i class="fa fa-code"></i>
                        Show code
                    </a>
                    <a class="js-copy u-link-v5 g-color-main g-color-primary--hover" href="#!"
                        data-content-target="#shortcode32" data-success-text="Copied">
                        <i class="fa fa-clone"></i>
                        Copy code
                    </a>
                </div>
