                        ...
                        <div class="row">
                            <div class="col-6 col-sm-4 col-lg-2 g-mb-40">
                                ...
                                <figure class="text-center">
                                    ...
                                    <div class="d-inline-block">
                                        <div
                                            class="d-flex justify-content-between w-100 g-max-width-145 g-bg-black g-color-white g-font-size-10 g-font-weight-700 text-uppercase">
                                            <span class="g-px-15 g-py-6">Need</span>
                                            <span
                                                class="g-bg-primary g-color-black g-font-weight-700 g-px-15 g-py-6">$125
                                                000</span>
                                        </div>
                                    </div>
                                    <!-- End Figure Body -->
                            ...
                            <div class="col-6 col-sm-4 col-lg-2 g-mb-40">
                                ...
                                <figure class="text-center">
                                    ...
                                    <div class="mx-auto g-width-130 g-height-130 g-mb-15">
                                        <img class="g-width-120 g-height-120 rounded-circle"
                                            src="assets/img-temp/125x125/img4.jpg" alt="Image Description">
                                    </div>
                                    <!-- End Figure Image -->
                                    ...
                                    <div class="d-inline-block">
                                        <div
                                            ...
                                            <span class="g-px-15 g-py-6">Need</span>
                                            <span
                                                class="g-bg-primary g-color-black g-font-weight-700 g-px-15 g-py-6">$690
                                                000</span>
                                        </div>
                                    </div>
                                    <!-- End Figure Body -->
                            ...
                            <div class="col-6 col-sm-4 col-lg-2 g-mb-40">
                                ...
                                <figure class="text-center">
                                    ...
                                    <div class="mx-auto g-width-130 g-height-130 g-mb-15">
                                        <img class="g-width-120 g-height-120 rounded-circle"
                                            src="assets/img-temp/125x125/img3.jpg" alt="Image Description">
                                    </div>
                                    <!-- End Figure Image -->
                                    ...
                                    <div class="d-inline-block">
                                        <div
                                            ...
                                            <span class="g-px-15 g-py-6">Need</span>
                                            <span
                                                class="g-bg-primary g-color-black g-font-weight-700 g-px-15 g-py-6">$420
                                                000</span>
                                        </div>
                                    </div>
                                    <!-- End Figure Body -->
                            ...
                            <div class="col-6 col-sm-4 col-lg-2 g-mb-40">
                                ...
                                <figure class="text-center">
                                    ...
                                    <div class="mx-auto g-width-130 g-height-130 g-mb-15">
                                        <img class="g-width-120 g-height-120 rounded-circle"
                                            src="assets/img-temp/125x125/img5.jpg" alt="Image Description">
                                    </div>
                                    <!-- End Figure Image -->
                                    ...
                                    <div class="d-inline-block">
                                        <div
                                            ...
                                            <span class="g-px-15 g-py-6">Need</span>
                                            <span
                                                class="g-bg-primary g-color-black g-font-weight-700 g-px-15 g-py-6">$661
                                                000</span>
                                        </div>
                                    </div>
                                    <!-- End Figure Body -->
                            ...
                            <div class="col-6 col-sm-4 col-lg-2 g-mb-40">
                                ...
                                <figure class="text-center">
                                    ...
                                    <div class="mx-auto g-width-130 g-height-130 g-mb-15">
                                        <img class="g-width-120 g-height-120 rounded-circle"
                                            src="assets/img-temp/125x125/img14.png" alt="Image Description">
                                    </div>
                                    <!-- End Figure Image -->

                                    <!-- Figure Info -->
                                    <h4 class="text-uppercase g-font-weight-700 h6 g-color-gray-dark-v1 g-mb-18">You
                                        can be here</h4>
                                    <a href="#!"
                                        class="rounded-0 btn btn-xxl btn-block u-btn-primary g-font-size-11 g-font-weight-700 text-uppercase g-px-10">Became
                                        a Donator</a>
                                    <!-- End Info -->
                                </figure>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 g-mb-30">
                                    ...
                                    <figure class="u-shadow-v19 g-bg-white g-rounded-4 g-pa-25">
                                        <div class="media g-mb-20">
                                            <div class="d-flex g-mr-20">
                                                ...
                                                <div class="g-brd-around g-brd-3 g-brd-gray-light-v3 rounded-circle">
                                                    <img class="rounded-circle g-width-50 g-height-50"
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="d-block">
                                                    <i
                                                        class="g-color-primary g-font-size-default icon-location-pin"></i>
                                                    <span class="g-color-gray-dark-v4 g-font-size-13">California,
                                                        US</span>
                                                </div>
                                                <!-- End Figure Info -->
                                            </div>
                                        ...
                                        <p>Finding ways to help tell your story through video is a powerful tool to make
                                            your branded content stand out from the rest.</p>
                                        ...
                                        <div class="media g-mb-20">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="d-block">
                                                    <i
                                                        class="g-color-primary g-font-size-default icon-location-pin"></i>
                                                    <span class="g-color-gray-dark-v4 g-font-size-13">Moscor,
                                                        Russia</span>
                                                </div>
                                                <!-- End Figure Info -->
                                            </div>
                                    ...
                                    <figure class="u-shadow-v19 g-bg-white g-rounded-4 g-pa-25">
                                        <div class="media g-mb-20">
                                            <div class="d-flex g-mr-20">
                                                ...
                                                <div class="g-brd-around g-brd-3 g-brd-gray-light-v3 rounded-circle">
                                                    <img class="rounded-circle g-width-50 g-height-50"
                                                        src="assets/img-temp/100x100/img14.jpg"
                                                        alt="Image Description">
                                                </div>
                                                <!-- Figure Image -->
                                            </div>
                                            <div class="media-body">
                                                ...
                                                <div class="d-block">
                                                    <i
                                                        class="g-color-primary g-font-size-default icon-location-pin"></i>
                                                    <span class="g-color-gray-dark-v4 g-font-size-13">Stockholm,
                                                        Sweden</span>
                                                </div>
                                                <!-- End Figure Info -->
                                            </div>
                    ...
                    <div class="shortcode-html">
                        ...
                        <div class="row">
                            <div class="col-md-4 g-mb-30">
                                <!-- Figure -->
                                <figure
                                    class="g-bg-cover g-bg-size-cover g-bg-pos-center g-bg-black-opacity-0_7--after text-center"
                                    style="background-image: url(assets/img-temp/900x900/img3.jpg);">
                                    <div class="g-pos-rel g-z-index-1 ">
                                        <div class="g-py-40 g-px-20">
                                            <!-- Figure Image -->
                                            <img class="g-width-100 g-height-100 rounded-circle g-mb-30"
                                                src="assets/img-temp/125x125/img5.jpg" alt="Image Description">
                                            <!-- Figure Image -->

                                            <!-- Figure Info -->
                                            <h4 class="g-color-white g-font-weight-600 g-font-size-16 g-mb-15">Mikel
                                                Andrews</h4>
                                            <span
                                                class="d-block g-color-primary g-font-weight-700 g-font-size-13 g-mb-15">Follow</span>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item mx-1">
                                                    <a class="u-icon-v1 u-icon-size--sm g-color-white-opacity-0_8 g-color-white--hover g-bg-primary--hover rounded-circle"
                                                        href="#!">
                                        ...
                                        <!-- Figure Footer -->
                                        <footer
                                            class="d-flex justify-content-between g-brd-top g-brd-white-opacity-0_2 g-py-20 g-px-40">
                                            <a class="g-color-white-opacity-0_6 g-color-white--hover g-font-size-13 g-text-underline--none--hover"
                                                href="#!">25,000 Followers</a>
                                            <a class="g-color-white-opacity-0_6 g-color-white--hover g-font-weight-600--hover g-font-size-13 g-text-underline--none--hover"
                                                href="#!">50 Following</a>
                                        </footer>
                                        <!-- End Figure Footer -->
                                    </div>
                            ...
                            <div class="col-md-4 g-mb-30">
                                ...
                                <figure
                                    class="g-bg-cover g-bg-size-cover g-bg-pos-center g-bg-black-opacity-0_7--after text-center"
                                    style="background-image: url(assets/img-temp/900x900/img6.jpg);">
                                    <div class="g-pos-rel g-z-index-1 ">
                                        <div class="g-py-40 g-px-20">
                                            <!-- Figure Image -->
                                            <img class="g-width-100 g-height-100 rounded-circle g-mb-30"
                                            ...
                                            <!-- Figure Info -->
                                            <h4 class="g-color-white g-font-weight-600 g-font-size-16 g-mb-15">Natasha
                                                Kolnikova</h4>
                                            <span
                                                class="d-block g-color-primary g-font-weight-700 g-font-size-13 g-mb-15">Follow</span>
                                            <ul class="list-inline mb-0">
                            ...
                            <div class="col-md-4 g-mb-30">
                                ...
                                <figure
                                    class="g-bg-cover g-bg-size-cover g-bg-pos-center g-bg-black-opacity-0_7--after text-center"
                                    style="background-image: url(assets/img-temp/900x900/img5.jpg);">
                                    <div class="g-pos-rel g-z-index-1 ">
                                        <div class="g-py-40 g-px-20">
                                            <!-- Figure Image -->
                                            <img class="g-width-100 g-height-100 rounded-circle g-mb-30"
                                            ...
                                            <!-- Figure Info -->
                                            <h4 class="g-color-white g-font-weight-600 g-font-size-16 g-mb-15">Frank
                                                Heller</h4>
                                            <span
                                                class="d-block g-color-primary g-font-weight-700 g-font-size-13 g-mb-15">Follow</span>
                                            <ul class="list-inline mb-0">
                            ...
                            <div class="row">
                                <div class="col-md-4 g-mb-30">
                                    ...
                                    <figure class="u-info-v7-1 u-info-v7-1__item g-bg-white g-rounded-4 text-center">
                                        <div class="g-py-40 g-px-20">
                                            <!-- Figure Image -->
                                            <img class="u-info-v7-1__item-child-v1 g-width-100 g-height-100 rounded-circle g-mb-20"
                                                src="assets/img-temp/125x125/img1.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                                            ...
                                            <div class="d-block">
                                                ...
                                                <em
                                                    class="g-color-gray-dark-v4 g-font-style-normal g-font-size-default">Employee</em>
                                            </div>
                                            <!-- End Figure Info -->
                                        </div>
                                    ...
                                    <figure class="u-info-v7-1 u-info-v7-1__item g-bg-white g-rounded-4 text-center">
                                        <div class="g-py-40 g-px-20">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <em
                                                    class="g-color-gray-dark-v4 g-font-style-normal g-font-size-default">Family</em>
                                            </div>
                                            <!-- End Figure Info -->
                                        </div>
                                    ...
                                    <figure class="u-info-v7-1 u-info-v7-1__item g-bg-white g-rounded-4 text-center">
                                        <div class="g-py-40 g-px-20">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <em
                                                    class="g-color-gray-dark-v4 g-font-style-normal g-font-size-default">Friend</em>
                                            </div>
                                            <!-- End Figure Info -->
                                        </div>
                    ...
                    <div class="shortcode-html">
                        ...
                        <div class="row">
                            <div class="col-md-4 g-mb-30">
                                <!-- Figure -->
                                <figure
                                    class="u-info-v7-1 g-brd-around g-brd-gray-light-v4 g-bg-white g-rounded-4 text-center">
                                    <div class="g-py-40 g-px-20">
                                        <!-- Figure Image -->
                                        ...
                                        <div class="d-block">
                                            <span
                                                class="u-info-v7-1__item-child-v2 g-color-gray-dark-v4 g-bg-gray-light-v5 g-font-size-default g-rounded-25 g-py-5 g-px-20 g-mr-3">
                                    ...
                                    <ul class="row list-inline g-py-20 g-ma-0">
                                        <li class="col g-brd-right g-brd-gray-light-v4">
                                            <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-cyan--hover"
                                                ...
                                                data-original-title="Mikel.Andrews">
                                        ...
                                        <li class="col g-brd-right g-brd-gray-light-v4">
                                            <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-red--hover"
                                                href="#!" data-toggle="tooltip"
                                                data-original-title="mikelandrews@gmail.com">
                                                <i class="icon-communication-062 u-line-icon-pro"></i>
                                            </a>
                                        </li>
                                        <li class="col">
                                            <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-purple--hover"
                                                href="#!" data-toggle="tooltip"
                                                data-original-title="+(01) 333 44 55">
                                                <i class="icon-electronics-005 u-line-icon-pro"></i>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <figure
                                    ...
                                    <ul class="row list-inline g-py-20 g-ma-0">
                                        <li class="col g-brd-right g-brd-gray-light-v4">
                                            <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-cyan--hover"
                                                href="#!" data-toggle="tooltip"
                                                data-original-title="Natasha.Kolnikova">
                                                <i class="icon-finance-067 u-line-icon-pro"></i>
                                            </a>
                                        </li>
                                        <li class="col g-brd-right g-brd-gray-light-v4">
                                            <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-red--hover"
                                                href="#!" data-toggle="tooltip"
                                                data-original-title="natashakolnikova@gmail.com">
                                                <i class="icon-communication-062 u-line-icon-pro"></i>
                                            </a>
                                        </li>
                                        <li class="col">
                                ...
                                <figure
                                    ...
                                    <ul class="row list-inline g-py-20 g-ma-0">
                                        <li class="col g-brd-right g-brd-gray-light-v4">
                                            <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-cyan--hover"
                                                href="#!" data-toggle="tooltip"
                                                data-original-title="Frank.Heller">
                                                <i class="icon-finance-067 u-line-icon-pro"></i>
                                            </a>
                                        </li>
                                        <li class="col g-brd-right g-brd-gray-light-v4">
                                            <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-red--hover"
                                                href="#!" data-toggle="tooltip"
                                                data-original-title="frankheller@gmail.com">
                                                <i class="icon-communication-062 u-line-icon-pro"></i>
                                            </a>
                                        </li>
                                        <li class="col">
                                ...
                                <div class="col-lg-4 g-mb-30">
                                    ...
                                    <figure class="u-block-hover u-shadow-v19 g-bg-white g-rounded-4 g-pa-15">
                                        <div class="d-flex justify-content-start">
                                            <!-- Figure Image -->
                                            <img class="g-width-80 g-height-80 rounded-circle g-mr-15"
                                                src="assets/img-temp/125x125/img1.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                                            ...
                                            <div class="d-block">
                                                <div class="g-mb-5">
                                                    ...
                                                    <em
                                                        class="d-block g-color-primary g-font-style-normal g-font-size-default">Employee</em>
                                                </div>
                                                <em
                                                    class="d-block g-color-gray-dark-v5 g-font-style-normal g-font-size-13 g-mb-2">mikel@gmail.com</em>
                                            </div>
                                            <!-- End Figure Info -->

                                            <!-- Figure Caption -->
                                            <figcaption
                                                class="u-block-hover__additional--fade g-bg-white-opacity-0_9 g-pa-30">
                                                <div
                                    ...
                                    <figure class="u-block-hover u-shadow-v19 g-bg-white g-rounded-4 g-pa-15">
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <em
                                                    class="d-block g-color-gray-dark-v5 g-font-style-normal g-font-size-13 g-mb-2">natasha@gmail.com</em>
                                            </div>
                                            <!-- End Figure Info -->
                                    ...
                                    <figure class="u-block-hover u-shadow-v19 g-bg-white g-rounded-4 g-pa-15">
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <em
                                                    class="d-block g-color-gray-dark-v5 g-font-style-normal g-font-size-13 g-mb-2">frank@gmail.com</em>
                                            </div>
                                            <!-- End Figure Info -->
                        ...
                        <div class="row">
                            <div class="col-lg-4 g-mb-30">
                                ...
                                <figure class="g-brd-around g-brd-gray-light-v4 g-rounded-4 g-pa-15">
                                    <div class="d-flex justify-content-start">
                                        <!-- Figure Image -->
                                        <img class="g-width-100 g-height-100 g-mr-15"
                                            src="assets/img-temp/125x125/img1.jpg" alt="Image Description">
                                        <!-- Figure Image -->
                                        ...
                                        <div class="d-block">
                                            ...
                                            <em
                                                class="d-block g-color-gray-dark-v5 g-font-style-normal g-font-size-13 g-mb-2">mikel@gmail.com</em>
                                            <em
                                                class="d-block g-color-gray-dark-v5 g-font-style-normal g-font-size-12">+(01)
                                                333 44 55</em>
                                        </div>
                                        <!-- End Figure Info -->
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 g-mb-30">
                                    ...
                                    <figure class="u-shadow-v19 g-bg-white g-rounded-4 g-pa-20">
                                        <div class="d-flex justify-content-start">
                                            <!-- Figure Image -->
                                            <img class="g-width-90 g-height-90 rounded-circle g-mr-15"
                                                src="assets/img-temp/125x125/img1.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="g-mb-5">
                                                    ...
                                                    <em
                                                        class="d-block g-color-gray-dark-v4 g-font-style-normal g-font-size-13">Google
                                                        Inc.</em>
                                                </div>
                                                <!-- End Figure Info -->
                                                ...
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item g-mx-2">
                                                        <a class="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-facebook--hover g-ml-minus-15"
                                                            href="#!">
                                                            <i
                                                    ...
                                                    <li class="list-inline-item g-mx-2">
                                                        <a class="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-twitter--hover"
                                                            href="#!">
                                                            <i
                                                                class="g-font-size-default g-line-height-1 u-icon__elem-regular fa fa-twitter"></i>
                                                            <i
                                                                class="g-font-size-default g-line-height-0_8 u-icon__elem-hover fa fa-twitter"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item g-mx-2">
                                                        <a class="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-instagram--hover"
                                                            href="#!">
                                                            <i
                                                                class="g-font-size-default g-line-height-1 u-icon__elem-regular fa fa-instagram"></i>
                                                            <i
                                                                class="g-font-size-default g-line-height-0_8 u-icon__elem-hover fa fa-instagram"></i>
                                                        </a>
                                                    </li>
                                                </ul>
                                                <!-- End Social Icons -->
                                        ...
                                        <div class="g-py-10">
                                            ...
                                            <ul class="list-unstyled g-color-gray-dark-v5 g-font-size-13 g-mb-0">
                                                <li class="g-mb-10">
                                                    <i
                                                        class="g-pos-rel g-mt-1 mr-2 icon-communication-062 u-line-icon-pro"></i>
                                                    <a href="#!">mikel@gmail.com</a>
                                                </li>
                                                <li>
                                                    <i
                                                        class="g-pos-rel g-top-1 mr-2 icon-electronics-005 u-line-icon-pro"></i>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            ...
                                            <a class="u-link-v5 g-brd-around g-brd-gray-light-v3 g-color-black g-color-primary--hover g-font-size-12 rounded g-px-10 g-py-5"
                                                href="#!">All projects</a>
                                        </div>
                                        <!-- End Figure Title -->
                                        ...
                                        <div class="d-flex justify-content-start">
                                            <!-- Figure Image -->
                                            <img class="g-width-50 g-height-50 rounded-circle g-mr-15"
                                                src="assets/img-temp/100x100/img11.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                                                ...
                                                <div class="g-mb-5">
                                                    <h3 class="h6 g-font-weight-600 mb-1">
                                                        <a class="g-color-black g-color-primary--hover"
                                                            href="#!">Help finding information online with us</a>
                                                    </h3>
                                                    <em
                                                        class="g-color-gray-dark-v4 g-font-style-normal g-font-size-12">Date:
                                                    </em>
                                        ...
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="g-mb-5">
                                                    ...
                                                    <em
                                                        class="d-block g-color-gray-dark-v4 g-font-style-normal g-font-size-13">Dropbox
                                                        Inc.</em>
                                                </div>
                                                <!-- End Figure Info -->
                                        ...
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="g-mb-5">
                                                    <h3 class="h6 g-font-weight-600 mb-1">
                                                        <a class="g-color-black g-color-primary--hover"
                                                            href="#!">How to protect your computer and laptop</a>
                                                    </h3>
                                                    <em
                                                        class="g-color-gray-dark-v4 g-font-style-normal g-font-size-12">Date:
                                                    </em>
                                ...
                                <div class="col-lg-4 g-mb-30">
                                    ...
                                    <figure class="u-shadow-v19 g-bg-white g-rounded-4 g-pa-20">
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="g-mb-5">
                                                    ...
                                                    <em
                                                        class="d-block g-color-gray-dark-v4 g-font-style-normal g-font-size-13">Apple
                                                        Inc.</em>
                                                </div>
                                                <!-- End Figure Info -->
                                        ...
                                        <div class="d-flex justify-content-start">
                                            <!-- Figure Image -->
                                            <img class="g-width-50 g-height-50 rounded-circle g-mr-15"
                                                src="assets/img-temp/100x100/img13.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                                            ...
                                            <div class="d-block">
                                                ...
                                                <div class="g-mb-5">
                                                    <h3 class="h6 g-font-weight-600 mb-1">
                                                        <a class="g-color-black g-color-primary--hover"
                                                            href="#!">Looking for your DVD printing solution</a>
                                                    </h3>
                                                    <em
                                                        class="g-color-gray-dark-v4 g-font-style-normal g-font-size-12">Date:
                                                    </em>
                        ...
                        <div class="row">
                            <div class="col-lg-4 g-mb-30">
                                ...
                                <figure class="u-shadow-v20 g-bg-cyan-gradient-opacity-v1 g-rounded-4 g-pa-30">
                                    <div class="d-flex justify-content-start">
                                        <!-- Figure Image -->
                                        <img class="align-self-center g-width-80 g-height-80 rounded-circle mr-4"
                                            src="assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                        <!-- Figure Image -->

                                        <!-- Figure Info -->
                                        <div class="d-block align-self-center">
                                            <h4 class="g-font-weight-600 g-font-size-16 g-color-white mb-2">Mikel
                                                Andrews</h4>
                            ...
                            <div class="col-lg-4 g-mb-30">
                                ...
                                <figure class="u-shadow-v20 g-bg-cyan-gradient-opacity-v1 g-rounded-4 g-pa-30">
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <!-- Figure Info -->
                                        <div class="d-block align-self-center">
                                            <h4 class="g-font-weight-600 g-font-size-16 g-color-white mb-2">Natasha
                                                Kolnikova</h4>
                            ...
                            <div class="col-lg-4 g-mb-30">
                                ...
                                <figure class="u-shadow-v20 g-bg-cyan-gradient-opacity-v1 g-rounded-4 g-pa-30">
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <!-- Figure Info -->
                                        <div class="d-block align-self-center">
                                            <h4 class="g-font-weight-600 g-font-size-16 g-color-white mb-2">Frank
                                                Heller</h4>
                        ...
                        <div class="shortcode-html">
                            ...
                            <div class="row">
                                <div class="col-md-4 g-mb-30">
                                    <!-- Figure -->
                                    <figure
                                        class="u-shadow-v21 u-shadow-v21--hover g-bg-white g-rounded-4 text-center g-transition-0_3">
                                        <div class="g-py-40 g-px-20">
                                            <!-- Figure Image -->
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">
                                                    <i
                                                        class="align-middle mr-2 icon-communication-062 u-line-icon-pro"></i>
                                                    mikel@gmail.com
                                                </li>
                                                <li class="d-block g-color-gray-dark-v5 g-font-size-13">
                                                    <i
                                                        class="align-middle mr-2 icon-hotel-restaurant-235 u-line-icon-pro"></i>
                    ...
                    <div class="shortcode-html">
                        ...
                        <div class="row">
                            <div class="col-md-4 g-mb-30">
                                <!-- Figure -->
                                <figure
                                    class="u-shadow-v21 u-shadow-v21--hover g-brd-around g-brd-gray-light-v4 g-bg-white g-rounded-4 text-center g-transition-0_3">
                                    <div class="g-py-40 g-px-20">
                                        <!-- Figure Image -->
                                        <img class="g-width-100 g-height-100 rounded-circle g-mb-30"
                                            src="assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                        ...
                                        <span
                                            class="d-block g-color-primary g-font-weight-600 g-font-size-13 g-mb-15">Follow</span>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item mx-1">
                                                <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-color-white--hover g-bg-primary--hover rounded-circle"
                                                    href="#!">
                                                    <i class="fa fa-instagram"></i>
                                                </a>
                                            </li>
                                    ...
                                    <footer class="d-flex justify-content-between g-bg-gray-light-v5 g-py-20 g-px-40">
                                        <a class="g-color-gray-dark-v5 g-color-primary--hover g-font-size-13 g-text-underline--none--hover"
                                            href="#!">25,000 Followers</a>
                                        <a class="g-color-gray-dark-v5 g-color-primary--hover g-font-weight-600--hover g-font-size-13 g-text-underline--none--hover"
                                            href="#!">50 Following</a>
                                    </footer>
                                    <!-- End Figure Footer -->
                                </figure>
                            ...
                            <div class="row">
                                <div class="col-lg-4 g-mb-30">
                                    ...
                                    <figure class="u-shadow-v21 u-block-hover">
                                        <div
                                            class="d-flex justify-content-start g-bg-teal--hover g-bg-white g-rounded-4 g-transition-0_3 g-transition--ease-in-out g-pa-30">
                                            <!-- Figure Image -->
                                            <img class="align-self-center g-width-80 g-height-80 rounded-circle mr-4"
                                                src="assets/img-temp/100x100/img14.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                                            ...
                                            <div class="d-block align-self-center">
                                                <h4
                                                    class="g-color-white--hover g-font-weight-600 g-font-size-16 g-transition-0_3 mb-2">
                                                    Mikel Andrews</h4>

                                                <!-- Figure Social Icons -->
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item g-mx-3">
                                                        <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-color-white--hover rounded-circle"
                                                            href="#!">
                                                            <i class="fa fa-twitter"></i>
                                                        </a>
                                                    </li>
                                ...
                                <div class="col-lg-4 g-mb-30">
                                    ...
                                    <figure class="u-shadow-v21 u-block-hover">
                                        <div
                                            class="d-flex justify-content-start g-bg-cyan--hover g-bg-white g-rounded-4 g-transition-0_3 g-transition--ease-in-out g-pa-30">
                                            <!-- Figure Image -->
                                            <img class="align-self-center g-width-80 g-height-80 rounded-circle mr-4"
                                                src="assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                                ...
                                <div class="col-lg-4 g-mb-30">
                                    ...
                                    <figure class="u-shadow-v21 u-block-hover">
                                        <div
                                            class="d-flex justify-content-start g-bg-purple--hover g-bg-white g-rounded-4 g-transition-0_3 g-transition--ease-in-out g-pa-30">
                                            <!-- Figure Image -->
                                            <img class="align-self-center g-width-80 g-height-80 rounded-circle mr-4"
                                                src="assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                            <!-- Figure Image -->
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3 g-mb-30">
                                ...
                                <div class="g-width-150 g-height-150 mb-4">
                                    <img class="img-fluid rounded-circle" src="assets/img-temp/200x200/img2.jpg"
                                        alt="Image Description">
                                </div>
                                ...
                                <h4 class="g-color-black g-font-weight-600 g-font-size-12 text-uppercase mb-3">Follow
                                    Me on:</h4>
                            ...
                            <div class="col-md-6 col-lg-3 g-mb-30">
                                <!-- Author Info -->
                                <div class="g-width-150 g-height-150 mb-4">
                                    <img class="img-fluid rounded-circle" src="assets/img-temp/200x200/img7.jpg"
                                        alt="Image Description">
                                </div>
                            ...
                            <div class="col-md-6 col-lg-3 g-mb-30">
                                <!-- Author Info -->
                                <div class="g-width-150 g-height-150 mb-4">
                                    <img class="img-fluid rounded-circle" src="assets/img-temp/200x200/img6.jpg"
                                        alt="Image Description">
                                </div>

                                <div class="g-mb-50">
                                    <h4 class="h6 g-color-black text-uppercase g-font-weight-600">Natasha Kolnikova
                                    </h4>
                                    <p>Chief investment strategist of Unify Marketing</p>
                                    <p>Leave a comment or a question below, I will answer them ASAP.</p>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-3 g-mb-30">
                                <!-- Author Info -->
                                <div class="g-width-150 g-height-150 mb-4">
                                    <img class="img-fluid rounded-circle" src="assets/img-temp/200x200/img4.jpg"
                                        alt="Image Description">
                                </div>
                                    ...
                                    <div class="u-shadow-v11 u-shadow-v21--hover text-center g-transition-0_3">
                                        <div class="g-bg-white g-pa-20">
                                            <div class="g-width-130 g-height-130 mx-auto mb-4">
                                                <img class="img-fluid g-brd-around g-brd-3 g-brd-gray-light-v3 rounded-circle"
                                                    src="assets/img-temp/200x200/img1.jpg" alt="Image Description">
                                            </div>
                                            <h3 class="h5"><a class="g-color-black" href="#">David
                                                    Gunning</a></h3>
                                            <span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Managing
                                                Director</span>
                                        ...
                                        <div class="g-bg-gray-light-v5 g-px-20 g-py-10">
                                            ...
                                            <span class="d-block g-color-gray-dark-v5 g-font-size-13">1 Sales dual
                                                agent</span>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-3 g-mb-30">
                                    ...
                                    <div class="u-shadow-v11 u-shadow-v21--hover text-center g-transition-0_3">
                                        <div class="g-bg-white g-pa-20">
                                            ...
                                            <h3 class="h5"><a class="g-color-black" href="#">Debbie
                                                    Heron</a></h3>
                                            <span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Managing
                                                Director</span>
                                        ...
                                        <div class="g-bg-gray-light-v5 g-px-20 g-py-10">
                                            ...
                                            <span class="d-block g-color-gray-dark-v5 g-font-size-13">0 Sales dual
                                                agent</span>
                                        </div>
                                        <a class="u-link-v2" href="page-agents-single-page-1.html"></a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-lg-3 g-mb-30">
                                    ...
                                    <div class="u-shadow-v11 u-shadow-v21--hover text-center g-transition-0_3">
                                        <div class="g-bg-white g-pa-20">
                                            ...
                                            <h3 class="h5"><a class="g-color-black" href="#">John
                                                    Lennard</a></h3>
                                            <span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Property
                                                Consultant</span>
                                        ...
                                        <div class="g-bg-secondary g-px-20 g-py-10">
                                            ...
                                            <span class="d-block g-color-gray-dark-v5 g-font-size-13">7 Sales dual
                                                agent</span>
                                        </div>
                                        <a class="u-link-v2" href="page-agents-single-page-1.html"></a>
                                    </div>
                                ...
                                <div class="col-sm-6 col-lg-3 g-mb-30">
                                    ...
                                    <div class="u-shadow-v11 u-shadow-v21--hover text-center g-transition-0_3">
                                        <div class="g-bg-white g-pa-20">
                                            ...
                                            <h3 class="h5"><a class="g-color-black" href="#">Andrea
                                                    Brown</a></h3>
                                            <span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Assistant
                                                Director</span>
                                            <span class="d-block g-font-size-13">Real Estate State</span>
                                        </div>
                                        <div class="g-bg-secondary g-px-20 g-py-10">
                                        ...
                                        <div class="media g-bg-white g-pa-20">
                                            ...
                                            <div class="media-body">
                                                <h3 class="h5"><a class="g-color-black" href="#">David
                                                        Gunning</a></h3>
                                                <span
                                                    class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Managing
                                                    Director</span>
                                                <span class="d-block g-font-size-13">Real Estate State</span>
                                                <div class="g-brd-top g-brd-gray-light-v3 g-pt-10 g-mt-10">
                                                    <span class="d-block">3 Sales lead agent</span>
                                                    <span class="d-block g-color-gray-dark-v5 g-font-size-13">1 Sales
                                                        dual agent</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="u-shadow-v11 u-shadow-v21--hover g-transition-0_3">
                                        <div class="media g-bg-white g-pa-20">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="g-brd-top g-brd-gray-light-v3 g-pt-10 g-mt-10">
                                                    <span class="d-block">1 Sales lead agent</span>
                                                    <span class="d-block g-color-gray-dark-v5 g-font-size-13">0 Sales
                                                        dual agent</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media g-bg-white g-pa-20">
                                            ...
                                            <div class="media-body">
                                                <h3 class="h5"><a class="g-color-black" href="#">John
                                                        Lennard</a></h3>
                                                <span
                                                    class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Property
                                                    Consultant</span>
                                                <span class="d-block g-font-size-13">American Property</span>
                                                <div class="g-brd-top g-brd-gray-light-v3 g-pt-10 g-mt-10">
                                                    <span class="d-block">22 Sales lead agent</span>
                                                    <span class="d-block g-color-gray-dark-v5 g-font-size-13">7 Sales
                                                        dual agent</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4 g-mb-30">
                                    ...
                                    <div class="u-shadow-v11 text-center">
                                        <div class="g-bg-white g-pa-20">
                                            <div class="g-width-130 g-height-130 mx-auto mb-4">
                                                <img class="img-fluid g-brd-around g-brd-3 g-brd-gray-light-v3 rounded-circle"
                                                    src="assets/img-temp/200x200/img6.jpg" alt="Image Description">
                                            </div>
                                            <div class="mb-3">
                                                <h3 class="h5"><a class="g-color-black" href="#">Rose
                                                        Allie</a></h3>
                                                <span
                                                    class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Managing
                                                    Director</span>
                                            </div>
                                            <span class="d-block g-font-weight-500 g-font-size-13">(0161) 347
                                                8854</span>
                                            <span
                                                class="d-block g-font-weight-500 g-font-size-13">rosa@realestate.com</span>
                                        </div>
                                        ...
                                        <a class="btn btn-block g-color-black g-bg-white g-bg-secondary--hover g-font-weight-600 g-font-size-12 text-uppercase rounded-0 g-px-25 g-py-15 mt-0"
                                            href="#">Request Info</a>
                                    </div>
                                    <!-- End Listing - Agents -->
                                </div>
                                ...
                                <div class="col-md-4 g-mb-30">
                                    ...
                                    <div class="u-shadow-v11 text-center">
                                        <div class="g-bg-white g-pa-20">
                                            ...
                                            <div class="mb-3">
                                                <h3 class="h5"><a class="g-color-black" href="#">Mikel
                                                        Andrews</a></h3>
                                                <span
                                                    class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Managing
                                                    Director</span>
                                ...
                                <div class="col-md-4 g-mb-30">
                                    ...
                                    <div class="u-shadow-v11 text-center">
                                        <div class="g-bg-white g-pa-20">
                                            ...
                                            <div class="mb-3">
                                                <h3 class="h5"><a class="g-color-black" href="#">Alberta
                                                        Watson</a></h3>
                                                <span
                                                    class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1">Managing
                                                    Director</span>
