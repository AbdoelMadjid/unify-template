    ...
    <main>
                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-3--lg g-mr-40--lg"
                            id="navBar">
                            <ul id="js-scroll-nav"
                                class="navbar-nav text-uppercase g-pos-rel g-font-weight-400 g-letter-spacing-0_5 ml-auto">
                        ...
                        <div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
                            <a class="btn u-btn-primary g-font-size-13 g-font-weight-400 g-letter-spacing-0_5 text-uppercase g-py-10 g-px-15"
        ...
        <section
            ...
            <div class="container g-py-200">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="g-color-black g-font-weight-300 g-font-size-45 g-line-height-1_2 mb-4">Have an
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 order-2 g-ml-30--lg g-mb-40">
                        ...
                        <p class="g-font-size-16 mb-3">The time has come to bring those ideas and plans to life. This
                            is where we really begin to visualize your napkin sketches and make them into beautiful
                            pixels.</p>
                        <p class="g-font-size-16 mb-3">Now that your brand is all dressed up and ready to party, it's
                            time to release it to the world. By the way, let's celebrate already.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 g-mb-30 g-mb-0--lg">
                        <article class="u-block-hover u-shadow-v21 rounded">
                            ...
                            <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white">
                                <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2"><a
                                        class="g-color-white" href="#!">Nulla ipsum dolor sit</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 g-mb-30 g-mb-0--lg">
                        <article class="u-block-hover u-shadow-v21 rounded">
                            ...
                            <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white">
                                <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2"><a
                                        class="g-color-white" href="#!">Adipiscing elitut</a></h3>
                                <p>Consectetur adipiscing elitut eleifend nisl</p>
                            </header>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <article class="u-block-hover u-shadow-v21 rounded">
                            ...
                            <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white">
                                <h3 class="g-font-size-18 g-color-gray-dark-v2 g-font-weight-400 mb-2"><a
                                        class="g-color-white" href="#!">Hac habitasse platea</a></h3>
                                <p>Consectetur adipiscing elitut eleifend nisl</p>
                            </header>
            ...
            <div class="container u-bg-overlay__inner g-py-80">
                <div class="row">
                    ...
                    <div class="col-lg-6 order-2 order-sm-1 g-mb-0 g-mb-100--sm g-mb-0--lg">
                        ...
                        <a class="btn u-btn-primary g-font-size-13 g-font-weight-400 g-letter-spacing-0_5 text-uppercase g-py-10 g-px-15 g-mr-15 g-mb-15 g-mb-5--sm"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-center g-pl-30--lg">
                        <header class="g-mb-30">
                            ...
                            <p class="g-font-size-16">Unify creative technology company providing key digital services.
                ...
                <div class="row">
                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                        ...
                        <article class="u-shadow-v11 rounded">
                            <div class="g-pa-30">
                                <h3 class="g-font-size-20 g-font-weight-300 mb-3"><a
        ...
        <section class="g-bg-primary g-color-white g-pa-30"
            ...
            <div class="d-md-flex justify-content-md-center text-center">
                ...
                <div class="align-self-md-center">
                    <a class="btn u-btn-white g-font-size-13 g-font-weight-400 g-letter-spacing-0_5 text-uppercase g-py-10 g-px-15"
                        target="_blank"
