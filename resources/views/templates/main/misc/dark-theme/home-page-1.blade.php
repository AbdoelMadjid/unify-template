...
<body>
    <main>
                        ...
                        <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--lg"
                            ...
                            <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                                ...
                                <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-15--xl" data-animation-in="fadeIn"
                                    ...
                                    <!-- Mega Menu -->
                                    <div class="w-100 hs-mega-menu  font-weight-normal g-brd-top g-brd-primary g-brd-top-2 g-mt-21 g-mt-11--lg--scrolling"
                                        ...
                                        <div class="row align-items-stretch no-gutters">
                                            ...
                                            <div class="col-lg-6">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li class="dropdown-item ">
                                                        <a href="../unify-main/home/home-page-1.html"
                                                            class="nav-link">Home 1</a>
                                                    </li>
                                                    <li class="dropdown-item ">
                                ...
                                <li class="hs-has-sub-menu nav-item  g-mx-10--lg g-mx-15--xl"
                                    ...
                                    <ul class="hs-sub-menu list-unstyled  g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-21 g-mt-11--lg--scrolling"
                                        ...
                                        <li class="dropdown-item hs-has-sub-menu ">
                                            ...
                                            <!-- Submenu (level 2) -->
                                            <ul class="hs-sub-menu list-unstyled  g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2"
                                        ...
                                        <li class="dropdown-item hs-has-sub-menu ">
                                            ...
                                            <!-- Submenu (level 2) -->
                                            <ul class="hs-sub-menu list-unstyled  u-dropdown-col-2 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2"
                                ...
                                <li class="nav-item hs-has-sub-menu  g-mx-10--lg g-mx-15--xl"
                                    ...
                                    <ul class="hs-sub-menu list-unstyled  g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-21 g-mt-11--lg--scrolling"
                                        ...
                                        <li class="dropdown-item ">
                                            <a class="nav-link"
                                                href="../unify-main/shortcodes/promo/shortcode-blocks-promo.html">Promo
                                                Blocks</a>
                                        </li>
                                        ...
                                        <li class="dropdown-item hs-has-sub-menu ">
                                            ...
                                            <ul class="hs-sub-menu list-unstyled  g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2"
                                                ...
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../revolution-slider/index.html">Revolution sliders</a>
                                                </li>
                                                <li class="dropdown-item ">
                                    ...
                                    <ul class="hs-sub-menu list-unstyled  g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-21 g-mt-11--lg--scrolling"
                                        ...
                                        <li class="dropdown-item hs-has-sub-menu ">
                                            ...
                                            <ul class="hs-sub-menu list-unstyled  u-dropdown-col-2 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2"
                                                ...
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../one-pages/consulting/index.html">Сonsulting</a>
                                                </li>
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                ...
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../one-pages/corporate/index.html">Corporate</a>
                                                </li>
                                                <li class="dropdown-item ">
                                        ...
                                        <!-- Demos - E-Commerce -->
                                        <li class="dropdown-item ">
                                            <a class="nav-link" href="../e-commerce/home-page-1.html">E-Commerce <span
                                                    class="g-opacity-0_5">(44 Pages)</span> <span
                                        ...
                                        <li class="dropdown-item hs-has-sub-menu ">
                                            ...
                                            <ul class="hs-sub-menu list-unstyled  g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2"
                                                ...
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../blog-magazine/classic/bm-classic-home-page-1.html">Home
                                                        1</a>
                                                </li>
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../blog-magazine/classic/bm-classic-home-page-2.html">Home
                                                        2 <span
                                                            class="u-label g-rounded-3 g-font-size-10 g-bg-lightred g-py-3 g-pos-rel g-top-minus-1 g-ml-5">New</span></a>
                                                </li>
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../blog-magazine/classic/bm-classic-home-page-3.html">Home
                                                        3 <span
                                                            class="u-label g-rounded-3 g-font-size-10 g-bg-lightred g-py-3 g-pos-rel g-top-minus-1 g-ml-5">New</span></a>
                                                </li>
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../blog-magazine/classic/bm-classic-home-page-4.html">Home
                                                        4 <span
                                                            class="u-label g-rounded-3 g-font-size-10 g-bg-lightred g-py-3 g-pos-rel g-top-minus-1 g-ml-5">New</span></a>
                                                </li>
                                                <li class="dropdown-item ">
                                                    <a class="nav-link"
                                                        href="../blog-magazine/classic/bm-classic-home-page-5.html">Home
                                                        5 <span
                                                            class="u-label g-rounded-3 g-font-size-10 g-bg-lightred g-py-3 g-pos-rel g-top-minus-1 g-ml-5">New</span></a>
                                                </li>
                                                <li class="dropdown-item ">
        ...
        <section
            ...
            <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_5--after g-bg-pos-bottom-center"
                style="height: 120%; background-image: url(../assets/img-temp/1920x1080/img25.jpg);"></div>

            <div class="container g-py-200">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="g-color-white g-font-weight-300 g-font-size-40 g-line-height-1_2 mb-4">Have an
                            easy<br>website with Unify
                        </h3>
                        <span class="d-block g-color-white-opacity-0_8 g-font-size-16 mb-5">Build, share, sell and
                            enjoy.</span>
                        <a class="js-fancybox u-link-v5 g-color-white" href="javascript:;"
                            ...
                            <span
                                class="align-middle u-icon-v3 u-block-hover--scale g-bg-white g-color-black g-bg-primary--hover g-rounded-50x g-cursor-pointer mr-2">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-4 g-px-40 g-mb-50 g-mb-0--lg">
                        ...
                        <div class="text-center">
                            <span
                                class="d-inline-block u-icon-v3 u-icon-size--xl g-bg-primary g-color-white rounded-circle g-mb-30">
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center g-mb-100 g-mb-0--lg">
                        <header class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                            <h2 class="h4 u-heading-v2__title g-color-white g-font-weight-600 text-uppercase">About
                                Our Company</h2>
                        </header>

                        <p class="g-font-size-16 g-mb-30">Build best responsive template with Unify 2 dignissimos
                    ...
                    <div class="col-lg-6 g-bg-img-hero g-pos-rel"
                        style="background-image: url(../assets/img/maps/map3.png);">
            ...
            <div class="container">
                <header class="g-mb-50">
                    <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                        <h2 class="h4 u-heading-v2__title g-color-white g-font-weight-600 text-uppercase">Our Recent
                            Projects</h2>
                    </div>
        ...
        <section class="dzsparallaxer auto-init height-is-based-on-content use-loading"
            data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
            <!-- Parallax Image -->
            <div class="divimage dzsparallaxer--target w-100 g-bg-img-hero u-bg-overlay g-bg-black-opacity-0_7--after"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 flex-sm-last g-mb-50 g-mb-0--lg">
                        <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
                            <h2 class="h4 u-heading-v2__title g-color-white g-font-weight-600 text-uppercase">Most
                                Quality Solution</h2>
                        </div>
                    ...
                    <!-- Video Icon -->
                    <div
                        class="col-lg-6 flex-sm-first align-self-center text-center g-pos-rel g-mb-0 g-mb-40--sm g-mb-0--lg">
                        <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                            data-src="//vimeo.com/167434033" data-speed="350" data-caption="Single Image">
                            <span
                                class="u-icon-v3 u-icon-size--xl u-block-hover--scale u-shadow-v24 g-bg-black g-color-white-opacity-0_9 g-color-primary--hover g-font-size-20 rounded-circle g-cursor-pointer g-mb-10">
                ...
                <div class="row">
                        ...
                        <div id="carouselCus1" class="js-carousel text-center g-mb-20" data-infinite="true"
                            ...
                            <div class="js-slide">
                                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                                    ...
                                    data-src="../assets/img-temp/600x450/img6.jpg" data-speed="1000"
                            ...
                            <div class="js-slide">
                                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                                    data-fancybox="lightbox-gallery--08-1"
                                    data-src="../assets/img-temp/600x450/img3.jpg" data-speed="1000"
                                    data-animate-in="bounceInDown" data-animate-out="bounceOutDown"
                                    data-overlay-blur-bg="true" data-caption="Lightbox Gallery">
                                    <img class="img-fluid w-100 rounded"
                            ...
                            <div class="js-slide">
                                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                                    data-fancybox="lightbox-gallery--08-1"
                                    data-src="../assets/img-temp/600x450/img4.jpg" data-speed="1000"
                                    data-animate-in="bounceInDown" data-animate-out="bounceOutDown"
                                    data-overlay-blur-bg="true" data-caption="Lightbox Gallery">
                                    <img class="img-fluid w-100 rounded"
                            ...
                            <div class="js-slide">
                                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                                    data-fancybox="lightbox-gallery--08-1"
                                    data-src="../assets/img-temp/600x450/img5.jpg" data-speed="1000"
                                    data-animate-in="bounceInDown" data-animate-out="bounceOutDown"
                                    data-overlay-blur-bg="true" data-caption="Lightbox Gallery">
                                    <img class="img-fluid w-100 rounded"
                            ...
                            <div class="js-slide">
                                <a class="js-fancybox d-block g-pos-rel" href="javascript:;"
                                    data-fancybox="lightbox-gallery--08-1"
                                    data-src="../assets/img-temp/600x450/img7.jpg" data-speed="1000"
                                    data-animate-in="bounceInDown" data-animate-out="bounceOutDown"
                                    data-overlay-blur-bg="true" data-caption="Lightbox Gallery">
                                    <img class="img-fluid w-100 rounded"
                    ...
                    <div class="col-lg-6 align-self-center g-pl-30--lg">
                        <header class="g-mb-30">
                            <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
                                <h2 class="h4 u-heading-v2__title g-color-white g-font-weight-600 text-uppercase">Our
                                    Environment</h2>
                            </div>
                            <p class="g-font-size-16">Unify
                                <strong>creative</strong> technology company providing key digital services. Focused on
                                helping our clients to build a
                                <strong>successful</strong> business on web and mobile.
                            </p>
                        </header>
                        ...
                        <a class="btn btn-xl u-btn-primary text-uppercase g-font-weight-600 g-font-size-12 rounded g-mr-15 g-mb-10 g-mb-0--sm"
                            href="#!">Check It Now</a>
        ...
        <section class="g-py-100">
            <div class="container">
                <header class="g-mb-50">
                    <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                        <h2 class="h4 u-heading-v2__title g-color-white g-font-weight-600 text-uppercase">Our Latest
                            News</h2>
                    </div>
                    <p class="g-font-size-16">Unify creative technology company providing key digital services. At
                        vero eoset dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti
                        quos dolores et quas moles.</p>
                </header>
                ...
                <div class="row">
                        ...
                        <article class=" rounded">
                            <div class="g-pa-30">
                                <h3 class="g-font-weight-300 g-mb-15">
                                    <a class="u-link-v5 g-color-white g-color-primary--hover" href="#!">Focused
                                        on helping our clients to build a great business</a>
                                </h3>
                            ...
                            <div class="media g-font-size-12 g-brd-top g-brd-white-opacity-0_3 g-pa-15-30">
                                ...
                                <div class="media-body align-self-center">
                                    <a class="u-link-v5 g-color-white g-color-primary--hover" href="#!">Kathy
                                        Reyes</a>
                                </div>

                                <div class="align-self-center">
                                    <a class="u-link-v5 g-color-white g-color-primary--hover g-mr-10"
                                        href="#!">
                    ...
                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                        ...
                        <article class=" rounded">
                            <div class="g-pa-30">
                                <h3 class="g-font-weight-300 g-mb-15">
                                    <a class="u-link-v5 g-color-white g-color-primary--hover" href="#!">We
                                        build your website to realise your vision, project and more</a>
                                </h3>
                                <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
                                    voluptatum deleniti atque corrupti quos dolores.</p>
                            </div>
                        ...
                        <article class=" rounded">
                            ...
                            <div class="media g-font-size-12 g-brd-top g-brd-white-opacity-0_3 g-pa-15-30">
                                <img class="d-flex mr-2 rounded-circle g-width-20 g-height-20"
                                    src="../assets/img-temp/100x100/img7.jpg" alt="Image description">
                                <div class="media-body align-self-center">
                                    <a class="u-link-v5 g-color-white g-color-primary--hover" href="#!">James
                                        Dalglish</a>
                                </div>
