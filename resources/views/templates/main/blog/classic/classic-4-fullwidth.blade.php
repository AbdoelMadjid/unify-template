                    ...
                    <article class="u-shadow-v11">
                        ...
                        <div class="g-bg-white g-pa-20">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">In an attempt to answer those questions,
                                I poured over the biggest collections of design principles.</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
                    ...
                    <article class="u-shadow-v11">
                        ...
                        <div class="g-bg-white g-pa-20">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">In an attempt to answer those questions,
                                ...
                                came to the following conclusion.</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
                ...
                <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-shadow-v11">
                        ...
                        <div class="g-bg-white g-pa-20">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">Apple Watch now has fitness algorithms
                                designed for wheelchair users. Instead of steps, the Workout.</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
                ...
                <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-shadow-v11">
                        ...
                        <div class="g-bg-white g-pa-20">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">Once someone starts using your app, they
                                need to know.</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
                ...
                <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-shadow-v11">
                        ...
                        <div class="g-bg-white g-pa-20">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">What real worlds are actually valid CSS
                                HEX colors? Pasring an English dictionary...</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
                ...
                <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-shadow-v11">
                        ...
                        <div class="g-bg-white g-pa-20">
                            ...
                            <p class="g-color-gray-dark-v4 g-line-height-1_8">I’ve made exceptions a handful of times
                                over the years.</p>
                            <a class="g-font-size-13" href="#!">Read more...</a>
