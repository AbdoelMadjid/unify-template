                    ...
                    <article class="u-shadow-v11 g-bg-white g-pos-rel">
                        <div class="g-pa-30">
                            <div class="mb-4">
                                <h3 class="h5 g-color-black g-font-weight-600 text-capitalize mb-3">
                                    <a class="g-color-black g-color-primary--hover g-text-underline--none--hover"
                                        href="#!">iOS 11: iPad Wishes and Concept Video</a>
                                </h3>
                                <p class="g-color-gray-dark-v5">Once heralded as a promising sign of Apple's renewed
                                    commitment to the iPad, iOS 9 has begun to feel like a one-hit wonder.</p>
                            </div>
                            <div class="d-flex justify-content-start">
                                <a class="align-self-center g-color-gray-dark-v5 g-color-black--hover g-text-underline--none--hover"
                                    href="#!">Hi-tech.</a>
                ...
                <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30">
                    ...
                    <article class="u-shadow-v11 g-bg-white g-pa-30">
                        <h3 class="h5 g-color-black g-font-weight-600 text-capitalize mb-0">
                            <a class="g-color-black g-color-primary--hover g-text-underline--none--hover"
                                href="#!">10 Typography Tips Every Business Should Know</a>
                        </h3>
                    </article>
                    <!-- End Article -->
                </div>
