                        ...
                        <div class="masonry-grid row g-mb-70">
                            ...
                            <div class="masonry-grid-item col-sm-6 g-mb-30">
                                ...
                                <article>
                                    ...
                                    <div
                                        class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-25 g-mt-minus-50 mx-auto">
                                        <span
                                        ...
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">Clark Valberg is the founder
                                            and CEO of InVision. If you are a designer...</p>
                            ...
                            <div class="masonry-grid-item col-sm-6 g-mb-30">
                                ...
                                <article>
                                    ...
                                    <div
                                        ...
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">At Wake, our mission has
                            ...
                            <div class="masonry-grid-item col-sm-6 g-mb-30">
                                ...
                                <article>
                                    ...
                                    <div
                                        ...
                                        <h2 class="h5 g-color-black g-font-weight-600 mb-3">
                                            <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer"
                                                href="#!">In the future, design principles won’t be about
                                                design</a>
                                        </h2>
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">In an attempt to answer
                                            those questions, I poured over the biggest collections of design principles
                                            on the internet [1][2], and came to the following conclusion.</p>
                                        <a class="g-font-size-13" href="#!">Read more...</a>
                                    </div>
                                </article>
                                <!-- End Blog Minimal Blocks -->
                            ...
                            <div class="masonry-grid-item col-sm-6 g-mb-30">
                                ...
                                <article>
                                    ...
                                    <div
                                        ...
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">Product teams working with
                                            low access to users and a long time to market, usually enterprise level
                                            services.</p>
                                        <a class="g-font-size-13" href="#!">Read more...</a>
                                    </div>
                                </article>
                                ...
                                <article>
                                    ...
                                    <div
                                        ...
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">Apple Watch now has fitness
                                            algorithms designed for wheelchair users. Instead of steps, the Workout.</p>
                                        <a class="g-font-size-13" href="#!">Read more...</a>
                                    </div>
                                </article>
                                <!-- End Blog Minimal Blocks -->
                            ...
                            <div class="masonry-grid-item col-sm-6 g-mb-30">
                                ...
                                <article>
                                    ...
                                    <div
                                        ...
                                        <h2 class="h5 g-color-black g-font-weight-600 mb-3">
                                            <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer"
                                                href="#!">New Rolls Royce Wraith coupe</a>
                                        </h2>
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">Once someone starts using
                                            your app, they need to know where to go.</p>
                                        <a class="g-font-size-13" href="#!">Read more...</a>
                                    </div>
                                </article>
                                <!-- End Blog Minimal Blocks -->
                            ...
                            <div class="masonry-grid-item col-sm-6 g-mb-30">
                                ...
                                <article>
                                    <img class="img-fluid w-100" src="assets/img-temp/500x450/img8.jpg"
                                        alt="Image Description">
                                    <div
                                        class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-25 g-mt-minus-50 mx-auto">
                                        <span
                                        ...
                                        <h2 class="h5 g-color-black g-font-weight-600 mb-3">
                                            <a class="u-link-v5 g-color-black g-color-primary--hover g-cursor-pointer"
                                                href="#!">#c0ffee is the color</a>
                                        </h2>
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">What real worlds are
                                            actually valid CSS HEX colors? Pasring an English dictionary...</p>
                                        <a class="g-font-size-13" href="#!">Read more...</a>
                                    </div>
                                </article>
                            ...
                            <div class="masonry-grid-item col-sm-6 g-mb-30">
                                <!-- Blog Grid Overlap Blocks -->
                                <article>
                                    <img class="img-fluid w-100" src="assets/img-temp/500x450/img7.jpg"
                                        alt="Image Description">
                                    <div
                                        class="g-width-80x g-bg-white g-pos-rel g-z-index-1 g-pa-25 g-mt-minus-50 mx-auto">
                                        <span
                                        ...
                                        <p class="g-color-gray-dark-v4 g-line-height-1_8">I’ve made exceptions a
                                            handful of times over the years.</p>
                                        <a class="g-font-size-13" href="#!">Read more...</a>
                                    </div>
                                </article>
                                <!-- End Blog Grid Overlap Blocks -->
                    ...
                    <div class="g-pr-20--lg">
                        ...
                        <div class="g-mb-50">
                            ...
                            <ul class="list-unstyled g-font-size-13 mb-0">
                                <li><a class="d-block u-link-v5 g-color-gray-dark-v4 rounded g-px-20 g-py-8"
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                            <button class="btn u-btn-primary g-rounded-left-50 g-py-13 g-px-20">
                                                <i
                                                    class="icon-communication-062 u-line-icon-pro g-pos-rel g-top-1"></i>
                                            </button>
                                        </span>
                                        <input
