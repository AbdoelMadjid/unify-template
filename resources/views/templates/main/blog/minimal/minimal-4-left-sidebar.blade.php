                ...
                <div class="col-lg-9 order-lg-2 g-mb-80">
                    <div class="g-pl-20--lg">
                        ...
                        <article class="g-mx-15 u-block-hover">
                            <div class="g-px-100--md g-py-30--md">
                                ...
                                <h2 class="h2 g-color-black g-font-weight-600 mb-4">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">Talking
                                        Why Her?</a>
                                </h2>
                            </div>
                            <div class="g-overflow-hidden">
                                <img class="img-fluid w-100 u-block-hover__main--mover-down"
                                    src="assets/img-temp/900x400/img1.jpg" alt="Image Description">
                            </div>
                            <div class="g-px-100--md g-py-30--md">
                                <div class="mb-4">
                                    <p class="g-font-size-18 g-line-height-2 mb-0">Working together on the daily
                                        requires each individual to let the greater good of the team’s work surface
                                        above their own ego. It’s important to stay detail oriented with every project
                                        we tackle.</p>
                                </div>
                        ...
                        <article class="g-mx-15 u-block-hover">
                            ...
                            <div class="g-overflow-hidden">
                                <img class="img-fluid w-100 u-block-hover__main--mover-down"
                                    src="assets/img-temp/900x400/img2.jpg" alt="Image Description">
                            </div>
                            <div class="g-px-100--md g-py-30--md">
                                <div class="mb-4">
                                    <p class="g-font-size-18 g-line-height-2 mb-0">Working together on the daily
                        ...
                        <article class="row align-items-center u-block-hover">
                            ...
                            <div class="col-md-6 g-mb-30">
                                <div class="g-pa-30--md">
                                    ...
                                    <h2 class="h3 g-color-black g-font-weight-600 mb-4">
                                        <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">In
                                            the future, design principles won’t be about design</a>
                                    </h2>
                                    <a class="g-color-gray-dark-v2 g-color-primary--hover g-font-weight-600 g-font-size-12 g-text-underline--none--hover text-uppercase"
                                        href="#!">Read more ...</a>
                                </div>
