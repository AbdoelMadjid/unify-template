                ...
                <div class="col-lg-9 g-mb-80">
                    <div class="g-pr-20--lg">
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <span
                                    class="d-block g-color-gray-dark-v4 g-font-weight-700 g-font-size-12 text-uppercase mb-2">1
                                    June 2017</span>
                            ...
                            <ul class="list-inline g-brd-y g-brd-gray-light-v3 g-font-size-13 g-py-13 mb-0">
                                ...
                                <li class="list-inline-item g-color-gray-dark-v4">
                                    <a class="d-inline-block g-color-gray-dark-v4 g-color-white--hover g-bg-gray-dark-v2--hover rounded g-transition-0_3 g-text-underline--none--hover g-px-15 g-py-5"
                                        href="#!">
                                        <i
                                            class="align-middle g-font-size-default mr-1 icon-medical-022 u-line-icon-pro"></i>
                                        57 Likes
                                    </a>
                                </li>
                            </ul>
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <span
                                    class="d-block g-color-gray-dark-v4 g-font-weight-700 g-font-size-12 text-uppercase mb-2">31
                                    May 2017</span>
                                <h2 class="h4 g-color-black g-font-weight-600 mb-3">
                                ...
                                <p class="g-color-gray-dark-v4 g-line-height-1_8">At Wake, our mission has always been
                                    ...
                                    empowers them to make better products.</p>
                                <a class="g-font-size-13" href="#!">Read more...</a>
                            </div>
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                ...
                                <p class="g-color-gray-dark-v4 g-line-height-1_8">In an attempt to answer those
                                    ...
                                    internet [1][2], and came to the following conclusion: corporate design principles
                                    are a set of shared guidelines that reflect the
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <span
                                    ...
                                    May 2017</span>
                                <h2 class="h4 g-color-black g-font-weight-600 mb-3">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">A UX
                                        strategy for the Ultimate Product Launch</a>
                                </h2>
                                <p class="g-color-gray-dark-v4 g-line-height-1_8">Product teams working with low
                                    access to users and a long time to market, usually enterprise level services and the
                                    like, need to make the most of their time, to compensate for access to users.</p>
                                <a class="g-font-size-13" href="#!">Read more...</a>
                            </div>
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <span
                                    ...
                                    June 2017</span>
                                <h2 class="h4 g-color-black g-font-weight-600 mb-3">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">Creating
                                        a New Language for Nutrition: McDonald’s Universal
                                        Icons for 109 Countries</a>
                                </h2>
                                <p class="g-color-gray-dark-v4 g-line-height-1_8">How ENLASO helped McDonald’s to
                                    culturally localize nutrition icons by distilling over 13,000 comments from
                                    iconographers for 109 countries</p>
                                <a class="g-font-size-13" href="#!">Read more...</a>
                            </div>
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <span
                                    ...
                                    May 2017</span>
                                <h2 class="h4 g-color-black g-font-weight-600 mb-3">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover" href="#!">The
                                        Hypnotic Allure of Cinemagraphic Waves</a>
                                </h2>
                                <p class="g-color-gray-dark-v4 g-line-height-1_8">Ocean waves are, by definition, in a
                                    constant state of motion. They swell, surge, crest, and break, and then ebb into
                                    another pulse of water.</p>
                                <a class="g-font-size-13" href="#!">Read more...</a>
                            </div>
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <span
                                    class="d-block g-color-gray-dark-v4 g-font-weight-700 g-font-size-12 text-uppercase mb-2">29
                                    May 2017</span>
                                <h2 class="h4 g-color-black g-font-weight-600 mb-3">
                                    <a class="u-link-v5 g-color-black g-color-primary--hover"
                                        href="#!">Accessibility - Apple</a>
                                </h2>
                                <p class="g-color-gray-dark-v4 g-line-height-1_8">Apple Watch now has fitness
                                    algorithms designed for wheelchair users. Instead of steps, the Workout and Activity
                                    apps track your pushes and keep you motivated.</p>
                                <a class="g-font-size-13" href="#!">Read more...</a>
                            </div>
                            ...
                            <ul class="list-unstyled g-font-size-13 mb-0">
                                <li>
                                    <a class="d-block u-link-v5 g-color-gray-dark-v4 rounded g-px-20 g-py-8"
                                        href="#!"><i class="mr-2 fa fa-angle-right"></i> People</a>
                                </li>
                                <li>
                                    <a class="d-block u-link-v5 g-color-gray-dark-v4 rounded g-px-20 g-py-8"
                                        href="#!"><i class="mr-2 fa fa-angle-right"></i> News Publications</a>
                                </li>
                                <li>
                                    <a class="d-block u-link-v5 g-color-gray-dark-v4 rounded g-px-20 g-py-8"
                                        href="#!"><i class="mr-2 fa fa-angle-right"></i> Marketing &amp; IT</a>
                                </li>
                                <li>
                                    <a class="d-block u-link-v5 g-color-gray-dark-v4 rounded g-px-20 g-py-8"
                                        href="#!"><i class="mr-2 fa fa-angle-right"></i> Business Strategy</a>
                                </li>
                                <li>
