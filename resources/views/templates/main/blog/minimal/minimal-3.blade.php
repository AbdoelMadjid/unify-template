                ...
                <div class="col-lg-7">
                    ...
                    <article class="g-mb-100">
                        ...
                        <div class="px-4">
                            ...
                            <h2 class="h5 g-color-black g-font-weight-600"><a
                    ...
                    <article class="g-mb-100">
                        ...
                        <div class="px-4">
                            ...
                            <p class="g-color-gray-dark-v4">At Wake, our mission has always been focused on bringing
                                ...
                                a space where designers can share ongoing work not only empowers them to make better
                                products.</p>
                            <a class="g-font-weight-700 g-font-size-13" href="#!">read more</a>
                        </div>
                    </article>
                    ...
                    <article class="g-mb-100">
                        ...
                        <div class="px-4">
                            ...
                            <p class="g-color-gray-dark-v4">In an attempt to answer those questions, I poured over the
                                biggest collections of design principles on the internet [1][2], and came to the
                                following conclusion: corporate design principles are a set of shared guidelines that
                                reflect the
