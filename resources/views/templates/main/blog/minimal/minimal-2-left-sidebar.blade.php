                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <div class="media g-mb-25">
                                    <img class="d-flex g-width-40 g-height-40 rounded-circle mr-2"
                                        src="assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                    <div class="media-body">
                                        <h4 class="h6 g-color-primary mb-0"><a href="#!">Alex Teseira</a></h4>
                                        <span class="d-block g-color-gray-dark-v4 g-font-size-12">May 31 2017 - 5 min
                                            read</span>
                                    </div>
                                </div>
                            ...
                            <ul
                                class="d-flex justify-content-end list-inline g-brd-y g-brd-gray-light-v3 g-font-size-13 g-py-13 mb-0">
                                <li class="list-inline-item mr-auto">
                                    <i
                                        class="align-middle g-color-primary g-font-size-default mr-1 icon-medical-022 u-line-icon-pro"></i>
                                    <a class="g-color-gray-dark-v4 g-color-primary--hover g-transition-0_3 g-text-underline--none--hover"
                                        href="#!">5k</a>
                                </li>
                                <li class="list-inline-item mr-4">
                                    <i
                                        class="align-middle g-color-primary g-font-size-default mr-1 icon-finance-206 u-line-icon-pro"></i>
                                    <a class="d-inline-block g-color-gray-dark-v4 g-text-underline--none--hover"
                                        href="#!">10 Comments</a>
                                </li>
                                <li class="list-inline-item">
                                    <i
                                        class="align-middle g-color-primary g-font-size-default mr-1 fa fa-bookmark-o"></i>
                                    <a class="d-inline-block g-color-gray-dark-v4 g-text-underline--none--hover"
                                        href="#!">Bookmark</a>
                                </li>
                            </ul>
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <div class="media g-mb-25">
                                    ...
                                    <div class="media-body">
                                        <h4 class="h6 g-color-primary mb-0"><a href="#!">Sara Kajevnikova</a>
                                        </h4>
                                        <span class="d-block g-color-gray-dark-v4 g-font-size-12">June 1 2017 - 8 min
                                            read</span>
                                    </div>
                                </div>
                        ...
                        <article class="g-mb-100">
                            <div class="g-mb-30">
                                <div class="media g-mb-25">
                                    ...
                                    <div class="media-body">
                                        <h4 class="h6 g-color-primary mb-0"><a href="#!">Alex Teseira</a></h4>
                                        <span class="d-block g-color-gray-dark-v4 g-font-size-12">June 2 2017 - 4 min
                                            read</span>
                                    </div>
                                </div>

                                <img class="img-fluid w-100 g-mb-25" src="assets/img-temp/740x380/img3.jpg"
                                    alt="Image Description">
                                <h2 class="h4 g-color-black g-font-weight-600 mb-3">
