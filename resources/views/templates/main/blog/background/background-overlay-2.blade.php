        ...
        <div class="container g-py-100">
            <div class="masonry-grid row g-mb-70">
                ...
                <div class="masonry-grid-item col-sm-6 g-mb-30">
                    ...
                    <article class="u-block-hover">
                        <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--mover-down" src="assets/img-temp/500x450/img1.jpg"
                ...
                <div class="masonry-grid-item col-sm-6 g-mb-30">
                    ...
                    <article class="u-block-hover">
                        <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--mover-down" src="assets/img-temp/500x450/img5.jpg"
                                alt="Image Description">
                        </div>
                        <div class="g-pos-abs g-top-0 g-right-0 g-z-index-1 g-pa-35">
                            <span class="d-block g-color-white g-font-weight-600 g-font-size-12">June 1, 2017</span>
                ...
                <div class="masonry-grid-item col-sm-6 g-mb-30">
                    ...
                    <article class="u-block-hover">
                        <div class="g-bg-cover g-bg-white-gradient-opacity-v1--after">
                            <img class="u-block-hover__main--mover-down" src="assets/img-temp/500x450/img6.jpg"
                                alt="Image Description">
                        </div>
                        <div class="g-pos-abs g-top-0 g-right-0 g-z-index-1 g-pa-35">
                            <span class="d-block g-color-white g-font-weight-600 g-font-size-12">June 1, 2017</span>
