        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-3 g-hidden-md-down">
                    <a href="unify/blogmagazine/classic/page-1" class="navbar-brand">
                    ...
                    <a id="account-dropdown-invoker"
                        ...
                        <div class="d-flex g-width-30 g-height-30 mr-2">
                            <img class="img-fluid rounded-circle"
                                src="blogmagazine/classic/assets/img-temp/100x100/img11.jpg" alt="Image Description">
                        </div>
    ...
    <div class="u-header__section u-header__section--light g-bg-white g-transition-0_3 g-py-10">
        <nav class="js-mega-menu navbar navbar-expand-lg g-px-0">
            <div class="container g-px-15">
                <!-- Logo -->
                <a class="navbar-brand g-hidden-lg-up" href="unify/blogmagazine/classic/page-1">
                    <img src="blogmagazine/classic/assets/img/logo.png" alt="Logo">
                </a>
                <!-- End Logo -->
                    ...
                    <ul class="navbar-nav g-font-weight-600">
                            ...
                            <ul id="nav-submenu--home"
                                ...
                                <li class="dropdown-item g-bg-secondary--hover">
                                    <a class="nav-link g-color-secondary-dark-v1"
                                        href="unify/blogmagazine/classic/page-1">Home Default</a>
                                </li>
                                <li class="dropdown-item g-bg-secondary--hover">
                                    <a class="nav-link g-color-secondary-dark-v1"
                                        href="unify/blogmagazine/classic/page-2">Home Option 2
                                        <span
                                ...
                                <li class="dropdown-item g-bg-secondary--hover">
                                    <a class="nav-link g-color-secondary-dark-v1"
                                        href="unify/blogmagazine/classic/page-3">Home Option 3
                                        <span
                                            class="float-right u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                                    </a>
                                </li>
                                <li class="dropdown-item g-bg-secondary--hover">
                                    <a class="nav-link g-color-secondary-dark-v1"
                                        href="unify/blogmagazine/classic/page-4">Home Option 4
                                        <span
                                            class="float-right u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                                    </a>
                                </li>
                                <li class="dropdown-item g-bg-secondary--hover">
                                    <a class="nav-link g-color-secondary-dark-v1"
                                        href="unify/blogmagazine/classic/page-5">Home Option 5
                                        <span
                                            class="float-right u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item hs-has-sub-menu g-mx-10--lg g-mx-20--xl">
                            ...
                            <ul id="nav-submenu--pages"
                                ...
                                <li class="dropdown-item g-bg-secondary--hover">
                                    <a class="nav-link g-color-secondary-dark-v1"
                                        href="unify/blogmagazine/classic/single-1">Single
                                        Page</a>
                                </li>
                            </ul>
                            <!-- End Submenu -->
                        ...
                        <!-- Mega Menu Item -->
                        <li class="hs-has-mega-menu nav-item g-mx-10--lg g-mx-20--xl" data-animation-in="fadeIn"
                                        ...
                                        <article class="u-block-hover">
                                            ...
                                            <header class="g-pos-abs g-bottom-10 g-left-20 g-right-20">
                                                ...
                                                <h3 class="h4 g-font-weight-600 g-mt-5">
                                                    <a class="g-color-white g-color-white--hover" href="#!">Be
                                                        ready, fashion of the year is coming
                                                        this year</a>
                                                </h3>
                                            </header>
                                        </article>
                                    ...
                                    <div class="col-lg-4">
                                        <article class="u-block-hover">
                                            ...
                                            <header class="g-pos-abs g-bottom-10 g-left-20 g-right-20">
                                                ...
                                                <h3 class="h4 g-font-weight-600 g-mt-5">
                                                    <a class="g-color-white g-color-white--hover" href="#!">Must
                                                        be visited places in the USA -
                                                        Florida Beaches</a>
                                                </h3>
                                            </header>
                                        </article>
                                    ...
                                    <div class="col-lg-4">
                                        <article class="u-block-hover">
                                            ...
                                            <header class="g-pos-abs g-bottom-10 g-left-20 g-right-20">
                                                ...
                                                <h3 class="h4 g-font-weight-600 g-mt-5">
                                                    <a class="g-color-white g-color-white--hover" href="#!">Why
                                                        your next glass of juice will cost
                                                        you more</a>
                                                </h3>
                                            </header>
                                        </article>
                                    ...
                                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                        <article class="u-block-hover">
                                            ...
                                            <span class="g-pos-abs g-top-20 g-left-20">
                                                ...
                                                <a class="btn btn-sm u-btn-black rounded-0" href="#!">July 06,
                                                    2016</a>
                                            </span>
                                            <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                                ...
                                                <h3 class="h5 g-font-weight-300 g-mb-0">
                                                    <a class="g-color-white g-color-white--hover" href="#!">Best
                                                        work places around the World for
                                                        your company</a>
                                                </h3>
                                            </div>
                                        </article>
                                    ...
                                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                        <article class="u-block-hover">
                                            ...
                                            <span class="g-pos-abs g-top-20 g-left-20">
                                                ...
                                                <a class="btn btn-sm u-btn-black rounded-0" href="#!">July 15,
                                                    2016</a>
                                            </span>
                                            <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                                <ul class="list-inline g-font-size-12 g-color-white g-mb-5">
                                                ...
                                                <h3 class="h5 g-font-weight-300 g-mb-0">
                                                    <a class="g-color-white g-color-white--hover" href="#!">Top
                                                        10 bust be used iOS apps for your
                                                        next project</a>
                                                </h3>
                                            </div>
                                        </article>
                                    ...
                                    <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                                        <article class="u-block-hover">
                                            ...
                                            <span class="g-pos-abs g-top-20 g-left-20">
                                                ...
                                                <a class="btn btn-sm u-btn-black rounded-0" href="#!">July 22,
                                                    2016</a>
                                            </span>
                                            <div class="g-pos-abs g-bottom-20 g-left-20 g-right-20">
                                                <ul class="list-inline g-font-size-12 g-color-white g-mb-5">
                        ...
                        <!-- Mega Menu Item -->
                        <li class="hs-has-mega-menu nav-item g-mx-10--lg g-ml-15--xl" data-animation-in="fadeIn"
                            data-animation-out="fadeOut" data-position="right">
